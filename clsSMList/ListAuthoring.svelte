                    ...
                    <div class="col-12">
                        ...
                        <div>
                            <span class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title={((handle_disable) ? l.new_not_allowed: l.csv_file)}>
                                <button class={"btn btn-primary btn-md" + ((handle_disable) ? " pointer_event_none": "")} data-cy="import_csv_btn" name="import_csv_btn" on:click={handleImport} disabled={handle_disable}>{l.import_csv}</button>
                            </span>
                            <input id="fileUpload" type="file" on:change={uploadCsv} class="upload h" />
                            <span class="d-inline-block ml-2" data-cy="generate_question_btn" data-bs-toggle="tooltip" data-bs-placement="top" title={((handle_generate) ? ((handle_disable) ? l.already_generated: l.save_war_msg): ((handle_disable) ? l.new_row_tooltip: l.generate_items))}>
                            ...
                            <span class="d-inline-block ml-2" data-bs-toggle="tooltip" data-bs-placement="top" title={((state.handle_disable_show) ? ((handle_disable) ? l.child_not_selected: l.child_not_generated): l.show_all)}>
                                <button class={"btn btn-primary btn-md width125" + ((state.handle_disable_show) ? " pointer_event_none": "")} name="show_all_child" data-cy="show_all_child" id="show_all_child" disabled={state.handle_disable_show} on:click={showAllChild}>{((state.selected_length > 0) ? l.show_all_label + ' (' + state.selected_length +')': l.show_all_label)}</button>
                            </span>
                        </div>
