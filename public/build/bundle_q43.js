    ...
    class JUI extends API{
        ...
        getBS(target, comp, options) {
            ...
            if (selected && this.bsCat1.includes(comp)) {
                let isIns = bootstrap[comp].getInstance && bootstrap[comp].getInstance(selected);
                if (isIns) {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b0, file$1, 510, 20, 24592);
    			attr_dev(div0, "class", "");
    			attr_dev(div0, "tabindex", "0");
    			attr_dev(div0, "aria-label", "Recording will end after 15 sec");
    			add_location(div0, file$1, 509, 16, 24499);
    			attr_dev(div1, "class", "col-12 pb-3");
    			add_location(div1, file$1, 508, 12, 24457);
    			add_location(b1, file$1, 522, 103, 25453);
    			attr_dev(div2, "class", "p-2 tokenfield bg-light mb-3");
    			attr_dev(div2, "aria-label", "Audio Recorder");
    			attr_dev(div2, "tabindex", "0");
    			add_location(div2, file$1, 522, 20, 25370);
    			...
    			add_location(span0, file$1, 524, 24, 25613);
    			...
    			add_location(span1, file$1, 541, 28, 27017);
    			attr_dev(button0, "type", "button");
    			...
    			add_location(button0, file$1, 533, 24, 26603);
    			...
    			add_location(span2, file$1, 552, 28, 27793);
    			attr_dev(button1, "type", "button");
    			...
    			add_location(button1, file$1, 543, 24, 27331);
    			...
    			add_location(span3, file$1, 567, 28, 28726);
    			...
    			add_location(button2, file$1, 554, 24, 28036);
    			...
    			add_location(div6, file$1, 532, 20, 26438);
    			attr_dev(div7, "class", "border rounded shadow-sm");
    			add_location(div7, file$1, 521, 16, 25311);
    			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
    			add_location(div8, file$1, 520, 12, 25253);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$1, 516, 62, 24874);
    			attr_dev(label, "for", "preview_show_transcript");
    			add_location(label, file$1, 516, 25, 24837);
    			add_location(div0, file$1, 516, 20, 24832);
    			...
    			add_location(textarea, file$1, 517, 20, 24932);
    			attr_dev(div1, "class", "col-12 pb-3");
    			add_location(div1, file$1, 515, 16, 24786);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 492, 20, 23569);
    			attr_dev(div, "class", "col-12 py-3");
    			add_location(div, file$1, 491, 16, 23523);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 480, 20, 23028);
    			attr_dev(div, "class", "col-12 py-3");
    			add_location(div, file$1, 479, 16, 22982);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, textarea);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 581, 20, 29397);
    			attr_dev(div2, "class", "modal-header");
    			add_location(div2, file$1, 579, 16, 29222);
    			...
    			add_location(div3, file$1, 583, 16, 29619);
    			attr_dev(button1, "type", "button");
    			...
    			add_location(button1, file$1, 587, 20, 29882);
    			attr_dev(button2, "type", "button");
