    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b0, file$1, 566, 20, 26751);
    			attr_dev(div0, "class", "");
    			attr_dev(div0, "tabindex", "0");
    			attr_dev(div0, "aria-label", "Recording will end after 15 sec");
    			add_location(div0, file$1, 565, 16, 26658);
    			attr_dev(div1, "class", "col-12 pb-3");
    			add_location(div1, file$1, 564, 12, 26616);
    			add_location(b1, file$1, 578, 103, 27612);
    			attr_dev(div2, "class", "p-2 tokenfield bg-light mb-3");
    			attr_dev(div2, "aria-label", "Audio Recorder");
    			attr_dev(div2, "tabindex", "0");
    			add_location(div2, file$1, 578, 20, 27529);
    			...
    			add_location(span0, file$1, 580, 24, 27772);
    			...
    			add_location(span1, file$1, 597, 28, 29176);
    			attr_dev(button0, "type", "button");
    			...
    			add_location(button0, file$1, 589, 24, 28762);
    			...
    			add_location(span2, file$1, 608, 28, 29995);
    			attr_dev(button1, "type", "button");
    			...
    			add_location(button1, file$1, 599, 24, 29533);
    			...
    			add_location(span3, file$1, 623, 28, 30928);
    			...
    			add_location(button2, file$1, 610, 24, 30238);
    			...
    			add_location(div6, file$1, 588, 20, 28597);
    			attr_dev(div7, "class", "border rounded shadow-sm");
    			add_location(div7, file$1, 577, 16, 27470);
    			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
    			add_location(div8, file$1, 576, 12, 27412);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$1, 572, 62, 27033);
    			attr_dev(label, "for", "preview_show_transcript");
    			add_location(label, file$1, 572, 25, 26996);
    			add_location(div0, file$1, 572, 20, 26991);
    			...
    			add_location(textarea, file$1, 573, 20, 27091);
    			attr_dev(div1, "class", "col-12 pb-3");
    			add_location(div1, file$1, 571, 16, 26945);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 548, 20, 25685);
    			attr_dev(div, "class", "col-12 py-3");
    			add_location(div, file$1, 547, 16, 25639);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 536, 20, 25144);
    			attr_dev(div, "class", "col-12 py-3");
    			add_location(div, file$1, 535, 16, 25098);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, textarea);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 637, 20, 31599);
    			attr_dev(div2, "class", "modal-header");
    			add_location(div2, file$1, 635, 16, 31424);
    			...
    			add_location(div3, file$1, 639, 16, 31821);
    			attr_dev(button1, "type", "button");
    			...
    			add_location(button1, file$1, 643, 20, 32084);
    			attr_dev(button2, "type", "button");
