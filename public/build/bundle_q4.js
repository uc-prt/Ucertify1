...
var app = (function () {
    ...
    function add_css$1() {
    	...
    	style.textContent = "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "h h-imp svelte_items_test");
    			attr_dev(button0, "id", "set-review");
    			add_location(button0, file$1, 577, 4, 19029);
    			attr_dev(button1, "tabindex", "0");
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "h h-imp svelte_items_test");
    			attr_dev(button1, "id", "unset-review");
    			add_location(button1, file$1, 578, 4, 19128);
    			attr_dev(div, "class", "h h-imp");
    			attr_dev(div, "id", "review_buttons");
    			add_location(div, file$1, 576, 3, 18983);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button0);
    ...
    // (568:2) {#if moduleArr[item_type] == "1" || moduleArr[item_type] == "2"}
    function create_if_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(568:2) {#if moduleArr[item_type] == \\\"1\\\" || moduleArr[item_type] == \\\"2\\\"}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 645, 7, 21261);
    			attr_dev(span1, "class", "position-relative bottom1");
    			add_location(span1, file$1, 646, 7, 21352);
    			...
    			add_location(div0, file$1, 641, 6, 21083);
    			...
    			add_location(div1, file$1, 633, 5, 20882);
    			...
    			add_location(div2, file$1, 649, 5, 21435);
    			attr_dev(center, "key", "imageHeight_3");
    			add_location(center, file$1, 632, 4, 20848);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, center, anchor);
    ...
    // (584:3) {#if moduleArr[item_type] == "4"}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 602, 10, 19950);
    			...
    			add_location(div0, file$1, 611, 10, 20236);
    			...
    			add_location(span, file$1, 618, 10, 20505);
			...
			: ""};
    			...
    			add_location(div1, file$1, 589, 9, 19580);
    			attr_dev(div2, "id", "SM0");
    			attr_dev(div2, "class", "relative");
    			add_location(div2, file$1, 588, 8, 19539);
    			attr_dev(td, "class", "border");
    			add_location(td, file$1, 587, 7, 19511);
    			add_location(tr, file$1, 586, 6, 19499);
    			add_location(tbody, file$1, 585, 5, 19485);
    			attr_dev(table, "id", "hptmain0");
    			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table no_overflow_wrapper");
    			add_location(table, file$1, 584, 4, 19381);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(584:3) {#if moduleArr[item_type] == \\\"4\\\"}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 663, 6, 21858);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 581, 2, 19247);
    			add_location(center, file$1, 566, 1, 18705);
    			...
    			add_location(input, file$1, 674, 1, 22107);
    			attr_dev(main, "class", "pt-0 svelte-11usv4u");
    			add_location(main, file$1, 565, 0, 18684);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
