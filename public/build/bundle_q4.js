...
var app = (function () {
    ...
    function add_css$1() {
    	...
    	style.textContent = "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 599, 7, 19754);
    			attr_dev(span1, "class", "position-relative bottom1");
    			add_location(span1, file$1, 600, 7, 19845);
    			...
    			add_location(div0, file$1, 595, 6, 19576);
    			...
    			add_location(div1, file$1, 587, 5, 19375);
    			...
    			add_location(div2, file$1, 603, 5, 19928);
    			attr_dev(center, "key", "imageHeight_3");
    			add_location(center, file$1, 586, 4, 19341);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, center, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 547, 10, 18317);
    			...
    			add_location(div0, file$1, 556, 10, 18603);
    			...
    			add_location(span, file$1, 569, 10, 18954);
			...
			: ""};
    			...
    			add_location(div1, file$1, 534, 9, 17947);
    			attr_dev(div2, "id", "SM0");
    			attr_dev(div2, "class", "relative");
    			add_location(div2, file$1, 533, 8, 17906);
    			attr_dev(td, "class", "border");
    			add_location(td, file$1, 532, 7, 17878);
    			add_location(tr, file$1, 531, 6, 17866);
    			add_location(tbody, file$1, 530, 5, 17852);
    			attr_dev(table, "id", "hptmain0");
    			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
    			add_location(table, file$1, 529, 4, 17768);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 617, 6, 20330);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 526, 2, 17634);
    			add_location(center, file$1, 520, 1, 17502);
    			...
    			add_location(input, file$1, 636, 1, 20819);
    			attr_dev(main, "class", "svelte-11usv4u");
    			add_location(main, file$1, 519, 0, 17494);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
