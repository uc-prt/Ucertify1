...
var app = (function () {
    ...
    function add_css$1() {
    	...
    	style.textContent = "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 637, 7, 20541);
    			attr_dev(span1, "class", "position-relative bottom1");
    			add_location(span1, file$1, 638, 7, 20632);
    			...
    			add_location(div0, file$1, 633, 6, 20363);
    			...
    			add_location(div1, file$1, 625, 5, 20162);
    			...
    			add_location(div2, file$1, 641, 5, 20715);
    			attr_dev(center, "key", "imageHeight_3");
    			add_location(center, file$1, 624, 4, 20128);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, center, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 585, 10, 19104);
    			...
    			add_location(div0, file$1, 594, 10, 19390);
    			...
    			add_location(span, file$1, 607, 10, 19741);
			...
			: ""};
    			...
    			add_location(div1, file$1, 572, 9, 18734);
    			attr_dev(div2, "id", "SM0");
    			attr_dev(div2, "class", "relative");
    			add_location(div2, file$1, 571, 8, 18693);
    			attr_dev(td, "class", "border");
    			add_location(td, file$1, 570, 7, 18665);
    			add_location(tr, file$1, 569, 6, 18653);
    			add_location(tbody, file$1, 568, 5, 18639);
    			attr_dev(table, "id", "hptmain0");
    			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table no_overflow_wrapper");
    			add_location(table, file$1, 567, 4, 18535);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 655, 6, 21117);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 564, 2, 18401);
    			add_location(center, file$1, 554, 1, 18126);
    			...
    			add_location(input, file$1, 666, 1, 21366);
    			attr_dev(main, "class", "svelte-11usv4u");
    			add_location(main, file$1, 553, 0, 18118);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span1, file$2, 441, 32, 16638);
    			...
    			add_location(span2, file$2, 426, 28, 15854);
