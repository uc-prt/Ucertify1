...
var app = (function () {
    ...
    function add_css$1() {
    	...
    	style.textContent = "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 588, 7, 19456);
    			attr_dev(span1, "class", "position-relative bottom1");
    			add_location(span1, file$1, 589, 7, 19547);
    			...
    			add_location(div0, file$1, 584, 6, 19278);
    			...
    			add_location(div1, file$1, 576, 5, 19077);
    			...
    			add_location(div2, file$1, 592, 5, 19630);
    			attr_dev(center, "key", "imageHeight_3");
    			add_location(center, file$1, 575, 4, 19043);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, center, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 536, 10, 18019);
    			...
    			add_location(div0, file$1, 545, 10, 18305);
    			...
    			add_location(span, file$1, 558, 10, 18656);
			...
			: ""};
    			...
    			add_location(div1, file$1, 523, 9, 17649);
    			attr_dev(div2, "id", "SM0");
    			attr_dev(div2, "class", "relative");
    			add_location(div2, file$1, 522, 8, 17608);
    			attr_dev(td, "class", "border");
    			add_location(td, file$1, 521, 7, 17580);
    			add_location(tr, file$1, 520, 6, 17568);
    			add_location(tbody, file$1, 519, 5, 17554);
    			attr_dev(table, "id", "hptmain0");
    			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
    			add_location(table, file$1, 518, 4, 17470);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 606, 6, 20032);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 515, 2, 17336);
    			add_location(center, file$1, 510, 1, 17241);
    			...
    			add_location(input, file$1, 617, 1, 20281);
    			attr_dev(main, "class", "svelte-11usv4u");
    			add_location(main, file$1, 509, 0, 17233);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
