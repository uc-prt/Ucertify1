...
var app = (function () {
    ...
    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-1gqfssy-style";
    	style.textContent = "main.svelte-1gqfssy{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-1gqfssy{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-1gqfssy{display:block}@media(min-width: 640px){main.svelte-1gqfssy{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 588, 7, 19482);
    			attr_dev(span1, "class", "position-relative bottom1");
    			add_location(span1, file$1, 589, 7, 19573);
    			...
    			add_location(div0, file$1, 584, 6, 19304);
    			...
    			add_location(div1, file$1, 576, 5, 19103);
    			...
    			add_location(div2, file$1, 592, 5, 19656);
    			attr_dev(center, "key", "imageHeight_3");
    			add_location(center, file$1, 575, 4, 19069);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, center, anchor);
    ...
    // (518:3) {#if moduleArr[item_type] == "4"}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 536, 10, 18045);
    			...
    			add_location(div0, file$1, 545, 10, 18331);
    			attr_dev(span, "id", "target");
    			attr_dev(span, "class", "target targetImg icomoon-plus-circle-2 svelte-1gqfssy");
    			...
    			add_location(span, file$1, 558, 10, 18682);
			...
			: ""};
    			...
    			add_location(div1, file$1, 523, 9, 17675);
    			attr_dev(div2, "id", "SM0");
    			attr_dev(div2, "class", "relative");
    			add_location(div2, file$1, 522, 8, 17634);
    			attr_dev(td, "class", "border");
    			add_location(td, file$1, 521, 7, 17606);
    			add_location(tr, file$1, 520, 6, 17594);
    			add_location(tbody, file$1, 519, 5, 17580);
    			attr_dev(table, "id", "hptmain0");
    			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
    			add_location(table, file$1, 518, 4, 17496);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(518:3) {#if moduleArr[item_type] == \\\"4\\\"}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 606, 6, 20058);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 515, 2, 17362);
    			add_location(center, file$1, 510, 1, 17267);
    			...
    			add_location(input, file$1, 617, 1, 20307);
    			attr_dev(main, "class", "svelte-1gqfssy");
    			add_location(main, file$1, 509, 0, 17259);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    			...
    			case "4":
    				{
    					...
    					$$invalidate(6, itemAreaTop = parseInt(parseXml.smxml.div._top) + 2 + "px");
    					let image = new Image();
    ...
    class HotspotPreview extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document_1$1.getElementById("svelte-1gqfssy-style")) add_css$1();
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span1, file$2, 441, 32, 16647);
    			...
    			add_location(span2, file$2, 426, 28, 15863);
