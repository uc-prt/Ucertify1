...
var app = (function () {
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 51, 40, 2860);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 42, 44, 2279);
    			add_location(div, file$1, 41, 40, 2229);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "tabindex", "0");
    			attr_dev(div, "title", div_title_value = /*col*/ ctx[9].label);
    			add_location(div, file$1, 33, 40, 1726);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = raw_value;
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", img_alt_value = /*col*/ ctx[9].imagealt);
    			attr_dev(img, "title", img_title_value = /*col*/ ctx[9].imagealt);
    			add_location(img, file$1, 25, 40, 1185);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*nextbutton, state, onImgLoad, ignoreItemIds, prevbutton*/ 1924) {
    ...
    // (701:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}
    function create_if_block_4$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*state*/ ctx[2].correct_match["category_" + /*dataj*/ ctx[40].sequence] == false && create_if_block_5$1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*state*/ ctx[2].correct_match["category_" + /*dataj*/ ctx[40].sequence] == false) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(701:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}",
    		ctx
    	});
    ...
    // (702:48) {#if state.correct_match['category_'+ dataj.sequence] == false}
    function create_if_block_5$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 702, 52, 36190);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*state*/ 4 && div_seq_no_value !== (div_seq_no_value = "category_" + /*dataj*/ ctx[40].sequence)) {
    				attr_dev(div, "seq_no", div_seq_no_value);
    			}

    			if (dirty[0] & /*state*/ 4 && div_key_value !== (div_key_value = /*dataj*/ ctx[40].id)) {
    				attr_dev(div, "key", div_key_value);
    			}

    			if (dirty[0] & /*state*/ 4 && div_data_tags_value !== (div_data_tags_value = /*dataj*/ ctx[40].tags)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(702:48) {#if state.correct_match['category_'+ dataj.sequence] == false}",
    		ctx
    	});
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 706, 60, 36876);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = raw_value;
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 4 && raw_value !== (raw_value = /*dataj*/ ctx[40].label + "")) div.innerHTML = raw_value;
    			if (dirty[0] & /*state*/ 4 && div_title_value !== (div_title_value = /*dataj*/ ctx[40].label)) {
    				attr_dev(div, "title", div_title_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_6$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 704, 60, 36463);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 4 && img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static//" + /*dataj*/ ctx[40].imageurl)) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty[0] & /*state*/ 4 && img_alt_value !== (img_alt_value = /*dataj*/ ctx[40].imagealt
    			? /*dataj*/ ctx[40].imagealt
    			: "No alt of image")) {
    				attr_dev(img, "alt", img_alt_value);
    			}

    			if (dirty[0] & /*state*/ 4 && img_title_value !== (img_title_value = /*dataj*/ ctx[40].imagealt
    			? /*dataj*/ ctx[40].imagealt
    			: "No alt of image")) {
    				attr_dev(img, "title", img_title_value);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(704:56) {#if dataj.imageurl != ''}",
    		ctx
    	});
    ...
    // (700:40) {#each state.xml.item.items as dataj}
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 4) show_if = /*datai*/ ctx[37].id == /*dataj*/ ctx[40].category && /*ignoreItemIds*/ ctx[7].indexOf(/*dataj*/ ctx[40].id) == -1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(700:40) {#each state.xml.item.items as dataj}",
    		ctx
    	});
    ...
    // (688:16) {#each state.xml.category.categories as datai, index}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$2, 690, 28, 35121);
    			...
    			add_location(div0, file$2, 689, 24, 34908);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 4 && raw_value !== (raw_value = /*datai*/ ctx[37].text + "")) div1.innerHTML = raw_value;
    			if (dirty[0] & /*state*/ 4 && div1_title_value !== (div1_title_value = /*datai*/ ctx[37].text)) {
    				attr_dev(div1, "title", div1_title_value);
    			}

    			if (dirty[0] & /*state, onImgLoad, ignoreItemIds*/ 388) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(688:16) {#each state.xml.category.categories as datai, index}",
    		ctx
    	});
    ...
    // (725:12) {#if AH.get('alignMatchReset') == true}
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 725, 16, 37874);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(725:12) {#if AH.get('alignMatchReset') == true}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 728, 16, 38089);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*matchButton*/ ctx[13], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 735, 16, 38384);
    			attr_dev(div1, "class", "yourAnswer");
    			add_location(div1, file$2, 738, 16, 38608);
    			attr_dev(div2, "class", "scoreDiv");
    			add_location(div2, file$2, 734, 12, 38345);
    			attr_dev(div3, "class", "finalResult");
    			add_location(div3, file$2, 733, 8, 38307);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(733:4) {#if targetView == 'block'}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div3, file$2, 684, 4, 34518);
    			add_location(div4, file$2, 674, 0, 34221);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
        ...
        ***SECTION START */
    	...
    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<AlignMatchPreview> was created with unknown prop '${key}'`);
    	});
    ...
    class AlignMatchPreview extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*xml*/ ctx[16] === undefined && !("xml" in props)) {
    			console_1$1.warn("<AlignMatchPreview> was created without expected prop 'xml'");
    		}

    		if (/*uxml*/ ctx[17] === undefined && !("uxml" in props)) {
    			console_1$1.warn("<AlignMatchPreview> was created without expected prop 'uxml'");
    		}

    		if (/*showAns*/ ctx[18] === undefined && !("showAns" in props)) {
    			console_1$1.warn("<AlignMatchPreview> was created without expected prop 'showAns'");
    		}

    		if (/*isReview*/ ctx[0] === undefined && !("isReview" in props)) {
    			console_1$1.warn("<AlignMatchPreview> was created without expected prop 'isReview'");
    		}

    		if (/*updateCSV*/ ctx[19] === undefined && !("updateCSV" in props)) {
    			console_1$1.warn("<AlignMatchPreview> was created without expected prop 'updateCSV'");
    		}

    		if (/*editorState*/ ctx[20] === undefined && !("editorState" in props)) {
    			console_1$1.warn("<AlignMatchPreview> was created without expected prop 'editorState'");
    		}
    	}
