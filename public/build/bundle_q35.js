...
var app = (function () {
    ...
    /* clsSMAlignMatch/showAnswer.svelte generated by Svelte v3.34.0 */

    const file$1 = "clsSMAlignMatch/showAnswer.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$1, 11, 12, 302);
    			add_location(tbody, file$1, 10, 8, 282);
    			attr_dev(table, "class", "table");
    			attr_dev(table, "id", "alignmatch-table");
    			add_location(table, file$1, 9, 4, 230);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 52, 40, 2862);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (42:36) {#if  col.imageurl && col.imageurl != ''}
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 43, 44, 2281);
    			add_location(div, file$1, 42, 40, 2231);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(42:36) {#if  col.imageurl && col.imageurl != ''}",
    		ctx
    	});
    ...
    // (25:32) {#if user_ans_table == 1}
    function create_if_block_2(ctx) {
    	let if_block_anchor;

    	function select_block_type_1(ctx, dirty) {
    		if (/*col*/ ctx[9].imageurl && /*state*/ ctx[2].userAnswerArr[/*col*/ ctx[9].tags][/*ind*/ ctx[11]].imageurl != "") return create_if_block_3;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(25:32) {#if user_ans_table == 1}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "tabindex", "0");
    			attr_dev(div, "title", div_title_value = /*col*/ ctx[9].label);
    			add_location(div, file$1, 34, 40, 1743);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = raw_value;
    ...
    // (26:36) {#if col.imageurl && state.userAnswerArr[col.tags][ind].imageurl != ''}
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", img_alt_value = /*col*/ ctx[9].imagealt);
    			attr_dev(img, "title", img_title_value = /*col*/ ctx[9].imagealt);
    			add_location(img, file$1, 26, 40, 1202);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(26:36) {#if col.imageurl && state.userAnswerArr[col.tags][ind].imageurl != ''}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*col*/ ctx[9].imageurl && /*col*/ ctx[9].imageurl != "") return create_if_block_5;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$1, 22, 28, 862);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$1, 19, 16, 679);
    		},
    		m: function mount(target, anchor) {
    ...
    /* clsSMAlignMatch/AlignMatchPreview.svelte generated by Svelte v3.34.0 */

    const { Object: Object_1, console: console_1, window: window_1 } = globals;
    const file$2 = "clsSMAlignMatch/AlignMatchPreview.svelte";
    ...
    function create_if_block_3$1(ctx) {
    	let each_1_anchor;
    	let each_value = /*state*/ ctx[3].xml.category.categories;
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*nextbutton, state, onImgLoad, ignoreItemIds, prevbutton*/ 1928) {
    				each_value = /*state*/ ctx[3].xml.category.categories;
    				validate_each_argument(each_value);
    				let i;
    ...
    // (705:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}
    function create_if_block_4$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*state*/ ctx[3].correct_match["category_" + /*dataj*/ ctx[40].sequence] == false && create_if_block_5$1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*state*/ ctx[3].correct_match["category_" + /*dataj*/ ctx[40].sequence] == false) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(705:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}",
    		ctx
    	});
    ...
    // (706:48) {#if state.correct_match['category_'+ dataj.sequence] == false}
    function create_if_block_5$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*dataj*/ ctx[40].imageurl != "") return create_if_block_6$1;
    		if (/*dataj*/ ctx[40].label != "") return create_if_block_7;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "seq_no", div_seq_no_value = "category_" + /*dataj*/ ctx[40].sequence);
    			attr_dev(div, "key", div_key_value = /*dataj*/ ctx[40].id);
    			attr_dev(div, "data-tags", div_data_tags_value = /*dataj*/ ctx[40].tags);
    			set_style(div, "display", "none");
    			add_location(div, file$2, 706, 52, 36345);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*state*/ 8 && div_seq_no_value !== (div_seq_no_value = "category_" + /*dataj*/ ctx[40].sequence)) {
    				attr_dev(div, "seq_no", div_seq_no_value);
    			}

    			if (dirty[0] & /*state*/ 8 && div_key_value !== (div_key_value = /*dataj*/ ctx[40].id)) {
    				attr_dev(div, "key", div_key_value);
    			}

    			if (dirty[0] & /*state*/ 8 && div_data_tags_value !== (div_data_tags_value = /*dataj*/ ctx[40].tags)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(706:48) {#if state.correct_match['category_'+ dataj.sequence] == false}",
    		ctx
    	});
    ...
    function create_if_block_7(ctx) {
    	let div;
    	let raw_value = /*dataj*/ ctx[40].label + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "title", div_title_value = /*dataj*/ ctx[40].label);
    			add_location(div, file$2, 710, 60, 37031);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = raw_value;
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && raw_value !== (raw_value = /*dataj*/ ctx[40].label + "")) div.innerHTML = raw_value;
    			if (dirty[0] & /*state*/ 8 && div_title_value !== (div_title_value = /*dataj*/ ctx[40].label)) {
    				attr_dev(div, "title", div_title_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_6$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			attr_dev(img, "data-check", img_data_check_value = /*index*/ ctx[39]);
    			if (img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static//" + /*dataj*/ ctx[40].imageurl)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "img-fluid");
    			attr_dev(img, "tabindex", img_tabindex_value = 0);

    			attr_dev(img, "alt", img_alt_value = /*dataj*/ ctx[40].imagealt
    			? /*dataj*/ ctx[40].imagealt
    			: "No alt of image");

    			attr_dev(img, "title", img_title_value = /*dataj*/ ctx[40].imagealt
    			? /*dataj*/ ctx[40].imagealt
    			: "No alt of image");

    			add_location(img, file$2, 708, 60, 36618);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);

    			if (!mounted) {
    				dispose = listen_dev(img, "load", /*onImgLoad*/ ctx[8], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static//" + /*dataj*/ ctx[40].imageurl)) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty[0] & /*state*/ 8 && img_alt_value !== (img_alt_value = /*dataj*/ ctx[40].imagealt
    			? /*dataj*/ ctx[40].imagealt
    			: "No alt of image")) {
    				attr_dev(img, "alt", img_alt_value);
    			}

    			if (dirty[0] & /*state*/ 8 && img_title_value !== (img_title_value = /*dataj*/ ctx[40].imagealt
    			? /*dataj*/ ctx[40].imagealt
    			: "No alt of image")) {
    				attr_dev(img, "title", img_title_value);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(708:56) {#if dataj.imageurl != ''}",
    		ctx
    	});
    ...
    // (704:40) {#each state.xml.item.items as dataj}
    function create_each_block_1$1(ctx) {
    	let show_if = /*datai*/ ctx[37].id == /*dataj*/ ctx[40].category && /*ignoreItemIds*/ ctx[7].indexOf(/*dataj*/ ctx[40].id) == -1;
    	let if_block_anchor;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8) show_if = /*datai*/ ctx[37].id == /*dataj*/ ctx[40].category && /*ignoreItemIds*/ ctx[7].indexOf(/*dataj*/ ctx[40].id) == -1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(704:40) {#each state.xml.item.items as dataj}",
    		ctx
    	});
    ...
    // (692:16) {#each state.xml.category.categories as datai, index}
    function create_each_block$1(ctx) {
    	...
    	let div2;
    	let div1;
    	let raw_value = /*datai*/ ctx[37].text + "";
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = /*state*/ ctx[3].xml.item.items;
    	validate_each_argument(each_value_1);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$2, 694, 28, 35276);
    			attr_dev(div0, "class", div0_class_value = "prevbutton col-lg-1 col-md-1 col-sm-2 col-2 px-sm-3 px-0 prevbutton_" + /*index*/ ctx[39]);
    			attr_dev(div0, "tabindex", div0_tabindex_value = 0);
    			attr_dev(div0, "title", "previous");
    			add_location(div0, file$2, 693, 24, 35063);
    			attr_dev(div1, "class", "font20 text-center text-dark");
    			attr_dev(div1, "tabindex", div1_tabindex_value = 0);
    			attr_dev(div1, "title", div1_title_value = /*datai*/ ctx[37].text);
    			add_location(div1, file$2, 698, 32, 35567);
    			attr_dev(div2, "class", "categorytitle card_border");
    			add_location(div2, file$2, 697, 28, 35495);
    			attr_dev(div3, "class", "elementContainer w-100 h-100 d-table");
    			add_location(div3, file$2, 702, 36, 35932);
    			attr_dev(div4, "class", "categoryiteminnercontainer w-100 h-100 text-center");
    			add_location(div4, file$2, 701, 32, 35831);
    			attr_dev(div5, "class", div5_class_value = "categoryitemcontainer p-1 categoryitemcontainer_" + /*index*/ ctx[39]);
    			add_location(div5, file$2, 700, 28, 35729);
    			attr_dev(div6, "class", "categoryinnercontainer p-0 r-lg col-lg-10 col-md-10 col-sm-8 col-8");
    			add_location(div6, file$2, 696, 24, 35386);
    			attr_dev(span1, "class", "icomoon-arrow-right-2 font26 btnGrp");
    			add_location(span1, file$2, 721, 28, 37754);
    			attr_dev(div7, "class", div7_class_value = "nextbutton col-md-1 col-lg-1 col-sm-2 col-2 px-sm-3 px-0 nextbutton_" + /*index*/ ctx[39]);
    			attr_dev(div7, "tabindex", div7_tabindex_value = 0);
    			attr_dev(div7, "title", "next");
    			add_location(div7, file$2, 720, 24, 37560);
    			attr_dev(div8, "class", "row np mb-3");
    			attr_dev(div8, "key", div8_key_value = /*index*/ ctx[39]);
    			add_location(div8, file$2, 692, 20, 35001);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "click", prevent_default(/*prevbutton*/ ctx[9]), false, true, false),
    					listen_dev(div0, "keydown", keydownAda, false, false, false),
    					listen_dev(div7, "click", /*nextbutton*/ ctx[10], false, false, false),
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && raw_value !== (raw_value = /*datai*/ ctx[37].text + "")) div1.innerHTML = raw_value;
    			if (dirty[0] & /*state*/ 8 && div1_title_value !== (div1_title_value = /*datai*/ ctx[37].text)) {
    				attr_dev(div1, "title", div1_title_value);
    			}

    			if (dirty[0] & /*state, onImgLoad, ignoreItemIds*/ 392) {
    				each_value_1 = /*state*/ ctx[3].xml.item.items;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(692:16) {#each state.xml.category.categories as datai, index}",
    		ctx
    	});
    ...
    // (729:12) {#if AH.get('alignMatchReset') == true}
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 729, 16, 38029);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*resetButton*/ ctx[14], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(729:12) {#if AH.get('alignMatchReset') == true}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	let button;
    	let t_value = /*state*/ ctx[3].xml.settings.matchButtonText + "";
    	let t;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 732, 16, 38244);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button, "click", /*matchButton*/ ctx[13], false, false, false),
    					listen_dev(button, "keydown", keydownAda, false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && t_value !== (t_value = /*state*/ ctx[3].xml.settings.matchButtonText + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(button);
    			mounted = false;
    ...
    function create_if_block$2(ctx) {
    	...
    	showanswer0 = new ShowAnswer({
    			props: {
    				jsondataCategory: /*jsonData*/ ctx[2].category,
    				objValues: objectValues(/*correctAnswerArray*/ ctx[6]),
    				state: /*state*/ ctx[3],
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 739, 16, 38565);
    			attr_dev(div1, "class", "yourAnswer");
    			add_location(div1, file$2, 742, 16, 38789);
    			attr_dev(div2, "class", "scoreDiv");
    			add_location(div2, file$2, 738, 12, 38526);
    			attr_dev(div3, "class", "finalResult");
    			add_location(div3, file$2, 737, 8, 38488);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*jsonData*/ 4) showanswer0_changes.jsondataCategory = /*jsonData*/ ctx[2].category;
    			if (dirty[0] & /*correctAnswerArray*/ 64) showanswer0_changes.objValues = objectValues(/*correctAnswerArray*/ ctx[6]);
    			if (dirty[0] & /*state*/ 8) showanswer0_changes.state = /*state*/ ctx[3];
    			showanswer0.$set(showanswer0_changes);
    			const showanswer1_changes = {};
    			if (dirty[0] & /*jsonData*/ 4) showanswer1_changes.jsondataCategory = /*jsonData*/ ctx[2].category;
    			if (dirty[0] & /*correctAnswerArray*/ 64) showanswer1_changes.objValues = objectValues(/*correctAnswerArray*/ ctx[6]);
    			if (dirty[0] & /*state*/ 8) showanswer1_changes.state = /*state*/ ctx[3];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(737:4) {#if targetView == 'block'}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	itemhelper = new ItemHelper({
    			props: {
    				handleReviewClick: /*handleReviewMode*/ ctx[15],
    	...
    	let if_block0 = /*state*/ ctx[3].xml && create_if_block_3$1(ctx);
    	let if_block1 = show_if && create_if_block_2$1(ctx);
    	let if_block2 = /*state*/ ctx[3].xml && create_if_block_1$1(ctx);
    	let if_block3 = /*targetView*/ ctx[5] == "block" && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", div0_class_value = "categorycontainer center-block " + (/*windowwidth*/ ctx[4] > 1200 ? "span9" : ""));
    			add_location(div0, file$2, 689, 8, 34800);
    			attr_dev(div1, "class", "text-center");
    			add_location(div1, file$2, 727, 8, 37935);
    			attr_dev(div2, "class", div2_class_value = "alignTestarea px-3 mx-auto mt-3 " + (/*targetView*/ ctx[5] == "block" ? "h" : ""));
    			set_style(div2, "max-width", /*state*/ ctx[3].maxWidth);
    			add_location(div2, file$2, 688, 4, 34673);
    			add_location(div3, file$2, 680, 0, 34449);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*windowwidth*/ 16 && div0_class_value !== (div0_class_value = "categorycontainer center-block " + (/*windowwidth*/ ctx[4] > 1200 ? "span9" : ""))) {
    			...
    			if (!current || dirty[0] & /*targetView*/ 32 && div2_class_value !== (div2_class_value = "alignTestarea px-3 mx-auto mt-3 " + (/*targetView*/ ctx[5] == "block" ? "h" : ""))) {
    			...
    			if (/*targetView*/ ctx[5] == "block") {
    				if (if_block3) {
    					if_block3.p(ctx, dirty);

    					if (dirty[0] & /*targetView*/ 32) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		$$invalidate(3, state.uxml = uxml, state);
    		...
    		if (state.uxml && state.uxml.includes("&useransxml=")) {
    			...
    			$$invalidate(3, state.uxml = replacedVal, state);
    		}
    	...
    	function parseXMLPreview(MYXML) {
    		...
    		$$invalidate(3, state.maxWidth = MYXML.smxml._maxwidth ? MYXML.smxml._maxwidth : 800, state);

    		// contains the value of cdata
    		$$invalidate(2, jsonData = JSON.parse(MYXML.smxml.__cdata));
    		...
    		$$invalidate(6, correctAnswerArray = []);
    		$$invalidate(3, state.correct_match = [], state);
    		...
    		jsonData.item.items.forEach(function (value, seq) {
    			if (correctAnswerArray[value.tags] == null) {
    				...
    				$$invalidate(6, correctAnswerArray[value.tags] = [], correctAnswerArray);
    			...
    			$$invalidate(3, state.correct_match["category_" + seq] = false, state);
    			value.sequence = seq;
    		});
    		...
    		$$invalidate(3, state.userAnswerArr = tmpArr, state);

    		// sets the value of state xml
    		$$invalidate(3, state.xml = jsonData, state);
    	...
    	function onImgLoad(event) {
    		...
    		if (elementContainerHeight != "" && elementContainerHeight != null && !isNaN(elementContainerHeight)) {
    			if (elementContainerHeight <= height) {
    				...
    				$$invalidate(3, state.imgHeight = height, state);
    		...
    		setTimeout(
    			function () {
    				if (!blnAllAttempted) {
    					...
    					$$invalidate(3, state.gameStatus = true, state);
    				}
    			},
    			200
    		);
    	...
    	function reverseToInitial() {
    		$$invalidate(3, state.gameStatus = false, state);
    	}
    	...
    	function setReview() {
    		...
    		// isReview = true;
    		$$invalidate(1, customIsReview = true);

    		$$invalidate(5, targetView = "block");
    	...
    	function unsetReview() {
    		$$invalidate(5, targetView = "none");
    		$$invalidate(0, isReview = false);
    		$$invalidate(1, customIsReview = false);
    	}
        ...
        ***SECTION START */
    				...
    				AH.selectAll(".categoryinnercontainer ", "all").forEach(function (container, i) {
    					if (AH.find(container, ".element", "all").length > 1) {
    						AH.find(container, ".element", "all").forEach(function (val) {
    							...
    							if (getComputedStyle(val, null).display == "table-cell") {
    								$$invalidate(3, state.correct_match[val.getAttribute("seq_no")] = true, state);
    							}
    						});
    			...
    			$$invalidate(3, state.uxml = JSON.stringify(userXML), state);
    	...
    	function resetButton() {
    		...
    		$$invalidate(6, correctAnswerArray = []); //stores correct Answer tagWise
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("uxml" in $$props) $$invalidate(17, uxml = $$props.uxml);
    		if ("showAns" in $$props) $$invalidate(18, showAns = $$props.showAns);
    		if ("isReview" in $$props) $$invalidate(0, isReview = $$props.isReview);
    		if ("updateCSV" in $$props) $$invalidate(19, updateCSV = $$props.updateCSV);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("jsonData" in $$props) $$invalidate(2, jsonData = $$props.jsonData);
    		if ("state" in $$props) $$invalidate(3, state = $$props.state);
    		if ("userXML" in $$props) userXML = $$props.userXML;
    		if ("windowwidth" in $$props) $$invalidate(4, windowwidth = $$props.windowwidth);
    		if ("targetView" in $$props) $$invalidate(5, targetView = $$props.targetView);
    		...
    		if ("correctAnswerArray" in $$props) $$invalidate(6, correctAnswerArray = $$props.correctAnswerArray);
    		...
    		if ("ignoreItemIds" in $$props) $$invalidate(7, ignoreItemIds = $$props.ignoreItemIds);
    	};
    ...
    class AlignMatchPreview extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*uxml*/ ctx[17] === undefined && !("uxml" in props)) {
    		...
    		if (/*updateCSV*/ ctx[19] === undefined && !("updateCSV" in props)) {
