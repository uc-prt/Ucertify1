...
var app = (function () {
    ...
    /* clsSMShadedGrid/ShadingPreview.svelte generated by Svelte v3.34.0 */

    const { console: console_1 } = globals;
    const file$1 = "clsSMShadedGrid/ShadingPreview.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*preview_table, isReview, userTab, gridClickPreview, adaKeyupGridClick, state, total_row_count*/ 1183) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*preview_table, isReview, userTab, gridClickPreview, adaKeyupGridClick, state*/ 1179) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			t = space();
    			attr_dev(td, "id", td_id_value = /*data*/ ctx[41].id);
    			attr_dev(td, "tabindex", td_tabindex_value = /*data*/ ctx[41].tabindex);
    			attr_dev(td, "aria-label", td_aria_label_value = /*data*/ ctx[41].arialabel);
    			attr_dev(td, "data-grid", "no");
    			attr_dev(td, "pevdata-id", td_pevdata_id_value = /*data*/ ctx[41].pevdata);

    			attr_dev(td, "class", td_class_value = `${/*isReview*/ ctx[0] && /*userTab*/ ctx[4] == false
			? ""
			: /*data*/ ctx[41].class} ${/*data*/ ctx[41].classDetails} ${/*isReview*/ ctx[0] && /*userTab*/ ctx[4] == false
			? /*data*/ ctx[41].spanclass == "icomoon-24px-correct"
				? "gridCorrect"
				: ""
			: /*data*/ ctx[41].correctAnswerColor} gridColor pointer border-dark text-center`);

    			set_style(td, "width", /*data*/ ctx[41].width);
    			set_style(td, "height", /*data*/ ctx[41].height);
    			set_style(td, "pointerEvents", "pointerEvents");
    			add_location(td, file$1, 393, 36, 14318);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(td, "click", /*gridClickPreview*/ ctx[7], false, false, false),
    					listen_dev(td, "keyup", /*adaKeyupGridClick*/ ctx[10], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*preview_table*/ 2 && td_id_value !== (td_id_value = /*data*/ ctx[41].id)) {
    				attr_dev(td, "id", td_id_value);
    			}

    			if (dirty[0] & /*preview_table*/ 2 && td_tabindex_value !== (td_tabindex_value = /*data*/ ctx[41].tabindex)) {
    				attr_dev(td, "tabindex", td_tabindex_value);
    			}

    			if (dirty[0] & /*preview_table*/ 2 && td_aria_label_value !== (td_aria_label_value = /*data*/ ctx[41].arialabel)) {
    				attr_dev(td, "aria-label", td_aria_label_value);
    			}

    			if (dirty[0] & /*preview_table*/ 2 && td_pevdata_id_value !== (td_pevdata_id_value = /*data*/ ctx[41].pevdata)) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 411, 52, 15834);
    			add_location(span1, file$1, 410, 48, 15775);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*preview_table*/ 2 && span0_class_value !== (span0_class_value = /*data*/ ctx[41].corrspanclass)) {
    				attr_dev(span0, "class", span0_class_value);
    			}

    			if (dirty[0] & /*preview_table*/ 2 && span0_aria_label_value !== (span0_aria_label_value = /*data*/ ctx[41].spanarialabel)) {
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*preview_table*/ 2 && span0_class_value !== (span0_class_value = /*data*/ ctx[41].spanclass)) {
    				attr_dev(span0, "class", span0_class_value);
    			}
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			t = space();
    			add_location(tr, file$1, 389, 20, 14093);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			t6 = text(t6_value);
    			add_location(tbody, file$1, 386, 8, 13951);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function showAnswer(val, iconState) {
    		...
    		if (val == "cans") {
    			$$invalidate(17, ans = state.correctAns);
    		} else if (val == "yans") {
    			$$invalidate(17, ans = state.userAns);
    		}
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("showSelectedAns" in $$props) $$invalidate(16, showSelectedAns = $$props.showSelectedAns);
    		if ("ans" in $$props) $$invalidate(17, ans = $$props.ans);
    		...
    		if ("cellIndex" in $$props) $$invalidate(18, cellIndex = $$props.cellIndex);
    		if ("showAnsIndex" in $$props) $$invalidate(19, showAnsIndex = $$props.showAnsIndex);
    		if ("locked_cell_values" in $$props) $$invalidate(20, locked_cell_values = $$props.locked_cell_values);
    		if ("shaded_cell_values" in $$props) $$invalidate(21, shaded_cell_values = $$props.shaded_cell_values);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*isReview, xml, state, cellIndex, showAnsIndex, total_row_count, ans, preview_table, showSelectedAns, locked_cell_values, shaded_cell_values*/ 4132879) {
    			//clearTimeout(timer);
    			//}, 500);
    			 {
    				if (isReview) {
    				...
    				$$invalidate(20, locked_cell_values = state.lockedCellValue != undefined && state.lockedCellValue != ""
    				? state.lockedCellValue.split(",")
    				: "");

    				$$invalidate(21, shaded_cell_values = state.shadedCell != ""
    				...
    				for (let i = 0; i < state.rowCount; i++) {
    					...
    					for (let j = 0; j < state.colCount; j++) {
    						$$invalidate(18, cellIndex = i + "_" + j);

    						if (ans != "") {
    							$$invalidate(19, showAnsIndex = ans.indexOf(cellIndex));
    							$$invalidate(16, showSelectedAns = showAnsIndex != -1 ? "gridSelected" : "");
    						} else {
    							$$invalidate(16, showSelectedAns = "");
    						}
    						...
    						$$invalidate(1, preview_table = [
    							...preview_table,
    							{
    								...
    								arialabel: "Grids row " + (i + 1) + " and column " + (j + 1) + " is " + (showSelectedAns == "gridSelected"
    								? "selected"
    								: "unselected"),
    								pevdata: cellIndex,
