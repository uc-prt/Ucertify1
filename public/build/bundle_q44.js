    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
			...
			: /*data*/ ctx[40].correctAnswerColor} gridColor pointer border-dark text-center`);
    			...
    			add_location(td, file$1, 392, 36, 14193);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 410, 52, 15709);
    			add_location(span1, file$1, 409, 48, 15650);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			t = space();
    			add_location(tr, file$1, 388, 20, 13968);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			t6 = text(t6_value);
    			add_location(tbody, file$1, 385, 8, 13826);
