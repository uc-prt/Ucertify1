...
var app = (function () {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 256, 8, 10722);
    			attr_dev(div, "class", "alert alert-danger font-weight-bold");
    			add_location(div, file$1, 255, 4, 10664);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    // (289:24) {#if (targetView == "block" && user_ans_tab == true)}
    function create_if_block_1(ctx) {
    	let if_block_anchor;

    	function select_block_type(ctx, dirty) {
    		if (/*data*/ ctx[21].anskey == /*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid]) return create_if_block_2;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(289:24) {#if (targetView == \\\"block\\\" && user_ans_tab == true)}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 295, 36, 12879);
    			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
    			add_location(span1, file$1, 294, 32, 12782);
    		},
    		m: function mount(target, anchor) {
    ...
    // (290:28) {#if data.anskey == state.datauserans[data.sliderid]}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 291, 36, 12586);
    			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
    			add_location(span1, file$1, 290, 32, 12489);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span1, anchor);
    			append_dev(span1, span0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(290:28) {#if data.anskey == state.datauserans[data.sliderid]}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	let t0;
    	let t1;
    	let t2_value = /*data*/ ctx[21].anskey + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(": ");
    			t2 = text(t2_value);
    			add_location(span, file$1, 308, 40, 13865);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*localSliderData*/ 2 && t2_value !== (t2_value = /*data*/ ctx[21].anskey + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    ...
    // (306:36) {#if !(targetView == "block" && user_ans_tab == false)}
    function create_if_block$1(ctx) {
    	...
    	let t2_value = (/*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid] == 0 || /*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid] == undefined
    	? /*data*/ ctx[21].defaultans
    	: /*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid]) + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(": ");
    			t2 = text(t2_value);
    			add_location(span, file$1, 306, 40, 13601);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*state, localSliderData*/ 6 && t2_value !== (t2_value = (/*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid] == 0 || /*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid] == undefined
    			? /*data*/ ctx[21].defaultans
    			: /*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid]) + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(span);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(306:36) {#if !(targetView == \\\"block\\\" && user_ans_tab == false)}",
    		ctx
    	});
    ...
    // (270:12) {#each localSliderData as data, i}
    function create_each_block(ctx) {
    	let div7;
    	let div0;
    	let span0;
    	let t0_value = /*data*/ ctx[21].title_val + "";
    	let t0;
    	let t1;
    	let div6;
    	let input;
    	...
    	let t4;
    	let t5;
    	let t6_value = /*data*/ ctx[21].minval + "";
    	let t6;
    	let t7;
    	let div3;
    	let div2;
    	...
    	let t9;
    	let t10;
    	let t11_value = /*data*/ ctx[21].maxval + "";
    	let t11;
    	let t12;
    	let div7_key_value;
    	let mounted;
    	...
    	const block = {
    		c: function create() {
    			...
    			t11 = text(t11_value);
    			t12 = space();
    			add_location(span0, file$1, 272, 24, 11333);
    			attr_dev(div0, "class", "slider_heading_test text-start text-white bg-primary");
    			attr_dev(div0, "tabindex", "0");
    			add_location(div0, file$1, 271, 20, 11229);
    			attr_dev(input, "id", input_id_value = /*data*/ ctx[21].sliderid);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "name", "sliderrange");
    			attr_dev(input, "min", input_min_value = /*data*/ ctx[21].minval);
    			attr_dev(input, "max", input_max_value = /*data*/ ctx[21].maxval);
    			attr_dev(input, "step", input_step_value = /*data*/ ctx[21].step_val);
    			attr_dev(input, "class", "slideritem");

    			input.value = input_value_value = /*targetView*/ ctx[4] == "block" && /*user_ans_tab*/ ctx[3] == false
    			? parseInt(/*data*/ ctx[21].anskey)
    			: /*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid] == 0 || /*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid] == undefined
    				? parseInt(/*data*/ ctx[21].defaultans)
    				: parseInt(/*state*/ ctx[2].datauserans[/*data*/ ctx[21].sliderid]);

    			input.disabled = input_disabled_value = /*targetView*/ ctx[4] == "block" ? true : false;
    			attr_dev(input, "tabindex", "0");
    			add_location(input, file$1, 275, 24, 11499);
    			add_location(span1, file$1, 301, 32, 13261);
    			attr_dev(div1, "class", "minRange float-start col px-0 text-start");
    			attr_dev(div1, "tabindex", "0");
    			add_location(div1, file$1, 300, 28, 13161);
    			attr_dev(div2, "class", "current_val");
    			add_location(div2, file$1, 304, 32, 13443);
    			attr_dev(div3, "class", "rangevalue col px-0");
    			attr_dev(div3, "tabindex", "0");
    			add_location(div3, file$1, 303, 28, 13364);
    			add_location(span2, file$1, 313, 32, 14150);
    			attr_dev(div4, "class", "max_val float-end col px-0 text-end");
    			attr_dev(div4, "tabindex", "0");
    			add_location(div4, file$1, 312, 28, 14055);
    			attr_dev(div5, "class", "range_details mt-2 row mx-0");
    			add_location(div5, file$1, 299, 24, 13091);
    			attr_dev(div6, "class", "col-md-12 select_slider_test w-100 pt-3 px-3 pb-2");
    			add_location(div6, file$1, 274, 20, 11411);
    			attr_dev(div7, "key", div7_key_value = /*i*/ ctx[23]);
    			attr_dev(div7, "class", "clearfix slider_container my-3 rounded w-100");
    			add_location(div7, file$1, 270, 16, 11142);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "input", /*handleRange*/ ctx[7], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*localSliderData*/ 2 && t0_value !== (t0_value = /*data*/ ctx[21].title_val + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*localSliderData*/ 2 && input_id_value !== (input_id_value = /*data*/ ctx[21].sliderid)) {
    				attr_dev(input, "id", input_id_value);
    			}

    			if (dirty & /*localSliderData*/ 2 && input_min_value !== (input_min_value = /*data*/ ctx[21].minval)) {
    				attr_dev(input, "min", input_min_value);
    			}

    			if (dirty & /*localSliderData*/ 2 && input_max_value !== (input_max_value = /*data*/ ctx[21].maxval)) {
    				attr_dev(input, "max", input_max_value);
    			}

    			if (dirty & /*localSliderData*/ 2 && input_step_value !== (input_step_value = /*data*/ ctx[21].step_val)) {
    			...
    			if (dirty & /*localSliderData*/ 2 && t6_value !== (t6_value = /*data*/ ctx[21].minval + "")) set_data_dev(t6, t6_value);
    			...
    			if (dirty & /*localSliderData*/ 2 && t11_value !== (t11_value = /*data*/ ctx[21].maxval + "")) set_data_dev(t11, t11_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(270:12) {#each localSliderData as data, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 268, 8, 11043);
    			attr_dev(div1, "id", "slidermain");
    			add_location(div1, file$1, 267, 4, 11013);
    			attr_dev(div2, "class", "text-center");
    			add_location(div2, file$1, 259, 0, 10766);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*localSliderData, l, state, undefined, targetView, user_ans_tab, parseInt, handleRange*/ 158) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleRange() {
    		...
    		(((($$invalidate(2, state), $$invalidate(0, isReview)), $$invalidate(11, xml)), $$invalidate(12, uxml)), $$invalidate(1, localSliderData));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<SliderItemPreview> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*isReview, xml, state, uxml, localSliderData*/ 6151) {
    			 {
    				if (isReview) {
    					$$invalidate(4, targetView = "block");
    ...
    class SliderItemPreview extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*xml*/ ctx[11] === undefined && !("xml" in props)) {
    			console_1$1.warn("<SliderItemPreview> was created without expected prop 'xml'");
    		}

    		if (/*uxml*/ ctx[12] === undefined && !("uxml" in props)) {
    			console_1$1.warn("<SliderItemPreview> was created without expected prop 'uxml'");
    		}

    		if (/*showAns*/ ctx[13] === undefined && !("showAns" in props)) {
    			console_1$1.warn("<SliderItemPreview> was created without expected prop 'showAns'");
    		}

    		if (/*isReview*/ ctx[0] === undefined && !("isReview" in props)) {
    			console_1$1.warn("<SliderItemPreview> was created without expected prop 'isReview'");
    		}

    		if (/*editorState*/ ctx[14] === undefined && !("editorState" in props)) {
    			console_1$1.warn("<SliderItemPreview> was created without expected prop 'editorState'");
    		}
    	}
