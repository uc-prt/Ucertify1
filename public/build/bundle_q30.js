...
var app = (function () {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 259, 8, 10798);
    			attr_dev(div, "class", "alert alert-danger font-weight-bold");
    			add_location(div, file$1, 258, 4, 10740);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    // (292:24) {#if (targetView == "block" && user_ans_tab == true)}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(292:24) {#if (targetView == \\\"block\\\" && user_ans_tab == true)}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 298, 36, 12953);
    			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
    			add_location(span1, file$1, 297, 32, 12856);
    		},
    		m: function mount(target, anchor) {
    ...
    // (293:28) {#if data.anskey == state.datauserans[data.sliderid]}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span1 = element("span");
    			span0 = element("span");
    			attr_dev(span0, "class", "icomoon-new-24px-checkmark-circle-1 font-weight-bold correctAns");
    			add_location(span0, file$1, 294, 36, 12662);
    			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
    			add_location(span1, file$1, 293, 32, 12565);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span1, anchor);
    			append_dev(span1, span0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(293:28) {#if data.anskey == state.datauserans[data.sliderid]}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(": ");
    			t2 = text(t2_value);
    			add_location(span, file$1, 311, 40, 13939);
    		},
    		m: function mount(target, anchor) {
    ...
    // (309:36) {#if !(targetView == "block" && user_ans_tab == false)}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(": ");
    			t2 = text(t2_value);
    			add_location(span, file$1, 309, 40, 13675);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(309:36) {#if !(targetView == \\\"block\\\" && user_ans_tab == false)}",
    		ctx
    	});
    ...
    // (273:12) {#each localSliderData as data, i}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(273:12) {#each localSliderData as data, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 271, 8, 11119);
    			attr_dev(div1, "id", "slidermain");
    			add_location(div1, file$1, 270, 4, 11089);
    			attr_dev(div2, "class", "text-center");
    			add_location(div2, file$1, 262, 0, 10842);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
