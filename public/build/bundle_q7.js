...
var app = (function () {
    ...
    /* clsSMTree/libs/oldJsTree.svelte generated by Svelte v3.34.0 */
    ...
    class treeviewHelper {
        ...
        onUserAnswerChange(result) {
            if (result) {
                JS$1.select("#answer", 'checked', result.ans ? true : false);
                JS$1.select("#special_module_user_xml", 'value', result.uXml);
        ...
        checkAns(treeid, elemnt) {
            ...
            // }
            if (window.inNative) {
                window.postMessage('height___' + JS$1.select("#treemain0").clientHeight, '*'); // increases the height of react native outer container
            }
            if (this.tempVar == 'u') {
                try {
                    ...
                    userAnswers = (JS$1.formatXml(this.userAnsXML.xml ? this.userAnsXML.xml : (new XMLSerializer()).serializeToString(this.userAnsXML[0])));
                    this.checkedAns = {
                        uXml: userAnswers,
                        ans: this.result,
                    };
        ...
        */
                ...
                if (typeof (pElem.li_attr.correctans) !== "undefined") {
                    ...
                    if (pElem.children.length > 0) {
                        ...
                        if (cans != uans) {
                            ...
                            JS$1.select('[tid="' + pElem.li_attr.tid + '"]').setAttribute('as', 0);
                        } else {
                            // sets the attribute 'as' with value 1 of element with tid equals to pElem.li_attr.tid
                            JS$1.select('[tid="' + pElem.li_attr.tid + '"]').setAttribute('as', 1);
                        }
                    } else {
                        this.result = false;
        ...
        showans(treeid, type) {
            if (type == "c") {
                ...
                JS$1.selectAll(".treecorrect_outer", 'addClass', "treecorrect_outer_border");
                JS$1.setCss(".treecorrect", {
                    display: "none"
                });
            }
            ...
            if (type == "c") {
                var timer5 = setTimeout(()=> {
                    ...
                    JS$1.selectAll(".treecorrect_outer", 'removeClass', "treecorrect_outer_border");
                    JS$1.setCss(".treecorrect", {
                        display: "block"
                    });
                    // clear the timeout
    ...
    /* clsSMTree/TreeViewPreview.svelte generated by Svelte v3.34.0 */
    ...
    function create_else_block(ctx) {
    	...
    	let each_value_1 = /*listItemCorrect*/ ctx[2];
    	...
    	let each_value = /*state*/ ctx[3].listItemAll;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(center0, file$1, 655, 16, 30068);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "h h-imp");
    			set_style(button, "display", "none");
    			attr_dev(button, "id", "delNodes");
    			add_location(button, file$1, 664, 16, 30442);
    			attr_dev(ul0, "id", "testme");
    			add_location(ul0, file$1, 682, 32, 31580);
    			attr_dev(div0, "class", "span6 treeall");
    			attr_dev(div0, "data-showcheckbox", div0_data_showcheckbox_value = /*state*/ ctx[3].showCheckbox);
    			add_location(div0, file$1, 681, 28, 31481);
    			add_location(ul1, file$1, 718, 36, 34199);
    			attr_dev(div1, "class", "span6 treecorrect");
    			set_style(div1, "width", "100%");
    			add_location(div1, file$1, 717, 32, 34110);
    			...
    			add_location(div2, file$1, 716, 28, 33994);
    			attr_dev(div3, "class", "row-fluid tree");
    			add_location(div3, file$1, 677, 24, 31220);
    			attr_dev(div4, "id", "treemain0");
    			attr_dev(div4, "data-totalcorrectans", div4_data_totalcorrectans_value = /*state*/ ctx[3].totalCorrectAns);
    			attr_dev(div4, "class", "treemain");
    			add_location(div4, file$1, 666, 20, 30591);
    			add_location(center1, file$1, 665, 16, 30562);
    			add_location(div5, file$1, 654, 12, 30046);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*listItemCorrect, isRerender, getIcon*/ 262) {
    				each_value_1 = /*listItemCorrect*/ ctx[2];
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (!current || dirty[0] & /*state*/ 8 && div0_data_showcheckbox_value !== (div0_data_showcheckbox_value = /*state*/ ctx[3].showCheckbox)) {
    				attr_dev(div0, "data-showcheckbox", div0_data_showcheckbox_value);
    			}

    			if (show_if) if_block2.p(ctx, dirty);

    			if (dirty[0] & /*isRerender, state, getIcon*/ 266) {
    				each_value = /*state*/ ctx[3].listItemAll;
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (!current || dirty[0] & /*state*/ 8 && div4_data_totalcorrectans_value !== (div4_data_totalcorrectans_value = /*state*/ ctx[3].totalCorrectAns)) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$1, 652, 12, 30006);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    // (668:24) {#if !window.inNative}
    function create_if_block_5(ctx) {
    	let div4;
    	let div1;
    	let div0;
    	let t0_value = /*state*/ ctx[3].headingListCorrect + "";
    	let t0;
    	let t1;
    	let div3;
    	let div2;
    	let t2_value = /*state*/ ctx[3].headingListAll + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 670, 36, 30861);
    			attr_dev(div1, "class", "span6");
    			add_location(div1, file$1, 669, 32, 30805);
    			attr_dev(div2, "class", "heading");
    			add_location(div2, file$1, 673, 36, 31042);
    			attr_dev(div3, "class", "span6");
    			add_location(div3, file$1, 672, 32, 30986);
    			attr_dev(div4, "class", "row-fluid");
    			add_location(div4, file$1, 668, 28, 30749);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && t0_value !== (t0_value = /*state*/ ctx[3].headingListCorrect + "")) set_data_dev(t0, t0_value);
    			if (dirty[0] & /*state*/ 8 && t2_value !== (t2_value = /*state*/ ctx[3].headingListAll + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(668:24) {#if !window.inNative}",
    		ctx
    	});
    ...
    // (679:28) {#if (window.inNative && window.inNative != undefined)}
    function create_if_block_4(ctx) {
    	let div;
    	let t_value = /*state*/ ctx[3].headingListCorrect + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 679, 32, 31365);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && t_value !== (t_value = /*state*/ ctx[3].headingListCorrect + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(679:28) {#if (window.inNative && window.inNative != undefined)}",
    		ctx
    	});
    ...
    // (685:40) {#if _listItemCorrect.item.length > 0}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(685:40) {#if _listItemCorrect.item.length > 0}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	let li;
    	let t0_value = /*_listItemCorrect*/ ctx[40].item + "";
    	let t0;
    	let t1;
    	let li_key_value;
    	let li_tid_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(li, "key", li_key_value = "treeC_" + /*isRerender*/ ctx[1] + "_" + /*_listItemCorrect*/ ctx[40].ID);
    			attr_dev(li, "class", "liItemIndex");
    			attr_dev(li, "tid", li_tid_value = /*_listItemCorrect*/ ctx[40].ID);
    			attr_dev(li, "correctans", li_correctans_value = /*_listItemCorrect*/ ctx[40].correctAns);
    			attr_dev(li, "userans", li_userans_value = /*_listItemCorrect*/ ctx[40].userAns || "");

    			attr_dev(li, "data-jstree", li_data_jstree_value = JSON.stringify({
    				opened: true,
    				selected: /*_listItemCorrect*/ ctx[40].isParant ? true : false,
    				icon: /*getIcon*/ ctx[8](/*_listItemCorrect*/ ctx[40]["level"])
    			}));

    			add_location(li, file$1, 696, 48, 32683);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*listItemCorrect*/ 4 && t0_value !== (t0_value = /*_listItemCorrect*/ ctx[40].item + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*isRerender, listItemCorrect*/ 6 && li_key_value !== (li_key_value = "treeC_" + /*isRerender*/ ctx[1] + "_" + /*_listItemCorrect*/ ctx[40].ID)) {
    				attr_dev(li, "key", li_key_value);
    			}

    			if (dirty[0] & /*listItemCorrect*/ 4 && li_tid_value !== (li_tid_value = /*_listItemCorrect*/ ctx[40].ID)) {
    				attr_dev(li, "tid", li_tid_value);
    			}

    			if (dirty[0] & /*listItemCorrect*/ 4 && li_correctans_value !== (li_correctans_value = /*_listItemCorrect*/ ctx[40].correctAns)) {
    				attr_dev(li, "correctans", li_correctans_value);
    			}

    			if (dirty[0] & /*listItemCorrect*/ 4 && li_userans_value !== (li_userans_value = /*_listItemCorrect*/ ctx[40].userAns || "")) {
    				attr_dev(li, "userans", li_userans_value);
    			}

    			if (dirty[0] & /*listItemCorrect*/ 4 && li_data_jstree_value !== (li_data_jstree_value = JSON.stringify({
    				opened: true,
    				selected: /*_listItemCorrect*/ ctx[40].isParant ? true : false,
    				icon: /*getIcon*/ ctx[8](/*_listItemCorrect*/ ctx[40]["level"])
    			}))) {
    ...
    // (686:44) {#if (window.inNative && window.inNative != undefined)}
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 686, 48, 31905);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(686:44) {#if (window.inNative && window.inNative != undefined)}",
    		ctx
    	});
    ...
    // (684:36) {#each listItemCorrect as _listItemCorrect}
    function create_each_block_1(ctx) {
    	let if_block_anchor;
    	let if_block = /*_listItemCorrect*/ ctx[40].item.length > 0 && create_if_block_2(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*_listItemCorrect*/ ctx[40].item.length > 0) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(684:36) {#each listItemCorrect as _listItemCorrect}",
    		ctx
    	});
    ...
    // (714:28) {#if (AH.isValid(window.inNative))}
    function create_if_block_1(ctx) {
    	let div;
    	let t_value = /*state*/ ctx[3].headingListAll + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 714, 32, 33866);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && t_value !== (t_value = /*state*/ ctx[3].headingListAll + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(714:28) {#if (AH.isValid(window.inNative))}",
    		ctx
    	});
    ...
    // (720:40) {#each state.listItemAll as data, i}
    function create_each_block(ctx) {
    	let li;
    	let span0;
    	let t0_value = /*data*/ ctx[37].item + "";
    	let t0;
    	let t1;
    	let span1;
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 728, 48, 34919);
    			attr_dev(span1, "class", "delete_button");
    			add_location(span1, file$1, 729, 48, 35011);
    			attr_dev(li, "key", li_key_value = "trreAll_" + /*isRerender*/ ctx[1] + "_" + /*i*/ ctx[39]);
    			attr_dev(li, "class", "liItemIndex");
    			attr_dev(li, "tid", li_tid_value = /*data*/ ctx[37].ID);
    			attr_dev(li, "seq", li_seq_value = /*data*/ ctx[37].isParant.toString().replace(/,\s|{|}/gmi, ""));
    			attr_dev(li, "multi", li_multi_value = /*data*/ ctx[37].multi);

    			attr_dev(li, "data-jstree", li_data_jstree_value = JSON.stringify({
    				icon: /*getIcon*/ ctx[8](/*data*/ ctx[37].level)
    			}));

    			add_location(li, file$1, 720, 44, 34325);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, span0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*state*/ 8 && t0_value !== (t0_value = /*data*/ ctx[37].item + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*isRerender*/ 2 && li_key_value !== (li_key_value = "trreAll_" + /*isRerender*/ ctx[1] + "_" + /*i*/ ctx[39])) {
    				attr_dev(li, "key", li_key_value);
    			}

    			if (dirty[0] & /*state*/ 8 && li_tid_value !== (li_tid_value = /*data*/ ctx[37].ID)) {
    				attr_dev(li, "tid", li_tid_value);
    			}

    			if (dirty[0] & /*state*/ 8 && li_seq_value !== (li_seq_value = /*data*/ ctx[37].isParant.toString().replace(/,\s|{|}/gmi, ""))) {
    				attr_dev(li, "seq", li_seq_value);
    			}

    			if (dirty[0] & /*state*/ 8 && li_multi_value !== (li_multi_value = /*data*/ ctx[37].multi)) {
    				attr_dev(li, "multi", li_multi_value);
    			}

    			if (dirty[0] & /*state*/ 8 && li_data_jstree_value !== (li_data_jstree_value = JSON.stringify({
    				icon: /*getIcon*/ ctx[8](/*data*/ ctx[37].level)
    			}))) {
    				attr_dev(li, "data-jstree", li_data_jstree_value);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(720:40) {#each state.listItemAll as data, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file$1, 650, 4, 29961);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const unsubscribe = hdd.subscribe(items => $$invalidate(3, state = items));
    	...
    	onDestroy(() => {
    		($$invalidate(2, listItemCorrect = []), listItemAll = []);
    	...
    	beforeUpdate(async () => {
    		...
    		if (xml != state.xml) {
    			$$invalidate(3, state.blank = true, state);
    			await tick();
    			$$invalidate(1, isRerender++, isRerender);
    	...
    	function loadModule(loadXml, uaXML) {
    		($$invalidate(2, listItemCorrect = []), listItemAll = []);
    		$$invalidate(3, state.listItemAll = [], state);
    		$$invalidate(3, state.xml = xml, state);
    		loadXml = XMLToJSON(loadXml);
    		parseXml(loadXml, uaXML);
    		$$invalidate(3, state.blank = false, state);
    	}
    	...
    	function parseXml(QXML, userXML) {
    		...
    		? $$invalidate(3, state.headingListCorrect = QXML.smxml.tree._headingCorrect, state)
    		: "";

    		QXML.smxml.tree._headingAll
    		? $$invalidate(3, state.headingListAll = QXML.smxml.tree._headingAll, state)
    		: "";
    		...
    		? $$invalidate(3, state.sort = QXML.smxml.tree._sort, state)
    		: "";

    		QXML.smxml.tree._options
    		? $$invalidate(3, state.options = QXML.smxml.tree._options, state)
    		: "";

    		if (QXML.smxml.tree._icons) {
    			$$invalidate(3, state.icons = QXML.smxml.tree._icons, state);
    	...
    	function calcNodes(treeData) {
    		...
    		$$invalidate(3, state.treeData = countData, state);
    	...
    	function setItemValueAll(listItem, userXML) {
    			...
    			if (isDragable) {
    				...
    				if (listItemCorrect[ID - 1]) {
    					if (listItemCorrect[ID - 1]["level"] > 0 && listItemCorrect[ID - 1]["item"].length > 0) {
    						...
    						$$invalidate(2, listItemCorrect[ID - 1]["correctAns"] = cans, listItemCorrect);
    					}
    				}
    				...
    				if (level > 0) {
    					cans = "";
    					$$invalidate(2, listItemCorrect[ID] = [], listItemCorrect);
    					$$invalidate(2, listItemCorrect[ID]["ID"] = ID, listItemCorrect);
    					$$invalidate(2, listItemCorrect[ID]["item"] = listItem[i], listItemCorrect);
    					$$invalidate(2, listItemCorrect[ID]["level"] = level, listItemCorrect);
    					$$invalidate(2, listItemCorrect[ID]["parentId"] = parentId[level - 1], listItemCorrect);
    					$$invalidate(2, listItemCorrect[ID]["isParant"] = isParant, listItemCorrect);

    					if (useransArray[ID]) {
    						// assign the 'useransArray[ID]' data in "listItemCorrect[ID]['userAns']"
    						$$invalidate(2, listItemCorrect[ID]["userAns"] = useransArray[ID], listItemCorrect);
    					}
    		...
    		$$invalidate(3, state.totalCorrectAns = countCorrect, state);
    		...
    		$$invalidate(3, state.listItemAll = listItemAll, state);
    	}
    	...
    	function parseOptions(options) {
    		...
    		$$invalidate(3, state.parsedOptions = jsonData, state);
    	}
    	...
    	function getParant(str) {
    		...
    		if (str.substr(0, 1) == "*") {
    			$$invalidate(3, state.showCheckbox = 1, state);
    			parant = "*";
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("isRerender" in $$props) $$invalidate(1, isRerender = $$props.isRerender);
    		if ("booleanDelete" in $$props) booleanDelete = $$props.booleanDelete;
    		if ("treeid" in $$props) treeid = $$props.treeid;
    		if ("listItemCorrect" in $$props) $$invalidate(2, listItemCorrect = $$props.listItemCorrect);
    		...
    		if ("preReview" in $$props) preReview = $$props.preReview;
    	};
