...
var app = (function () {
    ...
    /* clsSMDrawing/DrawingPreview.svelte generated by Svelte v3.34.0 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file, 2244, 20, 131079);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "close");
    			attr_dev(button0, "data-bs-dismiss", "modal");
    			add_location(button0, file, 2245, 20, 131142);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file, 2243, 16, 131032);
    			attr_dev(td0, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td0, file, 2252, 61, 131604);
    			attr_dev(span0, "class", "pl-3 font-weight-bold");
    			add_location(span0, file, 2252, 155, 131698);
    			attr_dev(div1, "class", "d-flex");
    			add_location(div1, file, 2252, 135, 131678);
    			attr_dev(td1, "class", "py-1");
    			add_location(td1, file, 2252, 118, 131661);
    			attr_dev(tr0, "tabindex", "0");
    			attr_dev(tr0, "role", "shortcut");
    			add_location(tr0, file, 2252, 28, 131571);
    			attr_dev(td2, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td2, file, 2253, 61, 131830);
    			attr_dev(span1, "class", "pl-3");
    			add_location(span1, file, 2253, 157, 131926);
    			attr_dev(div2, "class", "d-flex");
    			add_location(div2, file, 2253, 137, 131906);
    			attr_dev(td3, "class", "py-1");
    			add_location(td3, file, 2253, 120, 131889);
    			attr_dev(tr1, "tabindex", "0");
    			attr_dev(tr1, "role", "shortcut");
    			add_location(tr1, file, 2253, 28, 131797);
    			attr_dev(td4, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td4, file, 2254, 62, 132039);
    			attr_dev(span2, "class", "pl-3");
    			add_location(span2, file, 2254, 158, 132135);
    			attr_dev(div3, "class", "d-flex");
    			add_location(div3, file, 2254, 138, 132115);
    			attr_dev(td5, "class", "py-1");
    			add_location(td5, file, 2254, 121, 132098);
    			attr_dev(tr2, "tabindex", "0");
    			attr_dev(tr2, "role", "shortcut");
    			add_location(tr2, file, 2254, 28, 132005);
    			attr_dev(td6, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td6, file, 2255, 62, 132247);
    			attr_dev(span3, "class", "pl-3");
    			add_location(span3, file, 2255, 158, 132343);
    			attr_dev(div4, "class", "d-flex");
    			add_location(div4, file, 2255, 138, 132323);
    			attr_dev(td7, "class", "py-1");
    			add_location(td7, file, 2255, 121, 132306);
    			attr_dev(tr3, "tabindex", "0");
    			attr_dev(tr3, "role", "shortcut");
    			add_location(tr3, file, 2255, 28, 132213);
    			attr_dev(td8, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td8, file, 2256, 62, 132456);
    			attr_dev(span4, "class", "pl-3");
    			add_location(span4, file, 2256, 157, 132551);
    			attr_dev(div5, "class", "d-flex");
    			add_location(div5, file, 2256, 137, 132531);
    			attr_dev(td9, "class", "py-1");
    			add_location(td9, file, 2256, 120, 132514);
    			attr_dev(tr4, "tabindex", "0");
    			attr_dev(tr4, "role", "shortcut");
    			add_location(tr4, file, 2256, 28, 132422);
    			attr_dev(td10, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td10, file, 2257, 62, 132671);
    			attr_dev(span5, "class", "pl-3");
    			add_location(span5, file, 2257, 163, 132772);
    			attr_dev(div6, "class", "d-flex");
    			add_location(div6, file, 2257, 143, 132752);
    			attr_dev(td11, "class", "py-1");
    			add_location(td11, file, 2257, 126, 132735);
    			attr_dev(tr5, "tabindex", "0");
    			attr_dev(tr5, "role", "shortcut");
    			add_location(tr5, file, 2257, 28, 132637);
    			attr_dev(td12, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td12, file, 2258, 62, 132896);
    			attr_dev(span6, "class", "pl-3");
    			add_location(span6, file, 2258, 163, 132997);
    			attr_dev(div7, "class", "d-flex");
    			add_location(div7, file, 2258, 143, 132977);
    			attr_dev(td13, "class", "py-1");
    			add_location(td13, file, 2258, 126, 132960);
    			attr_dev(tr6, "tabindex", "0");
    			attr_dev(tr6, "role", "shortcut");
    			add_location(tr6, file, 2258, 28, 132862);
    			attr_dev(td14, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td14, file, 2259, 62, 133119);
    			attr_dev(span7, "class", "pl-3");
    			add_location(span7, file, 2259, 159, 133216);
    			attr_dev(div8, "class", "d-flex");
    			add_location(div8, file, 2259, 139, 133196);
    			attr_dev(td15, "class", "py-1");
    			add_location(td15, file, 2259, 122, 133179);
    			attr_dev(tr7, "tabindex", "0");
    			attr_dev(tr7, "role", "shortcut");
    			add_location(tr7, file, 2259, 28, 133085);
    			attr_dev(td16, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td16, file, 2260, 62, 133336);
    			attr_dev(span8, "class", "pl-3");
    			add_location(span8, file, 2260, 160, 133434);
    			attr_dev(div9, "class", "d-flex");
    			add_location(div9, file, 2260, 140, 133414);
    			attr_dev(td17, "class", "py-1");
    			add_location(td17, file, 2260, 123, 133397);
    			attr_dev(tr8, "tabindex", "0");
    			attr_dev(tr8, "role", "shortcut");
    			add_location(tr8, file, 2260, 28, 133302);
    			attr_dev(td18, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td18, file, 2261, 62, 133551);
    			attr_dev(span9, "class", "pl-3");
    			add_location(span9, file, 2261, 155, 133644);
    			attr_dev(div10, "class", "d-flex");
    			add_location(div10, file, 2261, 135, 133624);
    			attr_dev(td19, "class", "py-1");
    			add_location(td19, file, 2261, 118, 133607);
    			attr_dev(tr9, "tabindex", "0");
    			attr_dev(tr9, "role", "shortcut");
    			add_location(tr9, file, 2261, 28, 133517);
    			attr_dev(td20, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td20, file, 2262, 62, 133763);
    			attr_dev(span10, "class", "pl-3");
    			add_location(span10, file, 2262, 161, 133862);
    			attr_dev(div11, "class", "d-flex");
    			add_location(div11, file, 2262, 141, 133842);
    			attr_dev(td21, "class", "py-1");
    			add_location(td21, file, 2262, 124, 133825);
    			attr_dev(tr10, "tabindex", "0");
    			attr_dev(tr10, "role", "shortcut");
    			add_location(tr10, file, 2262, 28, 133729);
    			attr_dev(td22, "class", "py-1 font-weight-bold w-50 pr-0");
    			add_location(td22, file, 2263, 62, 133981);
    			attr_dev(span11, "class", "pl-3");
    			add_location(span11, file, 2263, 155, 134074);
    			attr_dev(div12, "class", "d-flex");
    			add_location(div12, file, 2263, 135, 134054);
    			attr_dev(td23, "class", "py-1");
    			add_location(td23, file, 2263, 118, 134037);
    			attr_dev(tr11, "tabindex", "0");
    			attr_dev(tr11, "role", "shortcut");
    			add_location(tr11, file, 2263, 28, 133947);
    			attr_dev(tbody, "tabindex", "0");
    			attr_dev(tbody, "role", "shortcut");
    			add_location(tbody, file, 2251, 24, 131506);
    			...
    			add_location(button4, file, 2280, 24, 134978);
    			...
    			add_location(button5, file, 2281, 24, 135275);
    			attr_dev(i1, "class", "icomoon-compass1");
    			add_location(i1, file, 2282, 252, 135751);
    			...
    			add_location(button6, file, 2282, 24, 135523);
    			...
    			add_location(div18, file, 2279, 20, 134873);
    			attr_dev(i2, "class", "icomoon-delete-sm");
    			add_location(i2, file, 2285, 224, 136149);
    			...
    			add_location(button7, file, 2285, 24, 135949);
    			attr_dev(i3, "class", "icomoon-close-2");
    			add_location(i3, file, 2286, 209, 136401);
    			...
    			add_location(button8, file, 2286, 24, 136216);
    			attr_dev(i4, "class", "icomoon-redo-2");
    			add_location(i4, file, 2287, 178, 136620);
    			...
    			add_location(button9, file, 2287, 24, 136466);
    			attr_dev(i5, "class", "icomoon-undo-2");
    			add_location(i5, file, 2288, 178, 136838);
    			...
    			add_location(button10, file, 2288, 24, 136684);
    			...
    			add_location(div19, file, 2284, 20, 135840);
    			...
    			add_location(button11, file, 2291, 24, 137034);
    			...
    			add_location(div20, file, 2290, 20, 136925);
    			attr_dev(i6, "class", "icomoon-new-24px-reset-1");
    			add_location(i6, file, 2294, 182, 137523);
    			...
    			add_location(button12, file, 2294, 24, 137365);
    			...
    			add_location(div21, file, 2293, 20, 137266);
    			...
    			add_location(div23, file, 2278, 16, 134759);
    			attr_dev(div24, "class", "mt-2 mb-3 previewBtnGrp");
    			add_location(div24, file, 2277, 12, 134705);
    			...
    			add_location(circle0, file, 2317, 36, 139079);
    			...
    			add_location(line, file, 2319, 40, 139326);
    			add_location(g5, file, 2318, 36, 139282);
    			...
    			add_location(circle1, file, 2322, 40, 139588);
    			attr_dev(title1, "id", "compassCenterTitle");
    			add_location(title1, file, 2323, 40, 139858);
    			attr_dev(desc0, "id", "compassCenterDesc");
    			add_location(desc0, file, 2324, 40, 139956);
    			...
    			add_location(path0, file, 2328, 52, 140339);
    			...
    			add_location(path1, file, 2329, 52, 140489);
    			...
    			add_location(path2, file, 2330, 52, 140637);
    			...
    			add_location(circle3, file, 2338, 40, 141274);
    			attr_dev(title2, "id", "compassRadiusTitle");
    			add_location(title2, file, 2339, 40, 141570);
    			attr_dev(desc1, "id", "compassRadiusDesc");
    			add_location(desc1, file, 2340, 40, 141714);
    			attr_dev(rect0, "x", "8.53");
    			attr_dev(rect0, "y", "1.11");
    			attr_dev(rect0, "width", "1.5");
    			attr_dev(rect0, "height", "21.79");
    			add_location(rect0, file, 2346, 60, 142213);
    			add_location(g7, file, 2345, 56, 142149);
    			attr_dev(rect1, "x", "13.97");
    			attr_dev(rect1, "y", "1.11");
    			attr_dev(rect1, "width", "1.5");
    			attr_dev(rect1, "height", "21.79");
    			add_location(rect1, file, 2349, 60, 142448);
    			add_location(g8, file, 2348, 56, 142384);
    			add_location(g9, file, 2344, 52, 142089);
    			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
    			add_location(path4, file, 2354, 60, 142797);
    			add_location(g10, file, 2353, 56, 142733);
    			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
    			add_location(path5, file, 2357, 60, 143052);
    			add_location(g11, file, 2356, 56, 142988);
    			add_location(g12, file, 2352, 52, 142673);
    			attr_dev(svg1, "x", "0px");
    			attr_dev(svg1, "y", "0px");
    			attr_dev(svg1, "viewBox", "1 -5 21 34");
    			attr_dev(svg1, "width", "33");
    			attr_dev(svg1, "height", "33");
    			add_location(svg1, file, 2343, 48, 141971);
    			attr_dev(pattern1, "id", "previewDrawingRadius");
    			attr_dev(pattern1, "width", "20");
    			attr_dev(pattern1, "height", "20");
    			add_location(pattern1, file, 2342, 44, 141864);
    			add_location(defs1, file, 2341, 40, 141813);
    			add_location(g13, file, 2337, 36, 141230);
    			...
    			add_location(circle4, file, 2365, 40, 143529);
    			attr_dev(title3, "id", "compassRotationTitle");
    			add_location(title3, file, 2366, 40, 143905);
    			attr_dev(desc2, "id", "compassRotationDesc");
    			add_location(desc2, file, 2367, 40, 144037);
    			...
    			add_location(circle5, file, 2377, 40, 145053);
    			...
    			add_location(circle6, file, 2378, 40, 145208);
    			attr_dev(title4, "id", "compassAngleTitle");
    			add_location(title4, file, 2379, 40, 145479);
    			attr_dev(desc3, "id", "compassAngleDesc");
    			add_location(desc3, file, 2380, 40, 145574);
    			add_location(g15, file, 2376, 36, 145009);
    			...
    			add_location(circle7, file, 2383, 40, 145751);
    			...
    			add_location(path7, file, 2391, 68, 146856);
    			...
    			add_location(g19, file, 2387, 52, 146255);
    			...
    			add_location(svg3, file, 2386, 48, 146108);
    			attr_dev(pattern3, "id", "previewLastCircleMid_icon");
    			attr_dev(pattern3, "width", "20");
    			attr_dev(pattern3, "height", "20");
    			add_location(pattern3, file, 2385, 44, 145996);
    			add_location(defs3, file, 2384, 40, 145945);
    			add_location(g20, file, 2382, 36, 145707);
    			add_location(g21, file, 2316, 32, 139039);
    			add_location(svg4, file, 2315, 28, 139001);
    			attr_dev(svg5, "class", "drawingCompassSvg h");
    			attr_dev(svg5, "focusable", "false");
    			add_location(svg5, file, 2314, 24, 138921);
