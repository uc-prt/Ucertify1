...
var app = (function () {
    				...
    				if (rel_id && JS$1('#' + rel_id).getAttribute('drag-single') == 1) ; 
    					...
    					// if (JS.select('#' + drag_id).getAttribute('drag-single') == 1 && drop_target != "") {
    						...
    						if (JS$1.select('#'+drop_id)) { //&& previous_droped_item[copied_id]
    							...
    							JS$1.select('#'+drop_id).classList.add('dragable');
    						}
    			...
    			if (pElem.nodeName == "SELECT") {
    				...
    				if (ansType=='c') {  //correct answer
    					...
    					if (anskey.length > 1) {
    						...
    						setTimeout(function(){
    							JS$1.select(pElem.parentElement,'attr', {'rel': 'multiple_answers', 'title' : tooltip + '</p>' ,'data-bs-toggle':'tooltip', 'data-toggle':'tooltip', 'data-bs-html':'true','data-html':'true'});
    							JS$1.enableBsAll("[data-bs-toggle='tooltip']", 'Tooltip', {container: 'body'});
    						},300);
    					}
    ...
    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-zkywc1-style";
    	style.textContent = ".toolbar_container_one.svelte-zkywc1{max-height:359px;max-width:641px;margin:0 auto;border:1px solid #91653E;border-width:0 1px 1px 1px;z-index:1;font-size:17px !important}.draggable_area.svelte-zkywc1{display:inline-flex;height:24px;width:100%;background-color:#654320}.dots_container.svelte-zkywc1{margin:auto;text-align:center}.dots.svelte-zkywc1{width:4px;height:4px;border-radius:50%;display:inline-block;background-color:#888}.toolbar_types_area.svelte-zkywc1{max-height:35px;display:inline-flex;width:-webkit-fill-available;width:100%;background-color:#F0F0F0}.select_area.svelte-zkywc1{width:162px;margin:4px 0}.option_selectbox.svelte-zkywc1{width:155px;padding:4px 2px;border:none;margin-left:2px;border:1px solid}.show_text_area.svelte-zkywc1{width:605px}.lower_part_toolbar.svelte-zkywc1{border:1px solid #91653E;border-width:1px 0}.orange_container.svelte-zkywc1{background-color:#FCFCD3}.column_four.svelte-zkywc1{background-color:#DDDDDD}.blue_container.svelte-zkywc1{background-color:#E6F2FC}.light_purpl_container.svelte-zkywc1{background-color:#F0F0F0}.blank_color.svelte-zkywc1{background-color:#D7E7DA}.blank_color.svelte-zkywc1:hover{outline:none}.font_changer.svelte-zkywc1{font-weight:bold;font-size:17px !important}.first_btn.svelte-zkywc1,.scnd_btn.svelte-zkywc1,.thrd_btn.svelte-zkywc1,.fourth_btn.svelte-zkywc1,.fifth_btn.svelte-zkywc1{text-align:center;width:80px;height:58px;padding:12px;border-right:1px solid #91653E}.first_btn.svelte-zkywc1:hover,.scnd_btn.svelte-zkywc1:hover,.thrd_btn.svelte-zkywc1:hover,.fourth_btn.svelte-zkywc1:hover,.fifth_btn.svelte-zkywc1:hover{outline:1px solid;outline-offset:-6px}.button_designs.svelte-zkywc1,.lower_part_toolbar.svelte-zkywc1{display:inline-flex}.scnd_btn.svelte-zkywc1,.fourth_btn.svelte-zkywc1{border-top:1px solid #91653E;border-bottom:1px solid #91653E}.columns_design.svelte-zkywc1{width:80px}.padder_btn.svelte-zkywc1{padding-top:2px}.remove_border.svelte-zkywc1{border:none}.xvariable.svelte-zkywc1{width:20px;margin:auto;height:19px;background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -32px -487px}.yvariable.svelte-zkywc1{width:22px;margin:auto;height:22px;background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -30px -714px}.xfraction.svelte-zkywc1{width:21px;margin:auto;height:49px;background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -23px -922px;;}.modulus.svelte-zkywc1{width:25px;margin:auto;height:30px;background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -27px -848px}.padder_less.svelte-zkywc1{padding-top:15px}.padder_remover.svelte-zkywc1{padding-top:10px}.padder_field.svelte-zkywc1{padding-top:12px}.sigma.svelte-zkywc1{width:16px;margin:auto;height:48px;background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -36px -381px}.h-bar.svelte-zkywc1{width:17px;margin:auto;height:34px;background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -32px -507px}.x-power-y.svelte-zkywc1{width:21px;margin:auto;height:38px;background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -899px}.long-division.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -79px;width:45px;height:32px;margin:auto}.square-root-two.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -183px;width:38px;height:39px;margin:auto}.x-times-fraction.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -223px;margin:auto;width:37px;height:50px}.square-root.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -274px;width:36px;height:34px;margin:auto}.brackets.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -309px;width:35px;height:34px;margin:auto}.h-power.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -344px;width:35px;height:36px;margin:auto}.curly-brackets.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -408px;width:33px;margin:auto;height:27px}.xsquare.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -461px;width:31px;height:25px;margin:auto}.integrtion.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -487px;width:30px;height:40px;margin:auto}.opp-recbrackets.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -528px;width:30px;height:27px;margin:auto}.square-brackets.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -556px;width:30px;height:34px;margin:auto}.xsubscript.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -591px;width:30px;height:31px;margin:auto}.dollar.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -623px;width:29px;height:31px;margin:auto}.h-sub.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -655px;margin:auto;width:29px;height:30px}.rec-brackets.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -686px;width:28px;height:31px;margin:auto}.xpower.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -718px;width:28px;height:30px;margin:auto}.bar-block.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -749px;width:26px;height:34px;margin:auto}.infinity.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -784px;width:26px;height:20px;margin:auto}.topbar-arrow.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -1px -805px;width:26px;height:42px;margin:auto}.h-sup.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png)-1px -848px;width:25px;height:26px;margin:auto}.colon.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -28px -749px;width:24px;height:31px;margin:auto}.not-lesser.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -28px -781px;width:24px;height:23px;margin:auto}.h-sup-sub.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -28px -805px;width:23px;height:36px;margin:auto}.not-greater.svelte-zkywc1{background:url(https://s3.amazonaws.com/jigyaasa_assets/items/toolbar_images.png) -30px -686px;width:22px;margin:auto;height:27px}.rborder_remover.svelte-zkywc1{border-right:0}.dec_widther.svelte-zkywc1{width:78px}.bborder_remover.svelte-zkywc1{border-bottom:0}.blank_color.svelte-zkywc1:hover{outline:0}.bborder_adder.svelte-zkywc1{border-bottom:1px solid #91653E}@media(max-width: 556px){.first_btn.svelte-zkywc1,.scnd_btn.svelte-zkywc1,.thrd_btn.svelte-zkywc1,.fourth_btn.svelte-zkywc1,.fifth_btn.svelte-zkywc1,.columns_design.svelte-zkywc1{width:30px}}@media(max-width: 768px){.first_btn.svelte-zkywc1,.scnd_btn.svelte-zkywc1,.thrd_btn.svelte-zkywc1,.fourth_btn.svelte-zkywc1,.fifth_btn.svelte-zkywc1,.columns_design.svelte-zkywc1{width:50px}}@media(max-width: 992px){.first_btn.svelte-zkywc1,.scnd_btn.svelte-zkywc1,.thrd_btn.svelte-zkywc1,.fourth_btn.svelte-zkywc1,.fifth_btn.svelte-zkywc1,.columns_design.svelte-zkywc1{width:80px}}.height_modifier.svelte-zkywc1{max-height:290px;overflow-y:scroll}.tborder_remover.svelte-zkywc1{border-top:0}.close_toolbar.svelte-zkywc1{padding:5px;color:#888;border:none;background-color:#654320}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_if_block_14(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "xvariable svelte-zkywc1");
    			add_location(div0, file$1, 143, 24, 7095);
    			attr_dev(div1, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div1, file$1, 142, 20, 6967);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button0, file$1, 145, 24, 7176);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "thrd_btn bborder_remover dec_widther bborder_adder blue_container svelte-zkywc1");
    			add_location(button1, file$1, 146, 24, 7309);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button2, file$1, 147, 24, 7489);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button3, file$1, 148, 24, 7645);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button4, file$1, 149, 24, 7789);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button5, file$1, 150, 24, 7945);
    			attr_dev(div2, "class", "not-lesser svelte-zkywc1");
    			add_location(div2, file$1, 152, 24, 8225);
    			attr_dev(div3, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div3, file$1, 151, 20, 8091);
    			attr_dev(div4, "class", "rec-brackets svelte-zkywc1");
    			add_location(div4, file$1, 155, 24, 8430);
    			attr_dev(div5, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(div5, file$1, 154, 20, 8303);
    			attr_dev(div6, "class", "xvariable svelte-zkywc1");
    			add_location(div6, file$1, 158, 24, 8633);
    			attr_dev(div7, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div7, file$1, 157, 20, 8510);
    			attr_dev(div8, "class", "xfraction svelte-zkywc1");
    			add_location(div8, file$1, 161, 24, 8827);
    			attr_dev(div9, "class", "scnd_btn dec_widther blue_container padder_btn svelte-zkywc1");
    			add_location(div9, file$1, 160, 20, 8710);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button6, file$1, 163, 24, 8908);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button7, file$1, 164, 24, 9062);
    			attr_dev(div10, "class", "yvariable svelte-zkywc1");
    			add_location(div10, file$1, 166, 24, 9321);
    			attr_dev(div11, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div11, file$1, 165, 20, 9198);
    			attr_dev(div12, "class", "x-times-fraction svelte-zkywc1");
    			add_location(div12, file$1, 169, 24, 9515);
    			attr_dev(div13, "class", "scnd_btn dec_widther blue_container padder_btn svelte-zkywc1");
    			add_location(div13, file$1, 168, 20, 9398);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button8, file$1, 171, 24, 9603);
    			attr_dev(div14, "class", "infinity svelte-zkywc1");
    			add_location(div14, file$1, 173, 24, 9863);
    			attr_dev(div15, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(div15, file$1, 172, 20, 9750);
    			attr_dev(div16, "class", "xsquare svelte-zkywc1");
    			add_location(div16, file$1, 176, 24, 10084);
    			attr_dev(div17, "class", "first_btn bborder_remover dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div17, file$1, 175, 20, 9939);
    			attr_dev(div18, "class", "xpower svelte-zkywc1");
    			add_location(div18, file$1, 179, 24, 10286);
    			attr_dev(div19, "class", "scnd_btn dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div19, file$1, 178, 20, 10159);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button9, file$1, 181, 24, 10364);
    			attr_dev(div20, "class", "brackets svelte-zkywc1");
    			add_location(div20, file$1, 183, 24, 10643);
    			attr_dev(div21, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(div21, file$1, 182, 20, 10516);
    			attr_dev(div22, "class", "square-root svelte-zkywc1");
    			add_location(div22, file$1, 186, 24, 10847);
    			attr_dev(div23, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div23, file$1, 185, 20, 10719);
    			attr_dev(div24, "class", "square-root-two svelte-zkywc1");
    			add_location(div24, file$1, 189, 24, 11060);
    			attr_dev(div25, "class", "fourth_btn dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div25, file$1, 188, 20, 10926);
    			attr_dev(div26, "class", "modulus svelte-zkywc1");
    			add_location(div26, file$1, 192, 24, 11266);
    			attr_dev(div27, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div27, file$1, 191, 20, 11143);
    			attr_dev(div28, "class", "square-brackets svelte-zkywc1");
    			add_location(div28, file$1, 195, 24, 11468);
    			attr_dev(div29, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(div29, file$1, 194, 20, 11341);
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button10, file$1, 197, 24, 11555);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button11, file$1, 198, 24, 11705);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button12, file$1, 199, 24, 11843);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button13, file$1, 200, 24, 12010);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button14, file$1, 201, 24, 12158);
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button15, file$1, 202, 24, 12321);
    			attr_dev(button16, "type", "button");
    			attr_dev(button16, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button16, file$1, 203, 24, 12469);
    			attr_dev(button17, "type", "button");
    			attr_dev(button17, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button17, file$1, 204, 24, 12635);
    			attr_dev(div30, "class", "integrtion svelte-zkywc1");
    			add_location(div30, file$1, 206, 24, 12924);
    			attr_dev(div31, "class", "first_btn bborder_remover dec_widther padder_remover blue_container svelte-zkywc1");
    			add_location(div31, file$1, 205, 20, 12769);
    			attr_dev(button18, "type", "button");
    			attr_dev(button18, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button18, file$1, 208, 24, 13006);
    			attr_dev(div32, "class", "sigma svelte-zkywc1");
    			add_location(div32, file$1, 210, 24, 13303);
    			attr_dev(div33, "class", "first_btn bborder_remover dec_widther blue_container padder_btn svelte-zkywc1");
    			add_location(div33, file$1, 209, 20, 13152);
    			attr_dev(button19, "type", "button");
    			attr_dev(button19, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button19, file$1, 212, 24, 13380);
    			attr_dev(button20, "type", "button");
    			attr_dev(button20, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button20, file$1, 213, 24, 13542);
    			attr_dev(button21, "type", "button");
    			attr_dev(button21, "class", "scnd_btn dec_widther bborder_remover blue_container svelte-zkywc1");
    			add_location(button21, file$1, 214, 24, 13697);
    			attr_dev(div34, "class", "column_five dec_widther blue_container columns_design svelte-zkywc1");
    			add_location(div34, file$1, 141, 16, 6879);
    			attr_dev(div35, "class", "yvariable svelte-zkywc1");
    			add_location(div35, file$1, 218, 24, 14103);
    			attr_dev(div36, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div36, file$1, 217, 20, 13975);
    			attr_dev(div37, "class", "x-times-fraction svelte-zkywc1");
    			add_location(div37, file$1, 221, 24, 14297);
    			attr_dev(div38, "class", "scnd_btn dec_widther blue_container padder_btn svelte-zkywc1");
    			add_location(div38, file$1, 220, 20, 14180);
    			attr_dev(button22, "type", "button");
    			attr_dev(button22, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button22, file$1, 223, 24, 14385);
    			attr_dev(button23, "type", "button");
    			attr_dev(button23, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button23, file$1, 224, 24, 14536);
    			attr_dev(button24, "type", "button");
    			attr_dev(button24, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button24, file$1, 225, 24, 14687);
    			attr_dev(button25, "type", "button");
    			attr_dev(button25, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button25, file$1, 226, 24, 14842);
    			attr_dev(button26, "type", "button");
    			attr_dev(button26, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button26, file$1, 227, 24, 14981);
    			attr_dev(button27, "type", "button");
    			attr_dev(button27, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button27, file$1, 228, 24, 15135);
    			attr_dev(div39, "class", "not-greater svelte-zkywc1");
    			add_location(div39, file$1, 230, 24, 15405);
    			attr_dev(div40, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div40, file$1, 229, 20, 15272);
    			attr_dev(button28, "type", "button");
    			attr_dev(button28, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button28, file$1, 232, 24, 15488);
    			attr_dev(button29, "type", "button");
    			attr_dev(button29, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button29, file$1, 233, 24, 15633);
    			attr_dev(button30, "type", "button");
    			attr_dev(button30, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button30, file$1, 234, 24, 15784);
    			attr_dev(div41, "class", "not-lesser svelte-zkywc1");
    			add_location(div41, file$1, 236, 24, 16055);
    			attr_dev(div42, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div42, file$1, 235, 20, 15921);
    			attr_dev(button31, "type", "button");
    			attr_dev(button31, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button31, file$1, 238, 24, 16137);
    			attr_dev(button32, "type", "button");
    			attr_dev(button32, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button32, file$1, 239, 24, 16285);
    			attr_dev(button33, "type", "button");
    			attr_dev(button33, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button33, file$1, 240, 24, 16449);
    			attr_dev(button34, "type", "button");
    			attr_dev(button34, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button34, file$1, 241, 24, 16604);
    			attr_dev(div43, "class", "bar-block svelte-zkywc1");
    			add_location(div43, file$1, 243, 24, 16904);
    			attr_dev(div44, "class", "fourth_btn dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div44, file$1, 242, 20, 16766);
    			attr_dev(button35, "type", "button");
    			attr_dev(button35, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button35, file$1, 245, 24, 16985);
    			attr_dev(button36, "type", "button");
    			attr_dev(button36, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button36, file$1, 246, 24, 17149);
    			attr_dev(button37, "type", "button");
    			attr_dev(button37, "class", "thrd_btn bborder_remover dec_widther blue_container bborder_adder svelte-zkywc1");
    			add_location(button37, file$1, 247, 24, 17306);
    			attr_dev(button38, "type", "button");
    			attr_dev(button38, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button38, file$1, 248, 24, 17484);
    			attr_dev(div45, "class", "topbar-arrow svelte-zkywc1");
    			add_location(div45, file$1, 250, 24, 17789);
    			attr_dev(div46, "class", "fourth_btn dec_widther padder_remover blue_container svelte-zkywc1");
    			add_location(div46, file$1, 249, 20, 17642);
    			attr_dev(button39, "type", "button");
    			attr_dev(button39, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button39, file$1, 252, 24, 17873);
    			attr_dev(button40, "type", "button");
    			attr_dev(button40, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button40, file$1, 253, 24, 18039);
    			attr_dev(button41, "type", "button");
    			attr_dev(button41, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button41, file$1, 254, 24, 18180);
    			attr_dev(button42, "type", "button");
    			attr_dev(button42, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button42, file$1, 255, 24, 18349);
    			attr_dev(button43, "type", "button");
    			attr_dev(button43, "class", "first_btn bborder_remover dec_widther padder_remover blue_container svelte-zkywc1");
    			add_location(button43, file$1, 256, 24, 18496);
    			attr_dev(button44, "type", "button");
    			attr_dev(button44, "class", "scnd_btn dec_widther blue_container blue_container padder_less svelte-zkywc1");
    			add_location(button44, file$1, 257, 24, 18678);
    			attr_dev(button45, "type", "button");
    			attr_dev(button45, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button45, file$1, 258, 24, 18855);
    			attr_dev(button46, "type", "button");
    			attr_dev(button46, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button46, file$1, 259, 24, 19014);
    			attr_dev(button47, "type", "button");
    			attr_dev(button47, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button47, file$1, 260, 24, 19166);
    			attr_dev(button48, "type", "button");
    			attr_dev(button48, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button48, file$1, 261, 24, 19322);
    			attr_dev(button49, "type", "button");
    			attr_dev(button49, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button49, file$1, 262, 24, 19470);
    			attr_dev(button50, "type", "button");
    			attr_dev(button50, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button50, file$1, 263, 24, 19637);
    			attr_dev(button51, "type", "button");
    			attr_dev(button51, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button51, file$1, 264, 24, 19789);
    			attr_dev(button52, "type", "button");
    			attr_dev(button52, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button52, file$1, 265, 24, 19950);
    			attr_dev(button53, "type", "button");
    			attr_dev(button53, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button53, file$1, 266, 24, 20096);
    			attr_dev(button54, "type", "button");
    			attr_dev(button54, "class", "scnd_btn dec_widther bborder_remover blue_container svelte-zkywc1");
    			add_location(button54, file$1, 267, 24, 20261);
    			attr_dev(div47, "class", "column_six dec_widther blue_container columns_design svelte-zkywc1");
    			add_location(div47, file$1, 216, 16, 13888);
    			attr_dev(div48, "class", "xsquare svelte-zkywc1");
    			add_location(div48, file$1, 271, 24, 20674);
    			attr_dev(div49, "class", "first_btn bborder_remover dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div49, file$1, 270, 20, 20529);
    			attr_dev(div50, "class", "xpower svelte-zkywc1");
    			add_location(div50, file$1, 274, 24, 20879);
    			attr_dev(div51, "class", "scnd_btn dec_widther blue_container padder_remover svelte-zkywc1");
    			add_location(div51, file$1, 273, 20, 20749);
    			attr_dev(button55, "type", "button");
    			attr_dev(button55, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button55, file$1, 276, 24, 20957);
    			attr_dev(div52, "class", "colon svelte-zkywc1");
    			add_location(div52, file$1, 278, 24, 21229);
    			attr_dev(div53, "class", "fourth_btn dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div53, file$1, 277, 20, 21109);
    			attr_dev(div54, "class", "infinity svelte-zkywc1");
    			add_location(div54, file$1, 281, 24, 21430);
    			attr_dev(div55, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(div55, file$1, 280, 20, 21302);
    			attr_dev(button56, "type", "button");
    			attr_dev(button56, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button56, file$1, 283, 24, 21510);
    			attr_dev(button57, "type", "button");
    			attr_dev(button57, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button57, file$1, 284, 24, 21659);
    			attr_dev(button58, "type", "button");
    			attr_dev(button58, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button58, file$1, 285, 24, 21817);
    			attr_dev(button59, "type", "button");
    			attr_dev(button59, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button59, file$1, 286, 24, 21960);
    			attr_dev(div56, "class", "brackets svelte-zkywc1");
    			add_location(div56, file$1, 288, 24, 22245);
    			attr_dev(div57, "class", "fourth_btn dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div57, file$1, 287, 20, 22106);
    			attr_dev(button60, "type", "button");
    			attr_dev(button60, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button60, file$1, 290, 24, 22325);
    			attr_dev(button61, "type", "button");
    			attr_dev(button61, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button61, file$1, 291, 24, 22491);
    			attr_dev(button62, "type", "button");
    			attr_dev(button62, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button62, file$1, 292, 24, 22636);
    			attr_dev(button63, "type", "button");
    			attr_dev(button63, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button63, file$1, 293, 24, 22793);
    			attr_dev(div58, "class", "curly-brackets svelte-zkywc1");
    			add_location(div58, file$1, 295, 24, 23087);
    			attr_dev(div59, "class", "first_btn bborder_remover dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div59, file$1, 294, 20, 22929);
    			attr_dev(button64, "type", "button");
    			attr_dev(button64, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button64, file$1, 297, 24, 23173);
    			attr_dev(button65, "type", "button");
    			attr_dev(button65, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button65, file$1, 298, 24, 23325);
    			attr_dev(button66, "type", "button");
    			attr_dev(button66, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button66, file$1, 299, 24, 23488);
    			attr_dev(button67, "type", "button");
    			attr_dev(button67, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button67, file$1, 300, 24, 23640);
    			attr_dev(div60, "class", "rec-brackets svelte-zkywc1");
    			add_location(div60, file$1, 302, 24, 23925);
    			attr_dev(div61, "class", "fourth_btn dec_widther padder_less blue_container svelte-zkywc1");
    			add_location(div61, file$1, 301, 20, 23786);
    			add_location(sup0, file$1, 304, 156, 24141);
    			attr_dev(button68, "type", "button");
    			attr_dev(button68, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button68, file$1, 304, 24, 24009);
    			add_location(sup1, file$1, 305, 139, 24303);
    			attr_dev(button69, "type", "button");
    			attr_dev(button69, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button69, file$1, 305, 24, 24188);
    			add_location(sup2, file$1, 306, 155, 24481);
    			attr_dev(button70, "type", "button");
    			attr_dev(button70, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button70, file$1, 306, 24, 24350);
    			attr_dev(button71, "type", "button");
    			attr_dev(button71, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button71, file$1, 307, 24, 24528);
    			attr_dev(button72, "type", "button");
    			attr_dev(button72, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button72, file$1, 308, 24, 24671);
    			attr_dev(button73, "type", "button");
    			attr_dev(button73, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button73, file$1, 309, 24, 24825);
    			add_location(sup3, file$1, 310, 156, 25101);
    			attr_dev(button74, "type", "button");
    			attr_dev(button74, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button74, file$1, 310, 24, 24969);
    			add_location(sup4, file$1, 311, 139, 25263);
    			attr_dev(button75, "type", "button");
    			attr_dev(button75, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button75, file$1, 311, 24, 25148);
    			add_location(sup5, file$1, 312, 155, 25441);
    			attr_dev(button76, "type", "button");
    			attr_dev(button76, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button76, file$1, 312, 24, 25310);
    			attr_dev(button77, "type", "button");
    			attr_dev(button77, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button77, file$1, 313, 24, 25489);
    			attr_dev(button78, "type", "button");
    			attr_dev(button78, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button78, file$1, 314, 24, 25622);
    			attr_dev(button79, "type", "button");
    			attr_dev(button79, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button79, file$1, 315, 24, 25782);
    			attr_dev(button80, "type", "button");
    			attr_dev(button80, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button80, file$1, 316, 24, 25930);
    			attr_dev(button81, "type", "button");
    			attr_dev(button81, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button81, file$1, 317, 24, 26094);
    			attr_dev(div62, "class", "h-sup svelte-zkywc1");
    			add_location(div62, file$1, 319, 24, 26381);
    			attr_dev(div63, "class", "first_btn bborder_remover dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div63, file$1, 318, 20, 26238);
    			attr_dev(button82, "type", "button");
    			attr_dev(button82, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button82, file$1, 321, 24, 26458);
    			attr_dev(div64, "class", "x-power-y svelte-zkywc1");
    			add_location(div64, file$1, 323, 24, 26760);
    			attr_dev(div65, "class", "thrd_btn bborder_remover dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div65, file$1, 322, 20, 26603);
    			add_location(sup6, file$1, 325, 160, 26977);
    			attr_dev(button83, "type", "button");
    			attr_dev(button83, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button83, file$1, 325, 24, 26841);
    			attr_dev(button84, "type", "button");
    			attr_dev(button84, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button84, file$1, 326, 24, 27024);
    			attr_dev(div66, "class", "column_seven dec_widther blue_container columns_design svelte-zkywc1");
    			add_location(div66, file$1, 269, 16, 20440);
    			attr_dev(div67, "class", "square-root svelte-zkywc1");
    			add_location(div67, file$1, 330, 24, 27436);
    			attr_dev(div68, "class", "first_btn bborder_remover dec_widther blue_container padder_field svelte-zkywc1");
    			add_location(div68, file$1, 329, 20, 27295);
    			attr_dev(div69, "class", "xsubscript svelte-zkywc1");
    			add_location(div69, file$1, 333, 24, 27642);
    			attr_dev(div70, "class", "scnd_btn dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div70, file$1, 332, 20, 27515);
    			attr_dev(div71, "class", "dollar svelte-zkywc1");
    			add_location(div71, file$1, 336, 24, 27859);
    			attr_dev(div72, "class", "thrd_btn bborder_remover dec_widther blue_container padder_less svelte-zkywc1");
    			add_location(div72, file$1, 335, 20, 27720);
    			attr_dev(div73, "class", "brackets svelte-zkywc1");
    			add_location(div73, file$1, 339, 24, 28073);
    			attr_dev(div74, "class", "fourth_btn dec_widther blue_container padder_field svelte-zkywc1");
    			add_location(div74, file$1, 338, 20, 27933);
    			attr_dev(button85, "type", "button");
    			attr_dev(button85, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button85, file$1, 341, 24, 28153);
    			attr_dev(button86, "type", "button");
    			attr_dev(button86, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button86, file$1, 342, 24, 28313);
    			attr_dev(button87, "type", "button");
    			attr_dev(button87, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button87, file$1, 343, 24, 28456);
    			add_location(sup7, file$1, 344, 139, 28725);
    			attr_dev(button88, "type", "button");
    			attr_dev(button88, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button88, file$1, 344, 24, 28610);
    			add_location(sup8, file$1, 345, 155, 28903);
    			attr_dev(button89, "type", "button");
    			attr_dev(button89, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button89, file$1, 345, 24, 28772);
    			add_location(sup9, file$1, 346, 139, 29065);
    			attr_dev(button90, "type", "button");
    			attr_dev(button90, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button90, file$1, 346, 24, 28950);
    			attr_dev(button91, "type", "button");
    			attr_dev(button91, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button91, file$1, 347, 24, 29112);
    			attr_dev(button92, "type", "button");
    			attr_dev(button92, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button92, file$1, 348, 24, 29279);
    			attr_dev(button93, "type", "button");
    			attr_dev(button93, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button93, file$1, 349, 24, 29424);
    			attr_dev(button94, "type", "button");
    			attr_dev(button94, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button94, file$1, 350, 24, 29584);
    			attr_dev(button95, "type", "button");
    			attr_dev(button95, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button95, file$1, 351, 24, 29728);
    			attr_dev(button96, "type", "button");
    			attr_dev(button96, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button96, file$1, 352, 24, 29895);
    			attr_dev(button97, "type", "button");
    			attr_dev(button97, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button97, file$1, 353, 24, 30040);
    			attr_dev(button98, "type", "button");
    			attr_dev(button98, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button98, file$1, 354, 24, 30200);
    			attr_dev(button99, "type", "button");
    			attr_dev(button99, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button99, file$1, 355, 24, 30359);
    			attr_dev(button100, "type", "button");
    			attr_dev(button100, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button100, file$1, 356, 24, 30526);
    			attr_dev(button101, "type", "button");
    			attr_dev(button101, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button101, file$1, 357, 24, 30676);
    			attr_dev(button102, "type", "button");
    			attr_dev(button102, "class", "fourth_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button102, file$1, 358, 24, 30839);
    			attr_dev(button103, "type", "button");
    			attr_dev(button103, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button103, file$1, 359, 24, 30984);
    			attr_dev(button104, "type", "button");
    			attr_dev(button104, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button104, file$1, 360, 24, 31140);
    			attr_dev(button105, "type", "button");
    			attr_dev(button105, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button105, file$1, 361, 24, 31284);
    			attr_dev(button106, "type", "button");
    			attr_dev(button106, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button106, file$1, 362, 24, 31448);
    			attr_dev(button107, "type", "button");
    			attr_dev(button107, "class", "thrd_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button107, file$1, 363, 24, 31600);
    			attr_dev(button108, "type", "button");
    			attr_dev(button108, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button108, file$1, 364, 24, 31762);
    			attr_dev(button109, "type", "button");
    			attr_dev(button109, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button109, file$1, 365, 24, 31903);
    			attr_dev(button110, "type", "button");
    			attr_dev(button110, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button110, file$1, 366, 24, 32068);
    			attr_dev(button111, "type", "button");
    			attr_dev(button111, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button111, file$1, 367, 24, 32216);
    			attr_dev(button112, "type", "button");
    			attr_dev(button112, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button112, file$1, 368, 24, 32387);
    			attr_dev(button113, "type", "button");
    			attr_dev(button113, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button113, file$1, 369, 24, 32533);
    			attr_dev(button114, "type", "button");
    			attr_dev(button114, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button114, file$1, 370, 24, 32696);
    			attr_dev(button115, "type", "button");
    			attr_dev(button115, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button115, file$1, 371, 24, 32842);
    			attr_dev(button116, "type", "button");
    			attr_dev(button116, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button116, file$1, 372, 24, 33005);
    			attr_dev(button117, "type", "button");
    			attr_dev(button117, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button117, file$1, 373, 24, 33153);
    			attr_dev(button118, "type", "button");
    			attr_dev(button118, "class", "scnd_btn dec_widther blue_container svelte-zkywc1");
    			add_location(button118, file$1, 374, 24, 33318);
    			attr_dev(button119, "type", "button");
    			attr_dev(button119, "class", "first_btn bborder_remover dec_widther blue_container svelte-zkywc1");
    			add_location(button119, file$1, 375, 24, 33466);
    			attr_dev(div75, "class", "column_eight dec_widther columns_design blue_container svelte-zkywc1");
    			add_location(div75, file$1, 328, 16, 27206);
    			attr_dev(div76, "class", "button_designs select_changer height_modifier svelte-zkywc1");
    ...
    function create_if_block_13(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div1, "class", "first_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(div1, file$1, 382, 16, 33845);
    			attr_dev(div2, "class", "xfraction svelte-zkywc1");
    			add_location(div2, file$1, 386, 20, 34127);
    			attr_dev(div3, "class", "blue_container scnd_btn padder_btn svelte-zkywc1");
    			add_location(div3, file$1, 385, 16, 34026);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button0, file$1, 388, 20, 34200);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "blue_container fourth_btn svelte-zkywc1");
    			add_location(button1, file$1, 389, 20, 34338);
    			attr_dev(div4, "class", "modulus svelte-zkywc1");
    			add_location(div4, file$1, 391, 20, 34572);
    			attr_dev(div5, "class", "blue_container fifth_btn bborder_remover padder_less svelte-zkywc1");
    			add_location(div5, file$1, 390, 16, 34453);
    			attr_dev(div6, "class", "column_five blue_container columns_design svelte-zkywc1");
    			add_location(div6, file$1, 381, 12, 33773);
    			attr_dev(div7, "class", "yvariable svelte-zkywc1");
    			add_location(div7, file$1, 396, 20, 34837);
    			attr_dev(div8, "class", "first_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(div8, file$1, 395, 16, 34725);
    			attr_dev(div9, "class", "x-times-fraction svelte-zkywc1");
    			add_location(div9, file$1, 399, 20, 35007);
    			attr_dev(div10, "class", "scnd_btn padder_btn blue_container svelte-zkywc1");
    			add_location(div10, file$1, 398, 16, 34906);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "thrd_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button2, file$1, 401, 20, 35087);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fourth_btn blue_container svelte-zkywc1");
    			add_location(button3, file$1, 402, 20, 35225);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "fifth_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button4, file$1, 403, 20, 35360);
    			attr_dev(div11, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div11, file$1, 394, 12, 34654);
    			attr_dev(div12, "class", "xsquare svelte-zkywc1");
    			add_location(div12, file$1, 407, 20, 35712);
    			attr_dev(div13, "class", "blue_container first_btn bborder_remover padder_less svelte-zkywc1");
    			add_location(div13, file$1, 406, 16, 35583);
    			attr_dev(div14, "class", "xpower svelte-zkywc1");
    			add_location(div14, file$1, 410, 20, 35893);
    			attr_dev(div15, "class", "blue_container scnd_btn padder_remover svelte-zkywc1");
    			add_location(div15, file$1, 409, 16, 35779);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button5, file$1, 412, 20, 35963);
    			attr_dev(div16, "class", "colon svelte-zkywc1");
    			add_location(div16, file$1, 414, 20, 36203);
    			attr_dev(div17, "class", "blue_container fourth_btn padder_less svelte-zkywc1");
    			add_location(div17, file$1, 413, 16, 36099);
    			attr_dev(div18, "class", "infinity svelte-zkywc1");
    			add_location(div18, file$1, 417, 20, 36380);
    			attr_dev(div19, "class", "blue_container fifth_btn bborder_remover svelte-zkywc1");
    			add_location(div19, file$1, 416, 16, 36268);
    			attr_dev(div20, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div20, file$1, 405, 12, 35510);
    			attr_dev(div21, "class", "square-root svelte-zkywc1");
    			add_location(div21, file$1, 422, 20, 36661);
    			attr_dev(div22, "class", "blue_container first_btn bborder_remover blue_container padder_field svelte-zkywc1");
    			add_location(div22, file$1, 421, 16, 36521);
    			attr_dev(div23, "class", "xsubscript svelte-zkywc1");
    			add_location(div23, file$1, 425, 20, 36858);
    			attr_dev(div24, "class", "blue_container scnd_btn blue_container padder_less svelte-zkywc1");
    			add_location(div24, file$1, 424, 16, 36732);
    			attr_dev(div25, "class", "dollar svelte-zkywc1");
    			add_location(div25, file$1, 428, 20, 37066);
    			attr_dev(div26, "class", "blue_container thrd_btn bborder_remover blue_container padder_less svelte-zkywc1");
    			add_location(div26, file$1, 427, 16, 36928);
    			attr_dev(div27, "class", "brackets svelte-zkywc1");
    			add_location(div27, file$1, 431, 20, 37271);
    			attr_dev(div28, "class", "blue_container fourth_btn blue_container padder_field svelte-zkywc1");
    			add_location(div28, file$1, 430, 16, 37132);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button6, file$1, 433, 20, 37343);
    			attr_dev(div29, "class", "column_eight columns_design svelte-zkywc1");
    			add_location(div29, file$1, 420, 12, 36463);
    			attr_dev(div30, "class", "button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_12(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div1, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			...
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button2, file$1, 448, 20, 38273);
    			attr_dev(div4, "class", "column_five blue_container columns_design svelte-zkywc1");
    			add_location(div4, file$1, 439, 12, 37589);
    			attr_dev(div5, "class", "yvariable svelte-zkywc1");
    			add_location(div5, file$1, 452, 20, 38576);
    			attr_dev(div6, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(div6, file$1, 451, 16, 38469);
    			attr_dev(div7, "class", "x-times-fraction svelte-zkywc1");
    			add_location(div7, file$1, 455, 20, 38746);
    			attr_dev(div8, "class", "blue_container scnd_btn padder_btn svelte-zkywc1");
    			add_location(div8, file$1, 454, 16, 38645);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button3, file$1, 457, 20, 38826);
    			attr_dev(div9, "class", "infinity svelte-zkywc1");
    			add_location(div9, file$1, 459, 20, 39057);
    			attr_dev(div10, "class", "blue_container fourth_btn svelte-zkywc1");
    			add_location(div10, file$1, 458, 16, 38960);
    			attr_dev(div11, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(div11, file$1, 461, 16, 39125);
    			attr_dev(div12, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div12, file$1, 450, 12, 38398);
    			attr_dev(div13, "class", "xsquare svelte-zkywc1");
    			add_location(div13, file$1, 465, 20, 39432);
    			attr_dev(div14, "class", "blue_container first_btn bborder_remover padder_less svelte-zkywc1");
    			add_location(div14, file$1, 464, 16, 39303);
    			attr_dev(div15, "class", "xpower svelte-zkywc1");
    			add_location(div15, file$1, 468, 20, 39610);
    			attr_dev(div16, "class", "blue_container scnd_btn padder_less svelte-zkywc1");
    			add_location(div16, file$1, 467, 16, 39499);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button4, file$1, 470, 20, 39680);
    			attr_dev(div17, "class", "brackets svelte-zkywc1");
    			add_location(div17, file$1, 472, 20, 39939);
    			attr_dev(div18, "class", "blue_container fourth_btn padder_less svelte-zkywc1");
    			add_location(div18, file$1, 471, 16, 39816);
    			attr_dev(div19, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(div19, file$1, 474, 16, 40007);
    			attr_dev(div20, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div20, file$1, 463, 12, 39230);
    			attr_dev(div21, "class", "square-root svelte-zkywc1");
    			add_location(div21, file$1, 478, 20, 40295);
    			attr_dev(div22, "class", "first_btn bborder_remover blue_container padder_field svelte-zkywc1");
    			add_location(div22, file$1, 477, 16, 40170);
    			attr_dev(div23, "class", "square-root-two svelte-zkywc1");
    			add_location(div23, file$1, 481, 20, 40485);
    			attr_dev(div24, "class", "scnd_btn blue_container padder_remover svelte-zkywc1");
    			add_location(div24, file$1, 480, 16, 40366);
    			attr_dev(div25, "class", "modulus svelte-zkywc1");
    			add_location(div25, file$1, 484, 20, 40678);
    			attr_dev(div26, "class", "thrd_btn bborder_remover blue_container padder_less svelte-zkywc1");
    			add_location(div26, file$1, 483, 16, 40560);
    			attr_dev(div27, "class", "square-brackets svelte-zkywc1");
    			add_location(div27, file$1, 487, 20, 40868);
    			attr_dev(div28, "class", "fourth_btn blue_container padder_less svelte-zkywc1");
    			add_location(div28, file$1, 486, 16, 40745);
    			attr_dev(div29, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(div29, file$1, 489, 16, 40943);
    			attr_dev(div30, "class", "column_eight columns_design svelte-zkywc1");
    			add_location(div30, file$1, 476, 12, 40112);
    			attr_dev(div31, "class", "btn-group button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_11(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div8 = element("div");
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(button0, file$1, 496, 20, 41245);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button1, file$1, 497, 20, 41385);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button2, file$1, 498, 20, 41507);
    			attr_dev(div0, "class", "not-greater svelte-zkywc1");
    			add_location(div0, file$1, 500, 20, 41744);
    			attr_dev(div1, "class", "blue_container fourth_btn svelte-zkywc1");
    			add_location(div1, file$1, 499, 16, 41642);
    			attr_dev(div2, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(div2, file$1, 502, 16, 41815);
    			attr_dev(div3, "class", "column_five blue_container columns_design svelte-zkywc1");
    			add_location(div3, file$1, 495, 12, 41169);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(button3, file$1, 505, 20, 41995);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button4, file$1, 506, 20, 42141);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button5, file$1, 507, 20, 42263);
    			attr_dev(div4, "class", "not-lesser svelte-zkywc1");
    			add_location(div4, file$1, 509, 20, 42501);
    			attr_dev(div5, "class", "blue_container fourth_btn svelte-zkywc1");
    			add_location(div5, file$1, 508, 16, 42398);
    			attr_dev(div6, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(div6, file$1, 511, 16, 42571);
    			attr_dev(div7, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div7, file$1, 504, 12, 41920);
    			attr_dev(div8, "class", "remove_border svelte-zkywc1");
    			add_location(div8, file$1, 513, 12, 42660);
    			attr_dev(div9, "class", "btn-group button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_10(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "blue_container fourth_btn svelte-zkywc1");
    			add_location(button3, file$1, 522, 16, 43337);
    			attr_dev(div0, "class", "bar-block svelte-zkywc1");
    			add_location(div0, file$1, 524, 20, 43605);
    			attr_dev(div1, "class", "blue_container fifth_btn bborder_remover padder_less svelte-zkywc1");
    			add_location(div1, file$1, 523, 16, 43468);
    			attr_dev(div2, "class", "column_five blue_container columns_design svelte-zkywc1");
    			add_location(div2, file$1, 518, 12, 42843);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(button4, file$1, 528, 16, 43760);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button5, file$1, 529, 16, 43904);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button6, file$1, 530, 16, 44041);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "blue_container fourth_btn svelte-zkywc1");
    			add_location(button7, file$1, 531, 16, 44185);
    			attr_dev(div3, "class", "topbar-arrow svelte-zkywc1");
    			add_location(div3, file$1, 533, 20, 44458);
    			attr_dev(div4, "class", "blue_container fifth_btn bborder_remover padder_remover svelte-zkywc1");
    			add_location(div4, file$1, 532, 16, 44312);
    			attr_dev(div5, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div5, file$1, 527, 12, 43689);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(button8, file$1, 537, 16, 44618);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button9, file$1, 538, 16, 44764);
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button10, file$1, 539, 16, 44885);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "blue_container fourth_btn svelte-zkywc1");
    			add_location(button11, file$1, 540, 16, 45034);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "blue_container fifth_btn bborder_remover padder_remover svelte-zkywc1");
    			add_location(button12, file$1, 541, 16, 45161);
    			attr_dev(div6, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div6, file$1, 536, 12, 44545);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "first_btn bborder_remover blue_container padder_less svelte-zkywc1");
    			add_location(button13, file$1, 544, 16, 45396);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "scnd_btn blue_container svelte-zkywc1");
    			add_location(button14, file$1, 545, 16, 45555);
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "thrd_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button15, file$1, 546, 16, 45678);
    			attr_dev(button16, "type", "button");
    			attr_dev(button16, "class", "fourth_btn blue_container svelte-zkywc1");
    			add_location(button16, file$1, 547, 16, 45824);
    			attr_dev(button17, "type", "button");
    			attr_dev(button17, "class", "fifth_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button17, file$1, 548, 16, 45945);
    			attr_dev(div7, "class", "column_eight columns_design svelte-zkywc1");
    			add_location(div7, file$1, 543, 12, 45338);
    			attr_dev(div8, "class", "btn-group button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "brackets svelte-zkywc1");
    			...
    			attr_dev(div3, "class", "curly-brackets svelte-zkywc1");
    			add_location(div3, file$1, 569, 20, 47816);
    			attr_dev(div4, "class", "blue_container fifth_btn bborder_remover padder_less svelte-zkywc1");
    			...
    			attr_dev(div6, "class", "rec-brackets svelte-zkywc1");
    			add_location(div6, file$1, 578, 20, 48669);
    			attr_dev(div7, "class", "blue_container fifth_btn bborder_remover padder_less svelte-zkywc1");
    			add_location(div7, file$1, 577, 16, 48531);
    			attr_dev(div8, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div8, file$1, 572, 12, 47905);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "first_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button12, file$1, 582, 20, 48818);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "scnd_btn blue_container svelte-zkywc1");
    			add_location(button13, file$1, 583, 20, 48966);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button14, file$1, 584, 20, 49104);
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "fourth_btn blue_container svelte-zkywc1");
    			add_location(button15, file$1, 585, 20, 49202);
    			attr_dev(div9, "class", "opp-recbrackets svelte-zkywc1");
    			add_location(div9, file$1, 587, 20, 49469);
    			attr_dev(div10, "class", "thrd_btn bborder_remover blue_container padder_less svelte-zkywc1");
    			add_location(div10, file$1, 586, 16, 49332);
    			attr_dev(div11, "class", "column_eight columns_design svelte-zkywc1");
    			add_location(div11, file$1, 581, 12, 48756);
    			attr_dev(div12, "class", "button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fourth_btn blank_color bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button3, file$1, 598, 20, 50172);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button4, file$1, 599, 20, 50287);
    			attr_dev(div0, "class", "column_five blue_container columns_design svelte-zkywc1");
    			add_location(div0, file$1, 594, 12, 49686);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(button5, file$1, 602, 20, 50487);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button6, file$1, 603, 20, 50631);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button7, file$1, 604, 20, 50758);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "fourth_btn blank_color bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button8, file$1, 605, 20, 50896);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button9, file$1, 606, 20, 51011);
    			attr_dev(div1, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div1, file$1, 601, 12, 50412);
    			add_location(sup0, file$1, 609, 140, 51333);
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(button10, file$1, 609, 20, 51213);
    			add_location(sup1, file$1, 610, 123, 51479);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button11, file$1, 610, 20, 51376);
    			add_location(sup2, file$1, 611, 139, 51641);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "blue_container thrd_btn bborder_remover svelte-zkywc1");
    			add_location(button12, file$1, 611, 20, 51522);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "fourth_btn blank_color bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button13, file$1, 612, 20, 51684);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button14, file$1, 613, 20, 51799);
    			attr_dev(div2, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div2, file$1, 608, 12, 51136);
    			add_location(sup3, file$1, 616, 140, 52106);
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "first_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button15, file$1, 616, 20, 51986);
    			add_location(sup4, file$1, 617, 123, 52252);
    			attr_dev(button16, "type", "button");
    			attr_dev(button16, "class", "scnd_btn blue_container svelte-zkywc1");
    			add_location(button16, file$1, 617, 20, 52149);
    			add_location(sup5, file$1, 618, 139, 52414);
    			attr_dev(button17, "type", "button");
    			attr_dev(button17, "class", "thrd_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button17, file$1, 618, 20, 52295);
    			attr_dev(button18, "type", "button");
    			attr_dev(button18, "class", "fourth_btn blue_container bborder_remover blank_color svelte-zkywc1");
    			add_location(button18, file$1, 619, 20, 52457);
    			attr_dev(button19, "type", "button");
    			attr_dev(button19, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button19, file$1, 620, 20, 52571);
    			attr_dev(div3, "class", "column_eight columns_design svelte-zkywc1");
    			add_location(div3, file$1, 615, 12, 51924);
    			attr_dev(div4, "class", "button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "blue_container fourth_btn svelte-zkywc1");
    			...
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "blue_container fourth_btn svelte-zkywc1");
    			...
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "blue_container first_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button15, file$1, 648, 20, 55152);
    			attr_dev(button16, "type", "button");
    			attr_dev(button16, "class", "blue_container scnd_btn blue_container svelte-zkywc1");
    			add_location(button16, file$1, 649, 20, 55307);
    			attr_dev(button17, "type", "button");
    			attr_dev(button17, "class", "blue_container thrd_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button17, file$1, 650, 20, 55450);
    			attr_dev(button18, "type", "button");
    			attr_dev(button18, "class", "blue_container fourth_btn blue_container bborder_remover blank_color svelte-zkywc1");
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "thrd_btn bborder_remover blank_color bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button2, file$1, 661, 20, 56310);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fourth_btn blank_color tborder_remover bborder_remover rborder_remover svelte-zkywc1");
    			...
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "thrd_btn bborder_remover blank_color bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button7, file$1, 668, 20, 57031);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "fourth_btn blank_color tborder_remover bborder_remover rborder_remover svelte-zkywc1");
    			...
    			attr_dev(div2, "class", "long-division svelte-zkywc1");
    			add_location(div2, file$1, 675, 20, 57746);
    			attr_dev(div3, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(div3, file$1, 674, 16, 57640);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "thrd_btn bborder_remover blank_color bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button11, file$1, 677, 20, 57823);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "fourth_btn blank_color tborder_remover bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button12, file$1, 678, 20, 57952);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button13, file$1, 679, 20, 58083);
    			attr_dev(div4, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div4, file$1, 672, 12, 57416);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "first_btn bborder_remover blue_container svelte-zkywc1");
    			add_location(button14, file$1, 682, 20, 58270);
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "scnd_btn blue_container svelte-zkywc1");
    			add_location(button15, file$1, 683, 20, 58421);
    			attr_dev(button16, "type", "button");
    			attr_dev(button16, "class", "thrd_btn bborder_remover blue_container bborder_remover blank_color svelte-zkywc1");
    			add_location(button16, file$1, 684, 20, 58559);
    			attr_dev(button17, "type", "button");
    			attr_dev(button17, "class", "fourth_btn blue_container tborder_remover bborder_remover blank_color svelte-zkywc1");
    			add_location(button17, file$1, 685, 20, 58687);
    			attr_dev(button18, "type", "button");
    			attr_dev(button18, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button18, file$1, 686, 20, 58817);
    			attr_dev(div5, "class", "column_eight columns_design svelte-zkywc1");
    			add_location(div5, file$1, 681, 12, 58208);
    			attr_dev(div6, "class", "button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fourth_btn rborder_remover bborder_remover blank_color svelte-zkywc1");
    			add_location(button3, file$1, 696, 20, 59555);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			...
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "fourth_btn rborder_remover bborder_remover blank_color svelte-zkywc1");
    			add_location(button8, file$1, 703, 20, 60298);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			...
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "fourth_btn rborder_remover bborder_remover blank_color svelte-zkywc1");
    			add_location(button13, file$1, 710, 20, 61045);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			...
    			attr_dev(button18, "type", "button");
    			attr_dev(button18, "class", "fourth_btn bborder_remover blank_color svelte-zkywc1");
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "thrd_btn bborder_remover blank_color bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button12, file$1, 741, 20, 63996);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "fourth_btn blank_color tborder_remover bborder_remover rborder_remover svelte-zkywc1");
    			add_location(button13, file$1, 742, 20, 64125);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "fifth_btn bborder_remover blank_color bborder_remover rborder_remover svelte-zkywc1");
    			...
    			attr_dev(button17, "type", "button");
    			attr_dev(button17, "class", "thrd_btn bborder_remover bborder_remover blank_color svelte-zkywc1");
    			add_location(button17, file$1, 748, 20, 64752);
    			attr_dev(button18, "type", "button");
    			attr_dev(button18, "class", "fourth_btn bborder_remover tborder_remover blank_color svelte-zkywc1");
    			...
    			attr_dev(div4, "class", "btn-group button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fourth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button3, file$1, 760, 20, 65730);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "fifth_btn bborder_remover bborder_remover rborder_remover blank_color svelte-zkywc1");
    			...
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "fourth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button8, file$1, 767, 20, 66490);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "fifth_btn bborder_remover bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button9, file$1, 768, 20, 66605);
    			attr_dev(div1, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div1, file$1, 763, 12, 65986);
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "first_btn bborder_remover blank_color svelte-zkywc1");
    			...
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "fourth_btn bborder_remover blank_color svelte-zkywc1");
    			...
    			attr_dev(div3, "class", "button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div1, "class", "blue_container first_btn bborder_remover bborder_adder padder_less svelte-zkywc1");
    			add_location(div1, file$1, 782, 16, 67612);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button0, file$1, 785, 20, 67836);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button1, file$1, 786, 20, 67950);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button2, file$1, 787, 20, 68064);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button3, file$1, 788, 20, 68178);
    			attr_dev(div2, "class", "column_five blue_container columns_design svelte-zkywc1");
    			add_location(div2, file$1, 781, 12, 67540);
    			attr_dev(div3, "class", "square-brackets svelte-zkywc1");
    			add_location(div3, file$1, 792, 20, 68526);
    			attr_dev(div4, "class", "blue_container first_btn bborder_remover bborder_adder padder_less svelte-zkywc1");
    			add_location(div4, file$1, 791, 16, 68374);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button4, file$1, 794, 20, 68605);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button5, file$1, 795, 20, 68719);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button6, file$1, 796, 20, 68833);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button7, file$1, 797, 20, 68947);
    			attr_dev(div5, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div5, file$1, 790, 12, 68303);
    			attr_dev(div6, "class", "curly-brackets svelte-zkywc1");
    			add_location(div6, file$1, 801, 20, 69301);
    			attr_dev(div7, "class", "blue_container first_btn bborder_remover bborder_adder padder_less svelte-zkywc1");
    			add_location(div7, file$1, 800, 16, 69145);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button8, file$1, 803, 20, 69379);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button9, file$1, 804, 20, 69477);
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button10, file$1, 805, 20, 69575);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button11, file$1, 806, 20, 69673);
    			attr_dev(div8, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div8, file$1, 799, 12, 69072);
    			attr_dev(div9, "class", "button_designs select_changer svelte-zkywc1");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button15 = element("button");
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "first_btn blue_container bborder_remover svelte-zkywc1");
    			add_location(button0, file$1, 813, 20, 69987);
    			attr_dev(div0, "class", "brackets svelte-zkywc1");
    			add_location(div0, file$1, 815, 20, 70246);
    			attr_dev(div1, "class", "scnd_btn blue_container padder_remover svelte-zkywc1");
    			add_location(div1, file$1, 814, 16, 70122);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button1, file$1, 817, 20, 70318);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button2, file$1, 818, 20, 70432);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button3, file$1, 819, 20, 70546);
    			attr_dev(div2, "class", "column_five blue_container columns_design svelte-zkywc1");
    			add_location(div2, file$1, 812, 12, 69911);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "first_btn blue_container bborder_remover svelte-zkywc1");
    			add_location(button4, file$1, 822, 20, 70746);
    			attr_dev(div3, "class", "integrtion svelte-zkywc1");
    			add_location(div3, file$1, 824, 20, 71003);
    			attr_dev(div4, "class", "scnd_btn blue_container padder_remover svelte-zkywc1");
    			add_location(div4, file$1, 823, 16, 70881);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button5, file$1, 826, 20, 71077);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button6, file$1, 827, 20, 71191);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button7, file$1, 828, 20, 71305);
    			attr_dev(div5, "class", "column_six blue_container columns_design svelte-zkywc1");
    			add_location(div5, file$1, 821, 12, 70671);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "first_btn blue_container bborder_remover svelte-zkywc1");
    			add_location(button8, file$1, 831, 20, 71507);
    			attr_dev(div6, "class", "sigma svelte-zkywc1");
    			add_location(div6, file$1, 833, 20, 71772);
    			attr_dev(div7, "class", "scnd_btn blue_container padder_btn svelte-zkywc1");
    			add_location(div7, file$1, 832, 16, 71654);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button9, file$1, 835, 20, 71841);
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			add_location(button10, file$1, 836, 20, 71955);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "fifth_btn bborder_remover blank_color rborder_remover svelte-zkywc1");
    			...
    			attr_dev(div10, "class", "first_btn bborder_remover padder_remover blue_container svelte-zkywc1");
    			add_location(div10, file$1, 840, 16, 72252);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "scnd_btn blue_container svelte-zkywc1");
    			add_location(button12, file$1, 843, 20, 72446);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button13, file$1, 844, 20, 72581);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button14, file$1, 845, 20, 72679);
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t24 = space();
    			button13 = element("button");
    			attr_dev(div0, "class", "h-sup svelte-zkywc1");
    			add_location(div0, file$1, 854, 20, 73214);
    			attr_dev(div1, "class", "blue_container first_btn bborder_remover padder_less svelte-zkywc1");
    			add_location(div1, file$1, 853, 16, 73087);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button0, file$1, 856, 20, 73283);
    			attr_dev(div2, "class", "x-power-y svelte-zkywc1");
    			add_location(div2, file$1, 858, 20, 73567);
    			attr_dev(div3, "class", "thrd_btn bborder_remover blue_container bborder_adder padder_less svelte-zkywc1");
    			...
    			attr_dev(div5, "class", "h-sub svelte-zkywc1");
    			add_location(div5, file$1, 865, 20, 74065);
    			attr_dev(div6, "class", "blue_container first_btn bborder_remover svelte-zkywc1");
    			add_location(div6, file$1, 864, 16, 73950);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button3, file$1, 867, 20, 74134);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "blue_container thrd_btn bborder_remover bborder_adder svelte-zkywc1");
    			...
    			attr_dev(div8, "class", "h-sup-sub svelte-zkywc1");
    			add_location(div8, file$1, 874, 20, 74875);
    			attr_dev(div9, "class", "blue_container first_btn bborder_remover padder_less svelte-zkywc1");
    			add_location(div9, file$1, 873, 16, 74742);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "blue_container scnd_btn svelte-zkywc1");
    			add_location(button7, file$1, 876, 20, 74948);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "thrd_btn bborder_remover blue_container bborder_adder svelte-zkywc1");
    			add_location(button8, file$1, 877, 20, 75094);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button9, file$1, 878, 20, 75247);
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "fifth_btn bborder_remover rborder_remover blank_color svelte-zkywc1");
    			add_location(button10, file$1, 879, 20, 75361);
    			attr_dev(div10, "class", "column_seven blue_container columns_design svelte-zkywc1");
    			add_location(div10, file$1, 872, 12, 74669);
    			attr_dev(div11, "class", "h-power svelte-zkywc1");
    			add_location(div11, file$1, 883, 20, 75681);
    			attr_dev(div12, "class", "first_btn bborder_remover padder_less blue_container svelte-zkywc1");
    			add_location(div12, file$1, 882, 16, 75544);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "scnd_btn blue_container svelte-zkywc1");
    			add_location(button11, file$1, 885, 20, 75752);
    			attr_dev(div13, "class", "h-bar svelte-zkywc1");
    			add_location(div13, file$1, 887, 20, 76047);
    			attr_dev(div14, "class", "thrd_btn bborder_remover padder_less bborder_adder blue_container svelte-zkywc1");
    			add_location(div14, file$1, 886, 16, 75894);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button12, file$1, 889, 20, 76116);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "fifth_btn bborder_remover blank_color svelte-zkywc1");
    			add_location(button13, file$1, 890, 20, 76214);
    			attr_dev(div15, "class", "column_eight columns_design svelte-zkywc1");
    			add_location(div15, file$1, 881, 12, 75486);
    			attr_dev(div16, "class", "button_designs select_changer svelte-zkywc1");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "dots svelte-zkywc1");
    			add_location(span0, file$1, 72, 16, 2053);
    			attr_dev(span1, "class", "dots svelte-zkywc1");
    			add_location(span1, file$1, 73, 16, 2096);
    			attr_dev(span2, "class", "dots svelte-zkywc1");
    			add_location(span2, file$1, 74, 16, 2139);
    			attr_dev(span3, "class", "dots svelte-zkywc1");
    			add_location(span3, file$1, 75, 16, 2182);
    			attr_dev(div0, "class", "dots_container svelte-zkywc1");
    			add_location(div0, file$1, 71, 12, 2008);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "icomoon-24px-incorrect-2 close_toolbar svelte-zkywc1");
    			add_location(button0, file$1, 77, 16, 2244);
    			attr_dev(div1, "class", "draggable_area svelte-zkywc1");
    			...
    			attr_dev(select, "class", "option_selectbox svelte-zkywc1");
    			if (/*type*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[10].call(select));
    			add_location(select, file$1, 82, 12, 2432);
    			attr_dev(div3, "class", "select_area svelte-zkywc1");
    			add_location(div3, file$1, 81, 8, 2394);
    			attr_dev(div4, "class", "show_text_area svelte-zkywc1");
    			add_location(div4, file$1, 100, 8, 3376);
    			attr_dev(div5, "class", "toolbar_types_area svelte-zkywc1");
    			add_location(div5, file$1, 80, 4, 2353);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "first_btn bborder_remover orange_container svelte-zkywc1");
    			add_location(button1, file$1, 105, 20, 3591);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "scnd_btn orange_container svelte-zkywc1");
    			add_location(button2, file$1, 106, 20, 3731);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "thrd_btn bborder_remover orange_container svelte-zkywc1");
    			add_location(button3, file$1, 107, 20, 3854);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "fourth_btn orange_container svelte-zkywc1");
    			...
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "fifth_btn bborder_remover light_purpl_container svelte-zkywc1");
    			add_location(button5, file$1, 109, 20, 4118);
    			attr_dev(div6, "class", "column_one columns_design svelte-zkywc1");
    			add_location(div6, file$1, 104, 12, 3531);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "first_btn bborder_remover orange_container svelte-zkywc1");
    			add_location(button6, file$1, 114, 20, 4430);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "scnd_btn orange_container svelte-zkywc1");
    			add_location(button7, file$1, 115, 20, 4570);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "thrd_btn bborder_remover orange_container svelte-zkywc1");
    			add_location(button8, file$1, 116, 20, 4693);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "fourth_btn orange_container svelte-zkywc1");
    			...
    			attr_dev(button10, "type", "button");
    			attr_dev(button10, "class", "fifth_btn bborder_remover light_purpl_container svelte-zkywc1");
    			add_location(button10, file$1, 118, 20, 4954);
    			attr_dev(div7, "class", "column_two columns_design svelte-zkywc1");
    			add_location(div7, file$1, 113, 12, 4370);
    			attr_dev(button11, "type", "button");
    			attr_dev(button11, "class", "first_btn bborder_remover orange_container svelte-zkywc1");
    			add_location(button11, file$1, 123, 20, 5270);
    			attr_dev(button12, "type", "button");
    			attr_dev(button12, "class", "scnd_btn orange_container svelte-zkywc1");
    			add_location(button12, file$1, 124, 20, 5409);
    			attr_dev(button13, "type", "button");
    			attr_dev(button13, "class", "thrd_btn bborder_remover orange_container svelte-zkywc1");
    			add_location(button13, file$1, 125, 20, 5532);
    			attr_dev(button14, "type", "button");
    			attr_dev(button14, "class", "fourth_btn orange_container svelte-zkywc1");
    			...
    			attr_dev(button15, "type", "button");
    			attr_dev(button15, "class", "fifth_btn bborder_remover light_purpl_container svelte-zkywc1");
    			add_location(button15, file$1, 127, 20, 5793);
    			attr_dev(div8, "class", "column_three columns_design svelte-zkywc1");
    			add_location(div8, file$1, 122, 12, 5208);
    			attr_dev(button16, "type", "button");
    			attr_dev(button16, "class", "first_btn bborder_remover hovr_btn svelte-zkywc1");
    			add_location(button16, file$1, 132, 20, 6107);
    			attr_dev(button17, "type", "button");
    			attr_dev(button17, "class", "scnd_btn hovr_btn svelte-zkywc1");
    			add_location(button17, file$1, 133, 20, 6245);
    			attr_dev(button18, "type", "button");
    			attr_dev(button18, "class", "thrd_btn bborder_remover hovr_btn svelte-zkywc1");
    			add_location(button18, file$1, 134, 20, 6363);
    			attr_dev(button19, "type", "button");
    			attr_dev(button19, "class", "fourth_btn hovr_btn svelte-zkywc1");
    			add_location(button19, file$1, 135, 20, 6490);
    			attr_dev(button20, "type", "button");
    			attr_dev(button20, "class", "fifth_btn bborder_remover hovr_btn svelte-zkywc1");
    			add_location(button20, file$1, 136, 20, 6603);
    			attr_dev(div9, "class", "column_four columns_design svelte-zkywc1");
    			add_location(div9, file$1, 131, 12, 6046);
    			attr_dev(div10, "class", "btn-group button_designs font_changer svelte-zkywc1");
    			add_location(div10, file$1, 103, 8, 3467);
    			attr_dev(div11, "class", "lower_part_toolbar svelte-zkywc1");
    			add_location(div11, file$1, 102, 4, 3426);
    			attr_dev(div12, "class", "toolbar_container_one svelte-zkywc1");
    ...
    class FillInTheBlanksToolbar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-zkywc1-style")) add_css$1();
    ...
    function add_css$2() {
    	var style = element("style");
    	style.id = "svelte-1n3vsyo-style";
    	style.textContent = "xmp{display:inline}#fillmain{overflow:hidden;max-width:1024px;text-align:left}#fillmain pre{background:none;border:none;font-size:14px!important}#fillmain .string{min-height:50px;margin-top:10px;margin-right:10px}#fillmain .footerStr{position:relative;margin-top:10px;background-color:#ccc;padding:15px;min-height:60px}#fillmain .footerStr .arrow-up{position:absolute;top:-10px;right:50%;width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-bottom:10px solid #ccc}#fillmain .fill-row{padding:6px}#fillmain .fillelement{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px 0 1px 0;top:-3px}#fillmain .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px 0 1px 0;top:-3px}td .drag-resize{top:0 !important}td .fillelement{top:0px !important}#fillmain input[type=\"text\"]{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}#fillmain .drag-resize{vertical-align:middle;border:1px solid #31B731;text-align:center;padding:3px;font-size:14px}#fillmain .drag-resize.dragable{cursor:move}#fillmain .drop-hover{border:1px dashed red!important;box-shadow:0 0 0 2px yellow inset;outline:1px solid blue}#fillmain .fillcheck ul{width:220px}#fillmain .fillcheck li.selected{background-color:#E5E5E5}.fillcheck .selected .icomoon-checkmark-3:before{float:left;color:blue;padding:3px;position:relative;right:14px}.fillcheck .icomoon-close-2:before{float:left;color:blue;position:relative;right:14px;font-size:20px}.MathJax_Display{display:inline!important}#fillmain .select{font-size:15px}#fillmain .textarea{vertical-align:middle;border-radius:3px;background:#ffe;border:1px solid #ccc;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075);box-shadow:inset 0 1px 1px rgba(0,0,0,0.075)}.ui-draggable-disabled{cursor:no-drop!important;opacity:0.5!important}.sel{border:2px solid #FF0000!important}#fillmain .dragable:focus{box-shadow:inset 0 0 0 1px transparent, inset 0 0 0 1px #ffffff, inset 0 0 0 2px #fff;outline:none}#fillmain .dropable:focus{box-shadow:inset 0 0 0 1px transparent, inset 0 0 0 1px #ffffff, inset 0 0 0 2px #fff;outline:none}.highlight_main{border:1px dashed #000}.copiedclr{background-color:#CCC!important}#fillmain select::-ms-expand{margin-left:2px}.fillintheblank{height:30px;padding:5px 10px;font-size:14px;margin-bottom:3px;line-height:20px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;color:#171718;background-color:#FFE;vertical-align:middle;background-image:none;border:1px solid #ccc;font-family:Roboto, sans-serif;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075);box-shadow:inset 0 1px 1px rgba(0,0,0,0.075);-webkit-transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s}.fillintheblank:focus{border-color:rgba(82,168,236,0.8);outline:0;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075),0 0 8px rgba(82,168,236,0.6);-moz-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075),0 0 8px rgba(82,168,236,0.6);box-shadow:inset 0 1px 1px rgba(0,0,0,0.075),0 0 8px rgba(82,168,236,0.6)}.correct_incorrect_icon_fill{position:absolute;width:17px;height:18px;right:-4px;top:-7px;font-size:17px;white-space:normal !important;z-index:9 !important}.corr_div{display:none;width:100%;height:100%;background-color:#21a81d;color:#ffffff;top:0%;padding-top:4px;border-radius:3px;cursor:none !important}.auto_height{height:auto!important}.auto_width{width:auto!important}.prettyprint{display:-ms-grid!important}.tooltip-inner{text-align:left}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(978:4) {#if state.matchtype == \\\"0\\\"}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(988:3) {#if state.showToolbar}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div4, file$2, 963, 2, 32890);
    			add_location(center1, file$2, 952, 1, 32655);
    			attr_dev(div5, "class", div5_class_value = /*xml*/ ctx[2] ? "mx-4 pl-2 pl-md-0" : "");
    			add_location(div5, file$2, 951, 0, 32610);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    **/
    ...
    class FillInTheBlanksPreview extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document_1$1.getElementById("svelte-1n3vsyo-style")) add_css$2();
