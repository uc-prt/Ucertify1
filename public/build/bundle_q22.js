...
var app = (function () {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 7, 2, 162);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    class Loader extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { size: 0, msg: 1 }, add_css$5);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 1593, 8, 85614);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$6, 1682, 24, 91346);
    			attr_dev(div2, "class", "float-right mt-2");
    			add_location(div2, file$6, 1680, 20, 91079);
    			attr_dev(div3, "class", "d-flex");
    			add_location(div3, file$6, 1676, 20, 90811);
    			...
    			add_location(div4, file$6, 1672, 16, 90456);
    			add_location(span4, file$6, 1698, 36, 92399);
    			attr_dev(div5, "class", "card-header rounded-0");
    			add_location(div5, file$6, 1697, 32, 92326);
    			attr_dev(textarea0, "name", "html");
    			attr_dev(textarea0, "id", "html_editor");
    			add_location(textarea0, file$6, 1701, 36, 92619);
    			...
    			add_location(div6, file$6, 1700, 32, 92494);
    			attr_dev(div7, "id", "html_panel");
    			attr_dev(div7, "class", "card m-0 p-0 rounded-0");
    			add_location(div7, file$6, 1696, 28, 92240);
    			add_location(span5, file$6, 1706, 36, 92933);
    			attr_dev(div8, "class", "card-header rounded-0");
    			add_location(div8, file$6, 1705, 32, 92860);
    			attr_dev(textarea1, "name", "css");
    			attr_dev(textarea1, "id", "css_editor");
    			add_location(textarea1, file$6, 1709, 36, 93151);
    			...
    			add_location(div9, file$6, 1708, 32, 93027);
    			attr_dev(div10, "id", "css_panel");
    			attr_dev(div10, "class", "card m-0 p-0 rounded-0");
    			add_location(div10, file$6, 1704, 28, 92775);
    			add_location(span6, file$6, 1714, 36, 93462);
    			attr_dev(div11, "class", "card-header rounded-0");
    			add_location(div11, file$6, 1713, 32, 93389);
    			attr_dev(textarea2, "name", "js");
    			attr_dev(textarea2, "id", "js_editor");
    			add_location(textarea2, file$6, 1717, 36, 93678);
    			...
    			add_location(div12, file$6, 1716, 32, 93555);
    			attr_dev(div13, "id", "js_panel");
    			attr_dev(div13, "class", "card m-0 p-0 rounded-0");
    			add_location(div13, file$6, 1712, 28, 93305);
    			attr_dev(div14, "id", "firstEditorDiv");
    			set_style(div14, "display", "flex");
    			add_location(div14, file$6, 1695, 24, 92163);
    			attr_dev(div15, "id", "top_content");
    			add_location(div15, file$6, 1694, 20, 92115);
    			add_location(span7, file$6, 1725, 32, 94090);
    			attr_dev(div16, "class", "card-header rounded-0");
    			add_location(div16, file$6, 1724, 28, 94021);
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div14 = element("div");
    			attr_dev(span0, "class", "icomoon-coding-44px s3 align-middle mr-1");
    			add_location(span0, file$6, 1605, 24, 86225);
    			attr_dev(span1, "class", "align-middle");
    			add_location(span1, file$6, 1605, 86, 86287);
    			attr_dev(div0, "class", "mt-2 pt pl-3 float-left");
    			add_location(div0, file$6, 1604, 20, 86162);
    			attr_dev(span2, "class", "icomoon-menu-2 s3 text-secondary pt-s d-block");
    			add_location(span2, file$6, 1608, 130, 86553);
    			...
    			add_location(button0, file$6, 1608, 24, 86447);
    			attr_dev(input, "type", "checkbox");
    			input.checked = input_checked_value = /*state*/ ctx[0].goDark;
    			attr_dev(input, "id", "goDark");
    			attr_dev(input, "class", "position-absolute bg-transparent");
    			add_location(input, file$6, 1612, 36, 86925);
    			add_location(span3, file$6, 1613, 36, 87087);
    			attr_dev(label, "for", "goDark");
    			attr_dev(label, "class", "dropdown-item mb-0 pointer");
    			add_location(label, file$6, 1611, 32, 86832);
    			add_location(li0, file$6, 1610, 28, 86794);
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			t5 = text(t5_value);
    			add_location(div0, file$6, 1745, 16, 94787);
    			attr_dev(div1, "class", "d-flex justify-content-between");
    			add_location(div1, file$6, 1744, 12, 94725);
    			attr_dev(h40, "class", "mt-1 font21 mb-4");
    			add_location(h40, file$6, 1743, 8, 94682);
    			add_location(br, file$6, 1752, 44, 95044);
    			add_location(h41, file$6, 1752, 20, 95020);
    			add_location(center, file$6, 1750, 16, 94948);
    			attr_dev(div2, "id", "remediationModel");
    			add_location(div2, file$6, 1749, 12, 94903);
    			set_style(div3, "overflow-y", "auto");
    			add_location(div3, file$6, 1748, 8, 94858);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 1756, 8, 95143);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$6, 1597, 4, 85709);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "h h-imp");
    			attr_dev(button1, "id", "unset-review");
    			add_location(button1, file$6, 1598, 4, 85817);
    			add_location(div0, file$6, 1599, 4, 85931);
    			attr_dev(input, "type", "hidden");
    			attr_dev(input, "id", "ansModeAnswer");
    			input.value = "";
    			add_location(input, file$6, 1762, 4, 95501);
    			attr_dev(div1, "id", "authoringArea");
    			attr_dev(div1, "class", "font14");
    			add_location(div1, file$6, 1591, 0, 85519);
    			add_location(div2, file$6, 1590, 0, 85512);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<WebPreview> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$7, 752, 24, 33511);
    			attr_dev(div0, "class", "inline-block pull-left");
    			add_location(div0, file$7, 751, 20, 33448);
    			attr_dev(button1, "type", "button");
    			...
    			add_location(button3, file$7, 871, 20, 39637);
    			attr_dev(div25, "class", "modal-header");
    			add_location(div25, file$7, 860, 16, 39066);
    			...
    			add_location(a0, file$7, 885, 36, 40360);
    			...
    			add_location(textarea3, file$7, 904, 36, 41466);
    			attr_dev(div27, "class", "card-body p-md");
    			add_location(div27, file$7, 903, 32, 41400);
    			attr_dev(div28, "id", "test_case_collapse");
    			attr_dev(div28, "class", "collapse in");
    			add_location(div28, file$7, 902, 28, 41317);
    			attr_dev(div29, "class", "card mb-2");
    			add_location(div29, file$7, 882, 24, 40123);
    			...
    			add_location(a1, file$7, 918, 36, 42343);
    			...
    			add_location(span6, file$7, 926, 40, 42807);
    			attr_dev(h42, "class", "panel-title");
    			add_location(h42, file$7, 917, 32, 42281);
    			...
    			add_location(div30, file$7, 916, 28, 42153);
    			...
    			add_location(textarea4, file$7, 940, 36, 45199);
    			attr_dev(div31, "class", "card-body p-md");
    			add_location(div31, file$7, 939, 32, 45133);
    			attr_dev(div32, "id", "internal_script_collapse");
    			attr_dev(div32, "class", "panel-collapse collapse");
    			add_location(div32, file$7, 938, 28, 45032);
    			attr_dev(div33, "class", "card mb-2");
    			add_location(div33, file$7, 915, 24, 42100);
    			...
    			add_location(a2, file$7, 954, 36, 46086);
    			...
    			add_location(span7, file$7, 962, 36, 46546);
    			attr_dev(h43, "class", "panel-title");
    			add_location(h43, file$7, 953, 32, 46024);
    			...
    			add_location(div34, file$7, 952, 28, 45896);
    			...
    			add_location(button4, file$7, 993, 20, 48164);
    			attr_dev(div40, "class", "modal-footer");
    			add_location(div40, file$7, 992, 16, 48116);
    			attr_dev(div41, "class", "modal-content");
    			add_location(div41, file$7, 859, 12, 39021);
    			attr_dev(div42, "class", "modal-dialog modal-lg modal-dialog-centered");
    			add_location(div42, file$7, 858, 8, 38950);
    			attr_dev(div43, "id", "autograde_modal");
    			attr_dev(div43, "class", "modal fade");
    			attr_dev(div43, "role", "dialog");
    			add_location(div43, file$7, 857, 4, 38881);
    			attr_dev(h44, "class", "modal-title");
    			add_location(h44, file$7, 1010, 20, 48802);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "close");
    			attr_dev(button5, "data-bs-dismiss", "modal");
    			attr_dev(button5, "aria-hidden", "true");
    			add_location(button5, file$7, 1011, 20, 48864);
    			attr_dev(div44, "class", "modal-header");
    			add_location(div44, file$7, 1009, 16, 48754);
    			attr_dev(label1, "for", "html_disable");
    			add_location(label1, file$7, 1015, 24, 49091);
    			option0.__value = "";
    			option0.value = option0.__value;
    			add_location(option0, file$7, 1017, 28, 49305);
    			option1.__value = "0";
    			option1.value = option1.__value;
    			add_location(option1, file$7, 1018, 28, 49373);
    			option2.__value = "1";
    			option2.value = option2.__value;
    			add_location(option2, file$7, 1019, 28, 49440);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 219, 1, 9777);
    			add_location(main, file$8, 218, 0, 9768);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<Web> was created with unknown prop '${key}'`);
    	});
