...
var app = (function () {
    ...
    function add_css$6(target) {
    	append_styles(target, "svelte-gqd0n6", ".height44{height:44px}.cancel_btn_pop{background-color:lightgray!important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
    }

    // (1649:4) {#if window.isIE || window.isIEEleven}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 1649, 8, 87732);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1649:4) {#if window.isIE || window.isIEEleven}",
    		ctx
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$6, 1738, 24, 93505);
    			attr_dev(div2, "class", "float-right mt-2");
    			add_location(div2, file$6, 1736, 20, 93197);
    			attr_dev(div3, "class", "d-flex");
    			add_location(div3, file$6, 1732, 20, 92929);
    			...
    			add_location(div4, file$6, 1728, 16, 92574);
    			add_location(span4, file$6, 1754, 36, 94558);
    			attr_dev(div5, "class", "card-header rounded-0");
    			add_location(div5, file$6, 1753, 32, 94485);
    			attr_dev(textarea0, "name", "html");
    			attr_dev(textarea0, "id", "html_editor");
    			add_location(textarea0, file$6, 1757, 36, 94778);
    			...
    			add_location(div6, file$6, 1756, 32, 94653);
    			attr_dev(div7, "id", "html_panel");
    			attr_dev(div7, "class", "card m-0 p-0 rounded-0");
    			add_location(div7, file$6, 1752, 28, 94399);
    			add_location(span5, file$6, 1762, 36, 95092);
    			attr_dev(div8, "class", "card-header rounded-0");
    			add_location(div8, file$6, 1761, 32, 95019);
    			attr_dev(textarea1, "name", "css");
    			attr_dev(textarea1, "id", "css_editor");
    			add_location(textarea1, file$6, 1765, 36, 95310);
    			...
    			add_location(div9, file$6, 1764, 32, 95186);
    			attr_dev(div10, "id", "css_panel");
    			attr_dev(div10, "class", "card m-0 p-0 rounded-0");
    			add_location(div10, file$6, 1760, 28, 94934);
    			add_location(span6, file$6, 1770, 36, 95621);
    			attr_dev(div11, "class", "card-header rounded-0");
    			add_location(div11, file$6, 1769, 32, 95548);
    			attr_dev(textarea2, "name", "js");
    			attr_dev(textarea2, "id", "js_editor");
    			add_location(textarea2, file$6, 1773, 36, 95837);
    			...
    			add_location(div12, file$6, 1772, 32, 95714);
    			attr_dev(div13, "id", "js_panel");
    			attr_dev(div13, "class", "card m-0 p-0 rounded-0");
    			add_location(div13, file$6, 1768, 28, 95464);
    			attr_dev(div14, "id", "firstEditorDiv");
    			set_style(div14, "display", "flex");
    			add_location(div14, file$6, 1751, 24, 94322);
    			attr_dev(div15, "id", "top_content");
    			add_location(div15, file$6, 1750, 20, 94274);
    			add_location(span7, file$6, 1781, 32, 96249);
    			attr_dev(div16, "class", "card-header rounded-0");
    			add_location(div16, file$6, 1780, 28, 96180);
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div14 = element("div");
    			attr_dev(span0, "class", "icomoon-coding-44px s3 align-middle mr-1");
    			add_location(span0, file$6, 1661, 24, 88343);
    			attr_dev(span1, "class", "align-middle");
    			add_location(span1, file$6, 1661, 86, 88405);
    			attr_dev(div0, "class", "mt-2 pt pl-3 float-left");
    			add_location(div0, file$6, 1660, 20, 88280);
    			attr_dev(span2, "class", "icomoon-menu-2 s3 text-secondary pt-s d-block");
    			add_location(span2, file$6, 1664, 130, 88671);
    			...
    			add_location(button0, file$6, 1664, 24, 88565);
    			attr_dev(input, "type", "checkbox");
    			input.checked = input_checked_value = /*state*/ ctx[0].goDark;
    			attr_dev(input, "id", "goDark");
    			attr_dev(input, "class", "position-absolute bg-transparent");
    			add_location(input, file$6, 1668, 36, 89043);
    			add_location(span3, file$6, 1669, 36, 89205);
    			attr_dev(label, "for", "goDark");
    			attr_dev(label, "class", "dropdown-item mb-0 pointer");
    			add_location(label, file$6, 1667, 32, 88950);
    			add_location(li0, file$6, 1666, 28, 88912);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1657:4) {#if window.inNative }",
    		ctx
    	});
    ...
    // (1794:4) <Dialog                      bind:visible={state.remediationToggle}          width="650"          on:close={() => state.remediationToggle = false}          style="background: #fff; border-radius: 5px;"      >
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			t5 = text(t5_value);
    			add_location(div0, file$6, 1801, 16, 96946);
    			attr_dev(div1, "class", "d-flex justify-content-between");
    			add_location(div1, file$6, 1800, 12, 96884);
    			attr_dev(h40, "class", "mt-1 font21 mb-4");
    			add_location(h40, file$6, 1799, 8, 96841);
    			add_location(br, file$6, 1808, 44, 97203);
    			add_location(h41, file$6, 1808, 20, 97179);
    			add_location(center, file$6, 1806, 16, 97107);
    			attr_dev(div2, "id", "remediationModel");
    			add_location(div2, file$6, 1805, 12, 97062);
    			set_style(div3, "overflow-y", "auto");
    			add_location(div3, file$6, 1804, 8, 97017);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(1794:4) <Dialog                      bind:visible={state.remediationToggle}          width=\\\"650\\\"          on:close={() => state.remediationToggle = false}          style=\\\"background: #fff; border-radius: 5px;\\\"      >",
    		ctx
    	});
    ...
    // (1814:12) <Button key="cancel_btn"  style={'float:right;margin:10px;b;'} class="cancel_btn_pop" variant="contained" on:click={() => state.remediationToggle = false }>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(1814:12) <Button key=\\\"cancel_btn\\\"  style={'float:right;margin:10px;b;'} class=\\\"cancel_btn_pop\\\" variant=\\\"contained\\\" on:click={() => state.remediationToggle = false }>",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 1812, 8, 97302);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$6, 1653, 4, 87827);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "h h-imp");
    			attr_dev(button1, "id", "unset-review");
    			add_location(button1, file$6, 1654, 4, 87935);
    			add_location(div0, file$6, 1655, 4, 88049);
    			attr_dev(input, "type", "hidden");
    			attr_dev(input, "id", "ansModeAnswer");
    			input.value = "";
    			add_location(input, file$6, 1818, 4, 97660);
    			attr_dev(div1, "id", "authoringArea");
    			attr_dev(div1, "class", "font14");
    			add_location(div1, file$6, 1647, 0, 87637);
    			add_location(div2, file$6, 1646, 0, 87630);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$7, 1017, 28, 49304);
    			option1.__value = "0";
    			option1.value = option1.__value;
    			add_location(option1, file$7, 1018, 28, 49372);
    			option2.__value = "1";
    			option2.value = option2.__value;
    			add_location(option2, file$7, 1019, 28, 49439);
    			...
    			add_location(label2, file$7, 1023, 24, 49613);
    			option3.__value = "";
    			option3.value = option3.__value;
    			add_location(option3, file$7, 1025, 28, 49799);
    			option4.__value = "0";
    			option4.value = option4.__value;
    			add_location(option4, file$7, 1026, 28, 49867);
    			option5.__value = "1";
    			option5.value = option5.__value;
    			add_location(option5, file$7, 1027, 28, 49934);
    			attr_dev(select1, "class", "form-select");
    			attr_dev(select1, "id", "css_disable");
    			attr_dev(select1, "data-cy", "css_disable");
    			add_location(select1, file$7, 1024, 24, 49680);
    			attr_dev(div46, "class", "form-group");
    			add_location(div46, file$7, 1022, 20, 49563);
    			attr_dev(label3, "for", "js_disable");
    			add_location(label3, file$7, 1031, 24, 50108);
    			option6.__value = "";
    			option6.value = option6.__value;
    			add_location(option6, file$7, 1033, 28, 50290);
    			option7.__value = "0";
    			option7.value = option7.__value;
    			add_location(option7, file$7, 1034, 28, 50358);
    			option8.__value = "1";
    			option8.value = option8.__value;
    			add_location(option8, file$7, 1035, 28, 50425);
    			attr_dev(select2, "class", "form-select");
    			attr_dev(select2, "id", "js_disable");
    			attr_dev(select2, "data-cy", "js_disable");
    			add_location(select2, file$7, 1032, 24, 50173);
    			attr_dev(div47, "class", "form-group");
    			add_location(div47, file$7, 1030, 20, 50058);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "btn btn-primary");
    			attr_dev(button6, "data-cy", "close_modal");
    			attr_dev(button6, "data-bs-dismiss", "modal");
    			add_location(button6, file$7, 1039, 24, 50600);
    			attr_dev(div48, "class", "float-right");
    			add_location(div48, file$7, 1038, 20, 50549);
    			...
    			input2.value = "";
    			add_location(input2, file$7, 1045, 4, 50815);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 224, 1, 9847);
    			add_location(main, file$8, 223, 0, 9838);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
