...
var app = (function () {
    ...
    function add_css$6() {
    	...
    	style.textContent = ".height44{height:44px}.cancel_btn_pop{background-color:lightgray!important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 1649, 8, 86088);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button1, file$6, 1737, 24, 91521);
    			attr_dev(input, "type", "checkbox");
    			input.checked = input_checked_value = /*state*/ ctx[0].goDark;
    			attr_dev(input, "id", "goDark");
    			attr_dev(input, "class", "transparent h");
    			add_location(input, file$6, 1741, 36, 92039);
    			add_location(span3, file$6, 1742, 36, 92181);
    			attr_dev(label, "for", "goDark");
    			attr_dev(label, "class", "dropdown-item mb-0 pointer");
    			add_location(label, file$6, 1740, 32, 91947);
    			add_location(li, file$6, 1739, 28, 91910);
    			...
    			add_location(ul, file$6, 1738, 24, 91772);
    			attr_dev(div2, "class", "float-right mt-2");
    			add_location(div2, file$6, 1736, 20, 91466);
    			attr_dev(div3, "class", "d-flex");
    			add_location(div3, file$6, 1732, 20, 91202);
    			...
    			add_location(div4, file$6, 1728, 16, 90851);
    			add_location(span4, file$6, 1754, 36, 92809);
    			attr_dev(div5, "class", "card-header rounded-0");
    			add_location(div5, file$6, 1753, 32, 92737);
    			attr_dev(textarea0, "name", "html");
    			attr_dev(textarea0, "id", "html_editor");
    			add_location(textarea0, file$6, 1757, 36, 93026);
    			...
    			add_location(div6, file$6, 1756, 32, 92902);
    			attr_dev(div7, "id", "html_panel");
    			attr_dev(div7, "class", "card m-0 p-0 rounded-0");
    			add_location(div7, file$6, 1752, 28, 92652);
    			add_location(span5, file$6, 1762, 36, 93335);
    			attr_dev(div8, "class", "card-header rounded-0");
    			add_location(div8, file$6, 1761, 32, 93263);
    			attr_dev(textarea1, "name", "css");
    			attr_dev(textarea1, "id", "css_editor");
    			add_location(textarea1, file$6, 1765, 36, 93550);
    			...
    			add_location(div9, file$6, 1764, 32, 93427);
    			attr_dev(div10, "id", "css_panel");
    			attr_dev(div10, "class", "card m-0 p-0 rounded-0");
    			add_location(div10, file$6, 1760, 28, 93179);
    			add_location(span6, file$6, 1770, 36, 93856);
    			attr_dev(div11, "class", "card-header rounded-0");
    			add_location(div11, file$6, 1769, 32, 93784);
    			attr_dev(textarea2, "name", "js");
    			attr_dev(textarea2, "id", "js_editor");
    			add_location(textarea2, file$6, 1773, 36, 94069);
    			...
    			add_location(div12, file$6, 1772, 32, 93947);
    			attr_dev(div13, "id", "js_panel");
    			attr_dev(div13, "class", "card m-0 p-0 rounded-0");
    			add_location(div13, file$6, 1768, 28, 93701);
    			attr_dev(div14, "id", "firstEditorDiv");
    			set_style(div14, "display", "flex");
    			add_location(div14, file$6, 1751, 24, 92576);
    			attr_dev(div15, "id", "top_content");
    			add_location(div15, file$6, 1750, 20, 92529);
    			add_location(span7, file$6, 1781, 32, 94473);
    			attr_dev(div16, "class", "card-header rounded-0");
    			add_location(div16, file$6, 1780, 28, 94405);
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div14 = element("div");
    			attr_dev(span0, "class", "icomoon-coding-44px s3 align-middle mr-1");
    			add_location(span0, file$6, 1661, 24, 86687);
    			attr_dev(span1, "class", "align-middle");
    			add_location(span1, file$6, 1661, 86, 86749);
    			attr_dev(div0, "class", "mt-2 pt pl-3 float-left");
    			add_location(div0, file$6, 1660, 20, 86625);
    			attr_dev(span2, "class", "icomoon-menu-2 s3 text-secondary pt-s d-block");
    			add_location(span2, file$6, 1664, 130, 87012);
    			...
    			add_location(button0, file$6, 1664, 24, 86906);
    			attr_dev(input, "type", "checkbox");
    			input.checked = input_checked_value = /*state*/ ctx[0].goDark;
    			attr_dev(input, "id", "goDark");
    			attr_dev(input, "class", "position-absolute bg-transparent");
    			add_location(input, file$6, 1668, 36, 87380);
    			add_location(span3, file$6, 1669, 36, 87541);
    			attr_dev(label, "for", "goDark");
    			attr_dev(label, "class", "dropdown-item mb-0 pointer");
    			add_location(label, file$6, 1667, 32, 87288);
    			add_location(li0, file$6, 1666, 28, 87251);
    ...
    // (1813:8) <div slot="footer" class="footer" style="border-top: 1px solid var(--divider, rgba(0, 0, 0, 0.1));">
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 1812, 8, 95495);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(1813:8) <div slot=\\\"footer\\\" class=\\\"footer\\\" style=\\\"border-top: 1px solid var(--divider, rgba(0, 0, 0, 0.1));\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text(t5_value);
    			t6 = space();
    			add_location(div0, file$6, 1801, 16, 95150);
    			attr_dev(div1, "class", "d-flex justify-content-between");
    			add_location(div1, file$6, 1800, 12, 95089);
    			attr_dev(h40, "class", "mt-1 font21 mb-4");
    			add_location(h40, file$6, 1799, 8, 95047);
    			add_location(br, file$6, 1808, 44, 95400);
    			add_location(h41, file$6, 1808, 20, 95376);
    			add_location(center, file$6, 1806, 16, 95306);
    			attr_dev(div2, "id", "remediationModel");
    			add_location(div2, file$6, 1805, 12, 95262);
    			set_style(div3, "overflow-y", "auto");
    			add_location(div3, file$6, 1804, 8, 95218);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$6, 1653, 4, 86179);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "h h-imp");
    			attr_dev(button1, "id", "unset-review");
    			add_location(button1, file$6, 1654, 4, 86286);
    			add_location(div0, file$6, 1655, 4, 86399);
    			attr_dev(input, "type", "hidden");
    			attr_dev(input, "id", "ansModeAnswer");
    			input.value = "";
    			add_location(input, file$6, 1818, 4, 95847);
    			attr_dev(div1, "id", "authoringArea");
    			attr_dev(div1, "class", "font14");
    			add_location(div1, file$6, 1647, 0, 85995);
    			add_location(div2, file$6, 1646, 0, 85989);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function runCode() {
    		// if(showHTML + showCSS + showJS > 1) {
    		window.scroll({ bottom: 200, behavior: "smooth" });
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$7, 1017, 28, 48287);
    			option1.__value = "0";
    			option1.value = option1.__value;
    			add_location(option1, file$7, 1018, 28, 48354);
    			option2.__value = "1";
    			option2.value = option2.__value;
    			add_location(option2, file$7, 1019, 28, 48420);
    			...
    			add_location(label2, file$7, 1023, 24, 48590);
    			option3.__value = "";
    			option3.value = option3.__value;
    			add_location(option3, file$7, 1025, 28, 48774);
    			option4.__value = "0";
    			option4.value = option4.__value;
    			add_location(option4, file$7, 1026, 28, 48841);
    			option5.__value = "1";
    			option5.value = option5.__value;
    			add_location(option5, file$7, 1027, 28, 48907);
    			attr_dev(select1, "class", "form-select");
    			attr_dev(select1, "id", "css_disable");
    			attr_dev(select1, "data-cy", "css_disable");
    			add_location(select1, file$7, 1024, 24, 48656);
    			attr_dev(div46, "class", "form-group");
    			add_location(div46, file$7, 1022, 20, 48541);
    			attr_dev(label3, "for", "js_disable");
    			add_location(label3, file$7, 1031, 24, 49077);
    			option6.__value = "";
    			option6.value = option6.__value;
    			add_location(option6, file$7, 1033, 28, 49257);
    			option7.__value = "0";
    			option7.value = option7.__value;
    			add_location(option7, file$7, 1034, 28, 49324);
    			option8.__value = "1";
    			option8.value = option8.__value;
    			add_location(option8, file$7, 1035, 28, 49390);
    			attr_dev(select2, "class", "form-select");
    			attr_dev(select2, "id", "js_disable");
    			attr_dev(select2, "data-cy", "js_disable");
    			add_location(select2, file$7, 1032, 24, 49141);
    			attr_dev(div47, "class", "form-group");
    			add_location(div47, file$7, 1030, 20, 49028);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "btn btn-primary");
    			attr_dev(button6, "data-cy", "close_modal");
    			attr_dev(button6, "data-bs-dismiss", "modal");
    			add_location(button6, file$7, 1039, 24, 49561);
    			attr_dev(div48, "class", "float-right");
    			add_location(div48, file$7, 1038, 20, 49511);
    			...
    			input2.value = "";
    			add_location(input2, file$7, 1045, 4, 49770);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 224, 1, 9623);
    			add_location(main, file$8, 223, 0, 9615);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
