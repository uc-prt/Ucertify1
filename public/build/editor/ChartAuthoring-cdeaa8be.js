...
import { O as JUI, a6 as l, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, v as validate_slots, e as element, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, B as noop, x as detach_dev, L as beforeUpdate, A as AH, o as onMount, a8 as afterUpdate, X as XMLToJSON, w as writable, c as create_component, l as set_style, m as mount_component, q as listen_dev, G as prop_dev, t as transition_in, a as transition_out, b as destroy_component, H as run_all } from './main-aaa128d2.js';
...
function add_css(target) {
	append_styles(target, "svelte-1v1w5xb", "input[type=number].svelte-1v1w5xb::-webkit-inner-spin-button,input[type=number].svelte-1v1w5xb::-webkit-outer-spin-button{-webkit-appearance:none;-moz-appearance:none;appearance:none}.modal_height.svelte-1v1w5xb{max-height:350px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ChartAuthoring> was created with unknown prop '${key}'`);
	});
...
//# sourceMappingURL=ChartAuthoring-cdeaa8be.js.map
