...
/* clsSMExternal\externalHelper.svelte generated by Svelte v3.34.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ExternalHelper> was created with unknown prop '${key}'`);
	});
...
export { itemHelper };
//# sourceMappingURL=externalHelper-bfd970ad.js.map
