...
class StepAlgoPreview extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-1dndgnp-style")) add_css();
...
//# sourceMappingURL=ItemPluginPreview-bc6b03d7.js.map
