...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 367, 8, 13480);
			...
			add_location(div1, file, 377, 8, 13784);
			add_location(center, file, 360, 8, 13256);
			attr_dev(div2, "class", "hotspot-token-preview svelte-4djjpi");
			attr_dev(div2, "tabindex", "0");
			add_location(div2, file, 359, 4, 13198);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 356, 8, 13096);
			attr_dev(div, "class", "alert alert-danger font-weight-bold");
			add_location(div, file, 355, 4, 13037);
		},
		m: function mount(target, anchor) {
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 409, 28, 15255);
			...
			add_location(span1, file, 442, 32, 17131);
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br, file, 405, 24, 15064);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 389, 20, 14166);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
//# sourceMappingURL=HotspotTokenPreview-761e2ac1.js.map
