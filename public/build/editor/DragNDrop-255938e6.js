...
function create_if_block$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label, file$h, 729, 36, 55871);
			...
			add_location(textarea, file$h, 730, 36, 55999);
			attr_dev(div0, "class", "form-group");
			add_location(div0, file$h, 728, 32, 55809);
			attr_dev(div1, "class", "ev");
			attr_dev(div1, "type", "tbd");
			add_location(div1, file$h, 732, 32, 56208);
			attr_dev(div2, "class", "col-sm-6 pr-1 pl-2");
			add_location(div2, file$h, 727, 28, 55743);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
...
function create_fragment$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option0, file$h, 60, 44, 4168);
			option1.__value = "black";
			option1.value = option1.__value;
			add_location(option1, file$h, 61, 44, 4248);
			option2.__value = "gray";
			option2.value = option2.__value;
			add_location(option2, file$h, 62, 44, 4334);
			attr_dev(select0, "class", "form-select form-control-md");
			...
			add_location(label6, file$h, 68, 40, 4672);
			attr_dev(input5, "type", "text");
			...
			add_location(label10, file$h, 97, 40, 7151);
			...
			add_location(input9, file$h, 104, 40, 7804);
			attr_dev(div25, "class", "form-group");
			add_location(div25, file$h, 102, 36, 7607);
			attr_dev(div26, "class", "col-sm-6 px-1");
			add_location(div26, file$h, 101, 32, 7542);
			attr_dev(div27, "class", "row");
			add_location(div27, file$h, 94, 28, 6969);
			attr_dev(div28, "class", "col-sm-12 d-none");
			add_location(div28, file$h, 93, 24, 6909);
			...
			add_location(input10, file$h, 110, 20, 8128);
			...
			add_location(label12, file$h, 118, 40, 8545);
			attr_dev(input11, "type", "text");
			...
			add_location(input14, file$h, 139, 40, 10440);
			attr_dev(div38, "class", "form-group");
			add_location(div38, file$h, 137, 36, 10231);
			attr_dev(div39, "class", "col-sm-6 px-1");
			add_location(div39, file$h, 136, 32, 10166);
			attr_dev(div40, "class", "row");
			add_location(div40, file$h, 129, 28, 9590);
			attr_dev(label16, "class", "control-label font-weight-normal mb-0");
			attr_dev(label16, "for", "drop-value");
			add_location(label16, file$h, 146, 40, 10910);
			attr_dev(input15, "type", "text");
			...
			add_location(input15, file$h, 147, 40, 11039);
			attr_dev(div41, "class", "form-group");
			add_location(div41, file$h, 145, 36, 10844);
			attr_dev(div42, "class", "col-sm-6 px-1");
			add_location(div42, file$h, 144, 32, 10779);
			attr_dev(label17, "class", "control-label font-weight-normal mb-0");
			attr_dev(label17, "for", "drop-border");
			add_location(label17, file$h, 152, 40, 11405);
			option3.__value = "";
			option3.value = option3.__value;
			add_location(option3, file$h, 154, 44, 11663);
			option4.__value = "black";
			option4.value = option4.__value;
			add_location(option4, file$h, 155, 44, 11743);
			option5.__value = "gray";
			option5.value = option5.__value;
			add_location(option5, file$h, 156, 44, 11829);
			attr_dev(select1, "class", "form-select form-control-md");
			attr_dev(select1, "id", "drop-border");
			attr_dev(select1, "name", "border");
			add_location(select1, file$h, 153, 40, 11542);
			attr_dev(div43, "class", "form-group");
			add_location(div43, file$h, 151, 36, 11339);
			attr_dev(div44, "class", "col-sm-6 px-1");
			add_location(div44, file$h, 150, 32, 11274);
			attr_dev(div45, "class", "row");
			add_location(div45, file$h, 143, 28, 10728);
			attr_dev(label18, "class", "control-label font-weight-normal mb-0");
			attr_dev(label18, "for", "drop-name");
			add_location(label18, file$h, 164, 40, 12250);
			...
			add_location(input18, file$h, 177, 40, 13411);
			attr_dev(div50, "class", "form-group");
			add_location(div50, file$h, 175, 36, 13202);
			attr_dev(div51, "class", "col-sm-12 px-1 d-none");
			add_location(div51, file$h, 174, 32, 13129);
			...
			add_location(input19, file$h, 182, 40, 13797);
			...
			add_location(input22, file$h, 213, 40, 16034);
			attr_dev(div63, "class", "form-group");
			add_location(div63, file$h, 211, 36, 15815);
			attr_dev(div64, "class", "col-sm-6 px-1");
			add_location(div64, file$h, 210, 32, 15750);
			attr_dev(div65, "class", "row");
			add_location(div65, file$h, 203, 28, 15137);
			attr_dev(label25, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label25, "for", "int-top");
			add_location(label25, file$h, 220, 40, 16530);
			...
			add_location(input32, file$h, 311, 40, 23841);
			attr_dev(div95, "class", "form-group");
			add_location(div95, file$h, 309, 36, 23622);
			attr_dev(div96, "class", "col-sm-6 px-1");
			add_location(div96, file$h, 308, 32, 23557);
			attr_dev(div97, "class", "row");
			add_location(div97, file$h, 301, 28, 22940);
			attr_dev(label38, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label38, "for", "mlt-top");
			add_location(label38, file$h, 318, 40, 24341);
			...
			add_location(input39, file$h, 394, 40, 30415);
			attr_dev(div123, "class", "form-group");
			add_location(div123, file$h, 392, 36, 30196);
			attr_dev(div124, "class", "col-sm-6 px-1");
			add_location(div124, file$h, 391, 32, 30131);
			attr_dev(div125, "class", "row");
			add_location(div125, file$h, 384, 28, 29520);
			attr_dev(label49, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label49, "for", "chk-top");
			add_location(label49, file$h, 401, 40, 30914);
			...
			add_location(input46, file$h, 452, 40, 34818);
			attr_dev(div144, "class", "form-group");
			add_location(div144, file$h, 450, 36, 34600);
			attr_dev(div145, "class", "col-sm-6 px-1");
			add_location(div145, file$h, 449, 32, 34535);
			attr_dev(div146, "class", "row");
			add_location(div146, file$h, 442, 28, 33925);
			attr_dev(label56, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label56, "for", "rd-top");
			add_location(label56, file$h, 459, 40, 35313);
			...
			add_location(input48, file$h, 466, 40, 35978);
			attr_dev(div149, "class", "form-group");
			add_location(div149, file$h, 464, 36, 35771);
			attr_dev(div150, "class", "col-sm-6 px-1");
			add_location(div150, file$h, 463, 32, 35706);
			attr_dev(div151, "class", "row");
			add_location(div151, file$h, 456, 28, 35131);
			attr_dev(label58, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label58, "for", "rd-name");
			add_location(label58, file$h, 473, 40, 36450);
			...
			add_location(input55, file$h, 522, 40, 40243);
			attr_dev(div169, "class", "form-group");
			add_location(div169, file$h, 520, 36, 40024);
			attr_dev(div170, "class", "col-sm-6 px-1");
			add_location(div170, file$h, 519, 32, 39959);
			attr_dev(div171, "class", "row");
			add_location(div171, file$h, 512, 28, 39345);
			attr_dev(label65, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label65, "for", "btn-top");
			add_location(label65, file$h, 529, 40, 40740);
			...
			add_location(input57, file$h, 536, 40, 41409);
			attr_dev(div174, "class", "form-group");
			add_location(div174, file$h, 534, 36, 41201);
			attr_dev(div175, "class", "col-sm-6 px-1");
			add_location(div175, file$h, 533, 32, 41136);
			attr_dev(div176, "class", "row");
			add_location(div176, file$h, 526, 28, 40558);
			attr_dev(label67, "class", "control-label font-weight-normal mb-0");
			attr_dev(label67, "for", "btn-value");
			add_location(label67, file$h, 543, 40, 41883);
			...
			add_location(input58, file$h, 544, 40, 42007);
			attr_dev(div177, "class", "form-group");
			add_location(div177, file$h, 542, 36, 41817);
			attr_dev(div178, "class", "col-sm-12 px-1");
			add_location(div178, file$h, 541, 32, 41751);
			attr_dev(label68, "class", "control-label font-weight-normal mb-0");
			attr_dev(label68, "for", "btn-class");
			add_location(label68, file$h, 549, 40, 42377);
			...
			add_location(input62, file$h, 580, 40, 44590);
			attr_dev(div190, "class", "form-group");
			add_location(div190, file$h, 578, 36, 44371);
			attr_dev(div191, "class", "col-sm-6 px-1");
			add_location(div191, file$h, 577, 32, 44306);
			attr_dev(div192, "class", "row");
			add_location(div192, file$h, 570, 28, 43690);
			attr_dev(label72, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label72, "for", "ddn-top");
			add_location(label72, file$h, 587, 40, 45089);
			...
			add_location(input64, file$h, 594, 40, 45760);
			attr_dev(div195, "class", "form-group");
			add_location(div195, file$h, 592, 36, 45552);
			attr_dev(div196, "class", "col-sm-6 px-1");
			add_location(div196, file$h, 591, 32, 45487);
			attr_dev(div197, "class", "row");
			add_location(div197, file$h, 584, 28, 44907);
			attr_dev(label74, "class", "control-label font-weight-normal mb-0");
			attr_dev(label74, "for", "ddn-value");
			add_location(label74, file$h, 601, 40, 46236);
			...
			add_location(input67, file$h, 632, 40, 48457);
			attr_dev(div209, "class", "form-group");
			add_location(div209, file$h, 630, 36, 48238);
			attr_dev(div210, "class", "col-sm-6 px-1");
			add_location(div210, file$h, 629, 32, 48173);
			attr_dev(div211, "class", "row");
			add_location(div211, file$h, 622, 28, 47558);
			attr_dev(label78, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label78, "for", "lst-top");
			add_location(label78, file$h, 639, 40, 48955);
			...
			add_location(input69, file$h, 646, 40, 49625);
			attr_dev(div214, "class", "form-group");
			add_location(div214, file$h, 644, 36, 49417);
			attr_dev(div215, "class", "col-sm-6 px-1");
			add_location(div215, file$h, 643, 32, 49352);
			attr_dev(div216, "class", "row");
			add_location(div216, file$h, 636, 28, 48773);
			attr_dev(label80, "class", "control-label font-weight-normal mb-0");
			attr_dev(label80, "for", "lst-value");
			add_location(label80, file$h, 653, 40, 50100);
			...
			add_location(textarea11, file$h, 654, 40, 50230);
			attr_dev(div217, "class", "form-group");
			add_location(div217, file$h, 652, 36, 50034);
			attr_dev(div218, "class", "col-sm-12 px-1");
			add_location(div218, file$h, 651, 32, 49968);
			...
			add_location(input74, file$h, 692, 40, 53037);
			attr_dev(div230, "class", "form-group");
			add_location(div230, file$h, 690, 36, 52818);
			attr_dev(div231, "class", "col-sm-6 px-1");
			add_location(div231, file$h, 689, 32, 52753);
			attr_dev(div232, "class", "row");
			add_location(div232, file$h, 682, 28, 52138);
			attr_dev(label85, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label85, "for", "tbd-top");
			add_location(label85, file$h, 699, 40, 53535);
			...
			add_location(input76, file$h, 706, 40, 54205);
			attr_dev(div235, "class", "form-group");
			add_location(div235, file$h, 704, 36, 53997);
			attr_dev(div236, "class", "col-sm-6 px-1");
			add_location(div236, file$h, 703, 32, 53932);
			attr_dev(div237, "class", "row");
			add_location(div237, file$h, 696, 28, 53353);
			attr_dev(label87, "class", "control-label font-weight-normal mb-0");
			attr_dev(label87, "for", "tbd-title");
			add_location(label87, file$h, 713, 40, 54680);
			...
			add_location(input77, file$h, 714, 40, 54808);
			attr_dev(div238, "class", "form-group");
			add_location(div238, file$h, 712, 36, 54614);
			attr_dev(div239, "class", "col-sm-12 px-1");
			add_location(div239, file$h, 711, 32, 54548);
			attr_dev(label88, "class", "control-label font-weight-normal mb-0");
			attr_dev(label88, "for", "tbd-class");
			add_location(label88, file$h, 719, 40, 55179);
			...
			add_location(input81, file$h, 752, 40, 57501);
			attr_dev(div248, "class", "form-group");
			add_location(div248, file$h, 750, 36, 57282);
			attr_dev(div249, "class", "col-sm-6 px-1");
			add_location(div249, file$h, 749, 32, 57217);
			attr_dev(div250, "class", "row");
			add_location(div250, file$h, 742, 28, 56604);
			attr_dev(label91, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label91, "for", "img-top");
			add_location(label91, file$h, 759, 40, 57997);
			...
			add_location(input83, file$h, 766, 40, 58665);
			attr_dev(div253, "class", "form-group");
			add_location(div253, file$h, 764, 36, 58457);
			attr_dev(div254, "class", "col-sm-6 px-1");
			add_location(div254, file$h, 763, 32, 58392);
			attr_dev(div255, "class", "row");
			add_location(div255, file$h, 756, 28, 57815);
			attr_dev(label93, "class", "control-label font-weight-normal mb-0");
			attr_dev(label93, "for", "img-title");
			add_location(label93, file$h, 773, 40, 59138);
			...
			add_location(input84, file$h, 774, 40, 59266);
			attr_dev(div256, "class", "form-group");
			add_location(div256, file$h, 772, 36, 59072);
			attr_dev(div257, "class", "col-sm-12 px-1");
			add_location(div257, file$h, 771, 32, 59006);
			attr_dev(label94, "class", "control-label font-weight-normal mb-0");
			attr_dev(label94, "for", "img-bgimg");
			add_location(label94, file$h, 779, 40, 59635);
			...
			add_location(input90, file$h, 822, 40, 62930);
			attr_dev(div273, "class", "form-group");
			add_location(div273, file$h, 820, 36, 62722);
			attr_dev(div274, "class", "col-sm-6 px-1");
			add_location(div274, file$h, 819, 32, 62657);
			attr_dev(label100, "class", "control-label font-weight-normal mb-0");
			attr_dev(label100, "for", "lbl-title");
			add_location(label100, file$h, 827, 40, 63320);
			...
			add_location(input91, file$h, 828, 40, 63448);
			attr_dev(div275, "class", "form-group");
			add_location(div275, file$h, 826, 36, 63254);
			attr_dev(div276, "class", "col-sm-12 px-1");
			add_location(div276, file$h, 825, 32, 63188);
			attr_dev(label101, "class", "control-label font-weight-normal mb-0");
			attr_dev(label101, "for", "lbl_border_size");
			add_location(label101, file$h, 833, 40, 63816);
			option12.__value = "0";
			option12.value = option12.__value;
			add_location(option12, file$h, 835, 44, 64097);
			option13.__value = "1";
			option13.value = option13.__value;
			add_location(option13, file$h, 836, 44, 64178);
			option14.__value = "2";
			option14.value = option14.__value;
			add_location(option14, file$h, 837, 44, 64252);
			option15.__value = "3";
			option15.value = option15.__value;
			add_location(option15, file$h, 838, 44, 64326);
			option16.__value = "4";
			option16.value = option16.__value;
			add_location(option16, file$h, 839, 44, 64400);
			option17.__value = "5";
			option17.value = option17.__value;
			add_location(option17, file$h, 840, 44, 64474);
			...
			add_location(select7, file$h, 834, 40, 63956);
			attr_dev(div277, "class", "form-group");
			add_location(div277, file$h, 832, 36, 63750);
			attr_dev(div278, "class", "col-sm-4 px-1");
			add_location(div278, file$h, 831, 32, 63685);
			attr_dev(label102, "class", "control-label font-weight-normal mb-0");
			attr_dev(label102, "for", "lbl_border_color");
			add_location(label102, file$h, 846, 40, 64802);
			option18.__value = "white";
			option18.value = option18.__value;
			add_location(option18, file$h, 848, 44, 65083);
			option19.__value = "black";
			option19.value = option19.__value;
			add_location(option19, file$h, 849, 44, 65168);
			option20.__value = "blue";
			option20.value = option20.__value;
			add_location(option20, file$h, 850, 44, 65254);
			option21.__value = "green";
			option21.value = option21.__value;
			add_location(option21, file$h, 851, 44, 65338);
			option22.__value = "red";
			option22.value = option22.__value;
			add_location(option22, file$h, 852, 44, 65424);
			...
			add_location(input97, file$h, 919, 40, 70308);
			attr_dev(div301, "class", "form-group");
			add_location(div301, file$h, 917, 36, 70099);
			attr_dev(div302, "class", "col-sm-3 px-1");
			add_location(div302, file$h, 916, 32, 70034);
			attr_dev(div303, "class", "row");
			add_location(div303, file$h, 897, 28, 68326);
			attr_dev(label110, "class", "control-label font-weight-normal mb-0");
			attr_dev(label110, "for", "area-matrix");
			add_location(label110, file$h, 926, 40, 70780);
			...
			add_location(input99, file$h, 933, 40, 71425);
			attr_dev(div306, "class", "form-group");
			add_location(div306, file$h, 931, 36, 71216);
			attr_dev(div307, "class", "col-sm-6 px-1");
			add_location(div307, file$h, 930, 32, 71151);
			attr_dev(div308, "class", "row");
			add_location(div308, file$h, 923, 28, 70598);
			attr_dev(label112, "class", "control-label font-weight-normal mb-0");
			attr_dev(label112, "for", "area-defaultans");
			add_location(label112, file$h, 940, 40, 71884);
			...
			add_location(input105, file$h, 976, 40, 74666);
			attr_dev(div322, "class", "form-group");
			add_location(div322, file$h, 974, 36, 74458);
			attr_dev(div323, "class", "col-sm-3 px-1");
			add_location(div323, file$h, 973, 32, 74393);
			attr_dev(div324, "class", "row");
			add_location(div324, file$h, 954, 28, 72679);
			attr_dev(label117, "class", "control-label font-weight-normal mb-0");
			attr_dev(label117, "for", "mnl-matrix");
			add_location(label117, file$h, 983, 40, 75141);
			...
			add_location(input107, file$h, 990, 40, 75787);
			attr_dev(div327, "class", "form-group");
			add_location(div327, file$h, 988, 36, 75579);
			attr_dev(div328, "class", "col-sm-6 px-1");
			add_location(div328, file$h, 987, 32, 75514);
			attr_dev(div329, "class", "row");
			add_location(div329, file$h, 980, 28, 74959);
			attr_dev(label119, "class", "control-label font-weight-normal mb-0");
			attr_dev(label119, "for", "mnl-value");
			add_location(label119, file$h, 997, 40, 76249);
			...
			add_location(input113, file$h, 1033, 40, 79014);
			attr_dev(div343, "class", "form-group");
			add_location(div343, file$h, 1031, 36, 78806);
			attr_dev(div344, "class", "col-sm-3 px-1");
			add_location(div344, file$h, 1030, 32, 78741);
			attr_dev(div345, "class", "row");
			add_location(div345, file$h, 1011, 28, 77029);
			attr_dev(label124, "class", "control-label font-weight-normal mb-0");
			attr_dev(label124, "for", "hpt-title");
			add_location(label124, file$h, 1040, 40, 79488);
			...
			add_location(input114, file$h, 1041, 40, 79616);
			attr_dev(div346, "class", "form-group");
			add_location(div346, file$h, 1039, 36, 79422);
			attr_dev(div347, "class", "col-sm-6 px-1");
			add_location(div347, file$h, 1038, 32, 79357);
			attr_dev(label125, "class", "control-label font-weight-normal mb-0");
			attr_dev(label125, "for", "hpt-name");
			add_location(label125, file$h, 1046, 40, 79986);
			...
			add_location(input115, file$h, 1047, 40, 80117);
			attr_dev(div348, "class", "form-group");
			add_location(div348, file$h, 1045, 36, 79920);
			attr_dev(div349, "class", "col-sm-6 px-1");
			add_location(div349, file$h, 1044, 32, 79855);
			attr_dev(div350, "class", "row");
			add_location(div350, file$h, 1037, 28, 79306);
			attr_dev(label126, "class", "control-label font-weight-normal mb-0");
			attr_dev(label126, "for", "hpt-targetimg");
			add_location(label126, file$h, 1054, 40, 80569);
			...
			add_location(input116, file$h, 1055, 40, 80706);
			attr_dev(div351, "class", "form-group");
			add_location(div351, file$h, 1053, 36, 80503);
			attr_dev(div352, "class", "col-sm-6 px-1");
			add_location(div352, file$h, 1052, 32, 80438);
			...
			add_location(input124, file$h, 1109, 40, 84763);
			attr_dev(div371, "class", "form-group");
			add_location(div371, file$h, 1107, 36, 84569);
			attr_dev(div372, "class", "col-sm-6 px-1");
			add_location(div372, file$h, 1106, 32, 84504);
			attr_dev(label133, "class", "control-label font-weight-normal mb-0");
			attr_dev(label133, "for", "tab-alt");
			add_location(label133, file$h, 1114, 40, 85147);
			...
			add_location(input125, file$h, 1115, 40, 85276);
			attr_dev(div373, "class", "form-group");
			add_location(div373, file$h, 1113, 36, 85081);
			attr_dev(div374, "class", "col-sm-6 px-1");
			add_location(div374, file$h, 1112, 32, 85016);
			attr_dev(div375, "class", "row");
			add_location(div375, file$h, 1105, 28, 84453);
			attr_dev(label134, "class", "control-label font-weight-normal mb-0");
			attr_dev(label134, "for", "tab-bgimg");
			add_location(label134, file$h, 1122, 40, 85721);
			...
			add_location(input126, file$h, 1123, 40, 85860);
			attr_dev(div376, "class", "form-group");
			add_location(div376, file$h, 1121, 36, 85655);
			attr_dev(button2, "type", "button");
			...
			add_location(button2, file$h, 1125, 36, 86056);
			attr_dev(div377, "class", "col-sm-6 px-1");
			add_location(div377, file$h, 1120, 32, 85590);
			...
			add_location(input129, file$h, 1145, 40, 87487);
			attr_dev(div384, "class", "form-group");
			add_location(div384, file$h, 1143, 36, 87281);
			...
			add_location(input130, file$h, 1152, 40, 88158);
			attr_dev(div386, "class", "form-group");
			add_location(div386, file$h, 1150, 36, 87963);
			attr_dev(div387, "class", "col-sm-6 px-1");
			add_location(div387, file$h, 1149, 32, 87898);
			attr_dev(div388, "class", "row");
			add_location(div388, file$h, 1141, 28, 87165);
			...
			add_location(input134, file$h, 1181, 40, 90203);
			attr_dev(div397, "class", "form-group");
			add_location(div397, file$h, 1179, 36, 89983);
			attr_dev(div398, "class", "col-sm-4 px-1");
			add_location(div398, file$h, 1178, 32, 89918);
			attr_dev(label141, "class", "control-label font-weight-normal mb-0");
			attr_dev(label141, "for", "base-bgimg-alt");
			add_location(label141, file$h, 1186, 40, 90598);
			...
			add_location(input135, file$h, 1187, 40, 90737);
			attr_dev(div399, "class", "form-group");
			add_location(div399, file$h, 1185, 36, 90532);
			attr_dev(div400, "class", "col-sm-4 px-1");
			add_location(div400, file$h, 1184, 32, 90467);
			attr_dev(div401, "class", "row");
			add_location(div401, file$h, 1171, 28, 89323);
			attr_dev(label142, "class", "control-label font-weight-normal mb-0");
			attr_dev(label142, "for", "base-bgimg");
			add_location(label142, file$h, 1194, 40, 91190);
			...
			add_location(input136, file$h, 1195, 40, 91330);
			attr_dev(div402, "class", "form-group");
			add_location(div402, file$h, 1193, 36, 91124);
			attr_dev(div403, "class", "col-sm-6 px-1");
			add_location(div403, file$h, 1192, 32, 91059);
			attr_dev(button4, "type", "button");
			attr_dev(button4, "id", "upload_media");
			attr_dev(button4, "class", "btn btn-outline-primary float-start");
			add_location(button4, file$h, 1199, 36, 91659);
			...
			add_location(input137, file$h, 1201, 40, 91894);
			...
			add_location(label143, file$h, 1202, 40, 92132);
			attr_dev(div404, "class", "form-group float-start mt-2");
			add_location(div404, file$h, 1200, 36, 91811);
			attr_dev(div405, "class", "col-sm-6 mt-3 pt-1 px-1");
			add_location(div405, file$h, 1198, 32, 91584);
			attr_dev(div406, "class", "row");
			add_location(div406, file$h, 1191, 28, 91008);
			attr_dev(div407, "class", "col-sm-12");
			add_location(div407, file$h, 1170, 24, 89270);
			attr_dev(div408, "class", "row mx-0");
			add_location(div408, file$h, 1169, 20, 89222);
			attr_dev(div409, "class", "base h");
			add_location(div409, file$h, 1168, 16, 89180);
			...
			add_location(input141, file$h, 1239, 40, 94922);
			attr_dev(div418, "class", "form-group");
			add_location(div418, file$h, 1237, 36, 94705);
			attr_dev(div419, "class", "col-sm-6 px-1");
			add_location(div419, file$h, 1236, 32, 94640);
			attr_dev(div420, "class", "row");
			add_location(div420, file$h, 1229, 28, 94048);
			attr_dev(label148, "class", "control-label font-weight-normal mb-0");
			attr_dev(label148, "for", "choicematrix-name");
			add_location(label148, file$h, 1246, 40, 95401);
			...
			add_location(textarea15, file$h, 1268, 32, 97250);
			attr_dev(div429, "class", "form-group");
			add_location(div429, file$h, 1266, 28, 97059);
			attr_dev(div430, "class", "ev");
			attr_dev(div430, "type", "rd");
			add_location(div430, file$h, 1270, 28, 97449);
			attr_dev(div431, "class", "col-sm-6 pl-2 pr-1");
			add_location(div431, file$h, 1265, 24, 96997);
			attr_dev(div432, "class", "row mx-0");
			add_location(div432, file$h, 1213, 20, 92708);
			attr_dev(div433, "class", "choicematrix h");
			add_location(div433, file$h, 1212, 16, 92658);
...
//# sourceMappingURL=DragNDrop-255938e6.js.map
