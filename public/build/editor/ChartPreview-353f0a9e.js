...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 530, 32, 22959);
			...
			add_location(span1, file, 529, 28, 22673);
			attr_dev(span2, "class", "icomoon-new-24px-delete-1 s2");
			add_location(span2, file, 533, 32, 23364);
			...
			add_location(span3, file, 532, 28, 23063);
			attr_dev(span4, "class", "icomoon-keyboard-2 s2");
			add_location(span4, file, 536, 32, 23733);
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file, 565, 36, 25772);
			attr_dev(label0, "class", "col-6 text-body");
			add_location(label0, file, 563, 32, 25645);
...
//# sourceMappingURL=ChartPreview-353f0a9e.js.map
