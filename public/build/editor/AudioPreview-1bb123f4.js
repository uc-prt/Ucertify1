...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 523, 24, 26242);
			...
			add_location(span1, file, 540, 28, 27663);
			...
			add_location(button0, file, 532, 24, 27241);
			...
			add_location(span2, file, 551, 28, 28461);
			...
			add_location(button1, file, 542, 24, 27990);
			...
			add_location(span3, file, 564, 28, 29305);
			...
			add_location(button2, file, 553, 24, 28717);
			...
			add_location(div6, file, 531, 20, 27075);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 520, 16, 25937);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 519, 12, 25878);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 515, 62, 25495);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 515, 25, 25458);
			add_location(div0, file, 515, 20, 25453);
			...
			add_location(textarea, file, 516, 20, 25554);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 514, 16, 25406);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 491, 20, 24166);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 490, 16, 24119);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 479, 20, 23613);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 478, 16, 23566);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 578, 20, 29990);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 576, 16, 29813);
			...
			add_location(div3, file, 580, 16, 30193);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 584, 20, 30460);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-1bb123f4.js.map
