...
function create_fragment$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div2, file$g, 49, 4, 2750);
			...
			add_location(input0, file$g, 51, 8, 2847);
			...
			add_location(input1, file$g, 52, 8, 3008);
			...
			add_location(input2, file$g, 53, 8, 3176);
			...
			add_location(input3, file$g, 54, 8, 3348);
			...
			add_location(input4, file$g, 55, 8, 3519);
			...
			add_location(input5, file$g, 56, 8, 3674);
			...
			add_location(input6, file$g, 57, 8, 3839);
			...
			add_location(input7, file$g, 58, 8, 3994);
			...
			add_location(input8, file$g, 59, 8, 4165);
			...
			add_location(input9, file$g, 60, 8, 4330);
			...
			add_location(input10, file$g, 61, 8, 4501);
			...
			add_location(input11, file$g, 62, 8, 4662);
			...
			add_location(input12, file$g, 63, 8, 4820);
			...
			add_location(input13, file$g, 64, 8, 4975);
			...
			add_location(input14, file$g, 65, 8, 5134);
			...
			add_location(input15, file$g, 66, 8, 5302);
			attr_dev(div3, "class", "row-fluid margin-top1 event-input");
			add_location(div3, file$g, 50, 4, 2790);
...
//# sourceMappingURL=DragNDrop-9c06a933.js.map
