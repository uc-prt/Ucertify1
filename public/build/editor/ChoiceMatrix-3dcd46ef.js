...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, M as append_styles, C as validate_each_argument, v as validate_slots, ab as afterUpdate, o as onMount, A as AH, X as XMLToJSON, w as writable, a9 as l, e as element, h as text, k as add_location, n as insert_dev, p as append_dev, B as noop, x as detach_dev, z as empty, K as destroy_each, f as space, j as attr_dev, a4 as null_to_empty, l as set_style, q as listen_dev, E as is_function, G as prop_dev, H as run_all, a1 as select_option } from './main-50717271.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(td, file, 449, 12, 15727);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label0, file, 350, 6, 10097);
			...
			add_location(select, file, 356, 24, 10254);
			...
			add_location(strong, file, 470, 52, 17193);
			attr_dev(small, "class", "text-danger font13");
			add_location(small, file, 470, 16, 17157);
			attr_dev(span1, "class", "font24 svelte-dt0zmm");
			add_location(span1, file, 479, 26, 17643);
			...
			add_location(button0, file, 473, 24, 17361);
			attr_dev(span2, "class", "font24 svelte-dt0zmm");
			add_location(span2, file, 489, 7, 17948);
			...
			add_location(button1, file, 483, 6, 17744);
			attr_dev(div3, "class", "text-center");
			attr_dev(div3, "style", div3_style_value = 'width:100%;');
			add_location(div3, file, 471, 16, 17277);
			attr_dev(div4, "class", "col-12 col-lg-12 p-0");
			add_location(div4, file, 346, 12, 9824);
			attr_dev(div5, "id", "authoring");
			attr_dev(div5, "class", "p-2 border");
			add_location(div5, file, 345, 8, 9767);
			add_location(div6, file, 344, 4, 9752);
			add_location(main, file, 343, 0, 9740);
		},
...
//# sourceMappingURL=ChoiceMatrix-3dcd46ef.js.map
