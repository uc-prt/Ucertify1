...
import { y as l, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, W as Checkbox, C as validate_each_argument, P as Dialog, Q as binding_callbacks, R as bind, v as validate_slots, L as beforeUpdate, X as XMLToJSON, o as onMount, A as AH$1, ad as afterUpdate, w as writable, ae as Loader, N as JSONToXML, V as Button, z as empty, n as insert_dev, x as detach_dev, e as element, f as space, c as create_component, h as text, j as attr_dev, k as add_location, p as append_dev, m as mount_component, q as listen_dev, G as prop_dev, $ as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component, K as destroy_each, H as run_all, Y as src_url_equal, a6 as null_to_empty, l as set_style, B as noop } from './main-48037624.js';
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea1, file, 843, 48, 35220);
			...
			add_location(div3, file, 842, 44, 35080);
			...
			add_location(span2, file, 861, 44, 37129);
			attr_dev(a, "id", a_id_value = /*data*/ ctx[58].id);
			add_location(a, file, 860, 40, 37005);
			attr_dev(div7, "class", "width1 float-right");
			add_location(div7, file, 859, 36, 36931);
			attr_dev(div8, "key", div8_key_value = /*i*/ ctx[60]);
			attr_dev(div8, "class", "d-flex align-items-center mb-2");
			add_location(div8, file, 821, 32, 32747);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*localCData*/ 1 && a_id_value !== (a_id_value = /*data*/ ctx[58].id)) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span1, file, 815, 48, 32324);
			attr_dev(a, "id", a_id_value = /*data*/ ctx[58].id);
...
function create_if_block_8(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (!src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value2.substr(1).split("##")[0].split('%%')[0])) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*data*/ ctx[58].value2.split("##")[1]
			? /*data*/ ctx[58].value2.split("##")[1]
			: null);

			add_location(img, file, 828, 52, 33635);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && !src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value2.substr(1).split("##")[0].split('%%')[0])) {
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 833, 52, 34172);
		},
		m: function mount(target, anchor) {
...
function create_if_block_6(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "class", "authoringImage");
			if (!src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value1.substr(1).split("##")[0].split('%%')[0])) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*data*/ ctx[58].value1.split("##")[1]
			? /*data*/ ctx[58].value1.split("##")[1]
			: null);

			add_location(img, file, 846, 52, 35611);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && !src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value1.substr(1).split("##")[0].split('%%')[0])) {
				attr_dev(img, "src", img_src_value);
			}
...
function create_if_block_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "data-bs-placement", "right");
			attr_dev(div, "title", "Delete Image");
			add_location(div, file, 851, 52, 36133);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
...
function create_if_block_4(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "class", "authoringImage");
			if (!src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp*/ ctx[64].substr(1).split("##")[0])) attr_dev(img, "src", img_src_value);
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && !src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp*/ ctx[64].substr(1).split("##")[0])) {
				attr_dev(img, "src", img_src_value);
			}
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "class", "authoringImage");
			if (!src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp1*/ ctx[61].substr(1).split("##")[0])) attr_dev(img, "src", img_src_value);
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && !src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp1*/ ctx[61].substr(1).split("##")[0])) {
				attr_dev(img, "src", img_src_value);
			}
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 960, 5, 41490);
			attr_dev(span, "class", "col-md-12");
			attr_dev(span, "style", span_style_value = 'margin-top:40px;margin-bottom:40px;');
			add_location(span, file, 963, 6, 41587);
			attr_dev(div1, "class", "row");
			add_location(div1, file, 962, 6, 41562);
			add_location(div2, file, 961, 5, 41549);
		},
		m: function mount(target, anchor) {
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			input.value = "No";
			add_location(input, file, 970, 6, 41782);
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 968, 5, 41726);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 877, 20, 37916);
			...
			add_location(button0, file, 872, 16, 37653);
			attr_dev(div11, "class", "text-left ml-2 pb-3");
			add_location(div11, file, 871, 12, 37602);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*state, localCData, removeCData, removetextbox, openImageDialogAlgo, editalgoCData, addListItem, openImageDialog, editCData*/ 50915) {
...
//# sourceMappingURL=MatchList-26e05ec9.js.map
