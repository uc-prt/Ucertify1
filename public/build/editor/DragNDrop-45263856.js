...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 765, 16, 32366);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 763, 16, 32063);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 768, 16, 32590);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$i(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 729, 2, 30577);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 728, 4, 30546);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 760, 232, 31956);
			...
			add_location(button0, file$i, 760, 16, 31740);
			attr_dev(div1, "class", "btn-group tools mr-1");
			attr_dev(div1, "data-t", "base");
			add_location(div1, file$i, 759, 12, 31674);
			...
			add_location(div2, file$i, 753, 8, 31466);
			add_location(center0, file$i, 752, 4, 31448);
			attr_dev(input1, "type", "hidden");
			attr_dev(input1, "id", "special_module_xml");
			attr_dev(input1, "name", "special_module_xml");
			add_location(input1, file$i, 790, 4, 35015);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "h");
			attr_dev(button1, "id", "update_xml");
			attr_dev(button1, "name", "update_xml");
			add_location(button1, file$i, 791, 4, 35094);
			attr_dev(div3, "class", "smnotes");
			add_location(div3, file$i, 793, 8, 35193);
			add_location(center1, file$i, 792, 4, 35175);
			attr_dev(div4, "class", "parent h");
			attr_dev(div4, "data-parent", "dndmain");
			add_location(div4, file$i, 795, 4, 35241);
			attr_dev(div5, "class", "input_border dragable-container overflow-auto p");
			add_location(div5, file$i, 727, 0, 30479);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=DragNDrop-45263856.js.map
