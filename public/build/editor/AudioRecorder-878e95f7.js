...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, A as AH, aa as afterUpdate, X as XMLToJSON, L as beforeUpdate, y as l, e as element, f as space, h as text, j as attr_dev, k as add_location, Y as src_url_equal, n as insert_dev, p as append_dev, _ as select_option, q as listen_dev, G as prop_dev, B as noop, x as detach_dev, H as run_all } from './main-e21fe4a5.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			option1.textContent = `${l.german_lang}`;
			option2 = element("option");
			option2.textContent = `${l.french_lang}`;
			option3 = element("option");
			option3.textContent = `${l.spanish_lang}`;
			option4 = element("option");
			option4.textContent = `${l.hindi_lang}`;
			option5 = element("option");
			option5.textContent = `${l.japanese_lang}`;
			option6 = element("option");
			option6.textContent = `${l.korean_lang}`;
			option7 = element("option");
			option7.textContent = `${l.italiano}`;
			t17 = space();
			div5 = element("div");
			...
			add_location(b0, file, 411, 12, 20123);
			attr_dev(div0, "class", "col-12");
			attr_dev(div0, "tabindex", "0");
			attr_dev(div0, "aria-label", "Recording will end after 15 sec");
			add_location(div0, file, 410, 8, 20031);
			add_location(b1, file, 415, 30, 20291);
			attr_dev(div1, "class", "pb-2");
			add_location(div1, file, 415, 12, 20273);
			...
			add_location(select, file, 422, 12, 20792);
			...
			add_location(span0, file, 455, 20, 22948);
			...
			add_location(img0, file, 457, 24, 23248);
			...
			add_location(div8, file, 456, 20, 23126);
			...
			add_location(img1, file, 460, 24, 23571);
			...
			add_location(span1, file, 472, 24, 24224);
			...
			add_location(button0, file, 464, 20, 23854);
			...
			add_location(span2, file, 483, 24, 24895);
			...
			add_location(button1, file, 474, 20, 24480);
			...
			add_location(span3, file, 496, 24, 25630);
			...
			add_location(button3, file, 509, 20, 26291);
			attr_dev(div16, "class", "modal-header");
			add_location(div16, file, 507, 16, 26114);
			...
			add_location(div17, file, 511, 16, 26494);
			...
			add_location(button4, file, 515, 20, 26740);
...
//# sourceMappingURL=AudioRecorder-878e95f7.js.map
