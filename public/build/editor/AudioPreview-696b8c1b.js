...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 549, 24, 26985);
			...
			add_location(span1, file, 566, 28, 28406);
			...
			add_location(button0, file, 558, 24, 27984);
			...
			add_location(span2, file, 577, 28, 29193);
			...
			add_location(button1, file, 568, 24, 28722);
			...
			add_location(span3, file, 592, 28, 30141);
			...
			add_location(button2, file, 579, 24, 29438);
			...
			add_location(div6, file, 557, 20, 27818);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 546, 16, 26680);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 545, 12, 26621);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 541, 62, 26238);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 541, 25, 26201);
			add_location(div0, file, 541, 20, 26196);
			...
			add_location(textarea, file, 542, 20, 26297);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 540, 16, 26149);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 517, 20, 24909);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 516, 16, 24862);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 505, 20, 24356);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 504, 16, 24309);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 606, 20, 30826);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 604, 16, 30649);
			...
			add_location(div3, file, 608, 16, 31050);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 612, 20, 31317);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-696b8c1b.js.map
