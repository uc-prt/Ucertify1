...
function add_css$1(target) {
	append_styles(target, "svelte-dt0ps7", "#resizeX.svelte-dt0ps7{position:absolute;top:0;right:0;width:3px;opacity:1;height:100%;cursor:w-resize}#resizeY.svelte-dt0ps7{position:absolute;bottom:0;width:100%;height:3px;opacity:1;cursor:s-resize}#resizeXY.svelte-dt0ps7{position:absolute;bottom:0;right:0;opacity:1;cursor:se-resize}#resizeXY.svelte-dt0ps7::before{content:'\\e354'\r\n    }\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_if_block_2$2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(801:2) {#if step && step.length}",
		ctx
	});
...
// (803:16) {#if (data._display == "1" || data._ddisplay == '1') && state.store.updated == false}
function create_if_block_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(803:16) {#if (data._display == \\\"1\\\" || data._ddisplay == '1') && state.store.updated == false}",
		ctx
	});
...
function create_each_block$g(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(802:3) {#each step as data}",
		ctx
	});
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 837, 16, 35044);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 835, 16, 34741);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
// (840:12) {#if state.data && image_loaded}
function create_if_block$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 840, 16, 35268);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(840:12) {#if state.data && image_loaded}",
		ctx
	});
...
function create_fragment$i(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 798, 2, 33150);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 797, 4, 33119);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 832, 232, 34634);
...
//# sourceMappingURL=DragNDrop-4c5f5a6c.js.map
