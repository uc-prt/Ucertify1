...
import { N as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, e as element, p as append_dev, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, a3 as onUserAnsChange, L as beforeUpdate, w as writable, c as create_component, f as space, j as attr_dev, k as add_location, n as insert_dev, m as mount_component, G as prop_dev, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, l as set_style, z as empty, h as text, a6 as toggle_class, q as listen_dev, a7 as HtmlTag } from './main-252585d3.js';
...
function add_css() {
	...
	style.textContent = "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 585, 7, 19949);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 586, 7, 20041);
			...
			add_location(div0, file, 581, 6, 19767);
			...
			add_location(div1, file, 573, 5, 19558);
			...
			add_location(div2, file, 589, 5, 20127);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 572, 4, 19523);
		},
		m: function mount(target, anchor) {
...
// (515:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 533, 10, 18460);
			...
			add_location(div0, file, 542, 10, 18755);
			...
			add_location(span, file, 555, 10, 19119);
			...
			add_location(div1, file, 520, 9, 18077);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 519, 8, 18035);
			attr_dev(td, "class", "border");
			add_location(td, file, 518, 7, 18006);
			add_location(tr, file, 517, 6, 17993);
			add_location(tbody, file, 516, 5, 17978);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 515, 4, 17893);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(515:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 603, 6, 20543);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 512, 2, 17756);
			add_location(center, file, 507, 1, 17656);
			...
			add_location(input, file, 614, 1, 20804);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 621, 1, 20938);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 506, 0, 17647);
		},
...
class HotspotPreview extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-11usv4u-style")) add_css();
...
//# sourceMappingURL=HotspotPreview-97162aab.js.map
