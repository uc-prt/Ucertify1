...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, e as element, p as append_dev, V as Checkbox, C as validate_each_argument, U as Button, O as Dialog, P as binding_callbacks, Q as bind, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, L as beforeUpdate, w as writable, y as l, M as JSONToXML, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, q as listen_dev, G as prop_dev, r as group_outros, a as transition_out, u as check_outros, t as transition_in, x as detach_dev, H as run_all, c as create_component, m as mount_component, Z as add_flush_callback, b as destroy_component, K as destroy_each, B as noop, a4 as null_to_empty, l as set_style, a0 as set_input_value } from './main-1f98a0c0.js';

/* clsSMStepAlgo\StepAlgo.svelte generated by Svelte v3.34.0 */
...
function add_css() {
	...
	style.id = "svelte-122z4mi-style";
	style.textContent = ".font18.svelte-122z4mi{font-size:16px}.fwidth.svelte-122z4mi{width:100%}.light-cyan-bg.svelte-122z4mi{background-color:#d4e4ff;color:#333}.top2.svelte-122z4mi{top:2px}.right5.svelte-122z4mi{right:5px}.right35.svelte-122z4mi{right:35px}.step_checkbox.svelte-122z4mi{width:22%;border:1px solid black;margin-left:10px;position:relative;bottom:1px;cursor:pointer;padding:3px 2px 0}.fixed_ans.svelte-122z4mi{top:10px;position:relative;float:right;border:1px solid #e0e0e0;background-color:#f5f5f5;border-radius:4px;padding:5px;font-size:15px;font-weight:700}.check_box.svelte-122z4mi{right:24px;position:relative;width:40px}.inner_inputs.svelte-122z4mi{margin:0 12px!important}.pointer.svelte-122z4mi{cursor:pointer !important}.width100.svelte-122z4mi{width:100px}[id^=\"fillmain\"]{overflow:hidden;text-align:left}[id^=\"fillmain\"] pre{background:none;border:none;font-size:14px!important}[id^=\"fillmain\"] .string{min-height:50px;margin-top:10px;margin-right:10px}[id^=\"fillmain\"] .footerstr{position:relative;margin-top:10px;background-color:#ccc;padding:15px;min-height:60px}[id^=\"fillmain\"] .footerstr .arrow-up{position:absolute;top:-10px;right:50%;width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-bottom:10px solid #ccc}[id^=\"fillmain\"] .fill-row{padding:6px}[id^=\"fillmain\"] .fillelement, [id^=\"fillmain\"] .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}#fillmain .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}#fillmain input[type=\"text\"]{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}#fillmain select{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}[id^=\"fillmain\"] .drag-resize{vertical-align:middle;border:1px solid #31B731;text-align:center;padding:3px;font-size:14px}[id^=\"fillmain\"] .drag-resize.ui-draggable{cursor:move}[id^=\"fillmain\"] .drop-hover{border:1px dashed red!important;box-shadow:0 0 0 2px yellow inset;outline:1px solid blue}[id^=\"fillmain\"] .fillcheck ul{width:220px}[id^=\"fillmain\"] .fillcheck li.selected{background-color:#E5E5E5}.fillcheck .selected .icomoon-checkmark-3:before{float:left;color:blue;padding:3px;position:relative;right:14px}.fillcheck .icomoon-close-2:before{float:left;color:blue;position:relative;right:14px;font-size:20px}.MathJax_Display{display:inline!important}[id^=\"fillmain\"] .select{font-size:15px}[id^=\"fillmain\"] .textarea{vertical-align:middle;border-radius:3px;background:#ffe;border:1px solid #ccc;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075);box-shadow:inset 0 1px 1px rgba(0,0,0,0.075)}.ui-draggable-disabled{cursor:no-drop!important;opacity:0.5!important}.colorStyle{background-color:#dee2e6!important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
// (486:20) <Checkbox                            id="go_next"                           checked = {state.gonext == 1 ? true: false}                           on:click={(e)=>{goNext("go_next",e)}}                       >
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(486:20) <Checkbox                            id=\\\"go_next\\\"                           checked = {state.gonext == 1 ? true: false}                           on:click={(e)=>{goNext(\\\"go_next\\\",e)}}                       >",
		ctx
	});
...
// (493:20) <Checkbox                            id="fixedans_checkbox"                           checked = {state.fixed == 1 ? true: false}                           on:click={(e)=>{fixedAnswer("fixedans_checkbox",e)}}                       >
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(493:20) <Checkbox                            id=\\\"fixedans_checkbox\\\"                           checked = {state.fixed == 1 ? true: false}                           on:click={(e)=>{fixedAnswer(\\\"fixedans_checkbox\\\",e)}}                       >",
		ctx
	});
...
function create_else_block_2(ctx) {
	...
	function click_handler_3(...args) {
		return /*click_handler_3*/ ctx[22](/*index*/ ctx[41], ...args);
	}

	checkbox = new Checkbox({
			props: {
				"data-seq": /*index*/ ctx[41],
				class: "inner_inputs option_checkbox",
				type: "checkbox",
				value: "mode",
				name: "mode_checkbox_",
				id: `mode_checkbox_${/*index*/ ctx[41]}`,
				checked: false
			},
			$$inline: true
		});
...
// (535:32) {#if item._mode == "1"}
function create_if_block_3(ctx) {
	let checkbox;
	let current;

	function click_handler_2(...args) {
		return /*click_handler_2*/ ctx[21](/*index*/ ctx[41], ...args);
	}
...
function create_if_block_1(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (/*item*/ ctx[39]._sticky == "1") return 0;
		return 1;
	}
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 546, 32, 21585);
			attr_dev(label, "class", "font-weight-normal me-1 position-relative top2 right35 svelte-122z4mi");
			attr_dev(label, "for", label_for_value = `sticky_checkbox_${/*index*/ ctx[41]}`);
			add_location(label, file, 553, 32, 22412);
			attr_dev(div, "class", "stick_checkbox d-inline-block");
			add_location(div, file, 545, 28, 21508);
		},
		m: function mount(target, anchor) {
...
function create_else_block_1(ctx) {
	...
	checkbox = new Checkbox({
			props: {
				...
				id: `sticky_checkbox_${/*index*/ ctx[41]}`
			},
			$$inline: true
		});

	checkbox.$on("click", /*handleChangeCheckbox*/ ctx[4].bind(this, /*index*/ ctx[41], "fillAuthor_" + /*index*/ ctx[41]));
...
function create_if_block_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(548:36) {#if item._sticky == \\\"1\\\"}",
		ctx
	});
...
// (502:12) {#each all_steps as item,index}
function create_each_block(ctx) {
	let fieldset;
	let legend;
	let t0_value = /*index*/ ctx[41] + 1 + "";
	let t0;
	let legend_style_value;
	let t1;
	let div1;
	let div0;
	let raw_value = /*item*/ ctx[39].__cdata + "";
	...
	function keyup_handler(...args) {
		return /*keyup_handler*/ ctx[19](/*index*/ ctx[41], ...args);
	}

	function change_handler(...args) {
		return /*change_handler*/ ctx[20](/*index*/ ctx[41], ...args);
	}
	...
	function select_block_type(ctx, dirty) {
		if (/*item*/ ctx[39]._mode == "1") return 0;
		return 1;
	}

	current_block_type_index = select_block_type(ctx);
	if_block0 = if_blocks[current_block_type_index] = if_block_creators[current_block_type_index](ctx);
	let if_block1 = /*index*/ ctx[41] == 0 && create_if_block_1(ctx);

	function click_handler_4(...args) {
		return /*click_handler_4*/ ctx[23](/*index*/ ctx[41], ...args);
	}

	function click_handler_5(...args) {
		return /*click_handler_5*/ ctx[24](/*index*/ ctx[41], ...args);
	}
	...
	const block = {
		c: function create() {
			...
			add_location(legend, file, 503, 20, 18355);
			attr_dev(div0, "data-seq", div0_data_seq_value = /*index*/ ctx[41]);
			attr_dev(div0, "class", "tinymce-editor-res steps_edit p-1 border fillAuthor");
			attr_dev(div0, "id", div0_id_value = `fillAuthor_${/*index*/ ctx[41]}`);
			...
			add_location(fieldset, file, 502, 16, 18233);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			ctx = new_ctx;
			if ((!current || dirty[0] & /*all_steps*/ 2) && raw_value !== (raw_value = /*item*/ ctx[39].__cdata + "")) div0.innerHTML = raw_value;
			if (!current || dirty[0] & /*all_steps*/ 2 && input_checked_value !== (input_checked_value = /*item*/ ctx[39].toggle == "1" ? false : true)) {
			...
			if (/*index*/ ctx[41] == 0) if_block1.p(ctx, dirty);
		},
		i: function intro(local) {
			if (current) return;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(502:12) {#each all_steps as item,index}",
		ctx
	});
...
// (571:12) <Button variant="fab" color="primary" mini aria-label="Add"                  on:click={addEvent.bind(this, 'steps')}                  class="btn btn-outline-primary rounded position-relative bottom0 bg-white shadow-sm height30"                  style={'float:left;width:120px;height:30px;border:1px solid #4285f4;color:#4285f4;text-transform:none;'}>
function create_default_slot_6(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 574, 16, 23875);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(571:12) <Button variant=\\\"fab\\\" color=\\\"primary\\\" mini aria-label=\\\"Add\\\"                  on:click={addEvent.bind(this, 'steps')}                  class=\\\"btn btn-outline-primary rounded position-relative bottom0 bg-white shadow-sm height30\\\"                  style={'float:left;width:120px;height:30px;border:1px solid #4285f4;color:#4285f4;text-transform:none;'}>",
		ctx
	});
...
// (592:16) {#if state.fillInTheBlanksChoice == 1}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 594, 28, 25259);
			attr_dev(input, "type", "text");
			...
			add_location(input, file, 597, 28, 25455);
			attr_dev(div1, "class", "d-flex mr-2");
			add_location(div1, file, 593, 24, 25204);
			attr_dev(div2, "class", "text-danger font-weight-bold ml-2 mt-3");
			add_location(div2, file, 607, 24, 25995);
			attr_dev(div3, "class", "text-danger ml-2");
			attr_dev(div3, "style", div3_style_value = "text-indent:15px");
			add_location(div3, file, 608, 24, 26092);
			attr_dev(div4, "class", "text-danger ml-2");
			attr_dev(div4, "style", div4_style_value = "text-indent:15px");
			add_location(div4, file, 609, 24, 26200);
			add_location(div5, file, 592, 20, 25173);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div5, anchor);
			append_dev(div5, div1);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(592:16) {#if state.fillInTheBlanksChoice == 1}",
		ctx
	});
...
// (623:28) <Button                                   variant = "contained"                                   color = "primary"                                  style = {'border:1px solid #4285f4;color:#4285f4;text-transform:none;'}                                   on:click = {addEditable}                                  class="btn btn-outline-primary height30 bg-white shadow-sm mt-1 top1 ml-1"                              >
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(623:28) <Button                                   variant = \\\"contained\\\"                                   color = \\\"primary\\\"                                  style = {'border:1px solid #4285f4;color:#4285f4;text-transform:none;'}                                   on:click = {addEditable}                                  class=\\\"btn btn-outline-primary height30 bg-white shadow-sm mt-1 top1 ml-1\\\"                              >",
		ctx
	});
...
// (633:32) <Button                                       id = {"latexEdit"}                                      variant = "contained"                                       color = "primary"                                      style = {'margin:5px;display:none;'}                                       on:click = {latexEdit}                                                                     >
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(633:32) <Button                                       id = {\\\"latexEdit\\\"}                                      variant = \\\"contained\\\"                                       color = \\\"primary\\\"                                      style = {'margin:5px;display:none;'}                                       on:click = {latexEdit}                                                                     >",
		ctx
	});
...
// (596:32) <Checkbox  id = "numeric" checked = {state.numeric}>
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(596:32) <Checkbox  id = \\\"numeric\\\" checked = {state.numeric}>",
		ctx
	});
...
// (651:16) <Button variant="contained" on:click={handleClose} class="colorStyle" >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(651:16) <Button variant=\\\"contained\\\" on:click={handleClose} class=\\\"colorStyle\\\" >",
		ctx
	});
...
// (654:16) <Button variant="contained" on:click={storeAns}                      class="bg-primary text-white">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(654:16) <Button variant=\\\"contained\\\" on:click={storeAns}                      class=\\\"bg-primary text-white\\\">",
		ctx
	});
...
// (578:8) <Dialog class="remove_right_margin" width="560" overlayClass="materialOverlay"  bind:visible={state.open} on:close={handleClose.bind(this)} disableEnforceFocus={true} style="background-color:#fff; border-radius: 5px;">
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 580, 20, 24313);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 579, 16, 24247);
			attr_dev(button0, "type", "button");
			...
			add_location(button0, file, 584, 24, 24510);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 585, 24, 24711);
			attr_dev(div2, "class", "btn-group mt-2 col-md-12 pl-1");
			add_location(div2, file, 583, 20, 24441);
			attr_dev(div3, "class", "left10 position-relative");
			add_location(div3, file, 582, 16, 24381);
			attr_dev(h4, "class", "mt-0 font21");
			add_location(h4, file, 578, 12, 24205);
			...
			add_location(div4, file, 590, 12, 25011);
			attr_dev(div5, "class", "svelteFooter");
			add_location(div5, file, 649, 12, 28501);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(578:8) <Dialog class=\\\"remove_right_margin\\\" width=\\\"560\\\" overlayClass=\\\"materialOverlay\\\"  bind:visible={state.open} on:close={handleClose.bind(this)} disableEnforceFocus={true} style=\\\"background-color:#fff; border-radius: 5px;\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	function dialog_visible_binding(value) {
		/*dialog_visible_binding*/ ctx[27](value);
	}
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*state*/ 1 | dirty[1] & /*$$scope*/ 2048) {
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<StepAlgo> was created with unknown prop '${key}'`);
	});
...
class StepAlgo extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-122z4mi-style")) add_css();
...
/* clsSMMixedItem\ItemPlugin.svelte generated by Svelte v3.34.0 */
...
//# sourceMappingURL=ItemPlugin-a2a44cd6.js.map
