...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 649, 7, 21691);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 650, 7, 21783);
			...
			add_location(div0, file, 645, 6, 21509);
			...
			add_location(div1, file, 637, 5, 21300);
			...
			add_location(div2, file, 653, 5, 21869);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 636, 4, 21265);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 597, 10, 20202);
			...
			add_location(div0, file, 606, 10, 20497);
			...
			add_location(span, file, 619, 10, 20861);
			...
			add_location(div1, file, 584, 9, 19819);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 583, 8, 19777);
			attr_dev(td, "class", "border");
			add_location(td, file, 582, 7, 19748);
			add_location(tr, file, 581, 6, 19735);
			add_location(tbody, file, 580, 5, 19720);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table no_overflow_wrapper");
			add_location(table, file, 579, 4, 19615);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 667, 6, 22285);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 576, 2, 19478);
			add_location(center, file, 561, 1, 18921);
			...
			add_location(input, file, 678, 1, 22545);
			attr_dev(main, "class", "pt-1 svelte-11usv4u");
			add_location(main, file, 560, 0, 18899);
		},
...
//# sourceMappingURL=HotspotPreview-2dbd442b.js.map
