...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 580, 24, 28309);
			...
			add_location(span1, file, 597, 28, 29730);
			...
			add_location(button0, file, 589, 24, 29308);
			...
			add_location(span2, file, 608, 28, 30560);
			...
			add_location(button1, file, 599, 24, 30089);
			...
			add_location(span3, file, 623, 28, 31508);
			...
			add_location(button2, file, 610, 24, 30805);
			...
			add_location(div6, file, 588, 20, 29142);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 577, 16, 28004);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 576, 12, 27945);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 572, 62, 27562);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 572, 25, 27525);
			add_location(div0, file, 572, 20, 27520);
			...
			add_location(textarea, file, 573, 20, 27621);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 571, 16, 27473);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h4, file, 636, 20, 32064);
			attr_dev(button0, "type", "button");
			...
			add_location(button0, file, 637, 20, 32193);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 635, 16, 32016);
			...
			add_location(div3, file, 639, 16, 32417);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 643, 20, 32684);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-75d45896.js.map
