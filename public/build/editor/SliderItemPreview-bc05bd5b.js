...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 238, 8, 10224);
			attr_dev(div, "class", "alert alert-danger font-weight-bold");
			add_location(div, file, 237, 4, 10166);
		},
...
// (270:24) {#if (targetView == "block" && user_ans_tab == true)}
function create_if_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(270:24) {#if (targetView == \\\"block\\\" && user_ans_tab == true)}",
		ctx
	});
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 276, 36, 12339);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 275, 32, 12242);
		},
		m: function mount(target, anchor) {
...
// (271:28) {#if data.anskey == state.datauserans[data.sliderid]}
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 272, 36, 12046);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 271, 32, 11949);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span1, anchor);
			append_dev(span1, span0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(271:28) {#if data.anskey == state.datauserans[data.sliderid]}",
		ctx
	});
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 289, 40, 13325);
		},
		m: function mount(target, anchor) {
...
// (287:36) {#if !(targetView == "block" && user_ans_tab == false)}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 287, 40, 13061);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span, anchor);
			append_dev(span, t0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(287:36) {#if !(targetView == \\\"block\\\" && user_ans_tab == false)}",
		ctx
	});
...
// (251:12) {#each localSliderData as data, i}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(251:12) {#each localSliderData as data, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div1, file, 248, 4, 10473);
			attr_dev(div2, "class", "text-center");
			add_location(div2, file, 241, 0, 10268);
		},
...
//# sourceMappingURL=SliderItemPreview-bc05bd5b.js.map
