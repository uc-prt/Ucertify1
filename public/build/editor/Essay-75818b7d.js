...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, W as Checkbox, Q as binding_callbacks, R as bind, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, L as beforeUpdate, e as element, h as text, f as space, j as attr_dev, k as add_location, a1 as add_render_callback, n as insert_dev, p as append_dev, a3 as select_option, a2 as set_input_value, q as listen_dev, F as set_data_dev, af as to_number, x as detach_dev, H as run_all, c as create_component, m as mount_component, $ as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component, a0 as select_value } from './main-6ecf8099.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 159, 12, 6427);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label0, file, 165, 24, 6650);
			attr_dev(div0, "class", "col-sm-3");
			add_location(div0, file, 164, 20, 6602);
			option0.__value = "*.txt,*.doc,*.docx,*.pdf,*.jpg,*.png,*.gif,*.bmp,*.jpeg";
			option0.value = option0.__value;
			option0.selected = "selected";
			add_location(option0, file, 169, 28, 7000);
			option1.__value = "*.txt";
			option1.value = option1.__value;
			add_location(option1, file, 170, 28, 7139);
			option2.__value = "*.pdf";
			option2.value = option2.__value;
			add_location(option2, file, 171, 28, 7205);
			option3.__value = "*.doc,*.docx";
			option3.value = option3.__value;
			add_location(option3, file, 172, 28, 7271);
			option4.__value = "*.doc,*.docx,*.pdf";
			option4.value = option4.__value;
			add_location(option4, file, 173, 28, 7351);
			option5.__value = "*.jpg,*.png,*.gif,*.bmp,*.jpeg";
			option5.value = option5.__value;
			add_location(option5, file, 174, 28, 7443);
			...
			add_location(select, file, 168, 24, 6831);
			attr_dev(div1, "class", "col-sm-8");
			add_location(div1, file, 167, 20, 6783);
			attr_dev(div2, "class", "row");
			add_location(div2, file, 163, 16, 6563);
			attr_dev(label1, "for", "files_number");
			attr_dev(label1, "class", "mb-0 font14 pt-1");
			add_location(label1, file, 180, 24, 7726);
			attr_dev(div3, "class", "col-sm-3");
			add_location(div3, file, 179, 20, 7678);
			...
			add_location(input, file, 183, 24, 7903);
			attr_dev(small, "class", "font11");
			add_location(small, file, 195, 24, 8479);
			attr_dev(div4, "class", "col-sm-8");
			add_location(div4, file, 182, 20, 7855);
			attr_dev(div5, "class", "row mt-2");
			add_location(div5, file, 178, 16, 7634);
			attr_dev(div6, "class", "upload-area mt-3 text-left svelte-j2f4ig");
			add_location(div6, file, 162, 12, 6505);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=Essay-75818b7d.js.map
