...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, y as language, e as element, f as space, h as text, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, Y as select_option, q as listen_dev, G as prop_dev, B as noop, x as detach_dev, H as run_all } from './main-6ec656b8.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b0, file, 400, 12, 19767);
			attr_dev(div0, "class", "col-12");
			attr_dev(div0, "tabindex", "0");
			attr_dev(div0, "aria-label", "Recording will end after 15 sec");
			add_location(div0, file, 399, 8, 19675);
			add_location(b1, file, 404, 30, 19935);
			attr_dev(div1, "class", "pb-2");
			add_location(div1, file, 404, 12, 19917);
			...
			add_location(select, file, 411, 12, 20436);
			...
			add_location(span0, file, 444, 20, 22592);
			...
			add_location(img0, file, 446, 24, 22892);
			...
			add_location(div8, file, 445, 20, 22770);
			...
			add_location(img1, file, 449, 24, 23215);
			...
			add_location(span1, file, 461, 24, 23868);
			...
			add_location(button0, file, 453, 20, 23498);
			...
			add_location(span2, file, 472, 24, 24550);
			...
			add_location(button1, file, 463, 20, 24135);
			...
			add_location(span3, file, 485, 24, 25296);
			...
			add_location(button3, file, 498, 20, 25954);
			attr_dev(div16, "class", "modal-header");
			add_location(div16, file, 496, 16, 25777);
			...
			add_location(div17, file, 500, 16, 26157);
			...
			add_location(button4, file, 504, 20, 26403);
...
//# sourceMappingURL=AudioRecorder-a7df4a2e.js.map
