...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 587, 7, 20010);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 588, 7, 20102);
			...
			add_location(div0, file, 583, 6, 19828);
			...
			add_location(div1, file, 575, 5, 19619);
			...
			add_location(div2, file, 591, 5, 20188);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 574, 4, 19584);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 535, 10, 18521);
			...
			add_location(div0, file, 544, 10, 18816);
			...
			add_location(span, file, 557, 10, 19180);
			...
			add_location(div1, file, 522, 9, 18138);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 521, 8, 18096);
			attr_dev(td, "class", "border");
			add_location(td, file, 520, 7, 18067);
			add_location(tr, file, 519, 6, 18054);
			add_location(tbody, file, 518, 5, 18039);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 517, 4, 17954);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 605, 6, 20604);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 514, 2, 17817);
			add_location(center, file, 509, 1, 17717);
			...
			add_location(input, file, 616, 1, 20865);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 508, 0, 17708);
		},
...
//# sourceMappingURL=HotspotPreview-fcce994e.js.map
