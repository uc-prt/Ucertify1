...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, J as append_styles, v as validate_slots, o as onMount, I as beforeUpdate, A as AH, ak as editorConfig, aa as afterUpdate, a1 as tick, w as writable, e as element, j as attr_dev, k as add_location, n as insert_dev, aj as action_destroyer, B as noop, x as detach_dev, C as validate_each_argument, al as validate_each_keys, z as empty, f as space, l as set_style, p as append_dev, q as listen_dev, G as run_all, am as update_keyed_each, an as destroy_block, D as is_function, a6 as HtmlTag } from './main-0651ad56.js';
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 398, 12, 13893);
			html_tag_1.a = t2;
			add_location(br, file, 407, 12, 14290);
			attr_dev(textarea, "id", "message");
			attr_dev(textarea, "rows", textarea_rows_value = 10);
			attr_dev(textarea, "cols", textarea_cols_value = 90);
			attr_dev(textarea, "placeholder", "Message");
			textarea.value = "\t\r\n            ";
			add_location(textarea, file, 408, 12, 14309);
			add_location(div1, file, 396, 8, 13833);
		},
...
// (380:4) {#if editorState.content_type == 'p'}
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(380:4) {#if editorState.content_type == 'p'}",
		ctx
	});
...
// (382:3) {#if item.view.includes(editorState.item)}
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 384, 5, 13456);
			attr_dev(div1, "key", div1_key_value = /*item*/ ctx[16].id);
			add_location(div1, file, 382, 4, 13395);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(382:3) {#if item.view.includes(editorState.item)}",
		ctx
	});
...
// (381:2) {#each webData as item, i (item.id)}
function create_each_block(key_1, ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(381:2) {#each webData as item, i (item.id)}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 378, 0, 13206);
		},
...
//# sourceMappingURL=WebPages-def659b3.js.map
