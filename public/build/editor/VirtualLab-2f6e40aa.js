...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, j as attr_dev, l as set_style, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, B as noop, x as detach_dev } from './main-ad414885.js';

/* clsSMVirtualLab/VirtualLab.svelte generated by Svelte v3.29.0 */
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 14, 2, 279);
			attr_dev(div, "id", "VirtualLab");
			add_location(div, file, 13, 1, 255);
			add_location(center, file, 12, 0, 245);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<VirtualLab> was created with unknown prop '${key}'`);
	});
...
//# sourceMappingURL=VirtualLab-2f6e40aa.js.map
