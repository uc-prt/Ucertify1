...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, y as language, O as Dialog, P as binding_callbacks, Q as bind, U as Button, v as validate_slots, o as onMount, A as AH, L as beforeUpdate, Z as tick, af as tag_player, R as Snackbar, w as writable, aa as Loader, e as element, h as text, f as space, j as attr_dev, l as set_style, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, F as set_data_dev, x as detach_dev, B as noop, H as run_all, c as create_component, m as mount_component, W as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component, Y as select_option, r as group_outros, u as check_outros, G as prop_dev, C as validate_each_argument, E as is_function, K as destroy_each } from './main-cb674ba0.js';
import './style-inject.es-1c867377.js';
import './codemirror.min-41ad232c.js';
import './simplescrollbars-c1002091.js';

/* clsSMEval\Eval.svelte generated by Svelte v3.29.0 */
...
// (1394:40) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == "psql")}
function create_if_block_3(ctx) {
	let button;
	let t0_value = /*state*/ ctx[2].database + "";
	let t0;
	let t1;
	let span;
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1401, 48, 60363);
			attr_dev(button, "type", "button");
			attr_dev(button, "tabindex", button_tabindex_value = language.zero);
			attr_dev(button, "class", "btn btn-md btn-light mr px-2 pt-1 database_select_button font14");
			add_location(button, file, 1394, 44, 59853);
		},
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*state*/ 4 && t0_value !== (t0_value = /*state*/ ctx[2].database + "")) set_data_dev(t0, t0_value);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1394:40) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == \\\"psql\\\")}",
		ctx
	});
...
// (1422:40) {#if (state.lang_type =='sql' || state.lang_type == 'mssql' || state.lang_type == "psql")}
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			button = element("button");
			button.textContent = `${language.resetDB}`;
			attr_dev(button, "type", "button");
			attr_dev(button, "class", "btn btn-light mr px-2 font14");
			add_location(button, file, 1422, 44, 61925);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1422:40) {#if (state.lang_type =='sql' || state.lang_type == 'mssql' || state.lang_type == \\\"psql\\\")}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option0, file, 1522, 44, 69039);
			option1.__value = "raw";
			option1.value = option1.__value;
			add_location(option1, file, 1523, 44, 69139);
			attr_dev(select, "id", "raw_btn");
			attr_dev(select, "class", "form-control secure-icon d-inline-block mr pull-right font14");
			attr_dev(select, "name", "raw_btn");
			set_style(select, "height", "34px");
			set_style(select, "width", "90px");
			add_location(select, file, 1514, 40, 68485);
		},
		m: function mount(target, anchor) {
...
// (1549:8) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == "psql")}
function create_if_block(ctx) {
	...
	let dialog_props = {
		...
		class: "dialog evalpro_dialog",
		$$slots: { default: [create_default_slot_5] },
		$$scope: { ctx }
	};

	if (/*state*/ ctx[2].database_modal_open !== void 0) {
		dialog_props.visible = /*state*/ ctx[2].database_modal_open;
	}
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*state*/ 4 | dirty[2] & /*$$scope*/ 1048576) {
				dialog_changes.$$scope = { dirty, ctx };
			}

			if (!updating_visible && dirty[0] & /*state*/ 4) {
				updating_visible = true;
				dialog_changes.visible = /*state*/ ctx[2].database_modal_open;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1549:8) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == \\\"psql\\\")}",
		ctx
	});
...
// (1555:20) {#each state.databases as database}
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1555, 24, 71234);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty[0] & /*state*/ 4 && t0_value !== (t0_value = /*database*/ ctx[79] + "")) set_data_dev(t0, t0_value);

			if (dirty[0] & /*state*/ 4 && div_key_value !== (div_key_value = /*database*/ ctx[79])) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1555:20) {#each state.databases as database}",
		ctx
	});
...
// (1550:12) <Dialog bind:visible={state.database_modal_open} width={225} aria-labelledby="simple-dialog-title" style="background-color:#fff;" class="dialog evalpro_dialog">
function create_default_slot_5(ctx) {
	...
	let mounted;
	let dispose;
	let each_value_1 = /*state*/ ctx[2].databases;
	...
	const block = {
		c: function create() {
			...
			set_style(span, "left", "20px");
			set_style(span, "top", "-12px");
			set_style(span, "font-size", "20px");
			set_style(span, "cursor", "pointer");
			add_location(span, file, 1551, 56, 70915);
			attr_dev(div0, "class", "font20");
			add_location(div0, file, 1551, 20, 70879);
			set_style(div1, "text-align", "left");
			set_style(div1, "width", "225px");
			set_style(div1, "margin-left", "17px");
			add_location(div1, file, 1550, 16, 70794);
			set_style(div2, "position", "relative");
			set_style(div2, "top", "14px");
			add_location(div2, file, 1553, 16, 71106);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*state, handleDatabaseItem*/ 516) {
				each_value_1 = /*state*/ ctx[2].databases;
				validate_each_argument(each_value_1);
				let i;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1550:12) <Dialog bind:visible={state.database_modal_open} width={225} aria-labelledby=\\\"simple-dialog-title\\\" style=\\\"background-color:#fff;\\\" class=\\\"dialog evalpro_dialog\\\">",
		ctx
	});
...
// (1568:16) {#each lang_type as lang}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (img.src !== (img_src_value = window.itemUrl + "images/" + (/*lang*/ ctx[76] == "c#" ? "csharp" : /*lang*/ ctx[76]) + "_lang.png")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Language");
			add_location(img, file, 1570, 28, 72484);
			...
			add_location(div0, file, 1569, 24, 72342);
			attr_dev(div1, "class", "pl-1 d-inline-block");
			set_style(div1, "padding", "15px");
			add_location(div1, file, 1572, 24, 72686);
			...
			add_location(div2, file, 1568, 20, 72139);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1568:16) {#each lang_type as lang}",
		ctx
	});
...
// (1563:8) <Dialog bind:visible={state.open} width={225} style="background-color:#fff;" class="dialog evalpro_dialog">
function create_default_slot_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(span, "font-size", "20px");
			set_style(span, "cursor", "pointer");
			add_location(span, file, 1564, 52, 71847);
			attr_dev(div0, "class", "font20");
			add_location(div0, file, 1564, 16, 71811);
			set_style(div1, "text-align", "left");
			set_style(div1, "width", "225px");
			set_style(div1, "margin-left", "17px");
			add_location(div1, file, 1563, 12, 71729);
			set_style(div2, "position", "relative");
			set_style(div2, "top", "14px");
			add_location(div2, file, 1566, 12, 72030);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1563:8) <Dialog bind:visible={state.open} width={225} style=\\\"background-color:#fff;\\\" class=\\\"dialog evalpro_dialog\\\">",
		ctx
	});
...
// (1637:28) <Button                                   color="primary"                                   unelevated="true"                                  on:click={addMore}                                   aria-label="Add"                                   style="height: 40px; width: 40px; border-radius: 50%"                              >
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(spna, file, 1643, 32, 78158);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1637:28) <Button                                   color=\\\"primary\\\"                                   unelevated=\\\"true\\\"                                  on:click={addMore}                                   aria-label=\\\"Add\\\"                                   style=\\\"height: 40px; width: 40px; border-radius: 50%\\\"                              >",
		ctx
	});
...
// (1667:8) <Snackbar              bind:visible={state.snackback}               bg="#333"               bottom={true}                timeout={3000}               style="position:fixed; bottom:50px"          >
function create_default_slot_2(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*message*/ 1) set_data_dev(t, /*message*/ ctx[0]);
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1667:8) <Snackbar              bind:visible={state.snackback}               bg=\\\"#333\\\"               bottom={true}                timeout={3000}               style=\\\"position:fixed; bottom:50px\\\"          >",
		ctx
	});
...
// (1677:12) <Button                  raised={true}                  on:click = {()=>{ state.remediationToggle = false}}                  class="bg-light"              >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1677:12) <Button                  raised={true}                  on:click = {()=>{ state.remediationToggle = false}}                  class=\\\"bg-light\\\"              >",
		ctx
	});
...
// (1676:8) <div slot="footer" class="svelteFooter">
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1675, 8, 79488);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1676:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\">",
		ctx
	});
...
// (1657:4) <Dialog bind:visible={state.remediationToggle} width={960} class="dialog bg-white">
function create_default_slot(ctx) {
	...
	let t2;
	let h4;
	let t3_value = language.calculate_answer + "";
	let t3;
	let br;
	...
	function snackbar_visible_binding(value) {
		/*snackbar_visible_binding*/ ctx[28].call(null, value);
	}
	...
	const block = {
		c: function create() {
			div1 = element("div");
			div0 = element("div");
			div0.textContent = `${language.remediation}`;
			t1 = space();
			div2 = element("div");
			...
			t6 = space();
			attr_dev(div0, "class", "font20");
			add_location(div0, file, 1658, 12, 78936);
			set_style(div1, "text-align", "left");
			add_location(div1, file, 1657, 8, 78891);
			add_location(br, file, 1663, 40, 79164);
			add_location(h4, file, 1663, 16, 79140);
			attr_dev(center, "class", "mt-xl");
			add_location(center, file, 1661, 12, 79044);
			attr_dev(div2, "id", "remediationModel");
			add_location(div2, file, 1660, 8, 79003);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*message*/ 1 | dirty[2] & /*$$scope*/ 1048576) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1657:4) <Dialog bind:visible={state.remediationToggle} width={960} class=\\\"dialog bg-white\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	let t0_value = (/*state*/ ctx[2].lang_type == "php"
	? "PHP"
	: toTitleCase(/*state*/ ctx[2].lang_type)) + "";
	...
	let t4_value = (/*state*/ ctx[2].lang_type == "php"
	? "PHP"
	: toTitleCase(/*state*/ ctx[2].lang_type)) + "";
	...
	let div1;
	let button1;
	let t6_value = language.add_testcase + "";
	let t6;
	...
	let i;
	let t9;
	let t10_value = language.run.toUpperCase() + "";
	let t10;
	...
	let t13;
	let button3;
	let t14_value = (/*state*/ ctx[2].preBlockShow ? "Hide" : "Show") + "";
	let t14;
	...
	let div5;
	let label0;
	let t19_value = language.enableline + "";
	let t19;
	let t20;
	...
	let t25;
	let button4;
	let t26_value = (/*state*/ ctx[2].postBlockShow ? "Hide" : "Show") + "";
	let t26;
	let t27;
	let div9;
	let textarea2;
	...
	let t48;
	let label1;
	let t49_value = language.is_graph + "";
	let t49;
	let t50;
	let input2;
	...
	let t52;
	let label2;
	let t53_value = language.ignore_error + "";
	let t53;
	let t54;
	let input3;
	...
	let t56;
	let label3;
	let t57_value = language.ignore_formatting + "";
	let t57;
	let t58;
	let input4;
	...
	let t60;
	let label4;
	let t61_value = language.ignore_reset_db + "";
	let t61;
	let t62;
	let input5;
	...
	let t64;
	let label5;
	let t65_value = language.pre_tag + "";
	let t65;
	let t66;
	let input6;
	...
	let h51;
	let span13;
	let t69_value = language.select_case_match + "";
	let t69;
	...
	let mounted;
	let dispose;
	let if_block0 = (/*state*/ ctx[2].lang_type == "sql" || /*state*/ ctx[2].lang_type == "mssql" || /*state*/ ctx[2].lang_type == "psql") && create_if_block_3(ctx);
	let if_block1 = (/*state*/ ctx[2].lang_type == "sql" || /*state*/ ctx[2].lang_type == "mssql" || /*state*/ ctx[2].lang_type == "psql") && create_if_block_2(ctx);
	let if_block2 = !/*isPreview*/ ctx[1] && create_if_block_1(ctx);
	let if_block3 = (/*state*/ ctx[2].lang_type == "sql" || /*state*/ ctx[2].lang_type == "mssql" || /*state*/ ctx[2].lang_type == "psql") && create_if_block(ctx);

	function dialog0_visible_binding(value) {
		/*dialog0_visible_binding*/ ctx[27].call(null, value);
	}
	...
	function dialog1_visible_binding(value) {
		/*dialog1_visible_binding*/ ctx[30].call(null, value);
	}
	...
	if (/*state*/ ctx[2].remediationToggle !== void 0) {
		dialog1_props.visible = /*state*/ ctx[2].remediationToggle;
	}
	...
	const block = {
		c: function create() {
			...
			div16 = element("div");
			div14 = element("div");
			div14.textContent = `${language.input}`;
			t30 = space();
			div15 = element("div");
			...
			div20 = element("div");
			a = element("a");
			a.textContent = `${language.testcases}`;
			t37 = space();
			div21 = element("div");
			t38 = space();
			...
			t41 = space();
			h4 = element("h4");
			h4.textContent = `${language.add_testcase}`;
			t43 = space();
			...
			h50 = element("h5");
			lable = element("lable");
			lable.textContent = `${language.setting}:`;
			t48 = space();
			...
			select = element("select");
			option0 = element("option");
			option0.textContent = `${language.case_insensitive}`;
			option1 = element("option");
			option1.textContent = `${language.partial_matching}`;
			option2 = element("option");
			option2.textContent = `${language.special_char}`;
			t74 = space();
			...
			button7.textContent = `${language.submit}`;
			t80 = space();
			button8 = element("button");
			button8.textContent = `${language.cancel}`;
			t82 = space();
			...
			add_location(span0, file, 1391, 44, 59542);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "tabindex", button0_tabindex_value = language.zero);
			attr_dev(button0, "class", "btn btn-md btn-light mr px-2 pt-1 language_select_button font14");
			add_location(button0, file, 1384, 40, 59007);
			attr_dev(span1, "class", "d-inline-block pt-2 pl-2 selected_language  h-imp font14");
			add_location(span1, file, 1404, 40, 60600);
			attr_dev(div0, "class", "float-left");
			set_style(div0, "margin", "-9px -14px 0 -17px");
			add_location(div0, file, 1383, 36, 58906);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "tabindex", button1_tabindex_value = language.zero);
			...
			add_location(button1, file, 1409, 40, 61018);
			attr_dev(i, "class", "fa fa-play");
			add_location(i, file, 1433, 44, 62683);
			attr_dev(button2, "type", "button");
			attr_dev(button2, "tabindex", button2_tabindex_value = language.zero);
			...
			add_location(button2, file, 1424, 40, 62112);
			attr_dev(div1, "class", "float-right");
			set_style(div1, "margin", "-9px -14px 0 4px");
			add_location(div1, file, 1408, 36, 60917);
			attr_dev(div2, "class", "card-header editor-heading pt-md");
			set_style(div2, "height", "44px");
			add_location(div2, file, 1382, 32, 58801);
			add_location(span2, file, 1444, 40, 63442);
			attr_dev(button3, "type", "button");
			attr_dev(button3, "tabindex", button3_tabindex_value = language.zero);
			...
			add_location(button3, file, 1445, 40, 63500);
			...
			add_location(div3, file, 1443, 36, 63280);
			attr_dev(textarea0, "id", "pre-editor");
			attr_dev(textarea0, "class", "h");
			attr_dev(textarea0, "placeholder", textarea0_placeholder_value = language.pre_code);
			attr_dev(textarea0, "name", "pre-editor");
			add_location(textarea0, file, 1457, 40, 64318);
			attr_dev(div4, "class", div4_class_value = "" + ((/*state*/ ctx[2].preBlockShow ? "" : "h-imp") + " pre-div"));
			add_location(div4, file, 1456, 36, 64219);
			attr_dev(span3, "class", "d-inline span4");
			add_location(span3, file, 1460, 40, 64672);
			attr_dev(label0, "tabindex", label0_tabindex_value = language.zero);
			attr_dev(label0, "class", "d-inline-block");
			attr_dev(label0, "for", "enable-line");
			add_location(label0, file, 1462, 44, 64826);
			attr_dev(input0, "type", "text");
			attr_dev(input0, "placeholder", input0_placeholder_value = language.separate_by_quote);
			...
			add_location(input0, file, 1463, 44, 64961);
			attr_dev(div5, "class", "pull-right");
			add_location(div5, file, 1461, 40, 64756);
			...
			add_location(div6, file, 1459, 36, 64494);
			attr_dev(textarea1, "id", "repl-editor");
			attr_dev(textarea1, "class", "h");
			attr_dev(textarea1, "placeholder", textarea1_placeholder_value = language.write_function_here);
			attr_dev(textarea1, "name", "repl-editor");
			add_location(textarea1, file, 1473, 40, 65606);
			attr_dev(div7, "class", "replEditor");
			add_location(div7, file, 1472, 36, 65540);
			add_location(span4, file, 1476, 40, 65956);
			...
			add_location(button4, file, 1477, 40, 66015);
			...
			add_location(div8, file, 1475, 36, 65794);
			attr_dev(textarea2, "id", "post-editor");
			attr_dev(textarea2, "class", "h");
			attr_dev(textarea2, "placeholder", textarea2_placeholder_value = language.postcode);
			attr_dev(textarea2, "name", "post-editor");
			add_location(textarea2, file, 1488, 40, 66774);
			attr_dev(div9, "class", div9_class_value = "post-div " + (/*state*/ ctx[2].postBlockShow ? "" : "h-imp"));
			add_location(div9, file, 1487, 36, 66672);
			...
			add_location(div10, file, 1439, 32, 62982);
			...
			add_location(textarea3, file, 1501, 36, 67547);
			attr_dev(div15, "id", "input");
			attr_dev(div15, "class", "card-body p-0");
			add_location(div15, file, 1500, 32, 67471);
			attr_dev(div16, "class", "card card-default m-b");
			add_location(div16, file, 1496, 28, 67229);
			attr_dev(span5, "class", "pt-2 d-inline-block font14");
			attr_dev(span5, "tabindex", span5_tabindex_value = language.zero);
			add_location(span5, file, 1512, 36, 68310);
			attr_dev(div17, "class", "card-header pr-0 pt-1");
			set_style(div17, "height", "44px");
			add_location(div17, file, 1511, 32, 68215);
			add_location(span6, file, 1533, 36, 69718);
			attr_dev(div18, "id", "output");
			attr_dev(div18, "tabindex", div18_tabindex_value = language.zero);
			...
			add_location(div21, file, 1540, 32, 70202);
			attr_dev(div22, "class", "card card-default");
			attr_dev(div22, "id", "test_card");
			set_style(div22, "display", "none");
			add_location(div22, file, 1536, 28, 69837);
			add_location(div23, file, 1495, 24, 67194);
			...
			add_location(div24, file, 1494, 20, 67069);
			attr_dev(div25, "class", "clearboth w-100");
			set_style(div25, "padding-top", 10 + "px");
			add_location(div25, file, 1374, 16, 58248);
			attr_dev(div26, "class", "row");
			add_location(div26, file, 1373, 12, 58213);
			attr_dev(div27, "class", "container");
			add_location(div27, file, 1372, 8, 58176);
			attr_dev(input1, "class", "form-control testCaseInput h-imp");
			attr_dev(input1, "type", "text");
			attr_dev(input1, "id", "id1");
			add_location(input1, file, 1581, 24, 73203);
			add_location(h4, file, 1582, 24, 73300);
			attr_dev(span7, "aria-hidden", "true");
			add_location(span7, file, 1584, 28, 73460);
			attr_dev(button5, "type", "button");
			attr_dev(button5, "class", "close");
			attr_dev(button5, "data-bs-dismiss", "modal");
			attr_dev(button5, "aria-label", "Close");
			add_location(button5, file, 1583, 24, 73351);
			attr_dev(div28, "class", "modal-header");
			add_location(div28, file, 1580, 20, 73151);
			attr_dev(lable, "class", "mt-1");
			add_location(lable, file, 1590, 32, 73920);
			attr_dev(input2, "class", "is_graph");
			attr_dev(input2, "type", "checkbox");
			input2.value = input2_value_value = /*state*/ ctx[2].is_graph;
			attr_dev(input2, "data-attr", input2_data_attr_value = /*state*/ ctx[2].is_graph);
			input2.checked = input2_checked_value = /*state*/ ctx[2].is_graph;
			add_location(input2, file, 1592, 36, 74080);
			attr_dev(span8, "class", "checkmark_eval");
			add_location(span8, file, 1593, 36, 74237);
			attr_dev(label1, "class", "container_eval mr-4");
			add_location(label1, file, 1591, 32, 73995);
			attr_dev(input3, "class", "ignore_error");
			attr_dev(input3, "type", "checkbox");
			input3.value = input3_value_value = /*state*/ ctx[2].ignore_error;
			input3.checked = input3_checked_value = /*state*/ ctx[2].ignore_error;
			add_location(input3, file, 1596, 36, 74438);
			attr_dev(span9, "class", "checkmark_eval");
			add_location(span9, file, 1597, 36, 74578);
			attr_dev(label2, "class", "container_eval mr-4");
			add_location(label2, file, 1595, 32, 74349);
			attr_dev(input4, "class", "ignore_formatting");
			attr_dev(input4, "type", "checkbox");
			input4.value = input4_value_value = /*state*/ ctx[2].ignore_formatting;
			input4.checked = input4_checked_value = /*state*/ ctx[2].ignore_formatting;
			add_location(input4, file, 1600, 36, 74779);
			attr_dev(span10, "class", "checkmark_eval");
			add_location(span10, file, 1601, 36, 74934);
			attr_dev(label3, "class", "container_eval");
			add_location(label3, file, 1599, 32, 74690);
			attr_dev(input5, "class", "ignore_reset_db");
			attr_dev(input5, "type", "checkbox");
			input5.value = input5_value_value = /*state*/ ctx[2].ignore_reset_db;
			input5.checked = input5_checked_value = /*state*/ ctx[2].ignore_reset_db;
			add_location(input5, file, 1604, 36, 75133);
			attr_dev(span11, "class", "checkmark_eval");
			add_location(span11, file, 1605, 36, 75282);
			attr_dev(label4, "class", "container_eval");
			add_location(label4, file, 1603, 32, 75046);
			attr_dev(input6, "class", "is_pre_tag");
			attr_dev(input6, "type", "checkbox");
			input6.value = input6_value_value = /*state*/ ctx[2].is_pre_tag;
			input6.checked = input6_checked_value = /*state*/ ctx[2].is_pre_tag;
			add_location(input6, file, 1608, 36, 75473);
			attr_dev(span12, "class", "checkmark_eval");
			add_location(span12, file, 1609, 36, 75607);
			attr_dev(label5, "class", "container_eval");
			add_location(label5, file, 1607, 32, 75394);
			...
			add_location(h50, file, 1589, 28, 73748);
			attr_dev(div29, "id", "setting");
			attr_dev(div29, "class", "setting");
			add_location(div29, file, 1588, 24, 73684);
			attr_dev(span13, "tabindex", span13_tabindex_value = language.zero);
			add_location(span13, file, 1616, 36, 76035);
			option0.__value = "0";
			option0.value = option0.__value;
			add_location(option0, file, 1625, 40, 76669);
			option1.__value = "1";
			option1.value = option1.__value;
			add_location(option1, file, 1626, 40, 76758);
			option2.__value = "2";
			option2.value = option2.__value;
			add_location(option2, file, 1627, 40, 76847);
			set_style(select, "margin", "2px 24px");
			attr_dev(select, "classes", "v-bottom");
			attr_dev(select, "id", "testcase_sensitive");
			add_location(select, file, 1617, 36, 76152);
			attr_dev(h51, "class", "float-left");
			set_style(h51, "width", "auto");
			add_location(h51, file, 1615, 32, 75954);
			set_style(textarea4, "height", "100px");

			attr_dev(textarea4, "class", textarea4_class_value = /*state*/ ctx[2].lang_type == "sql" || /*state*/ ctx[2].lang_type == "psql"
		...
		m: function mount(target, anchor) {
			...
			select_option(select, /*state*/ ctx[2].testcase_sensitive);
		...
		p: function update(ctx, dirty) {
			if ((!current || dirty[0] & /*state*/ 4) && t0_value !== (t0_value = (/*state*/ ctx[2].lang_type == "php"
			? "PHP"
			: toTitleCase(/*state*/ ctx[2].lang_type)) + "")) set_data_dev(t0, t0_value);

			if (/*state*/ ctx[2].lang_type == "sql" || /*state*/ ctx[2].lang_type == "mssql" || /*state*/ ctx[2].lang_type == "psql") {
				if (if_block0) {
			...
			if ((!current || dirty[0] & /*state*/ 4) && t4_value !== (t4_value = (/*state*/ ctx[2].lang_type == "php"
			? "PHP"
			: toTitleCase(/*state*/ ctx[2].lang_type)) + "")) set_data_dev(t4, t4_value);
			...
			if ((!current || dirty[0] & /*state*/ 4) && t14_value !== (t14_value = (/*state*/ ctx[2].preBlockShow ? "Hide" : "Show") + "")) set_data_dev(t14, t14_value);

			if (!current || dirty[0] & /*state*/ 4 && div4_class_value !== (div4_class_value = "" + ((/*state*/ ctx[2].preBlockShow ? "" : "h-imp") + " pre-div"))) {
				attr_dev(div4, "class", div4_class_value);
			}

			if ((!current || dirty[0] & /*state*/ 4) && t26_value !== (t26_value = (/*state*/ ctx[2].postBlockShow ? "Hide" : "Show") + "")) set_data_dev(t26, t26_value);

			if (!current || dirty[0] & /*state*/ 4 && div9_class_value !== (div9_class_value = "post-div " + (/*state*/ ctx[2].postBlockShow ? "" : "h-imp"))) {
			...
			if (!current || dirty[0] & /*state*/ 4 && input2_value_value !== (input2_value_value = /*state*/ ctx[2].is_graph)) {
				prop_dev(input2, "value", input2_value_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input2_data_attr_value !== (input2_data_attr_value = /*state*/ ctx[2].is_graph)) {
				attr_dev(input2, "data-attr", input2_data_attr_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input2_checked_value !== (input2_checked_value = /*state*/ ctx[2].is_graph)) {
				prop_dev(input2, "checked", input2_checked_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input3_value_value !== (input3_value_value = /*state*/ ctx[2].ignore_error)) {
				prop_dev(input3, "value", input3_value_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input3_checked_value !== (input3_checked_value = /*state*/ ctx[2].ignore_error)) {
				prop_dev(input3, "checked", input3_checked_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input4_value_value !== (input4_value_value = /*state*/ ctx[2].ignore_formatting)) {
				prop_dev(input4, "value", input4_value_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input4_checked_value !== (input4_checked_value = /*state*/ ctx[2].ignore_formatting)) {
				prop_dev(input4, "checked", input4_checked_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input5_value_value !== (input5_value_value = /*state*/ ctx[2].ignore_reset_db)) {
				prop_dev(input5, "value", input5_value_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input5_checked_value !== (input5_checked_value = /*state*/ ctx[2].ignore_reset_db)) {
				prop_dev(input5, "checked", input5_checked_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input6_value_value !== (input6_value_value = /*state*/ ctx[2].is_pre_tag)) {
				prop_dev(input6, "value", input6_value_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && input6_checked_value !== (input6_checked_value = /*state*/ ctx[2].is_pre_tag)) {
				prop_dev(input6, "checked", input6_checked_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && select_value_value !== (select_value_value = /*state*/ ctx[2].testcase_sensitive)) {
				select_option(select, /*state*/ ctx[2].testcase_sensitive);
			}

			if (!current || dirty[0] & /*state*/ 4 && textarea4_class_value !== (textarea4_class_value = /*state*/ ctx[2].lang_type == "sql" || /*state*/ ctx[2].lang_type == "psql"
			? "form-control width-md1 d-inline-block mr-md h-imp"
			: "form-control width-md1 d-inline-block mr-md")) {
				attr_dev(textarea4, "class", textarea4_class_value);
			}

			if (!current || dirty[0] & /*state*/ 4 && textarea5_class_value !== (textarea5_class_value = "form-control " + (/*state*/ ctx[2].lang_type == "sql" || /*state*/ ctx[2].lang_type == "psql"
			? "span9"
			: "width-md1") + " d-inline-block ml-md")) {
			...
			if (dirty[0] & /*state, message*/ 5 | dirty[2] & /*$$scope*/ 1048576) {
				dialog1_changes.$$scope = { dirty, ctx };
			}

			if (!updating_visible_1 && dirty[0] & /*state*/ 4) {
				updating_visible_1 = true;
				dialog1_changes.visible = /*state*/ ctx[2].remediationToggle;
...
*/
	onMount(() => {
		...
		$$invalidate(2, state.module = type, state);
		...
		if (caseSensitive && specialChar && partialMatch) {
			$$invalidate(2, state.ignore_special_char = specialChar[0].split("=")[1].replace(/["']/g, ""), state);
			$$invalidate(2, state.case_insensitive = caseSensitive[0].split("=")[1].replace(/["']/g, ""), state);
			$$invalidate(2, state.partial_match = partialMatch[0].split("=")[1].replace(/["']/g, ""), state);
		}
		...
		if (langArr.length == 1) {
			language$1 = langArr.toString().match(/language="(.*?)"/gim);
			language$1 = language$1.toString().replace(/language=|"/gi, "");
			xmlArr[language$1] = xml;
			$$invalidate(2, state.lang_type = language$1, state);
			$$invalidate(2, state.xmlArr = xmlArr, state);
		} else {
			for (let i = 0; i < langArr.length; i++) {
				language$1 = langArr[i].match(/language="(.*?)"/gim);
				language$1 = language$1.toString().replace(/language=|"/gi, "");
				xmlArr[language$1] = langArr[i];
			}
		...
		AH.bind("#enable-line", "keyup", () => {
			$$invalidate(2, state.xml = generateXml(), state);
...
*/
	beforeUpdate(async () => {
		if (toggleMode != state.toggleMode) {
			$$invalidate(2, state.toggleMode = toggleMode, state);
			...
			if (state.toggleMode == true) {
				...
				$$invalidate(2, state.qxml = qxml, state);
				$$invalidate(2, state.titleData = AH.select("#title").innerHTML, state);
				$$invalidate(2, state.stemData = AH.select("#stem").innerHTML, state);
				$$invalidate(2, state.remediationData = AH.select("#remediation").innerHTML, state);
				await tick();
 ...
 */
	function handleLanguageModalOpen() {
		$$invalidate(2, state.open = !state.open, state);
 ...
 */
	function handleLanguageSelection(lang) {
		$$invalidate(2, state.open = !state.open, state);
		$$invalidate(2, state.databases = all_databases[lang], state);
		...
		if (state.xmlArr[lang]) {
			$$invalidate(2, state.xml = state.xmlArr[lang], state);
			$$invalidate(2, state.lang_type = lang, state);
			...
			$$invalidate(2, state.xml = newXML, state);
			$$invalidate(2, state.lang_type = lang, state);
 ...
 */
	function handleDatabaseModalOpen() {
		$$invalidate(2, state.database_modal_open = !state.database_modal_open, state);
 ...
 */
	function handleDatabaseItem(database) {
		$$invalidate(2, state.database_modal_open = !state.database_modal_open, state);
		$$invalidate(2, state.database = database, state);
		currentDB = database;
		setDefaultXML();
	}
 ...
 */
	function remediationMode() {
		$$invalidate(2, state.remediationToggle = true, state);
		answerCheckEvalpro();
	}
	...
	function answerCheckEvalpro() {
		...
		AH.ajax({
			...
			if (response["ajaxRes"] == 1) {
				...
				$$invalidate(0, message = "Passed");

				if (response["answer"] == "0") {
					$$invalidate(0, message = "Failed");
				}
	...
	function runCode(event, raw = false) {
		...
		AH.ajax({
			...
			if (res.status_message == "Successful") {
				if (res.output) {
					$$invalidate(2, state.output = res.output, state);
 ...
 */
	function parseXML(xml) {
		...
		$$invalidate(2, state.database = currentDB, state);
		...
		$$invalidate(2, state.preShow = showPre ? showPre : 0, state);
		$$invalidate(2, state.postShow = showPost ? showPost : 0, state);
		$$invalidate(2, state.editorShow = showEditor ? showEditor : 0, state);
		$$invalidate(2, state.is_graph = is_graph, state);
		$$invalidate(2, state.ignore_error = ignore_error, state);
		$$invalidate(2, state.ignore_formatting = ignore_formatting, state);
		$$invalidate(2, state.ignore_reset_db = ignore_reset_db, state);
		$$invalidate(2, state.is_pre_tag = is_pre_tag, state);
		$$invalidate(2, state.enableLines = stringBetween(xml, "enableline"), state);
 ...
 */
	function setDefaultXML(type) {
		...
		if (state.lang_type == "sql" || state.lang_type == "psql" || state.lang_type == "mssql") {
			...
			$$invalidate(2, state.databases = all_databases[state.lang_type], state);
		}
 ...
 */
	function addMore(inp = "", oup = "", i) {
		...
		caseStack.innerHTML = `<div class="w-100 p-3 mt-2 mb-2" style="background: #f1f1f1"><div class="w-100"><h5 class="float-left p-1" style="width: 90%"><lable class="bage mr-4 test_case_label">${language.testcase + (index + 1)}</lable><label class="container_eval mr-4">${language.case_insensitive}<input class="case_insensitive" type="checkbox" value="${state.case_insensitive}" ${case_insensitive_checked}><span class="checkmark_eval"></span></label><label class="container_eval mr-4">${language.ignore_special_char}<input class="ignore_special_char" type="checkbox" value="${state.ignore_special_char}" ${ignore_special_char_checked}><span class="checkmark_eval"></span></label><label class="container_eval">${language.partial_match}<input class="partial_match" type="checkbox" value="${state.partial_match}" ${partial_match_checked}><span class="checkmark_eval"></span></label></h5><span tabIndex="0" class="float-right p-2 icomoon-new-24px-delete-1 s5 pointer caseDelBtn"></span></div><textarea class="form-control d-inline-block mr-md ${isSql}" style="width: 48%;height: 100px;" placeholder="${language.input_seperated_comma}">${inp}</textarea>
		...
		? "98%"
		: "48%"}" placeholder="${language.output}">${oup}</textarea></div>`;
	...
	function deleteCase(event) {
		if (AH.select("#caseContainer").children.length == 1) {
			...
			AH.selectAll(".test_case_label").forEach(_elm => {
				_elm.textContent = language.testcase + counter++;
			});
		}
	}
 ...
 */
	function addTestCase() {
		...
		$$invalidate(2, state.case_insensitive = case_match_insensitive, state);
		$$invalidate(2, state.ignore_special_char = casematch_specail_char, state);
		$$invalidate(2, state.partial_match = partialmatch, state);
		$$invalidate(2, state.is_graph = settings.is_graph, state);
		$$invalidate(2, state.ignore_error = settings.ignore_error, state);
		$$invalidate(2, state.ignore_formatting = settings.ignore_formatting, state);
		$$invalidate(2, state.ignore_reset_db = settings.ignore_reset_db, state);
		$$invalidate(2, state.is_pre_tag = settings.is_pre_tag, state);
 ...
 */
	...
	Object_1.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Eval> was created with unknown prop '${key}'`);
	});
	...
	function dialog_visible_binding(value) {
		...
		($$invalidate(2, state), $$invalidate(21, xml));
	}
	...
	const click_handler_2 = () => {
		$$invalidate(2, state.remediationToggle = false, state);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ("isPreview" in $$props) $$invalidate(1, isPreview = $$props.isPreview);
		if ("aXml" in $$props) aXml = $$props.aXml;
		if ("language" in $$props) language$1 = $$props.language;
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*xml, state*/ 2097156) {
			 if (xml != state.xml) $$invalidate(2, state.xml = xml, state);
		}
	};
...
export default Eval;
//# sourceMappingURL=Eval-6f171c66.js.map
