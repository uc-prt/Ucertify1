...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(i0, file$1, 1441, 231, 84465);
			attr_dev(button0, "type", "button");
			...
			add_location(button0, file$1, 1441, 24, 84258);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file$1, 1442, 24, 84530);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file$1, 1443, 210, 84936);
			attr_dev(button2, "type", "button");
			...
			add_location(button2, file$1, 1443, 24, 84750);
			...
			add_location(div0, file$1, 1440, 20, 84152);
			attr_dev(i2, "class", "icomoon-delete-sm");
			add_location(i2, file$1, 1446, 178, 85291);
			attr_dev(button3, "type", "button");
			...
			add_location(button3, file$1, 1446, 24, 85137);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file$1, 1447, 183, 85518);
			...
			add_location(button4, file$1, 1447, 24, 85359);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file$1, 1448, 160, 85720);
			...
			add_location(button5, file$1, 1448, 24, 85584);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file$1, 1449, 160, 85921);
			...
			add_location(button6, file$1, 1449, 24, 85785);
			...
			add_location(div1, file$1, 1445, 20, 85027);
			...
			add_location(div5, file$1, 1439, 16, 84040);
			attr_dev(div6, "id", "add_point_msg");
			attr_dev(div6, "class", "text-danger my-1");
			add_location(div6, file$1, 1461, 16, 86978);
			attr_dev(div7, "class", "mt-2 mb-2");
			add_location(div7, file$1, 1438, 12, 83999);
			attr_dev(i7, "class", "icomoon-24px-settings-1");
			add_location(i7, file$1, 1467, 28, 87432);
			...
			add_location(button10, file$1, 1466, 24, 87285);
			attr_dev(div8, "class", "btn-group position-absolute setting_btn");
			add_location(div8, file$1, 1465, 20, 87206);
			...
			add_location(img, file$1, 1470, 20, 87556);
			attr_dev(title, "id", "authoringSvgTitle");
			add_location(title, file$1, 1472, 24, 87782);
			attr_dev(g0, "class", "backgroundFocusPath");
			add_location(g0, file$1, 1473, 24, 87857);
			attr_dev(g1, "class", "drawing_paths");
			add_location(g1, file$1, 1474, 24, 87918);
			attr_dev(g2, "class", "backgroundFocusPoint");
			add_location(g2, file$1, 1475, 24, 87973);
			...
			add_location(circle0, file$1, 1479, 36, 88230);
			...
			add_location(line, file$1, 1481, 40, 88406);
			add_location(g3, file$1, 1480, 36, 88361);
			...
			add_location(circle1, file$1, 1484, 40, 88637);
			...
			add_location(path0, file$1, 1488, 52, 89090);
			...
			add_location(path1, file$1, 1489, 52, 89241);
			...
			add_location(path2, file$1, 1490, 52, 89390);
			...
			add_location(circle3, file$1, 1498, 40, 90035);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file$1, 1504, 60, 90638);
			add_location(g5, file$1, 1503, 56, 90573);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file$1, 1507, 60, 90876);
			add_location(g6, file$1, 1506, 56, 90811);
			add_location(g7, file$1, 1502, 52, 90512);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file$1, 1512, 60, 91230);
			add_location(g8, file$1, 1511, 56, 91165);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file$1, 1515, 60, 91488);
			add_location(g9, file$1, 1514, 56, 91423);
			add_location(g10, file$1, 1510, 52, 91104);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file$1, 1501, 48, 90393);
			attr_dev(pattern1, "id", "drawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file$1, 1500, 44, 90292);
			add_location(defs1, file$1, 1499, 40, 90240);
			add_location(g11, file$1, 1497, 36, 89990);
			...
			add_location(circle4, file$1, 1523, 40, 91973);
			...
			add_location(circle5, file$1, 1533, 40, 93103);
			...
			add_location(circle6, file$1, 1534, 40, 93260);
			add_location(g13, file$1, 1532, 36, 93057);
			...
			add_location(circle7, file$1, 1537, 40, 93517);
			...
			add_location(path7, file$1, 1545, 68, 94585);
			...
			add_location(g17, file$1, 1541, 52, 93980);
			...
			add_location(svg3, file$1, 1540, 48, 93832);
			attr_dev(pattern3, "id", "lastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file$1, 1539, 44, 93726);
			add_location(defs3, file$1, 1538, 40, 93674);
			add_location(g18, file$1, 1536, 36, 93472);
			add_location(g19, file$1, 1478, 32, 88189);
			attr_dev(svg4, "class", "drawing-compass-wrapper");
			add_location(svg4, file$1, 1477, 28, 88118);
			attr_dev(svg5, "class", "drawing_compass_svg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file$1, 1476, 24, 88035);
			...
			add_location(svg6, file$1, 1471, 20, 87657);
			attr_dev(div9, "id", "centerImg");
			attr_dev(div9, "class", "centerImg authCenterImg my-auto relative ml-0");
			add_location(div9, file$1, 1464, 16, 87110);
			add_location(div10, file$1, 1463, 12, 87087);
			add_location(center, file$1, 1437, 8, 83977);
			attr_dev(div11, "class", "drawing_module_container");
			add_location(div11, file$1, 1436, 4, 83929);
			add_location(main, file$1, 1435, 0, 83917);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=Drawing-a8d9e043.js.map
