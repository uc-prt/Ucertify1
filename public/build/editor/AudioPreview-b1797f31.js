...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, A as AH, y as language, X as XMLToJSON, a7 as afterUpdate, _ as onUserAnsChange, e as element, c as create_component, f as space, h as text, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as run_all, G as prop_dev } from './main-9d98459d.js';
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 523, 24, 25715);
			...
			add_location(span1, file, 540, 28, 27119);
			...
			add_location(button0, file, 532, 24, 26705);
			...
			add_location(span2, file, 551, 28, 27906);
			...
			add_location(button1, file, 542, 24, 27444);
			...
			add_location(span3, file, 564, 28, 28737);
			...
			add_location(button2, file, 553, 24, 28160);
			...
			add_location(div6, file, 531, 20, 26540);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 520, 16, 25413);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 519, 12, 25355);
		},
...
// (514:12) {#if state.showTranscript == true}
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 515, 62, 24976);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 515, 25, 24939);
			add_location(div0, file, 515, 20, 24934);
			...
			add_location(textarea, file, 516, 20, 25034);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 514, 16, 24888);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(514:12) {#if state.showTranscript == true}",
		ctx
	});
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 491, 20, 23671);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 490, 16, 23625);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 479, 20, 23130);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 478, 16, 23084);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(478:12) {#if answer_status != true}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 578, 20, 29408);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 576, 16, 29233);
			...
			add_location(div3, file, 580, 16, 29609);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 584, 20, 29872);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-b1797f31.js.map
