...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, T as Snackbar, Q as binding_callbacks, R as bind, P as Dialog, v as validate_slots, o as onMount, a2 as tick, a8 as onDestroy, A as AH, y as l, L as beforeUpdate, ag as tag_player, ab as afterUpdate, V as Button, W as Checkbox, ah as Textfield, w as writable, ac as Loader, e as element, f as space, c as create_component, j as attr_dev, k as add_location, l as set_style, n as insert_dev, p as append_dev, m as mount_component, Z as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, h as text, F as set_data_dev, B as noop } from './main-5b31e398.js';
...
// (348:0) <Dialog        bind:visible={state.remediationToggle}   width={450}   style="background: #fff; border-radius: 5px;"   class="remove_right_margin"  >
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t4 = space();
			t5 = text(t5_value);
			add_location(div0, file, 355, 3, 14615);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 354, 2, 14566);
			attr_dev(h40, "class", "mt-1 font21 mb-4");
			add_location(h40, file, 353, 1, 14533);
			add_location(br, file, 361, 27, 14807);
			add_location(h41, file, 361, 3, 14783);
			attr_dev(center, "class", "mt-xl");
			add_location(center, file, 359, 2, 14731);
			attr_dev(div2, "id", "remediationModel");
			set_style(div2, "overflow-y", "auto");
			set_style(div2, "padding-right", "20px");
			add_location(div2, file, 358, 1, 14653);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(348:0) <Dialog        bind:visible={state.remediationToggle}   width={450}   style=\\\"background: #fff; border-radius: 5px;\\\"   class=\\\"remove_right_margin\\\"  >",
		ctx
	});
...
// (366:2) <Button     unelevated={true}              outlined={true}     color="primary"     on:Click={()=>{ state.remediationToggle = false }}    >
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(366:2) <Button     unelevated={true}              outlined={true}     color=\\\"primary\\\"     on:Click={()=>{ state.remediationToggle = false }}    >",
		ctx
	});
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 364, 1, 14858);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=Labsimulation-0cf819db.js.map
