...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, O as Dialog, P as binding_callbacks, Q as bind, v as validate_slots, L as beforeUpdate, a7 as afterUpdate, o as onMount, U as Button, a8 as Loader, w as writable, a5 as Lang$1, A as AH, e as element, j as attr_dev, k as add_location, n as insert_dev, x as detach_dev, f as space, c as create_component, p as append_dev, m as mount_component, q as listen_dev, W as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component, H as run_all, l as set_style, B as noop, h as text, F as set_data_dev, V as Checkbox, Z as tick, r as group_outros, u as check_outros } from './main-ad414885.js';
...
// (1738:8) {#if window.isIE || window.isIEEleven}
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1738, 12, 94552);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1738:8) {#if window.isIE || window.isIEEleven}",
		ctx
	});
...
function create_else_block(ctx) {
	...
	let t3;
	let span3;
	let t4_value = (/*state*/ ctx[0].goDark ? Lang$1.normal_mode : Lang$1.dark_mode) + "";
	let t4;
	let t5;
	let div2;
	let button1;
	...
	const block = {
		c: function create() {
			...
			span0 = element("span");
			span1 = element("span");
			span1.textContent = `${Lang$1.html_css_js}`;
			t1 = space();
			div1 = element("div");
			...
			button1.textContent = `${Lang$1.run}`;
			t7 = space();
			div19 = element("div");
			div14 = element("div");
			div13 = element("div");
			...
			div15 = element("div");
			span7 = element("span");
			span7.textContent = `${Lang$1.result}`;
			t18 = space();
			div16 = element("div");
			attr_dev(span0, "class", "icomoon-coding-44px s3 align-middle mr-1");
			add_location(span0, file, 1821, 40, 100445);
			attr_dev(span1, "class", "align-middle");
			add_location(span1, file, 1821, 102, 100507);
			attr_dev(div0, "class", "mt-2 pt pl-3 float-left");
			add_location(div0, file, 1820, 36, 100367);
			attr_dev(span2, "class", "icomoon-menu-2 s3 text-secondary pt-s d-block");
			add_location(span2, file, 1824, 121, 100788);
			attr_dev(button0, "class", "btn border-0 px-0 ml-2 mr-2");
			attr_dev(button0, "type", "button");
			attr_dev(button0, "data-toggle", "dropdown");
			add_location(button0, file, 1824, 40, 100707);
			attr_dev(input, "type", "checkbox");
			attr_dev(input, "defaultchecked", input_defaultchecked_value = /*state*/ ctx[0].goDark);
			attr_dev(input, "id", "goDark");
			attr_dev(input, "class", "position-absolute transparent");
			add_location(input, file, 1828, 52, 101186);
			add_location(span3, file, 1829, 52, 101367);
			attr_dev(label, "htmlfor", "goDark");
			attr_dev(label, "class", "dropdown-item mb-0 pointer");
			add_location(label, file, 1827, 48, 101074);
			add_location(li, file, 1826, 44, 101021);
			attr_dev(ul, "class", "dropdown-menu dropdown-menu-right");
			attr_dev(ul, "x-placement", "bottom-end");
			add_location(ul, file, 1825, 40, 100905);
			attr_dev(div1, "class", "float-right mt-2");
			add_location(div1, file, 1823, 36, 100636);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-primary runcode_btn ml mt");
			add_location(button1, file, 1835, 40, 101737);
			attr_dev(div2, "class", "inline-block pull-right");
			add_location(div2, file, 1834, 36, 101659);
			attr_dev(div3, "id", "web_toolbar");
			attr_dev(div3, "class", "bg-light w-100 height44 web_toolbar text-dark");
			add_location(div3, file, 1819, 32, 100254);
			add_location(span4, file, 1843, 52, 102393);
			attr_dev(div4, "class", "card-header rounded-0");
			add_location(div4, file, 1842, 48, 102305);
			attr_dev(textarea0, "name", "html");
			attr_dev(textarea0, "id", "html_editor");
			add_location(textarea0, file, 1846, 52, 102658);
			...
			add_location(div5, file, 1845, 48, 102518);
			attr_dev(div6, "id", "html_panel");
			attr_dev(div6, "class", "card m-0 p-0 rounded-0");
			add_location(div6, file, 1841, 44, 102204);
			add_location(span5, file, 1851, 52, 103047);
			attr_dev(div7, "class", "card-header rounded-0");
			add_location(div7, file, 1850, 48, 102959);
			attr_dev(textarea1, "name", "css");
			attr_dev(textarea1, "id", "css_editor");
			add_location(textarea1, file, 1854, 52, 103310);
			...
			add_location(div8, file, 1853, 48, 103171);
			attr_dev(div9, "id", "css_panel");
			attr_dev(div9, "class", "card m-0 p-0 rounded-0");
			add_location(div9, file, 1849, 44, 102859);
			add_location(span6, file, 1860, 56, 103784);
			attr_dev(div10, "class", "card-header rounded-0");
			add_location(div10, file, 1859, 52, 103692);
			attr_dev(textarea2, "name", "js");
			attr_dev(textarea2, "id", "js_editor");
			add_location(textarea2, file, 1863, 56, 104057);
			...
			add_location(div11, file, 1862, 52, 103915);
			attr_dev(div12, "id", "js_panel");
			attr_dev(div12, "class", "card m-0 p-0 rounded-0");
			add_location(div12, file, 1858, 48, 103589);
			attr_dev(div13, "id", "firstEditorDiv");
			set_style(div13, "display", "flex");
			add_location(div13, file, 1840, 40, 102112);
			attr_dev(div14, "id", "top_content");
			add_location(div14, file, 1839, 36, 102049);
			add_location(span7, file, 1882, 48, 105421);
			attr_dev(div15, "class", "card-header rounded-0");
			add_location(div15, file, 1881, 44, 105337);
			...
			add_location(div16, file, 1884, 44, 105540);
			attr_dev(div17, "class", "card rounded-0 nm");
			add_location(div17, file, 1880, 40, 105261);
			attr_dev(div18, "id", "bottom_content");
			attr_dev(div18, "style", div18_style_value = "overflow: hidden");
			add_location(div18, file, 1879, 36, 105168);
			attr_dev(div19, "id", "accordion");
			attr_dev(div19, "style", div19_style_value = "width:100%; background:white; ");
			add_location(div19, file, 1838, 32, 101951);
			attr_dev(div20, "class", "row");
			add_location(div20, file, 1818, 28, 100204);
			attr_dev(div21, "class", "container-fluid");
			add_location(div21, file, 1817, 24, 100146);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*state*/ 1 && input_defaultchecked_value !== (input_defaultchecked_value = /*state*/ ctx[0].goDark)) {
				attr_dev(input, "defaultchecked", input_defaultchecked_value);
			}

			if (dirty[0] & /*state*/ 1 && t4_value !== (t4_value = (/*state*/ ctx[0].goDark ? Lang$1.normal_mode : Lang$1.dark_mode) + "")) set_data_dev(t4, t4_value);
		},
		d: function destroy(detaching) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			li1 = element("li");
			a0 = element("a");
			a0.textContent = `${Lang$1.html}`;
			t9 = space();
			li2 = element("li");
			a1 = element("a");
			a1.textContent = `${Lang$1.css}`;
			t11 = space();
			li3 = element("li");
			a2 = element("a");
			a2.textContent = `${Lang$1.js}`;
			t13 = space();
			div12 = element("div");
			div8 = element("div");
			div5 = element("div");
			...
			div13 = element("div");
			span4 = element("span");
			span4.textContent = `${Lang$1.result}`;
			t18 = space();
			div14 = element("div");
			attr_dev(span0, "class", "icomoon-coding-44px s3 align-middle mr-1");
			add_location(span0, file, 1752, 36, 95344);
			attr_dev(span1, "class", "align-middle");
			add_location(span1, file, 1752, 98, 95406);
			attr_dev(div0, "class", "mt-2 pt pl-3 float-left");
			add_location(div0, file, 1751, 32, 95270);
			attr_dev(span2, "class", "icomoon-menu-2 s3 text-secondary pt-s d-block");
			add_location(span2, file, 1755, 117, 95680);
			attr_dev(button0, "class", "btn border-0 px-0 ml-2 mr-2");
			attr_dev(button0, "type", "button");
			attr_dev(button0, "data-toggle", "dropdown");
			add_location(button0, file, 1755, 36, 95599);
			attr_dev(input, "type", "checkbox");
			attr_dev(input, "defaultchecked", input_defaultchecked_value = /*state*/ ctx[0].goDark);
			attr_dev(input, "id", "goDark");
			attr_dev(input, "class", "position-absolute transparent");
			add_location(input, file, 1759, 48, 96062);
			add_location(span3, file, 1760, 48, 96239);
			attr_dev(label, "htmlfor", "goDark");
			attr_dev(label, "class", "dropdown-item mb-0 pointer");
			add_location(label, file, 1758, 44, 95954);
			add_location(li0, file, 1757, 40, 95905);
			attr_dev(ul0, "class", "dropdown-menu dropdown-menu-right");
			attr_dev(ul0, "x-placement", "bottom-end");
			add_location(ul0, file, 1756, 36, 95793);
			attr_dev(div1, "class", "float-right mt-2 mr-2");
			add_location(div1, file, 1754, 32, 95527);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-primary runcode_btn ml mt");
			add_location(button1, file, 1766, 36, 96585);
			attr_dev(div2, "class", "inline-block pull-right");
			add_location(div2, file, 1765, 32, 96511);
			attr_dev(div3, "id", "web_toolbar");
			attr_dev(div3, "class", "bg-gray height44 web_toolbar text-dark");
			add_location(div3, file, 1750, 28, 95168);
			attr_dev(a0, "class", "nav-link active text-white");
			attr_dev(a0, "href", "#html_panel");
			attr_dev(a0, "role", "tab");
			attr_dev(a0, "data-toggle", "tab");
			add_location(a0, file, 1772, 40, 97053);
			attr_dev(li1, "class", "nav-item");
			attr_dev(li1, "id", "html_pane");
			add_location(li1, file, 1771, 36, 96976);
			attr_dev(a1, "class", "nav-link text-white");
			attr_dev(a1, "href", "#css_panel");
			attr_dev(a1, "role", "tab");
			attr_dev(a1, "data-toggle", "tab");
			add_location(a1, file, 1775, 40, 97306);
			attr_dev(li2, "class", "nav-item");
			attr_dev(li2, "id", "css_pane");
			add_location(li2, file, 1774, 36, 97230);
			attr_dev(a2, "class", "nav-link text-white");
			attr_dev(a2, "href", "#js_panel");
			attr_dev(a2, "role", "tab");
			attr_dev(a2, "data-toggle", "tab");
			add_location(a2, file, 1778, 40, 97549);
			attr_dev(li3, "class", "nav-item");
			attr_dev(li3, "id", "js_pane");
			add_location(li3, file, 1777, 36, 97474);
			attr_dev(ul1, "class", "nav nav-pills nav-fill");
			attr_dev(ul1, "role", "tablist");
			add_location(ul1, file, 1770, 32, 96889);
			attr_dev(textarea0, "name", "html");
			attr_dev(textarea0, "id", "html_editor");
			add_location(textarea0, file, 1785, 48, 98164);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1747:16) {#if window.inNative }",
		ctx
	});
...
// (1920:1) <div slot="title" style="text-align: left;">
function create_title_slot(ctx) {
	...
	const block = {
		c: function create() {
			div0 = element("div");
			div1 = element("div");
			div1.textContent = `${Lang$1.remediation}`;
			add_location(div1, file, 1920, 2, 107074);
			attr_dev(div0, "slot", "title");
			set_style(div0, "text-align", "left");
			add_location(div0, file, 1919, 1, 107027);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1920:1) <div slot=\\\"title\\\" style=\\\"text-align: left;\\\">",
		ctx
	});
...
// (1932:2) <Button key="cancel_btn" class="cancel_btn_pop" style={'float:right;margin:10px;background-color:gray;'} variant="contained" on:click={() => state.remediationToggle = false }>
function create_default_slot_1(ctx) {
	let t_value = Lang$1.cancel + "";
	let t;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1932:2) <Button key=\\\"cancel_btn\\\" class=\\\"cancel_btn_pop\\\" style={'float:right;margin:10px;background-color:gray;'} variant=\\\"contained\\\" on:click={() => state.remediationToggle = false }>",
		ctx
	});
...
// (1931:1) <div slot="footer" class="footer" style="border-top: 1px solid var(--divider, rgba(0, 0, 0, 0.1));">
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1930, 1, 107278);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1931:1) <div slot=\\\"footer\\\" class=\\\"footer\\\" style=\\\"border-top: 1px solid var(--divider, rgba(0, 0, 0, 0.1));\\\">",
		ctx
	});
...
// (1915:12) <Dialog              bind:visible={state.remediationToggle}  width="650"     on:close={() => state.remediationToggle = false} >
function create_default_slot(ctx) {
	...
	let t1;
	let h4;
	let t2_value = Lang$1.calculate_answer + "";
	let t2;
	let br;
	let t3;
	let t4_value = Lang$1.please_wait + "";
	let t4;
	let t5;
	let current;
	...
	const block = {
		c: function create() {
			...
			t4 = text(t4_value);
			t5 = space();
			add_location(br, file, 1926, 28, 107220);
			add_location(h4, file, 1926, 4, 107196);
			add_location(center, file, 1924, 3, 107158);
			attr_dev(div0, "id", "remediationModel");
			add_location(div0, file, 1923, 2, 107127);
			add_location(div1, file, 1922, 1, 107119);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1915:12) <Dialog              bind:visible={state.remediationToggle}  width=\\\"650\\\"     on:close={() => state.remediationToggle = false} >",
		ctx
	});
...
function create_fragment(ctx) {
	...
	function dialog_visible_binding(value) {
		/*dialog_visible_binding*/ ctx[11].call(null, value);
	}
	...
	dialog.$on("close", /*close_handler*/ ctx[12]);
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 1742, 8, 94722);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "h h-imp");
			attr_dev(button1, "id", "unset-review");
			add_location(button1, file, 1743, 8, 94833);
			add_location(div0, file, 1744, 8, 94950);
			attr_dev(input, "type", "hidden");
			attr_dev(input, "id", "ansModeAnswer");
			input.value = "";
			add_location(input, file, 1936, 8, 107624);
			attr_dev(div1, "id", "authoringArea");
			attr_dev(div1, "class", "font14");
			add_location(div1, file, 1736, 4, 94451);
			add_location(div2, file, 1730, 4, 93974);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const xml = window.uaXML && !(/smans/gi).test(window.uaXML)
	? window.uaXML
	: window.QXML;
...
*/
		...
		$$invalidate(0, state.goDark = !state.goDark, state);
	});
	...
	function reset() {
		...
		if (document.getElementById("special_module_user_xml") != null) document.getElementById("special_module_user_xml").value = "";
	...
	function saveWebAnswer(code, code_lang) {
		...
		let qxml = !(/smans/g).test(window.uaXML) && window.uaXML
		? window.uaXML
		: window.QXML;
		...
		if (document.getElementById("special_module_user_xml") != null) document.getElementById("special_module_user_xml").value = uXml;

		// assign the user answer xml in variable 'userAnswers'
		//let userAnswers = userAnswer = jQuery("#special_module_user_xml").val(); // Replaced
		let userAnswers;

		if (document.querySelector("#special_module_user_xml") != null) userAnswers = userAnswer = document.getElementById("special_module_user_xml").value;
	...
	const writable_props = ["inQuizPlayer", "editorState"];
	...
	$$self.$$set = $$props => {
		if ("inQuizPlayer" in $$props) $$invalidate(6, inQuizPlayer = $$props.inQuizPlayer);
		if ("editorState" in $$props) $$invalidate(7, editorState = $$props.editorState);
	};
...
class WebPreview extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { xml: 5, inQuizPlayer: 6, editorState: 7 }, [-1, -1]);
		...
		if (/*inQuizPlayer*/ ctx[6] === undefined && !("inQuizPlayer" in props)) {
			console_1.warn("<WebPreview> was created without expected prop 'inQuizPlayer'");
		}

		if (/*editorState*/ ctx[7] === undefined && !("editorState" in props)) {
			console_1.warn("<WebPreview> was created without expected prop 'editorState'");
		}
	}
...
// (775:28) <Checkbox                                   defaultChecked={state.goDark}                                  on:click={changeTheme}                                  id="goDark"                             >
function create_default_slot$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(775:28) <Checkbox                                   defaultChecked={state.goDark}                                  on:click={changeTheme}                                  id=\\\"goDark\\\"                             >",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	checkbox = new Checkbox({
			props: {
				defaultChecked: /*state*/ ctx[0].goDark,
				id: "goDark",
	...
	const block = {
		c: function create() {
			...
			div0 = element("div");
			button0 = element("button");
			button0.textContent = `${Lang$1.autograde}`;
			t1 = space();
			div1 = element("div");
			button1 = element("button");
			button1.textContent = `${Lang$1.disable}`;
			t3 = space();
			div2 = element("div");
			...
			label0.textContent = `${Lang$1.autograde}`;
			t22 = space();
			...
			h41 = element("h4");
			a0 = element("a");
			a0.textContent = `${Lang$1.testcases}`;
			t27 = space();
			span5 = element("span");
			t28 = space();
			div28 = element("div");
			...
			h42 = element("h4");
			a1 = element("a");
			a1.textContent = `${Lang$1.internalScript}`;
			t31 = space();
			span6 = element("span");
			t32 = space();
			div32 = element("div");
			...
			h43 = element("h4");
			a2 = element("a");
			a2.textContent = `${Lang$1.externalScript}`;
			t35 = space();
			span7 = element("span");
			t36 = space();
			div36 = element("div");
			...
			div44 = element("div");
			h44 = element("h4");
			h44.textContent = `${Lang$1.disable}`;
			t41 = space();
			...
			label1.textContent = `${Lang$1.html}:`;
			t46 = space();
			select0 = element("select");
			option0 = element("option");
			option0.textContent = `${Lang$1.editable}`;
			option1 = element("option");
			option1.textContent = `${Lang$1.hidden}`;
			option2 = element("option");
			option2.textContent = `${Lang$1.disabled}`;
			t50 = space();
			div46 = element("div");
			label2 = element("label");
			label2.textContent = `${Lang$1.css}:`;
			t53 = space();
			select1 = element("select");
			option3 = element("option");
			option3.textContent = `${Lang$1.editable}`;
			option4 = element("option");
			option4.textContent = `${Lang$1.hidden}`;
			option5 = element("option");
			option5.textContent = `${Lang$1.disabled}`;
			t57 = space();
			div47 = element("div");
			label3 = element("label");
			label3.textContent = `${Lang$1.js}:`;
			t60 = space();
			select2 = element("select");
			option6 = element("option");
			option6.textContent = `${Lang$1.editable}`;
			option7 = element("option");
			option7.textContent = `${Lang$1.hidden}`;
			option8 = element("option");
			option8.textContent = `${Lang$1.disabled}`;
			t64 = space();
			div48 = element("div");
			button6 = element("button");
			button6.textContent = `${Lang$1.done}`;
			t66 = space();
			...
			add_location(button0, file$1, 748, 24, 32952);
			attr_dev(div0, "class", "inline-block pull-left");
			add_location(div0, file$1, 747, 20, 32891);
			attr_dev(button1, "type", "button");
			...
			add_location(button3, file$1, 864, 20, 38799);
			attr_dev(div25, "class", "modal-header");
			add_location(div25, file$1, 853, 16, 38239);
			...
			add_location(a0, file$1, 878, 36, 39506);
			...
			add_location(textarea3, file$1, 896, 36, 40555);
			attr_dev(div27, "class", "card-body p-md");
			add_location(div27, file$1, 895, 32, 40490);
			attr_dev(div28, "id", "test_case_collapse");
			attr_dev(div28, "class", "collapse in");
			add_location(div28, file$1, 894, 28, 40408);
			attr_dev(div29, "class", "card mb");
			add_location(div29, file$1, 875, 24, 39274);
			...
			add_location(a1, file$1, 910, 36, 41416);
			...
			add_location(span6, file$1, 918, 40, 41872);
			attr_dev(h42, "class", "panel-title");
			add_location(h42, file$1, 909, 32, 41355);
			...
			add_location(div30, file$1, 908, 28, 41228);
			...
			add_location(textarea4, file$1, 928, 36, 42548);
			attr_dev(div31, "class", "card-body p-md");
			add_location(div31, file$1, 927, 32, 42483);
			attr_dev(div32, "id", "internal_script_collapse");
			attr_dev(div32, "class", "panel-collapse collapse");
			add_location(div32, file$1, 926, 28, 42383);
			attr_dev(div33, "class", "card mb");
			add_location(div33, file$1, 907, 24, 41178);
			...
			add_location(a2, file$1, 942, 36, 43422);
			...
			add_location(span7, file$1, 950, 36, 43874);
			attr_dev(h43, "class", "panel-title");
			add_location(h43, file$1, 941, 32, 43361);
			...
			add_location(div34, file$1, 940, 28, 43234);
			...
			textarea5.value = "\n                                    ";
			add_location(textarea5, file$1, 960, 36, 44471);
			attr_dev(div35, "class", "card-body p-md");
			add_location(div35, file$1, 959, 32, 44406);
			attr_dev(div36, "id", "external_script_collapse");
			attr_dev(div36, "class", "panel-collapse collapse");
			add_location(div36, file$1, 958, 28, 44306);
			attr_dev(div37, "class", "card mb-xl");
			add_location(div37, file$1, 939, 24, 43181);
			attr_dev(div38, "class", "panel-group");
			attr_dev(div38, "id", "grade_accordion");
			add_location(div38, file$1, 874, 20, 39203);
			attr_dev(div39, "class", "modal-body overflow-auto");
			add_location(div39, file$1, 873, 16, 39144);
			...
			add_location(button4, file$1, 975, 20, 45193);
			attr_dev(div40, "class", "modal-footer");
			add_location(div40, file$1, 974, 16, 45146);
			attr_dev(div41, "class", "modal-content");
			add_location(div41, file$1, 852, 12, 38195);
			attr_dev(div42, "class", "modal-dialog modal-lg modal-dialog-centered");
			add_location(div42, file$1, 851, 8, 38125);
			attr_dev(div43, "id", "autograde_modal");
			attr_dev(div43, "class", "modal fade");
			attr_dev(div43, "role", "dialog");
			add_location(div43, file$1, 850, 4, 38057);
			attr_dev(h44, "class", "modal-title");
			add_location(h44, file$1, 992, 20, 45814);
			attr_dev(button5, "type", "button");
			attr_dev(button5, "class", "close");
			attr_dev(button5, "data-bs-dismiss", "modal");
			attr_dev(button5, "aria-hidden", "true");
			add_location(button5, file$1, 993, 20, 45875);
			attr_dev(div44, "class", "modal-header");
			add_location(div44, file$1, 991, 16, 45767);
			attr_dev(label1, "for", "html_disable");
			add_location(label1, file$1, 997, 24, 46098);
			option0.__value = "";
			option0.value = option0.__value;
			add_location(option0, file$1, 999, 28, 46287);
			option1.__value = "0";
			option1.value = option1.__value;
			add_location(option1, file$1, 1000, 28, 46354);
			option2.__value = "1";
			option2.value = option2.__value;
			add_location(option2, file$1, 1001, 28, 46420);
			attr_dev(select0, "class", "form-control");
			attr_dev(select0, "id", "html_disable");
			attr_dev(select0, "auto:focus", "autofocus");
			add_location(select0, file$1, 998, 24, 46166);
			attr_dev(div45, "class", "form-group");
			add_location(div45, file$1, 996, 20, 46049);
			attr_dev(label2, "for", "css_disable");
			add_location(label2, file$1, 1005, 24, 46590);
			option3.__value = "";
			option3.value = option3.__value;
			add_location(option3, file$1, 1007, 28, 46753);
			option4.__value = "0";
			option4.value = option4.__value;
			add_location(option4, file$1, 1008, 28, 46820);
			option5.__value = "1";
			option5.value = option5.__value;
			add_location(option5, file$1, 1009, 28, 46886);
			attr_dev(select1, "class", "form-control");
			attr_dev(select1, "id", "css_disable");
			add_location(select1, file$1, 1006, 24, 46656);
			attr_dev(div46, "class", "form-group");
			add_location(div46, file$1, 1004, 20, 46541);
			attr_dev(label3, "for", "js_disable");
			add_location(label3, file$1, 1013, 24, 47056);
			option6.__value = "";
			option6.value = option6.__value;
			add_location(option6, file$1, 1015, 28, 47216);
			option7.__value = "0";
			option7.value = option7.__value;
			add_location(option7, file$1, 1016, 28, 47283);
			option8.__value = "1";
			option8.value = option8.__value;
			add_location(option8, file$1, 1017, 28, 47349);
			attr_dev(select2, "class", "form-control");
			attr_dev(select2, "id", "js_disable");
			add_location(select2, file$1, 1014, 24, 47120);
			attr_dev(div47, "class", "form-group");
			add_location(div47, file$1, 1012, 20, 47007);
			attr_dev(button6, "type", "button");
			attr_dev(button6, "class", "btn btn-primary");
			attr_dev(button6, "data-bs-dismiss", "modal");
			add_location(button6, file$1, 1021, 24, 47520);
			attr_dev(div48, "class", "float-right");
			add_location(div48, file$1, 1020, 20, 47470);
			attr_dev(div49, "class", "modal-body");
			add_location(div49, file$1, 995, 16, 46004);
			attr_dev(div50, "class", "modal-content");
			add_location(div50, file$1, 990, 12, 45723);
			attr_dev(div51, "class", "modal-dialog modal-sm modal-dialog-centered");
			add_location(div51, file$1, 989, 8, 45653);
			attr_dev(div52, "id", "disable_modal");
			attr_dev(div52, "class", "modal fade");
			attr_dev(div52, "role", "dialog");
			add_location(div52, file$1, 988, 4, 45587);
			attr_dev(input2, "type", "hidden");
			attr_dev(input2, "id", "ansModeAnswer");
			input2.value = "";
			add_location(input2, file$1, 1027, 4, 47707);
			attr_dev(div53, "id", "authoringArea");
			set_style(div53, "line-height", "20pxfont-size: 14px");
			add_location(div53, file$1, 742, 0, 32638);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*state*/ 1) checkbox_changes.defaultChecked = /*state*/ ctx[0].goDark;
...
class WebAuthoring extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*showAns*/ ctx[9] === undefined && !("showAns" in props)) {
			console.warn("<WebAuthoring> was created without expected prop 'showAns'");
		}
	}
...
function create_if_block_2(ctx) {
	...
	webauthoring = new WebAuthoring({
			props: {
				key: "2",
				xml: /*xml*/ ctx[0],
				toggleMode: /*toggleMode*/ ctx[2],
				getChildXml: /*getChildXml*/ ctx[3],
				showAns: /*showAns*/ ctx[4],
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*toggleMode*/ 4) webauthoring_changes.toggleMode = /*toggleMode*/ ctx[2];
			if (dirty & /*getChildXml*/ 8) webauthoring_changes.getChildXml = /*getChildXml*/ ctx[3];
			if (dirty & /*showAns*/ 16) webauthoring_changes.showAns = /*showAns*/ ctx[4];
			if (dirty & /*editorState*/ 2) webauthoring_changes.editorState = /*editorState*/ ctx[1];
			if (dirty & /*isReview*/ 32) webauthoring_changes.isReview = /*isReview*/ ctx[5];
...
function create_if_block_1$1(ctx) {
	...
	webpreview = new WebPreview({
			props: {
				key: "1",
				xml: window.QXML,
				inQuizPlayer: /*editorState*/ ctx[1] ? 0 : 1,
				editorState: /*editorState*/ ctx[1]
			},
			$$inline: true
		});
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*editorState*/ 2) webpreview_changes.inQuizPlayer = /*editorState*/ ctx[1] ? 0 : 1;
			if (dirty & /*editorState*/ 2) webpreview_changes.editorState = /*editorState*/ ctx[1];
...
// (225:2) {#if state.currentComponent == 2}
function create_if_block$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(225:2) {#if state.currentComponent == 2}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*state*/ ctx[6].currentComponent == 2) return 0;
		if (/*state*/ ctx[6].currentComponent == 1) return 1;
		if (/*state*/ ctx[6].currentComponent == 0) return 2;
		return -1;
	}
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 223, 1, 9747);
			add_location(main, file$2, 222, 0, 9739);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	beforeUpdate(() => {
		if (editorState) {
			...
			if (toggleMode != state.toggle) {
				...
				$$invalidate(6, state.toggle = toggleMode, state);
				...
				if (toggleMode == true) {
					...
					$$invalidate(6, state.currentComponent = 1, state); //<WebPreview xml={xml} inQuizPlayer={0} key={1} />;
				} else // ajaxContentUpdate({imgAltText:1,container:['#stemShow']});
				{
					...
					$$invalidate(6, state.currentComponent = 0, state);
		...
		if (editorState) {
			...
			AH.listen(document, "mouseover", "#webModule", () => {
				if (isHover == 0) {
					...
					$$invalidate(6, state.currentComponent = 1, state);
				}
			});
			...
			$$invalidate(6, state.currentComponent = 1, state); //<WebPreview xml={window.QXML} inQuizPlayer={1} key={2} />;
		}
	...
	function getComp() {
		if (editorState) {
			...
			setTimeout(
				() => {
					$$invalidate(6, state.currentComponent = isPreview == 1 ? 1 : 0, state);
				},
				1000
			);
		} else {
			// render preview component in case other than Editor such as book, quiz etc
			$$invalidate(6, state.currentComponent = 1, state); //<WebPreview xml={window.QXML} inQuizPlayer={0} key={1} />; 
		}
	}
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Web> was created with unknown prop '${key}'`);
	});

	$$self.$$set = $$props => {
		if ("xml" in $$props) $$invalidate(0, xml = $$props.xml);
		if ("inEditor" in $$props) $$invalidate(7, inEditor = $$props.inEditor);
		if ("editorState" in $$props) $$invalidate(1, editorState = $$props.editorState);
		if ("toggleMode" in $$props) $$invalidate(2, toggleMode = $$props.toggleMode);
		if ("getChildXml" in $$props) $$invalidate(3, getChildXml = $$props.getChildXml);
		if ("showAns" in $$props) $$invalidate(4, showAns = $$props.showAns);
		if ("setInlineEditor" in $$props) $$invalidate(8, setInlineEditor = $$props.setInlineEditor);
...
class Web extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*inEditor*/ ctx[7] === undefined && !("inEditor" in props)) {
		...
		if (/*toggleMode*/ ctx[2] === undefined && !("toggleMode" in props)) {
			console_1$1.warn("<Web> was created without expected prop 'toggleMode'");
		}

		if (/*getChildXml*/ ctx[3] === undefined && !("getChildXml" in props)) {
		...
		if (/*setInlineEditor*/ ctx[8] === undefined && !("setInlineEditor" in props)) {
...
export default Web;
//# sourceMappingURL=Web-1b9477ee.js.map
