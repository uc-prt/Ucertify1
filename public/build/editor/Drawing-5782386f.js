...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, F as set_data_dev, G as prop_dev, B as noop, x as detach_dev, g as globals, a5 as Lang, a7 as afterUpdate, o as onMount, A as AH, a6 as swal, X as XMLToJSON, M as JSONToXML, w as writable, ai as svg_element, c as create_component, m as mount_component, q as listen_dev, t as transition_in, a as transition_out, b as destroy_component } from './main-9d98459d.js';
import { D as Draggable } from './Draggable-fd11fbe1.js';
import { R as Resizable } from './Resizable-60cb0f46.js';

/* clsSMDrawing/DrawingModal.svelte generated by Svelte v3.29.0 */
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file, 24, 32, 1058);
			attr_dev(div1, "class", "form-group text-left");
			add_location(div1, file, 22, 28, 846);
			attr_dev(div2, "class", "col-6");
			add_location(div2, file, 21, 24, 798);
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<DrawingModal> was created with unknown prop '${key}'`);
	});
...
/* clsSMDrawing/Drawing.svelte generated by Svelte v3.29.0 */
...
function create_fragment$1(ctx) {
	...
	let div3;
	let button8;
	let t10_value = Lang.add_focus_pnt + "";
	let t10;
	...
	let mounted;
	let dispose;
	drawingmodal = new DrawingModal({ props: { l: Lang }, $$inline: true });
	...
	const block = {
		c: function create() {
			...
			t12 = space();
			div6 = element("div");
			div6.textContent = `${Lang.delete_point_msg}`;
			t14 = space();
			div10 = element("div");
			div9 = element("div");
			div8 = element("div");
			...
			add_location(i0, file$1, 1441, 231, 83012);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "tabindex", "0");
			attr_dev(button0, "data-title", "scribble");
			attr_dev(button0, "title", button0_title_value = Lang.scribble);
			...
			add_location(button0, file$1, 1441, 24, 82805);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "tabindex", "0");
			attr_dev(button1, "data-title", "line");
			attr_dev(button1, "title", button1_title_value = Lang.line);
			...
			add_location(button1, file$1, 1442, 24, 83076);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file$1, 1443, 210, 83481);
			attr_dev(button2, "type", "button");
			attr_dev(button2, "tabindex", "0");
			attr_dev(button2, "data-title", "compass");
			attr_dev(button2, "title", button2_title_value = Lang.compass);
			...
			add_location(button2, file$1, 1443, 24, 83295);
			attr_dev(div0, "tabindex", "0");
			attr_dev(div0, "class", "btn-group mr-2");
			attr_dev(div0, "role", "group");
			attr_dev(div0, "aria-label", div0_aria_label_value = Lang.draw_tools);
			add_location(div0, file$1, 1440, 20, 82700);
			attr_dev(i2, "class", "icomoon-delete-sm");
			add_location(i2, file$1, 1446, 198, 83853);
			attr_dev(button3, "type", "button");
			attr_dev(button3, "tabindex", "0");
			attr_dev(button3, "data-title", "eraser");
			attr_dev(button3, "title", button3_title_value = Lang.delete_tool);
			...
			add_location(button3, file$1, 1446, 24, 83679);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file$1, 1447, 183, 84079);
			attr_dev(button4, "type", "button");
			attr_dev(button4, "title", button4_title_value = Lang.clear_screen);
			...
			add_location(button4, file$1, 1447, 24, 83920);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file$1, 1448, 160, 84280);
			attr_dev(button5, "type", "button");
			attr_dev(button5, "tabindex", "0");
			attr_dev(button5, "title", button5_title_value = Lang.redo);
			...
			add_location(button5, file$1, 1448, 24, 84144);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file$1, 1449, 160, 84480);
			attr_dev(button6, "type", "button");
			attr_dev(button6, "tabindex", "0");
			attr_dev(button6, "title", button6_title_value = Lang.undo);
			...
			add_location(button6, file$1, 1449, 24, 84344);
			attr_dev(div1, "tabindex", "0");
			attr_dev(div1, "class", "btn-group mr-2");
			attr_dev(div1, "role", "group");
			attr_dev(div1, "aria-label", div1_aria_label_value = Lang.removing_tools);
			add_location(div1, file$1, 1445, 20, 83570);
			attr_dev(button7, "type", "button");
			attr_dev(button7, "tabindex", "0");
			attr_dev(button7, "data-title", "authoring_point");
			attr_dev(button7, "title", button7_title_value = Lang.add_show_point);
			attr_dev(button7, "name", "authoring_point");
			attr_dev(button7, "id", "authoring_point");
			attr_dev(button7, "class", "btn btn-light tooltip_btn");
			add_location(button7, file$1, 1452, 24, 84661);
			attr_dev(div2, "class", "btn-group mr-2");
			attr_dev(div2, "role", "group");
			attr_dev(div2, "aria-label", div2_aria_label_value = Lang.answer_point);
			add_location(div2, file$1, 1451, 20, 84567);
			attr_dev(button8, "type", "button");
			attr_dev(button8, "tabindex", "0");
			attr_dev(button8, "title", button8_title_value = Lang.add_finish_point);
			attr_dev(button8, "name", "focus_point");
			attr_dev(button8, "id", "focus_point");
			attr_dev(button8, "class", "btn btn-light tooltip_btn");
			add_location(button8, file$1, 1455, 24, 84991);
			attr_dev(div3, "class", "btn-group mr-2");
			attr_dev(div3, "role", "group");
			attr_dev(div3, "aria-label", div3_aria_label_value = Lang.access_mode);
			add_location(div3, file$1, 1454, 20, 84898);
			attr_dev(i6, "class", "icomoon-new-24px-reset-1");
			add_location(i6, file$1, 1458, 146, 85409);
			attr_dev(button9, "type", "button");
			attr_dev(button9, "tabindex", "0");
			attr_dev(button9, "title", button9_title_value = Lang.reset);
			attr_dev(button9, "name", "default_button");
			attr_dev(button9, "id", "reset_btn");
			attr_dev(button9, "class", "btn btn-light tooltip_btn");
			add_location(button9, file$1, 1458, 24, 85287);
			attr_dev(div4, "class", "btn-group mr-2");
			attr_dev(div4, "role", "group");
			attr_dev(div4, "aria-label", div4_aria_label_value = Lang.def_mode);
			add_location(div4, file$1, 1457, 20, 85197);
			attr_dev(div5, "class", "btn-toolbar auth_drawing_toolbar");
			attr_dev(div5, "role", "toolbar");
			attr_dev(div5, "aria-label", div5_aria_label_value = Lang.drawing_tools);
			add_location(div5, file$1, 1439, 16, 82589);
			attr_dev(div6, "id", "add_point_msg");
			attr_dev(div6, "class", "text-danger my-1");
			add_location(div6, file$1, 1461, 16, 85525);
			attr_dev(div7, "class", "mt-2 mb-2");
			add_location(div7, file$1, 1438, 12, 82549);
			attr_dev(i7, "class", "icomoon-24px-settings-1");
			add_location(i7, file$1, 1467, 28, 85973);
			...
			add_location(button10, file$1, 1466, 24, 85827);
			attr_dev(div8, "class", "btn-group position-absolute setting_btn");
			add_location(div8, file$1, 1465, 20, 85749);
			attr_dev(img, "class", "border");
			if (img.src !== (img_src_value = /*bgImgPath*/ ctx[1] + /*state*/ ctx[0].bgImg)) attr_dev(img, "src", img_src_value);
			attr_dev(img, "id", "svgImg");
			attr_dev(img, "alt", img_alt_value = /*state*/ ctx[0].alt);
			add_location(img, file$1, 1470, 20, 86094);
			attr_dev(title, "id", "authoringSvgTitle");
			add_location(title, file$1, 1472, 24, 86318);
			attr_dev(g0, "class", "backgroundFocusPath");
			add_location(g0, file$1, 1473, 24, 86392);
			attr_dev(g1, "class", "drawing_paths");
			add_location(g1, file$1, 1474, 24, 86452);
			attr_dev(g2, "class", "backgroundFocusPoint");
			add_location(g2, file$1, 1475, 24, 86506);
			...
			add_location(circle0, file$1, 1479, 36, 86759);
			...
			add_location(line, file$1, 1481, 40, 86933);
			add_location(g3, file$1, 1480, 36, 86889);
			...
			add_location(circle1, file$1, 1484, 40, 87161);
			...
			add_location(path0, file$1, 1488, 52, 87610);
			...
			add_location(path1, file$1, 1489, 52, 87760);
			...
			add_location(path2, file$1, 1490, 52, 87908);
			...
			add_location(circle3, file$1, 1498, 40, 88545);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file$1, 1504, 60, 89142);
			add_location(g5, file$1, 1503, 56, 89078);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file$1, 1507, 60, 89377);
			add_location(g6, file$1, 1506, 56, 89313);
			add_location(g7, file$1, 1502, 52, 89018);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file$1, 1512, 60, 89726);
			add_location(g8, file$1, 1511, 56, 89662);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file$1, 1515, 60, 89981);
			add_location(g9, file$1, 1514, 56, 89917);
			add_location(g10, file$1, 1510, 52, 89602);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file$1, 1501, 48, 88900);
			attr_dev(pattern1, "id", "drawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file$1, 1500, 44, 88800);
			add_location(defs1, file$1, 1499, 40, 88749);
			add_location(g11, file$1, 1497, 36, 88501);
			...
			add_location(circle4, file$1, 1523, 40, 90458);
			...
			add_location(circle5, file$1, 1533, 40, 91578);
			...
			add_location(circle6, file$1, 1534, 40, 91734);
			add_location(g13, file$1, 1532, 36, 91533);
			...
			add_location(circle7, file$1, 1537, 40, 91988);
			...
			add_location(path7, file$1, 1545, 68, 93048);
			...
			add_location(g17, file$1, 1541, 52, 92447);
			...
			add_location(svg3, file$1, 1540, 48, 92300);
			attr_dev(pattern3, "id", "lastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file$1, 1539, 44, 92195);
			add_location(defs3, file$1, 1538, 40, 92144);
			add_location(g18, file$1, 1536, 36, 91944);
			add_location(g19, file$1, 1478, 32, 86719);
			attr_dev(svg4, "class", "drawing-compass-wrapper");
			add_location(svg4, file$1, 1477, 28, 86649);
			attr_dev(svg5, "class", "drawing_compass_svg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file$1, 1476, 24, 86567);
			...
			add_location(svg6, file$1, 1471, 20, 86194);
			attr_dev(div9, "id", "centerImg");
			attr_dev(div9, "class", "centerImg authCenterImg my-auto relative ml-0");
			add_location(div9, file$1, 1464, 16, 85654);
			add_location(div10, file$1, 1463, 12, 85632);
			add_location(center, file$1, 1437, 8, 82528);
			attr_dev(div11, "class", "drawing_module_container");
			add_location(div11, file$1, 1436, 4, 82481);
			add_location(main, file$1, 1435, 0, 82470);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(button10, "click", /*openModal*/ ctx[2], false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
			if (!current || dirty[0] & /*state*/ 1 && img.src !== (img_src_value = /*bgImgPath*/ ctx[1] + /*state*/ ctx[0].bgImg)) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function validateInput(current) {
		...
		if (current.value.trim() == "") {
			isValid = false;
			AH.insert(current.parentElement, "<span class=\"error text-danger\">" + Lang.fill_warning + "</span>", "beforeend");
		} else if (current.classList.contains("num") && Number(current.value) < 600) {
			isValid = false;

			// shows warning message if width of image is less than 600
			AH.insert(current.parentElement, "<span class=\"error text-danger\">" + Lang.val_gt_limit + "</span>", "beforeend");
			...
			AH.insert(current.closest(".toolsCheckbox").parentElement, "<span class=\"error text-danger\">" + Lang.select_one_tool + "</span>", "beforeend");
		}
	...
	Object_1.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Drawing> was created with unknown prop '${key}'`);
	});

	$$self.$$set = $$props => {
		if ("xml" in $$props) $$invalidate(3, xml = $$props.xml);
	...
	return [state, bgImgPath, openModal, xml, getChildXml];
}

class Drawing extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { xml: 3, getChildXml: 4 }, [-1, -1, -1]);
		...
		if (/*xml*/ ctx[3] === undefined && !("xml" in props)) {
...
//# sourceMappingURL=Drawing-5782386f.js.map
