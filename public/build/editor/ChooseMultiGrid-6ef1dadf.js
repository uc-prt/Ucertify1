...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, y as l, C as validate_each_argument, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, N as JSONToXML, z as empty, n as insert_dev, x as detach_dev, e as element, f as space, j as attr_dev, k as add_location, p as append_dev, q as listen_dev, H as run_all, h as text, l as set_style, G as prop_dev, F as set_data_dev, B as noop, K as destroy_each, Q as binding_callbacks, E as is_function, Y as src_url_equal } from './main-05ea5008.js';

/* clsSMChoose\ChooseMultiGrid.svelte generated by Svelte v3.40.2 */
const file = "clsSMChoose\\ChooseMultiGrid.svelte";
...
function create_else_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(th, file, 427, 7, 13541);
		},
...
function create_if_block_8(ctx) {
	...
	function click_handler() {
		return /*click_handler*/ ctx[26](/*i*/ ctx[42]);
	}
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 423, 9, 13400);
			attr_dev(div, "tabindex", "0");
			attr_dev(div, "title", "Delete Column");
			attr_dev(div, "role", "button");
			attr_dev(div, "id", div_id_value = "delcol" + (/*i*/ ctx[42] - 1));
			attr_dev(div, "data-id", div_data_id_value = /*i*/ ctx[42] - 1);
			attr_dev(div, "key", div_key_value = "delcol" + (/*i*/ ctx[42] - 1));
			add_location(div, file, 422, 8, 13214);
			attr_dev(th, "key", th_key_value = /*i*/ ctx[42] - 1);
			attr_dev(th, "class", "text-left bg-white align-middle");
			add_location(th, file, 421, 7, 13150);
		},
		m: function mount(target, anchor) {
			insert_dev(target, th, anchor);
			append_dev(th, div);
...
// (420:5) {#each authoring_data.localCData1.slice(0, parseInt(state.maxcol)+1) as data, i }
function create_each_block_2(ctx) {
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*i*/ ctx[42] != 0) return create_if_block_8;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(420:5) {#each authoring_data.localCData1.slice(0, parseInt(state.maxcol)+1) as data, i }",
		ctx
	});
...
// (441:6) {#if table_row && table_row.length > 0}
function create_if_block_2(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*table_row, editCdata, updateXML, deleteimage, openImageDialog, updateCorrect*/ 5060) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(441:6) {#if table_row && table_row.length > 0}",
		ctx
	});
...
function create_if_block_3(ctx) {
	...
	let span;
	let t2;
	let show_if_3 = /*data*/ ctx[43].colData.value.charAt(0) == "*" || /*data*/ ctx[43].colData.value.charAt(0) == "!" && /*data*/ ctx[43].colData.value.charAt(1) == "*";
	let div1_key_value;
	let t3;
	let show_if_2 = /*data*/ ctx[43].colData.value.indexOf("*") != 0 && /*data*/ ctx[43].colData.value.indexOf("*") != 1;
	let t4;
	let show_if_1 = /*data*/ ctx[43].colData.value.charAt(0) == "*";
	let t5;
	let show_if = /*data*/ ctx[43].colData.value.charAt(0) == "!" && /*data*/ ctx[43].colData.value.charAt(1) == "*";
	let t6;
	let td_id_value;
	let mounted;
	let dispose;
	...
	function click_handler_2(...args) {
		return /*click_handler_2*/ ctx[28](/*data*/ ctx[43], ...args);
	}
	...
	const block = {
		c: function create() {
			...
			input.checked = input_checked_value = /*data*/ ctx[43].colData.value.charAt(0) == "!";
			attr_dev(input, "name", input_name_value = /*data*/ ctx[43].name);
			attr_dev(input, "id", input_id_value = /*data*/ ctx[43].name);
			attr_dev(input, "aria-label", "fix cell checkbox");
			attr_dev(input, "key", input_key_value = /*data*/ ctx[43].name);
			attr_dev(input, "class", "m-2 position-relative top1");
			attr_dev(input, "role", "button");
			add_location(input, file, 445, 11, 14342);
			attr_dev(i, "class", "icomoon-lock-sm s3 m-2 text-dark");
			add_location(i, file, 457, 11, 14790);
			attr_dev(span, "class", "icomoon-images s4");
			add_location(span, file, 459, 12, 15054);
			...
			add_location(div0, file, 458, 11, 14851);
			attr_dev(div1, "key", div1_key_value = /*data*/ ctx[43].key);
			attr_dev(div1, "class", "light-cyan-bg p-2 width200 d-flex");
			add_location(div1, file, 444, 10, 14267);
			attr_dev(td, "class", "columnContainer p-0 width200");
			attr_dev(td, "id", td_id_value = /*data*/ ctx[43].id);
			add_location(td, file, 443, 9, 14200);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen_dev(
						...
						"click",
						function () {
							if (is_function(/*updateCorrect*/ ctx[7].bind(this, /*data*/ ctx[43].colData.value, /*data*/ ctx[43].count))) /*updateCorrect*/ ctx[7].bind(this, /*data*/ ctx[43].colData.value, /*data*/ ctx[43].count).apply(this, arguments);
						},
						false,
						false,
						false
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*table_row*/ 4 && input_checked_value !== (input_checked_value = /*data*/ ctx[43].colData.value.charAt(0) == "!")) {
				prop_dev(input, "checked", input_checked_value);
			}

			if (dirty[0] & /*table_row*/ 4 && input_name_value !== (input_name_value = /*data*/ ctx[43].name)) {
				attr_dev(input, "name", input_name_value);
			}

			if (dirty[0] & /*table_row*/ 4 && input_id_value !== (input_id_value = /*data*/ ctx[43].name)) {
				attr_dev(input, "id", input_id_value);
			}

			if (dirty[0] & /*table_row*/ 4 && input_key_value !== (input_key_value = /*data*/ ctx[43].name)) {
				attr_dev(input, "key", input_key_value);
			}

			if (dirty[0] & /*table_row*/ 4) show_if_3 = /*data*/ ctx[43].colData.value.charAt(0) == "*" || /*data*/ ctx[43].colData.value.charAt(0) == "!" && /*data*/ ctx[43].colData.value.charAt(1) == "*";
			...
			if (dirty[0] & /*table_row*/ 4 && div1_key_value !== (div1_key_value = /*data*/ ctx[43].key)) {
				attr_dev(div1, "key", div1_key_value);
			}

			if (dirty[0] & /*table_row*/ 4) show_if_2 = /*data*/ ctx[43].colData.value.indexOf("*") != 0 && /*data*/ ctx[43].colData.value.indexOf("*") != 1;
			...
			if (dirty[0] & /*table_row*/ 4) show_if_1 = /*data*/ ctx[43].colData.value.charAt(0) == "*";
			...
			if (dirty[0] & /*table_row*/ 4) show_if = /*data*/ ctx[43].colData.value.charAt(0) == "!" && /*data*/ ctx[43].colData.value.charAt(1) == "*";
			...
			if (dirty[0] & /*table_row*/ 4 && td_id_value !== (td_id_value = /*data*/ ctx[43].id)) {
...
// (462:11) {#if (data.colData.value.charAt(0) == "*") || ((data.colData.value.charAt(0) == "!") &&  (data.colData.value.charAt(1) == "*"))}
function create_if_block_7(ctx) {
	...
	function click_handler_3() {
		return /*click_handler_3*/ ctx[29](/*data*/ ctx[43]);
	}
	...
	const block = {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*table_row*/ 4 && div_id_value !== (div_id_value = /*data*/ ctx[43].delbtn)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(462:11) {#if (data.colData.value.charAt(0) == \\\"*\\\") || ((data.colData.value.charAt(0) == \\\"!\\\") &&  (data.colData.value.charAt(1) == \\\"*\\\"))}",
		ctx
	});
...
// (466:10) {#if (data.colData.value.indexOf("*") != 0 && data.colData.value.indexOf("*") != 1)}
function create_if_block_6(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(input, "id", input_id_value = /*data*/ ctx[43].authTA);
			attr_dev(input, "name", input_name_value = /*data*/ ctx[43].authTA);
			attr_dev(input, "key", input_key_value = /*data*/ ctx[43].authTA);
			attr_dev(input, "aria-label", "Option Value");

			input.value = input_value_value = /*data*/ ctx[43].colData.value.charAt(0) == "!"
			? /*data*/ ctx[43].colData.value.slice(1)
			: /*data*/ ctx[43].colData.value;

			attr_dev(input, "class", "px-2 pb-2 form-control");
			add_location(input, file, 467, 12, 15649);
			attr_dev(div, "class", "p-2");
			add_location(div, file, 466, 11, 15618);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			...
			if (!mounted) {
				dispose = [
					listen_dev(
						...
						"change",
						function () {
							if (is_function(/*editCdata*/ ctx[8].bind(/*data*/ ctx[43].colData.value, /*data*/ ctx[43].count))) /*editCdata*/ ctx[8].bind(/*data*/ ctx[43].colData.value, /*data*/ ctx[43].count).apply(this, arguments);
						},
						false,
						false,
						false
					),
					listen_dev(input, "blur", /*updateXML*/ ctx[6], false, false, false)
				];
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*table_row*/ 4 && input_id_value !== (input_id_value = /*data*/ ctx[43].authTA)) {
				attr_dev(input, "id", input_id_value);
			}

			if (dirty[0] & /*table_row*/ 4 && input_name_value !== (input_name_value = /*data*/ ctx[43].authTA)) {
				attr_dev(input, "name", input_name_value);
			}

			if (dirty[0] & /*table_row*/ 4 && input_key_value !== (input_key_value = /*data*/ ctx[43].authTA)) {
				attr_dev(input, "key", input_key_value);
			}

			if (dirty[0] & /*table_row*/ 4 && input_value_value !== (input_value_value = /*data*/ ctx[43].colData.value.charAt(0) == "!"
			? /*data*/ ctx[43].colData.value.slice(1)
			: /*data*/ ctx[43].colData.value) && input.value !== input_value_value) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(466:10) {#if (data.colData.value.indexOf(\\\"*\\\") != 0 && data.colData.value.indexOf(\\\"*\\\") != 1)}",
		ctx
	});
...
// (483:10) {#if data.colData.value.charAt(0) == "*"}
function create_if_block_5(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "id", img_id_value = /*data*/ ctx[43].authTA);
			set_style(img, "height", "70px");
			set_style(img, "width", "100%");
			set_style(img, "object-fit", "contain");
			attr_dev(img, "class", "authoringImage px-2");
			if (!src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[43].colData.value.split("##")[0].slice(1))) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*data*/ ctx[43].colData.value.split("##")[1]
			? /*data*/ ctx[43].colData.value.split("##")[1]
			: null);

			add_location(img, file, 483, 11, 16288);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*table_row*/ 4 && img_id_value !== (img_id_value = /*data*/ ctx[43].authTA)) {
				attr_dev(img, "id", img_id_value);
			}

			if (dirty[0] & /*table_row*/ 4 && !src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[43].colData.value.split("##")[0].slice(1))) {
				attr_dev(img, "src", img_src_value);
			}

			if (dirty[0] & /*table_row*/ 4 && img_alt_value !== (img_alt_value = /*data*/ ctx[43].colData.value.split("##")[1]
			? /*data*/ ctx[43].colData.value.split("##")[1]
			: null)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(483:10) {#if data.colData.value.charAt(0) == \\\"*\\\"}",
		ctx
	});
...
// (486:10) {#if (data.colData.value.charAt(0) == "!") &&  (data.colData.value.charAt(1) == "*")}
function create_if_block_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(img, "width", "100%");
			set_style(img, "object-fit", "contain");
			if (!src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[43].colData.value.split("##")[0].slice(2))) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*data*/ ctx[43].colData.value.split("##")[1]
			? /*data*/ ctx[43].colData.value.split("##")[1]
			: null);

			add_location(img, file, 486, 11, 16705);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*table_row*/ 4 && !src_url_equal(img.src, img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[43].colData.value.split("##")[0].slice(2))) {
				attr_dev(img, "src", img_src_value);
			}
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(486:10) {#if (data.colData.value.charAt(0) == \\\"!\\\") &&  (data.colData.value.charAt(1) == \\\"*\\\")}",
		ctx
	});
...
// (442:7) {#each table_row as data}
function create_each_block_1(ctx) {
	let if_block_anchor;
	let if_block = /*data*/ ctx[43].row == /*i*/ ctx[42] && create_if_block_3(ctx);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(442:7) {#each table_row as data}",
		ctx
	});
...
// (434:4) {#each authoring_data.localCData1.slice(0, parseInt(state.maxrow)) as item, i}
function create_each_block(ctx) {
	...
	function click_handler_1() {
		return /*click_handler_1*/ ctx[27](/*i*/ ctx[42]);
	}
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 437, 8, 13963);
			...
			attr_dev(span1, "id", span1_id_value = "delrow" + /*i*/ ctx[42]);
			add_location(span1, file, 436, 7, 13774);
			attr_dev(td, "class", "text-center width46");
			add_location(td, file, 435, 6, 13733);
			add_location(tr, file, 434, 5, 13721);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(434:4) {#each authoring_data.localCData1.slice(0, parseInt(state.maxrow)) as item, i}",
		ctx
	});
...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(button1, "click", /*removeRow*/ ctx[14], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file, 525, 5, 18439);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(525:4) {#if state.maxrow<=2}",
		ctx
	});
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(button0, "class", "btn btn-light");
			attr_dev(button0, "data-bs-dismiss", "modal");
			add_location(button0, file, 553, 5, 19504);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "id", "cdata");
			attr_dev(button1, "class", "btn btn-primary");
			attr_dev(button1, "data-bs-dismiss", "modal");
			add_location(button1, file, 554, 5, 19590);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button0, anchor);
			insert_dev(target, t1, anchor);
			...
			if (!mounted) {
				dispose = listen_dev(button1, "click", /*removeOption*/ ctx[16], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(button, "class", "btn btn-light");
			attr_dev(button, "data-bs-dismiss", "modal");
			add_location(button, file, 551, 5, 19405);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(551:4) {#if state.maxcol<=2}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label0, file, 409, 3, 12515);
			...
			add_location(input0, file, 411, 4, 12643);
			attr_dev(div0, "class", "width10 ml-3 float-end");
			add_location(div0, file, 410, 3, 12601);
			attr_dev(div1, "class", "form-group row mx-0 mb-1");
			add_location(div1, file, 408, 2, 12472);
			...
			add_location(div2, file, 407, 1, 12348);
			attr_dev(tr, "class", "table-head border-top");
			add_location(tr, file, 418, 4, 12998);
			add_location(thead, file, 417, 3, 12985);
			add_location(tbody, file, 432, 3, 13623);
			attr_dev(table, "class", "table relative");
			attr_dev(table, "id", "mytable");
			add_location(table, file, 416, 2, 12937);
			attr_dev(span0, "class", "icomoon-new-24px-add-circle-1 s3 mr-1");
			add_location(span0, file, 497, 3, 17284);
			attr_dev(button0, "type", "button");
		...
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen_dev(input0, "change", /*updateSetting*/ ctx[5], false, false, false),
					listen_dev(input0, "blur", /*updateXML*/ ctx[6], false, false, false),
					listen_dev(button0, "click", /*addColumn*/ ctx[15], false, false, false),
					listen_dev(button1, "click", /*addRow*/ ctx[13], false, false, false),
					listen_dev(button5, "click", /*uploadImage*/ ctx[19], false, false, false),
					listen_dev(button6, "click", /*closeImageDialog*/ ctx[10], false, false, false),
					listen_dev(button7, "click", /*insertImage*/ ctx[11], false, false, false)
				];
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*openConfirmationCol, authoring_data, state*/ 262147) {
			...
			if (dirty[0] & /*table_row, editCdata, updateXML, deleteimage, openImageDialog, updateCorrect, openConfirmationRow, authoring_data, state*/ 136135) {
			...
			? l.row_limit
			: l.del_confirmation) + "")) set_data_dev(t15, t15_value);
			...
			? l.col_limit
			: l.del_confirmation) + "")) set_data_dev(t22, t22_value);
		...
		d: function destroy(detaching) {
			...
			/*input3_binding*/ ctx[30](null);
			/*input4_binding*/ ctx[31](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance($$self, $$props, $$invalidate) {
	...
	function openImageDialog(e, class_name) {
		...
		if (childImg) {
			...
			$$invalidate(0, state.imgVal = breakPath[breakPath.length - 1], state);
			$$invalidate(0, state.altVal = childImg.getAttribute('alt'), state);
		} else {
			$$invalidate(0, state.imgVal = '', state);
			$$invalidate(0, state.altVal = '', state);
		}

		$$invalidate(3, MatchlistImg.value = state.imgVal, MatchlistImg);
		$$invalidate(4, MatchlistAlt.value = state.altVal, MatchlistAlt);
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ChooseMultiGrid> was created with unknown prop '${key}'`);
	});

	const click_handler = i => {
		openConfirmationCol(i - 1);
	};
	...
	const click_handler_2 = (data, e) => {
		openImageDialog(e, data.authTA);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ('xml' in $$props) $$invalidate(20, xml = $$props.xml);
		if ('getChildXml' in $$props) $$invalidate(21, getChildXml = $$props.getChildXml);
		if ('cols' in $$props) $$invalidate(22, cols = $$props.cols);
		if ('counter' in $$props) $$invalidate(23, counter = $$props.counter);
		if ('counter1' in $$props) $$invalidate(24, counter1 = $$props.counter1);
		if ('count' in $$props) $$invalidate(25, count = $$props.count);
		if ('table_row' in $$props) $$invalidate(2, table_row = $$props.table_row);
		if ('MatchlistImg' in $$props) $$invalidate(3, MatchlistImg = $$props.MatchlistImg);
		if ('MatchlistAlt' in $$props) $$invalidate(4, MatchlistAlt = $$props.MatchlistAlt);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*state, cols, authoring_data, counter, counter1, count, table_row*/ 62914567) {
			 {
				$$invalidate(25, count = 0);
				$$invalidate(23, counter = 0);
				$$invalidate(22, cols = parseInt(state.maxcol));
				$$invalidate(24, counter1 = cols);
				...
				authoring_data.localCData1.slice(0, parseInt(state.maxrow)).map(function (data, index) {
					...
					$$invalidate(23, counter = counter1);
					$$invalidate(24, counter1 = counter1 + cols);
				});
			}
		}
	};
...
class ChooseMultiGrid extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { xml: 20, getChildXml: 21 }, null, [-1, -1]);
...
//# sourceMappingURL=ChooseMultiGrid-6ef1dadf.js.map
