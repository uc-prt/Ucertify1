...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, v as validate_slots, L as beforeUpdate, o as onMount, w as writable, A as AH, e as element, f as space, h as text, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, B as noop, x as detach_dev, H as run_all } from './main-6da9f99a.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 94, 16, 3151);
			attr_dev(span1, "class", "dots svelte-1rpbtbi");
			add_location(span1, file, 95, 16, 3195);
			attr_dev(span2, "class", "dots svelte-1rpbtbi");
			add_location(span2, file, 96, 16, 3239);
			attr_dev(span3, "class", "dots svelte-1rpbtbi");
			add_location(span3, file, 97, 16, 3283);
			...
			add_location(button64, file, 277, 20, 19265);
			...
			add_location(button108, file, 364, 20, 28964);
			add_location(sup7, file, 365, 135, 29230);
			attr_dev(button109, "type", "button");
			attr_dev(button109, "class", "scnd_btn dec_widther blue_container svelte-1rpbtbi");
			add_location(button109, file, 365, 20, 29115);
			add_location(sup8, file, 366, 151, 29405);
			...
			add_location(button110, file, 366, 20, 29274);
			add_location(sup9, file, 367, 135, 29564);
			attr_dev(button111, "type", "button");
			attr_dev(button111, "class", "scnd_btn dec_widther blue_container svelte-1rpbtbi");
			add_location(button111, file, 367, 20, 29449);
			...
			add_location(button196, file, 607, 20, 50547);
			...
			add_location(button201, file, 614, 20, 51278);
			...
			add_location(button206, file, 621, 20, 52073);
			...
			add_location(button230, file, 657, 20, 55835);
			...
			add_location(button235, file, 666, 20, 56664);
			...
			add_location(button236, file, 667, 20, 56794);
			...
			add_location(button240, file, 673, 20, 57392);
			...
			add_location(button241, file, 674, 20, 57522);
			...
			add_location(button244, file, 682, 20, 58193);
			...
			add_location(button245, file, 683, 20, 58323);
			...
			add_location(button249, file, 689, 20, 58936);
			...
			add_location(button255, file, 699, 20, 59901);
			...
			add_location(button260, file, 706, 20, 60651);
			...
			add_location(button265, file, 713, 20, 61405);
			...
			add_location(button284, file, 742, 20, 64344);
			...
			add_location(button285, file, 743, 20, 64474);
			...
			add_location(button289, file, 749, 20, 65107);
			...
			add_location(button295, file, 759, 20, 66054);
			...
			add_location(button300, file, 766, 20, 66821);
			...
			add_location(button307, file, 782, 20, 68142);
			...
			add_location(button308, file, 783, 20, 68257);
			...
			add_location(button309, file, 784, 20, 68372);
			...
			add_location(button311, file, 791, 20, 68920);
			...
			add_location(button312, file, 792, 20, 69035);
			...
			add_location(button313, file, 793, 20, 69150);
			...
			add_location(button320, file, 812, 20, 70613);
			...
			add_location(button321, file, 813, 20, 70728);
			...
			add_location(button324, file, 821, 20, 71381);
			...
			add_location(button325, file, 822, 20, 71496);
			...
			add_location(button328, file, 830, 20, 72154);
			...
			add_location(button329, file, 831, 20, 72269);
			...
			add_location(button336, file, 853, 20, 73935);
			...
			add_location(button339, file, 861, 20, 74569);
			...
			add_location(button340, file, 862, 20, 74734);
			...
			add_location(button343, file, 870, 20, 75406);
			...
			add_location(button344, file, 871, 20, 75560);
...
//# sourceMappingURL=mathquill-c4380554.js.map
