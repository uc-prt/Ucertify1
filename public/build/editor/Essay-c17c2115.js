...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, W as Checkbox, Q as binding_callbacks, R as bind, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, L as beforeUpdate, e as element, h as text, f as space, j as attr_dev, k as add_location, a1 as add_render_callback, n as insert_dev, p as append_dev, a3 as select_option, a2 as set_input_value, q as listen_dev, F as set_data_dev, af as to_number, x as detach_dev, H as run_all, c as create_component, m as mount_component, $ as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component, a0 as select_value } from './main-613f6bf1.js';
...
function add_css(target) {
	append_styles(target, "svelte-j2f4ig", "a:hover{text-decoration:none}.hero-unit.svelte-j2f4ig.svelte-j2f4ig{border:1px solid #ccc;width:84%;padding:18px!important;font-size:15px!important;margin-bottom:30px;font-weight:200;line-height:30px;color:inherit;background-color:#eeeeee;-webkit-border-radius:6px;-moz-border-radius:6px;border-radius:6px}#essay_editorAuth.svelte-j2f4ig.svelte-j2f4ig{max-height:250px;height:250px;background-color:white;border-collapse:separate;border:1px solid rgb(204, 204, 204);padding:4px;box-sizing:content-box;-webkit-box-shadow:rgba(0, 0, 0, 0.0745098) 0px 1px 1px 0px inset;box-shadow:rgba(0, 0, 0, 0.0745098) 0px 1px 1px 0px inset;border-top-right-radius:3px;border-bottom-right-radius:3px;border-bottom-left-radius:3px;border-top-left-radius:3px;overflow:scroll;outline:none}.essay-container .upload-area.svelte-j2f4ig #files_number.svelte-j2f4ig{width:115px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (157:8) <Checkbox                bind:checked={isUpload}              on:click={updateXML}              id="uploadChk"              name="uploadChk"              color="primary"          >
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 163, 12, 6555);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(157:8) <Checkbox                bind:checked={isUpload}              on:click={updateXML}              id=\\\"uploadChk\\\"              name=\\\"uploadChk\\\"              color=\\\"primary\\\"          >",
		ctx
	});
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label0, file, 169, 24, 6778);
			attr_dev(div0, "class", "col-sm-3");
			add_location(div0, file, 168, 20, 6730);
			option0.__value = "*.txt,*.doc,*.docx,*.pdf,*.jpg,*.png,*.gif,*.bmp,*.jpeg";
			option0.value = option0.__value;
			option0.selected = "selected";
			add_location(option0, file, 173, 28, 7128);
			option1.__value = "*.txt";
			option1.value = option1.__value;
			add_location(option1, file, 174, 28, 7267);
			option2.__value = "*.pdf";
			option2.value = option2.__value;
			add_location(option2, file, 175, 28, 7333);
			option3.__value = "*.doc,*.docx";
			option3.value = option3.__value;
			add_location(option3, file, 176, 28, 7399);
			option4.__value = "*.doc,*.docx,*.pdf";
			option4.value = option4.__value;
			add_location(option4, file, 177, 28, 7479);
			option5.__value = "*.jpg,*.png,*.gif,*.bmp,*.jpeg";
			option5.value = option5.__value;
			add_location(option5, file, 178, 28, 7571);
			...
			add_location(select, file, 172, 24, 6959);
			attr_dev(div1, "class", "col-sm-8");
			add_location(div1, file, 171, 20, 6911);
			attr_dev(div2, "class", "row");
			add_location(div2, file, 167, 16, 6691);
			attr_dev(label1, "for", "files_number");
			attr_dev(label1, "class", "mb-0 font14 pt-1");
			add_location(label1, file, 184, 24, 7854);
			attr_dev(div3, "class", "col-sm-3");
			add_location(div3, file, 183, 20, 7806);
			...
			add_location(input, file, 187, 24, 8031);
			attr_dev(small, "class", "font11");
			add_location(small, file, 199, 24, 8607);
			attr_dev(div4, "class", "col-sm-8");
			add_location(div4, file, 186, 20, 7983);
			attr_dev(div5, "class", "row mt-2");
			add_location(div5, file, 182, 16, 7762);
			attr_dev(div6, "class", "upload-area mt-3 text-left svelte-j2f4ig");
			add_location(div6, file, 166, 12, 6633);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=Essay-c17c2115.js.map
