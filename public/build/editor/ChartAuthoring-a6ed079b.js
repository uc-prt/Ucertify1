...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 221, 32, 10009);
			...
			add_location(button0, file$1, 220, 28, 9766);
			attr_dev(span1, "class", "icomoon-new-24px-delete-1 s2 updateGraph");
			add_location(span1, file$1, 224, 32, 10389);
			...
			add_location(button1, file$1, 223, 28, 10125);
			add_location(span2, file$1, 219, 24, 9731);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$1, 229, 172, 10894);
			...
			add_location(div2, file$1, 234, 16, 11073);
			...
			add_location(div3, file$1, 216, 12, 9486);
			add_location(center, file$1, 215, 8, 9465);
			...
			add_location(textarea, file$1, 237, 8, 11561);
			attr_dev(div4, "id", "authoringDiv");
			add_location(div4, file$1, 213, 4, 9407);
			add_location(main, file$1, 212, 0, 9396);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=ChartAuthoring-a6ed079b.js.map
