...
import { O as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, P as Dialog, Q as binding_callbacks, R as bind, T as Snackbar, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, U as Draggable, V as Button, W as Checkbox, N as JSONToXML, y as l, w as writable, e as element, f as space, c as create_component, j as attr_dev, l as set_style, k as add_location, Y as src_url_equal, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, G as prop_dev, Z as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as run_all, _ as select_value, h as text, $ as add_render_callback, a0 as set_input_value, a1 as select_option, B as noop } from './main-cdf6a001.js';
...
// (941:8) <Dialog class="remove_right_margin" width="600" bind:visible={state.openImg} style="background: #fff; border-radius: 5px;">
function create_default_slot_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 943, 20, 46844);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 942, 16, 46778);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 941, 12, 46731);
			...
			add_location(input0, file, 948, 20, 47029);
			...
			add_location(button, file, 957, 20, 47409);
			attr_dev(div2, "class", "d-flex");
			add_location(div2, file, 947, 16, 46987);
			...
			add_location(img, file, 966, 20, 47812);
			attr_dev(div3, "class", "mx-auto width8 p-2 border mt-2");
			add_location(div3, file, 965, 16, 47746);
			...
			add_location(label0, file, 969, 20, 47961);
			add_location(span0, file, 968, 16, 47933);
			...
			add_location(input1, file, 971, 16, 48106);
			attr_dev(label1, "for", "hotBorder");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 983, 28, 48698);
			add_location(span1, file, 982, 24, 48662);
			option0.__value = "0";
			option0.value = option0.__value;
			add_location(option0, file, 986, 28, 48926);
			option1.__value = "1";
			option1.value = option1.__value;
			add_location(option1, file, 987, 28, 48987);
			option2.__value = "2";
			option2.value = option2.__value;
			add_location(option2, file, 988, 28, 49045);
			option3.__value = "3";
			option3.value = option3.__value;
			add_location(option3, file, 989, 28, 49103);
			option4.__value = "4";
			option4.value = option4.__value;
			add_location(option4, file, 990, 28, 49161);
			option5.__value = "5";
			option5.value = option5.__value;
			add_location(option5, file, 991, 28, 49219);
			...
			add_location(select0, file, 985, 24, 48823);

			attr_dev(div4, "class", div4_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block pr-2 mt-2 w-sm"
			: "hidden");

			add_location(div4, file, 981, 20, 48551);
			attr_dev(label2, "for", "hotBorderColor");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 996, 28, 49474);
			add_location(span2, file, 995, 24, 49438);
			option6.__value = "white";
			option6.value = option6.__value;
			add_location(option6, file, 999, 28, 49717);
			option7.__value = "black";
			option7.value = option7.__value;
			add_location(option7, file, 1000, 28, 49782);
			option8.__value = "grey";
			option8.value = option8.__value;
			add_location(option8, file, 1001, 28, 49848);
			...
			add_location(select1, file, 998, 24, 49604);

			attr_dev(div5, "class", div5_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block mt-2 w-sm"
			: "hidden");

			add_location(div5, file, 994, 20, 49332);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 980, 16, 48509);
			add_location(br, file, 1005, 16, 49987);
			attr_dev(label3, "for", "setLineColor");
			attr_dev(label3, "class", "mt-2 text-dark");
			add_location(label3, file, 1008, 24, 50121);
			add_location(span3, file, 1007, 20, 50089);
			option9.__value = "Please Select";
			option9.value = option9.__value;
			add_location(option9, file, 1011, 24, 50379);
			option10.__value = "red";
			option10.value = option10.__value;
			add_location(option10, file, 1012, 24, 50435);
			option11.__value = "black";
			option11.value = option11.__value;
			add_location(option11, file, 1013, 24, 50493);
			option12.__value = "blue";
			option12.value = option12.__value;
			add_location(option12, file, 1014, 24, 50555);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(941:8) <Dialog class=\\\"remove_right_margin\\\" width=\\\"600\\\" bind:visible={state.openImg} style=\\\"background: #fff; border-radius: 5px;\\\">",
		ctx
	});
...
// (1020:16) <Button                      on:click={handleClose}                      unelevated={true}                      outlined={true}                      class="text-capitalize"                      color="#ccc"                  >
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1020:16) <Button                      on:click={handleClose}                      unelevated={true}                      outlined={true}                      class=\\\"text-capitalize\\\"                      color=\\\"#ccc\\\"                  >",
		ctx
	});
...
// (1028:16) <Button                      on:click={handleSubmit.bind(this, 'img')}                      class="bg-primary text-white"                      style="text-transform: none"                      key={l.submit}                  >
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1028:16) <Button                      on:click={handleSubmit.bind(this, 'img')}                      class=\\\"bg-primary text-white\\\"                      style=\\\"text-transform: none\\\"                      key={l.submit}                  >",
		ctx
	});
...
function create_footer_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1018, 12, 50678);
		},
		m: function mount(target, anchor) {
...
// (1037:8) <Dialog class="remove_right_margin" width="600" bind:visible={state.openDrag} style="background: #fff; border-radius: 5px;">
function create_default_slot_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1039, 20, 51583);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 1038, 16, 51517);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 1037, 12, 51470);
			attr_dev(label0, "for", "dragHeight");
			attr_dev(label0, "class", "my-1 text-dark");
			add_location(label0, file, 1046, 28, 51853);
			add_location(span0, file, 1045, 24, 51817);
			attr_dev(input0, "type", "number");
			attr_dev(input0, "id", "dragHeight");
			attr_dev(input0, "placeholder", "Height");
			attr_dev(input0, "defaultvalue", " ");
			attr_dev(input0, "class", "form-control");
			add_location(input0, file, 1048, 24, 51973);
			attr_dev(div2, "class", "col-6 pr-1");
			add_location(div2, file, 1044, 20, 51767);
			attr_dev(label1, "for", "dragWidth");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1058, 28, 52377);
			add_location(span1, file, 1057, 24, 52341);
			attr_dev(input1, "type", "number");
			attr_dev(input1, "id", "dragWidth");
			attr_dev(input1, "placeholder", "Width");
			attr_dev(input1, "defaultvalue", " ");
			attr_dev(input1, "class", "form-control");
			add_location(input1, file, 1060, 24, 52495);
			attr_dev(div3, "class", "col-6 pl-1");
			add_location(div3, file, 1056, 20, 52291);
			attr_dev(div4, "class", "row");
			add_location(div4, file, 1043, 16, 51728);
			attr_dev(label2, "for", "dragTop");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1072, 28, 52961);
			add_location(span2, file, 1071, 24, 52925);
			attr_dev(input2, "type", "number");
			attr_dev(input2, "id", "dragTop");
			attr_dev(input2, "placeholder", "Top");
			attr_dev(input2, "defaultvalue", " ");
			attr_dev(input2, "class", "form-control");
			add_location(input2, file, 1074, 24, 53075);
			attr_dev(div5, "class", "col-6 pr-1");
			add_location(div5, file, 1070, 20, 52875);
			attr_dev(label3, "for", "dragLeft");
			attr_dev(label3, "class", "my-1 text-dark");
			add_location(label3, file, 1084, 28, 53473);
			add_location(span3, file, 1083, 24, 53437);
			attr_dev(input3, "type", "number");
			attr_dev(input3, "id", "dragLeft");
			attr_dev(input3, "placeholder", "Left");
			attr_dev(input3, "defaultvalue", " ");
			attr_dev(input3, "class", "form-control");
			add_location(input3, file, 1086, 24, 53589);
			attr_dev(div6, "class", "col-6 pl-1");
			add_location(div6, file, 1082, 20, 53387);
			attr_dev(div7, "class", "row mt-2");
			add_location(div7, file, 1069, 16, 52831);
			set_style(div8, "overflow-y", "auto");
			set_style(div8, "padding-right", "20px");
			add_location(div8, file, 1042, 12, 51658);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h4, anchor);
			append_dev(h4, div1);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1037:8) <Dialog class=\\\"remove_right_margin\\\" width=\\\"600\\\" bind:visible={state.openDrag} style=\\\"background: #fff; border-radius: 5px;\\\">",
		ctx
	});
...
// (1098:16) <Button                      on:click={handleClose}                      unelevated={true}                      outlined={true}                      class="text-capitalize"                      color="#ccc"                  >
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1098:16) <Button                      on:click={handleClose}                      unelevated={true}                      outlined={true}                      class=\\\"text-capitalize\\\"                      color=\\\"#ccc\\\"                  >",
		ctx
	});
...
// (1106:16) <Button                      on:click={handleSubmit.bind(this, 'drag')}                      class="bg-primary text-white"                      style="text-transform: none"                      key={l.done}                  >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1106:16) <Button                      on:click={handleSubmit.bind(this, 'drag')}                      class=\\\"bg-primary text-white\\\"                      style=\\\"text-transform: none\\\"                      key={l.done}                  >",
		ctx
	});
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 1096, 12, 53943);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(button0, div, null);
...
// (1116:8) <Snackbar bind:visible={state.snackback} bg="#f44336" bottom={true} timeout={10} style="position:fixed; bottom:50px">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1116:8) <Snackbar bind:visible={state.snackback} bg=\\\"#f44336\\\" bottom={true} timeout={10} style=\\\"position:fixed; bottom:50px\\\">",
		ctx
	});
...
// (1119:16) <Button color="#ff0" on:click={() => (state.snackback = false)}>
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1119:16) <Button color=\\\"#ff0\\\" on:click={() => (state.snackback = false)}>",
		ctx
	});
...
function create_action_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1117, 12, 54768);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div1, file, 857, 20, 43093);
			...
			add_location(div4, file, 866, 16, 43574);
			attr_dev(div5, "class", "drawImage d-none");
			add_location(div5, file, 848, 12, 42778);
			attr_dev(i1, "class", "icomoon-24px-edit-1");
			add_location(i1, file, 901, 24, 45030);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light px-1 pt-sm1 pb-sm1 mt");
			add_location(button1, file, 896, 20, 44799);
			attr_dev(div6, "class", "btn-group tools");
			add_location(div6, file, 895, 16, 44748);
			attr_dev(img, "id", "im");
			...
			add_location(img, file, 904, 16, 45138);
			attr_dev(i2, "class", "icomoon-24px-edit-1");
			add_location(i2, file, 928, 28, 46219);
			attr_dev(button2, "type", "button");
			attr_dev(button2, "class", "btn btn-light px-1 pt-sm1 pb-sm1");
			add_location(button2, file, 923, 24, 45969);
			attr_dev(div7, "class", "btn-group tools h");
			add_location(div7, file, 922, 20, 45912);
			...
			add_location(div8, file, 916, 16, 45620);
			...
			add_location(div9, file, 889, 12, 44546);
			...
			add_location(textarea, file, 933, 12, 46375);
			attr_dev(center, "class", "mt");
			attr_dev(center, "id", "mainContent");
			add_location(center, file, 829, 8, 42118);
			add_location(div10, file, 828, 4, 42103);
		},
...
//# sourceMappingURL=Hotspot-164da130.js.map
