...
function create_default_slot_1(ctx) {
	...
	let t0;
	let h4;
	let t1_value = l.calculate_answer + "";
	let t1;
	let br;
	let t2;
	let t3_value = l.please_wait + "";
	let t3;
	let current;
...
function create_title_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "style", "");
			add_location(div0, file, 352, 2, 14503);
			attr_dev(div1, "slot", "title");
			set_style(div1, "text-align", "left");
			add_location(div1, file, 351, 1, 14455);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=Labsimulation-8ba14651.js.map
