...
import { O as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, P as Dialog, Q as binding_callbacks, R as bind, T as Snackbar, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, U as Draggable, V as Button, W as Checkbox, N as JSONToXML, y as l, w as writable, e as element, f as space, c as create_component, j as attr_dev, l as set_style, k as add_location, Y as src_url_equal, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, G as prop_dev, Z as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as run_all, _ as select_value, h as text, $ as add_render_callback, a0 as set_input_value, a1 as select_option, B as noop } from './main-f7ef01f7.js';
...
function create_default_slot_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option0, file, 986, 28, 48925);
			option1.__value = "1";
			option1.value = option1.__value;
			add_location(option1, file, 987, 28, 48986);
			option2.__value = "2";
			option2.value = option2.__value;
			add_location(option2, file, 988, 28, 49044);
			option3.__value = "3";
			option3.value = option3.__value;
			add_location(option3, file, 989, 28, 49102);
			option4.__value = "4";
			option4.value = option4.__value;
			add_location(option4, file, 990, 28, 49160);
			option5.__value = "5";
			option5.value = option5.__value;
			add_location(option5, file, 991, 28, 49218);
			...
			add_location(label2, file, 996, 28, 49473);
			add_location(span2, file, 995, 24, 49437);
			option6.__value = "white";
			option6.value = option6.__value;
			add_location(option6, file, 999, 28, 49715);
			option7.__value = "black";
			option7.value = option7.__value;
			add_location(option7, file, 1000, 28, 49780);
			option8.__value = "grey";
			option8.value = option8.__value;
			add_location(option8, file, 1001, 28, 49846);
			...
			add_location(select1, file, 998, 24, 49603);

			attr_dev(div5, "class", div5_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block mt-2 w-sm"
			: "hidden");

			add_location(div5, file, 994, 20, 49331);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 980, 16, 48509);
			add_location(br, file, 1005, 16, 49985);
			attr_dev(label3, "for", "setLineColor");
			attr_dev(label3, "class", "mt-2 text-dark");
			add_location(label3, file, 1008, 24, 50119);
			add_location(span3, file, 1007, 20, 50087);
			option9.__value = "Please Select";
			option9.value = option9.__value;
			add_location(option9, file, 1011, 24, 50376);
			option10.__value = "red";
			option10.value = option10.__value;
			add_location(option10, file, 1012, 24, 50432);
			option11.__value = "black";
			option11.value = option11.__value;
			add_location(option11, file, 1013, 24, 50490);
			option12.__value = "blue";
			option12.value = option12.__value;
			add_location(option12, file, 1014, 24, 50552);
			...
			add_location(select2, file, 1010, 20, 50242);
			attr_dev(div7, "class", div7_class_value = /*state*/ ctx[7].valueMultiple == 3 ? "" : "hidden");
			add_location(div7, file, 1006, 16, 50009);
...
function create_footer_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1018, 12, 50675);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1039, 20, 51580);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 1038, 16, 51514);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 1037, 12, 51467);
			attr_dev(label0, "for", "dragHeight");
			attr_dev(label0, "class", "my-1 text-dark");
			add_location(label0, file, 1046, 28, 51850);
			add_location(span0, file, 1045, 24, 51814);
			attr_dev(input0, "type", "number");
			attr_dev(input0, "id", "dragHeight");
			attr_dev(input0, "placeholder", "Height");
			attr_dev(input0, "defaultvalue", " ");
			attr_dev(input0, "class", "form-control");
			add_location(input0, file, 1048, 24, 51970);
			attr_dev(div2, "class", "col-6 pr-1");
			add_location(div2, file, 1044, 20, 51764);
			attr_dev(label1, "for", "dragWidth");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1058, 28, 52374);
			add_location(span1, file, 1057, 24, 52338);
			attr_dev(input1, "type", "number");
			attr_dev(input1, "id", "dragWidth");
			attr_dev(input1, "placeholder", "Width");
			attr_dev(input1, "defaultvalue", " ");
			attr_dev(input1, "class", "form-control");
			add_location(input1, file, 1060, 24, 52492);
			attr_dev(div3, "class", "col-6 pl-1");
			add_location(div3, file, 1056, 20, 52288);
			attr_dev(div4, "class", "row");
			add_location(div4, file, 1043, 16, 51725);
			attr_dev(label2, "for", "dragTop");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1072, 28, 52958);
			add_location(span2, file, 1071, 24, 52922);
			attr_dev(input2, "type", "number");
			attr_dev(input2, "id", "dragTop");
			attr_dev(input2, "placeholder", "Top");
			attr_dev(input2, "defaultvalue", " ");
			attr_dev(input2, "class", "form-control");
			add_location(input2, file, 1074, 24, 53072);
			attr_dev(div5, "class", "col-6 pr-1");
			add_location(div5, file, 1070, 20, 52872);
			attr_dev(label3, "for", "dragLeft");
			attr_dev(label3, "class", "my-1 text-dark");
			add_location(label3, file, 1084, 28, 53470);
			add_location(span3, file, 1083, 24, 53434);
			attr_dev(input3, "type", "number");
			attr_dev(input3, "id", "dragLeft");
			attr_dev(input3, "placeholder", "Left");
			attr_dev(input3, "defaultvalue", " ");
			attr_dev(input3, "class", "form-control");
			add_location(input3, file, 1086, 24, 53586);
			attr_dev(div6, "class", "col-6 pl-1");
			add_location(div6, file, 1082, 20, 53384);
			attr_dev(div7, "class", "row mt-2");
			add_location(div7, file, 1069, 16, 52828);
			set_style(div8, "overflow-y", "auto");
			set_style(div8, "padding-right", "20px");
			add_location(div8, file, 1042, 12, 51655);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h4, anchor);
			append_dev(h4, div1);
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 1096, 12, 53940);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(button0, div, null);
...
function create_action_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1117, 12, 54765);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=Hotspot-5449bbd8.js.map
