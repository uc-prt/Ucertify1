...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 637, 7, 21178);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 638, 7, 21270);
			...
			add_location(div0, file, 633, 6, 20996);
			...
			add_location(div1, file, 625, 5, 20787);
			...
			add_location(div2, file, 641, 5, 21356);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 624, 4, 20752);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 585, 10, 19689);
			...
			add_location(div0, file, 594, 10, 19984);
			...
			add_location(span, file, 607, 10, 20348);
			...
			add_location(div1, file, 572, 9, 19306);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 571, 8, 19264);
			attr_dev(td, "class", "border");
			add_location(td, file, 570, 7, 19235);
			add_location(tr, file, 569, 6, 19222);
			add_location(tbody, file, 568, 5, 19207);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table no_overflow_wrapper");
			add_location(table, file, 567, 4, 19102);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 655, 6, 21772);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 564, 2, 18965);
			add_location(center, file, 554, 1, 18680);
			...
			add_location(input, file, 666, 1, 22032);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 553, 0, 18671);
		},
...
//# sourceMappingURL=HotspotPreview-2175813e.js.map
