...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h4, file, 2240, 20, 133167);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "close");
			attr_dev(button0, "data-bs-dismiss", "modal");
			add_location(button0, file, 2241, 20, 133231);
			attr_dev(div0, "class", "modal-header");
			add_location(div0, file, 2239, 16, 133119);
			attr_dev(td0, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td0, file, 2247, 61, 133698);
			attr_dev(span0, "class", "pl-3 font-weight-bold");
			add_location(span0, file, 2247, 155, 133792);
			attr_dev(div1, "class", "d-flex");
			add_location(div1, file, 2247, 135, 133772);
			attr_dev(td1, "class", "py-1");
			add_location(td1, file, 2247, 118, 133755);
			attr_dev(tr0, "tabindex", "0");
			attr_dev(tr0, "role", "shortcut");
			add_location(tr0, file, 2247, 28, 133665);
			attr_dev(td2, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td2, file, 2248, 61, 133925);
			attr_dev(span1, "class", "pl-3");
			add_location(span1, file, 2248, 157, 134021);
			attr_dev(div2, "class", "d-flex");
			add_location(div2, file, 2248, 137, 134001);
			attr_dev(td3, "class", "py-1");
			add_location(td3, file, 2248, 120, 133984);
			attr_dev(tr1, "tabindex", "0");
			attr_dev(tr1, "role", "shortcut");
			add_location(tr1, file, 2248, 28, 133892);
			attr_dev(td4, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td4, file, 2249, 62, 134135);
			attr_dev(span2, "class", "pl-3");
			add_location(span2, file, 2249, 158, 134231);
			attr_dev(div3, "class", "d-flex");
			add_location(div3, file, 2249, 138, 134211);
			attr_dev(td5, "class", "py-1");
			add_location(td5, file, 2249, 121, 134194);
			attr_dev(tr2, "tabindex", "0");
			attr_dev(tr2, "role", "shortcut");
			add_location(tr2, file, 2249, 28, 134101);
			attr_dev(td6, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td6, file, 2250, 62, 134344);
			attr_dev(span3, "class", "pl-3");
			add_location(span3, file, 2250, 158, 134440);
			attr_dev(div4, "class", "d-flex");
			add_location(div4, file, 2250, 138, 134420);
			attr_dev(td7, "class", "py-1");
			add_location(td7, file, 2250, 121, 134403);
			attr_dev(tr3, "tabindex", "0");
			attr_dev(tr3, "role", "shortcut");
			add_location(tr3, file, 2250, 28, 134310);
			attr_dev(td8, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td8, file, 2251, 62, 134554);
			attr_dev(span4, "class", "pl-3");
			add_location(span4, file, 2251, 157, 134649);
			attr_dev(div5, "class", "d-flex");
			add_location(div5, file, 2251, 137, 134629);
			attr_dev(td9, "class", "py-1");
			add_location(td9, file, 2251, 120, 134612);
			attr_dev(tr4, "tabindex", "0");
			attr_dev(tr4, "role", "shortcut");
			add_location(tr4, file, 2251, 28, 134520);
			attr_dev(td10, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td10, file, 2252, 62, 134770);
			attr_dev(span5, "class", "pl-3");
			add_location(span5, file, 2252, 163, 134871);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 2252, 143, 134851);
			attr_dev(td11, "class", "py-1");
			add_location(td11, file, 2252, 126, 134834);
			attr_dev(tr5, "tabindex", "0");
			attr_dev(tr5, "role", "shortcut");
			add_location(tr5, file, 2252, 28, 134736);
			attr_dev(td12, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td12, file, 2253, 62, 134996);
			attr_dev(span6, "class", "pl-3");
			add_location(span6, file, 2253, 163, 135097);
			attr_dev(div7, "class", "d-flex");
			add_location(div7, file, 2253, 143, 135077);
			attr_dev(td13, "class", "py-1");
			add_location(td13, file, 2253, 126, 135060);
			attr_dev(tr6, "tabindex", "0");
			attr_dev(tr6, "role", "shortcut");
			add_location(tr6, file, 2253, 28, 134962);
			attr_dev(td14, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td14, file, 2254, 62, 135220);
			attr_dev(span7, "class", "pl-3");
			add_location(span7, file, 2254, 159, 135317);
			attr_dev(div8, "class", "d-flex");
			add_location(div8, file, 2254, 139, 135297);
			attr_dev(td15, "class", "py-1");
			add_location(td15, file, 2254, 122, 135280);
			attr_dev(tr7, "tabindex", "0");
			attr_dev(tr7, "role", "shortcut");
			add_location(tr7, file, 2254, 28, 135186);
			attr_dev(td16, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td16, file, 2255, 62, 135438);
			attr_dev(span8, "class", "pl-3");
			add_location(span8, file, 2255, 160, 135536);
			attr_dev(div9, "class", "d-flex");
			add_location(div9, file, 2255, 140, 135516);
			attr_dev(td17, "class", "py-1");
			add_location(td17, file, 2255, 123, 135499);
			attr_dev(tr8, "tabindex", "0");
			attr_dev(tr8, "role", "shortcut");
			add_location(tr8, file, 2255, 28, 135404);
			attr_dev(td18, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td18, file, 2256, 62, 135654);
			attr_dev(span9, "class", "pl-3");
			add_location(span9, file, 2256, 155, 135747);
			attr_dev(div10, "class", "d-flex");
			add_location(div10, file, 2256, 135, 135727);
			attr_dev(td19, "class", "py-1");
			add_location(td19, file, 2256, 118, 135710);
			attr_dev(tr9, "tabindex", "0");
			attr_dev(tr9, "role", "shortcut");
			add_location(tr9, file, 2256, 28, 135620);
			attr_dev(td20, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td20, file, 2257, 62, 135867);
			attr_dev(span10, "class", "pl-3");
			add_location(span10, file, 2257, 161, 135966);
			attr_dev(div11, "class", "d-flex");
			add_location(div11, file, 2257, 141, 135946);
			attr_dev(td21, "class", "py-1");
			add_location(td21, file, 2257, 124, 135929);
			attr_dev(tr10, "tabindex", "0");
			attr_dev(tr10, "role", "shortcut");
			add_location(tr10, file, 2257, 28, 135833);
			attr_dev(td22, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td22, file, 2258, 62, 136086);
			attr_dev(span11, "class", "pl-3");
			add_location(span11, file, 2258, 155, 136179);
			attr_dev(div12, "class", "d-flex");
			add_location(div12, file, 2258, 135, 136159);
			attr_dev(td23, "class", "py-1");
			add_location(td23, file, 2258, 118, 136142);
			attr_dev(tr11, "tabindex", "0");
			attr_dev(tr11, "role", "shortcut");
			add_location(tr11, file, 2258, 28, 136052);
			attr_dev(tbody, "tabindex", "0");
			attr_dev(tbody, "role", "shortcut");
			add_location(tbody, file, 2246, 24, 133599);
			...
			add_location(button4, file, 2275, 24, 137079);
			...
			add_location(button5, file, 2276, 24, 137377);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file, 2277, 252, 137854);
			...
			add_location(button6, file, 2277, 24, 137626);
			...
			add_location(div18, file, 2274, 20, 136973);
			attr_dev(i2, "class", "icomoon-delete-sm");
			add_location(i2, file, 2280, 224, 138255);
			...
			add_location(button7, file, 2280, 24, 138055);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file, 2281, 209, 138508);
			...
			add_location(button8, file, 2281, 24, 138323);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file, 2282, 178, 138728);
			...
			add_location(button9, file, 2282, 24, 138574);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file, 2283, 178, 138947);
			...
			add_location(button10, file, 2283, 24, 138793);
			...
			add_location(div19, file, 2279, 20, 137945);
			...
			add_location(button11, file, 2286, 24, 139146);
			...
			add_location(div20, file, 2285, 20, 139036);
			attr_dev(i6, "class", "icomoon-new-24px-reset-1");
			add_location(i6, file, 2289, 182, 139638);
			...
			add_location(button12, file, 2289, 24, 139480);
			...
			add_location(div21, file, 2288, 20, 139380);
			...
			add_location(button13, file, 2292, 24, 139829);
			...
			add_location(div22, file, 2291, 20, 139737);
			...
			add_location(div23, file, 2273, 16, 136858);
			attr_dev(div24, "class", "mt-2 mb-3 previewBtnGrp");
			add_location(div24, file, 2272, 12, 136803);
			...
			add_location(circle0, file, 2312, 36, 141217);
			...
			add_location(line, file, 2314, 40, 141391);
			add_location(g5, file, 2313, 36, 141346);
			...
			add_location(circle1, file, 2317, 40, 141622);
			attr_dev(title1, "id", "compassCenterTitle");
			add_location(title1, file, 2318, 40, 141876);
			attr_dev(desc0, "id", "compassCenterDesc");
			add_location(desc0, file, 2319, 40, 141975);
			...
			add_location(path0, file, 2323, 52, 142351);
			...
			add_location(path1, file, 2324, 52, 142502);
			...
			add_location(path2, file, 2325, 52, 142651);
			...
			add_location(circle3, file, 2333, 40, 143296);
			attr_dev(title2, "id", "compassRadiusTitle");
			add_location(title2, file, 2334, 40, 143576);
			attr_dev(desc1, "id", "compassRadiusDesc");
			add_location(desc1, file, 2335, 40, 143721);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file, 2341, 60, 144226);
			add_location(g7, file, 2340, 56, 144161);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file, 2344, 60, 144464);
			add_location(g8, file, 2343, 56, 144399);
			add_location(g9, file, 2339, 52, 144100);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file, 2349, 60, 144818);
			add_location(g10, file, 2348, 56, 144753);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file, 2352, 60, 145076);
			add_location(g11, file, 2351, 56, 145011);
			add_location(g12, file, 2347, 52, 144692);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file, 2338, 48, 143981);
			attr_dev(pattern1, "id", "previewDrawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file, 2337, 44, 143873);
			add_location(defs1, file, 2336, 40, 143821);
			add_location(g13, file, 2332, 36, 143251);
			...
			add_location(circle4, file, 2360, 40, 145561);
			attr_dev(title3, "id", "compassRotationTitle");
			add_location(title3, file, 2361, 40, 145938);
			attr_dev(desc2, "id", "compassRotationDesc");
			add_location(desc2, file, 2362, 40, 146071);
			...
			add_location(circle5, file, 2372, 40, 147097);
			...
			add_location(circle6, file, 2373, 40, 147253);
			attr_dev(title4, "id", "compassAngleTitle");
			add_location(title4, file, 2374, 40, 147491);
			attr_dev(desc3, "id", "compassAngleDesc");
			add_location(desc3, file, 2375, 40, 147587);
			add_location(g15, file, 2371, 36, 147052);
			...
			add_location(circle7, file, 2378, 40, 147767);
			...
			add_location(path7, file, 2386, 68, 148880);
			...
			add_location(g19, file, 2382, 52, 148275);
			...
			add_location(svg3, file, 2381, 48, 148127);
			attr_dev(pattern3, "id", "previewLastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file, 2380, 44, 148014);
			add_location(defs3, file, 2379, 40, 147962);
			add_location(g20, file, 2377, 36, 147722);
			add_location(g21, file, 2311, 32, 141176);
			add_location(svg4, file, 2310, 28, 141137);
			attr_dev(svg5, "class", "drawingCompassSvg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file, 2309, 24, 141056);
			...
			add_location(svg6, file, 2302, 20, 140515);
			attr_dev(div26, "id", "centerImg");
			attr_dev(div26, "class", "centerImg centerImgPreview my-auto relative ml-0");
			add_location(div26, file, 2297, 16, 140150);
			add_location(div27, file, 2296, 12, 140127);
			attr_dev(center, "class", "preview_drawing_container");
			add_location(center, file, 2271, 8, 136747);
			attr_dev(div28, "class", "drawing_module_container");
			add_location(div28, file, 2268, 4, 136551);
			attr_dev(main, "id", "drawingPreviewMain");
			add_location(main, file, 2235, 0, 132900);
		},
...
//# sourceMappingURL=DrawingPreview-b0e130f6.js.map
