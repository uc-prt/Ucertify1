...
import { F as FillInTheBlanksToolbar } from './mathquill-734bcd1e.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div4, file, 863, 2, 31172);
			add_location(center1, file, 855, 1, 30972);
			attr_dev(div5, "class", div5_class_value = /*xml*/ ctx[2] ? "mx-4 pl-2 pl-md-0" : "");
			add_location(div5, file, 854, 0, 30926);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 897, 0, 32148);
		},
...
//# sourceMappingURL=FillInTheBlanksPreview-10308bd6.js.map
