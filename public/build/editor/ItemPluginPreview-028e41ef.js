...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, J as append_styles, v as validate_slots, I as beforeUpdate, A as AH, X as XMLToJSON, o as onMount, w as writable, y as l, aa as afterUpdate, K as JSONToXML, a2 as onUserAnsChange, C as validate_each_argument, N as binding_callbacks, O as bind, e as element, c as create_component, f as space, j as attr_dev, k as add_location, n as insert_dev, m as mount_component, p as append_dev, q as listen_dev, Y as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as destroy_each, r as group_outros, u as check_outros } from './main-45bc4ad8.js';
import { I as ItemHelper } from './ItemHelper-235435bf.js';
import './style-inject.es-1c867377.js';
import { F as FillInTheBlanksToolbar } from './mathquill-12e70b0b.js';
...
function add_css(target) {
	append_styles(target, "svelte-1g1j92b", ".darkgrey_border{border:1px solid #ccc!important}.p-lg{padding:15px}.true-hover{outline:0;border:2px solid #14ca14!important}.false-hover{outline:0;border:1px solid #e45252!important}.default-hover{border-color:transparent!important;-webkit-box-shadow:inset 0 1px 0px 0px rgba(0,0,0,.075), 0 0 1px rgba(2, 2, 2, 0.9)!important;-moz-box-shadow:inset 0 1px 0px 0px rgba(0,0,0,.075), 0 0 1px rgba(2, 2, 2, 0.9)!important;box-shadow:inset 0 1px 0px 0px rgba(0,0,0,.075), 0 0 1px rgba(2, 2, 2, 0.9)!important}.blocked{display:block !important}.border_green{border:3px solid green!important}.border_red{border:3px solid red!important}.sticky{z-index:800;position:sticky;top:0\r\n\t}.corr_div{position:absolute!important;width:38px;line-height:30px;background-color:#21a81d;color:#ffffff;z-index:1;display:inline-block;vertical-align:middle;cursor:default}.corr_div_correct{position:relative;width:38px;line-height:30px;background-color:#21a81d;color:#ffffff;z-index:1;display:inline-block;vertical-align:middle;cursor:default}[id^=\"fillmain\"]{overflow:hidden;text-align:left}[id^=\"fillmain\"] pre{background:none;border:none;font-size:14px!important}[id^=\"fillmain\"] .string{min-height:50px;margin-top:10px;margin-right:10px}[id^=\"fillmain\"] .footerstr{position:relative;margin-top:10px;background-color:#ccc;padding:15px;min-height:60px}[id^=\"fillmain\"] .footerstr .arrow-up{position:absolute;top:-10px;right:50%;width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-bottom:10px solid #ccc}[id^=\"fillmain\"] .fill-row{padding:6px}#fillmain .fillelement{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}#fillmain .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}[id^=\"fillmain\"] input[type=\"text\"]{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}[id^=\"fillmain\"] select{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}[id^=\"fillmain\"] .drag-resize{vertical-align:middle;border:1px solid #31B731;text-align:center;padding:3px;font-size:14px}[id^=\"fillmain\"] .drag-resize.ui-draggable{cursor:move}[id^=\"fillmain\"] .drop-hover{border:1px dashed red!important;box-shadow:0 0 0 2px yellow inset;outline:1px solid blue}[id^=\"fillmain\"] .fillcheck ul{width:220px}[id^=\"fillmain\"] .fillcheck li.selected{background-color:#E5E5E5}.fillcheck .selected .icomoon-checkmark-3:before{float:left;color:blue;padding:3px;position:relative;right:14px}.fillcheck .icomoon-close-2:before{float:left;color:blue;position:relative;right:14px;font-size:20px}.MathJax_Display{display:inline!important}[id^=\"fillmain\"] .select{font-size:15px}[id^=\"fillmain\"] .textarea{vertical-align:middle;border-radius:3px;background:#ffe;border:1px solid #ccc;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075);box-shadow:inset 0 1px 1px rgba(0,0,0,0.075)}.ui-draggable-disabled{cursor:no-drop!important;opacity:0.5!important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_if_block(ctx) {
	...
	let each_value = /*state*/ ctx[5].itemArray;
	...
	function fillintheblankstoolbar_display_binding(value) {
		/*fillintheblankstoolbar_display_binding*/ ctx[15](value);
	}

	let fillintheblankstoolbar_props = {
		spanId: /*state*/ ctx[5].spanId,
		divId: /*state*/ ctx[5].divId,
		action: /*fill_math*/ ctx[2][/*fillId*/ ctx[4]],
		show: /*toggleToolbar*/ ctx[7]
	};

	if (/*state*/ ctx[5].showToolbar !== void 0) {
		fillintheblankstoolbar_props.display = /*state*/ ctx[5].showToolbar;
	}
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", div0_class_value = 'inNativeStyle');
			attr_dev(div0, "style", div0_style_value = "width:" + (AH.isValid(window.inNative) ? "100%" : "700px"));
			add_location(div0, file, 1136, 3, 35632);
			...
			add_location(button, file, 1166, 4, 37353);
			attr_dev(div1, "class", div1_class_value = /*state*/ ctx[5].hideNext ? 'h-imp' : null);
			add_location(div1, file, 1165, 3, 37303);
			add_location(center, file, 1127, 2, 35417);
		},
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*isSticky, state, special_module, isReview*/ 105) {
				each_value = /*state*/ ctx[5].itemArray;
				validate_each_argument(each_value);
				let i;
			...
			if (dirty[0] & /*fill_math, fillId*/ 20) fillintheblankstoolbar_changes.action = /*fill_math*/ ctx[2][/*fillId*/ ctx[4]];

			if (!updating_display && dirty[0] & /*state*/ 32) {
				updating_display = true;
				fillintheblankstoolbar_changes.display = /*state*/ ctx[5].showToolbar;
				add_flush_callback(() => updating_display = false);
			}

			fillintheblankstoolbar.$set(fillintheblankstoolbar_changes);

			if (!current || dirty[0] & /*state*/ 32 && div1_class_value !== (div1_class_value = /*state*/ ctx[5].hideNext ? 'h-imp' : null)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1126:1) {#if state.blank == false}",
		ctx
	});
...
// (1139:4) {#each state.itemArray as item, index}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1142, 9, 36253);
			attr_dev(div1, "id", div1_id_value = 'data-block_' + /*index*/ ctx[72]);

			attr_dev(div1, "class", div1_class_value = "main_item darkgrey_border secure-icon p-lg jqsfield spanlink_nav " + (/*state*/ ctx[5].display == 1 && /*special_module*/ ctx[3]?.smans && /*special_module*/ ctx[3]?.smans["s" + /*index*/ ctx[72]] != undefined && /*isReview*/ ctx[0]
			? /*special_module*/ ctx[3]?.smans["s" + /*index*/ ctx[72]].overall == 1
				? 'border_green'
				: 'border_red'
			: ''));

			attr_dev(div1, "key", div1_key_value = /*index*/ ctx[72]);
			add_location(div1, file, 1141, 8, 35925);
			attr_dev(div2, "id", div2_id_value = "s" + /*index*/ ctx[72]);
			attr_dev(div2, "class", div2_class_value = "bg-white");
			add_location(div2, file, 1140, 7, 35876);
			attr_dev(div3, "data-sticky", div3_data_sticky_value = /*isSticky*/ ctx[6](/*index*/ ctx[72]));
			attr_dev(div3, "class", "bt-pd bg-white mt-3");
			attr_dev(div3, "tabindex", div3_tabindex_value = 0);
			add_location(div3, file, 1139, 6, 35787);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*state*/ 32 && raw_value !== (raw_value = /*item*/ ctx[70].cdata + "")) div0.innerHTML = raw_value;
			if (dirty[0] & /*state, special_module, isReview*/ 41 && div1_class_value !== (div1_class_value = "main_item darkgrey_border secure-icon p-lg jqsfield spanlink_nav " + (/*state*/ ctx[5].display == 1 && /*special_module*/ ctx[3]?.smans && /*special_module*/ ctx[3]?.smans["s" + /*index*/ ctx[72]] != undefined && /*isReview*/ ctx[0]
			? /*special_module*/ ctx[3]?.smans["s" + /*index*/ ctx[72]].overall == 1
				? 'border_green'
				: 'border_red'
			: ''))) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1139:4) {#each state.itemArray as item, index}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 1124, 0, 35374);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ('answer_array' in $$props) answer_array = $$props.answer_array;
...
//# sourceMappingURL=ItemPluginPreview-028e41ef.js.map
