...
class DndModalBox extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-16t69t-style")) add_css();
...
function add_css$1() {
	...
	style.textContent = "#resizeX.svelte-dt0ps7{position:absolute;top:0;right:0;width:3px;opacity:1;height:100%;cursor:w-resize}#resizeY.svelte-dt0ps7{position:absolute;bottom:0;width:100%;height:3px;opacity:1;cursor:s-resize}#resizeXY.svelte-dt0ps7{position:absolute;bottom:0;right:0;opacity:1;cursor:se-resize}#resizeXY.svelte-dt0ps7::before{content:'\\e354'\r\n    }\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 835, 16, 34980);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 833, 16, 34677);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
// (838:12) {#if state.data && image_loaded}
function create_if_block$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 838, 16, 35204);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(838:12) {#if state.data && image_loaded}",
		ctx
	});
...
function create_fragment$i(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 797, 2, 33106);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 796, 4, 33075);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 830, 232, 34570);
...
class DragNDrop extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-dt0ps7-style")) add_css$1();
...
//# sourceMappingURL=DragNDrop-dd6fc91b.js.map
