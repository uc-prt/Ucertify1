...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, A as AH, y as language, X as XMLToJSON, a7 as afterUpdate, e as element, f as space, c as create_component, h as text, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as run_all, G as prop_dev } from './main-0211720b.js';
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 524, 24, 25755);
			...
			add_location(span1, file, 541, 28, 27159);
			...
			add_location(button0, file, 533, 24, 26745);
			...
			add_location(span2, file, 552, 28, 27946);
			...
			add_location(button1, file, 543, 24, 27484);
			...
			add_location(span3, file, 565, 28, 28777);
			...
			add_location(button2, file, 554, 24, 28200);
			...
			add_location(div6, file, 532, 20, 26580);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 521, 16, 25453);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 520, 12, 25395);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 516, 62, 25016);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 516, 25, 24979);
			add_location(div0, file, 516, 20, 24974);
			...
			add_location(textarea, file, 517, 20, 25074);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 515, 16, 24928);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 492, 20, 23711);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 491, 16, 23665);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 480, 20, 23170);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 479, 16, 23124);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 579, 20, 29448);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 577, 16, 29273);
			...
			add_location(div3, file, 581, 16, 29649);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 585, 20, 29912);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-b0d0d732.js.map
