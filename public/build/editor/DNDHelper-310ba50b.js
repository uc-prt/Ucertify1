...
/* clsSMDragNDrop\DNDHelper.svelte generated by Svelte v3.29.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<DNDHelper> was created with unknown prop '${key}'`);
	});
...
export { itemHelper };
//# sourceMappingURL=DNDHelper-310ba50b.js.map
