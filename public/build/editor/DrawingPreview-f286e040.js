...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, y as l, v as validate_slots, o as onMount, A as AH, a7 as swal, a6 as afterUpdate, X as XMLToJSON, a0 as onUserAnsChange, w as writable, e as element, f as space, h as text, ag as svg_element, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, E as set_data_dev, B as noop, x as detach_dev } from './main-1f6da6d4.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h4, file, 2241, 20, 133243);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "close");
			attr_dev(button0, "data-bs-dismiss", "modal");
			add_location(button0, file, 2242, 20, 133307);
			attr_dev(div0, "class", "modal-header");
			add_location(div0, file, 2240, 16, 133195);
			attr_dev(td0, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td0, file, 2249, 61, 133776);
			attr_dev(span0, "class", "pl-3 font-weight-bold");
			add_location(span0, file, 2249, 155, 133870);
			attr_dev(div1, "class", "d-flex");
			add_location(div1, file, 2249, 135, 133850);
			attr_dev(td1, "class", "py-1");
			add_location(td1, file, 2249, 118, 133833);
			attr_dev(tr0, "tabindex", "0");
			attr_dev(tr0, "role", "shortcut");
			add_location(tr0, file, 2249, 28, 133743);
			attr_dev(td2, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td2, file, 2250, 61, 134003);
			attr_dev(span1, "class", "pl-3");
			add_location(span1, file, 2250, 157, 134099);
			attr_dev(div2, "class", "d-flex");
			add_location(div2, file, 2250, 137, 134079);
			attr_dev(td3, "class", "py-1");
			add_location(td3, file, 2250, 120, 134062);
			attr_dev(tr1, "tabindex", "0");
			attr_dev(tr1, "role", "shortcut");
			add_location(tr1, file, 2250, 28, 133970);
			attr_dev(td4, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td4, file, 2251, 62, 134213);
			attr_dev(span2, "class", "pl-3");
			add_location(span2, file, 2251, 158, 134309);
			attr_dev(div3, "class", "d-flex");
			add_location(div3, file, 2251, 138, 134289);
			attr_dev(td5, "class", "py-1");
			add_location(td5, file, 2251, 121, 134272);
			attr_dev(tr2, "tabindex", "0");
			attr_dev(tr2, "role", "shortcut");
			add_location(tr2, file, 2251, 28, 134179);
			attr_dev(td6, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td6, file, 2252, 62, 134422);
			attr_dev(span3, "class", "pl-3");
			add_location(span3, file, 2252, 158, 134518);
			attr_dev(div4, "class", "d-flex");
			add_location(div4, file, 2252, 138, 134498);
			attr_dev(td7, "class", "py-1");
			add_location(td7, file, 2252, 121, 134481);
			attr_dev(tr3, "tabindex", "0");
			attr_dev(tr3, "role", "shortcut");
			add_location(tr3, file, 2252, 28, 134388);
			attr_dev(td8, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td8, file, 2253, 62, 134632);
			attr_dev(span4, "class", "pl-3");
			add_location(span4, file, 2253, 157, 134727);
			attr_dev(div5, "class", "d-flex");
			add_location(div5, file, 2253, 137, 134707);
			attr_dev(td9, "class", "py-1");
			add_location(td9, file, 2253, 120, 134690);
			attr_dev(tr4, "tabindex", "0");
			attr_dev(tr4, "role", "shortcut");
			add_location(tr4, file, 2253, 28, 134598);
			attr_dev(td10, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td10, file, 2254, 62, 134848);
			attr_dev(span5, "class", "pl-3");
			add_location(span5, file, 2254, 163, 134949);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 2254, 143, 134929);
			attr_dev(td11, "class", "py-1");
			add_location(td11, file, 2254, 126, 134912);
			attr_dev(tr5, "tabindex", "0");
			attr_dev(tr5, "role", "shortcut");
			add_location(tr5, file, 2254, 28, 134814);
			attr_dev(td12, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td12, file, 2255, 62, 135074);
			attr_dev(span6, "class", "pl-3");
			add_location(span6, file, 2255, 163, 135175);
			attr_dev(div7, "class", "d-flex");
			add_location(div7, file, 2255, 143, 135155);
			attr_dev(td13, "class", "py-1");
			add_location(td13, file, 2255, 126, 135138);
			attr_dev(tr6, "tabindex", "0");
			attr_dev(tr6, "role", "shortcut");
			add_location(tr6, file, 2255, 28, 135040);
			attr_dev(td14, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td14, file, 2256, 62, 135298);
			attr_dev(span7, "class", "pl-3");
			add_location(span7, file, 2256, 159, 135395);
			attr_dev(div8, "class", "d-flex");
			add_location(div8, file, 2256, 139, 135375);
			attr_dev(td15, "class", "py-1");
			add_location(td15, file, 2256, 122, 135358);
			attr_dev(tr7, "tabindex", "0");
			attr_dev(tr7, "role", "shortcut");
			add_location(tr7, file, 2256, 28, 135264);
			attr_dev(td16, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td16, file, 2257, 62, 135516);
			attr_dev(span8, "class", "pl-3");
			add_location(span8, file, 2257, 160, 135614);
			attr_dev(div9, "class", "d-flex");
			add_location(div9, file, 2257, 140, 135594);
			attr_dev(td17, "class", "py-1");
			add_location(td17, file, 2257, 123, 135577);
			attr_dev(tr8, "tabindex", "0");
			attr_dev(tr8, "role", "shortcut");
			add_location(tr8, file, 2257, 28, 135482);
			attr_dev(td18, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td18, file, 2258, 62, 135732);
			attr_dev(span9, "class", "pl-3");
			add_location(span9, file, 2258, 155, 135825);
			attr_dev(div10, "class", "d-flex");
			add_location(div10, file, 2258, 135, 135805);
			attr_dev(td19, "class", "py-1");
			add_location(td19, file, 2258, 118, 135788);
			attr_dev(tr9, "tabindex", "0");
			attr_dev(tr9, "role", "shortcut");
			add_location(tr9, file, 2258, 28, 135698);
			attr_dev(td20, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td20, file, 2259, 62, 135945);
			attr_dev(span10, "class", "pl-3");
			add_location(span10, file, 2259, 161, 136044);
			attr_dev(div11, "class", "d-flex");
			add_location(div11, file, 2259, 141, 136024);
			attr_dev(td21, "class", "py-1");
			add_location(td21, file, 2259, 124, 136007);
			attr_dev(tr10, "tabindex", "0");
			attr_dev(tr10, "role", "shortcut");
			add_location(tr10, file, 2259, 28, 135911);
			attr_dev(td22, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td22, file, 2260, 62, 136164);
			attr_dev(span11, "class", "pl-3");
			add_location(span11, file, 2260, 155, 136257);
			attr_dev(div12, "class", "d-flex");
			add_location(div12, file, 2260, 135, 136237);
			attr_dev(td23, "class", "py-1");
			add_location(td23, file, 2260, 118, 136220);
			attr_dev(tr11, "tabindex", "0");
			attr_dev(tr11, "role", "shortcut");
			add_location(tr11, file, 2260, 28, 136130);
			attr_dev(tbody, "tabindex", "0");
			attr_dev(tbody, "role", "shortcut");
			add_location(tbody, file, 2248, 24, 133677);
			...
			add_location(button4, file, 2277, 24, 137178);
			...
			add_location(button5, file, 2278, 24, 137476);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file, 2279, 252, 137953);
			...
			add_location(button6, file, 2279, 24, 137725);
			...
			add_location(div18, file, 2276, 20, 137072);
			attr_dev(i2, "class", "icomoon-delete-sm");
			add_location(i2, file, 2282, 224, 138354);
			...
			add_location(button7, file, 2282, 24, 138154);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file, 2283, 209, 138607);
			...
			add_location(button8, file, 2283, 24, 138422);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file, 2284, 178, 138827);
			...
			add_location(button9, file, 2284, 24, 138673);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file, 2285, 178, 139046);
			...
			add_location(button10, file, 2285, 24, 138892);
			...
			add_location(div19, file, 2281, 20, 138044);
			...
			add_location(button11, file, 2288, 24, 139245);
			...
			add_location(div20, file, 2287, 20, 139135);
			attr_dev(i6, "class", "icomoon-new-24px-reset-1");
			add_location(i6, file, 2291, 182, 139737);
			...
			add_location(button12, file, 2291, 24, 139579);
			...
			add_location(div21, file, 2290, 20, 139479);
			...
			add_location(div23, file, 2275, 16, 136957);
			attr_dev(div24, "class", "mt-2 mb-3 previewBtnGrp");
			add_location(div24, file, 2274, 12, 136902);
			...
			add_location(circle0, file, 2314, 36, 141316);
			...
			add_location(line, file, 2316, 40, 141565);
			add_location(g5, file, 2315, 36, 141520);
			...
			add_location(circle1, file, 2319, 40, 141830);
			attr_dev(title1, "id", "compassCenterTitle");
			add_location(title1, file, 2320, 40, 142101);
			attr_dev(desc0, "id", "compassCenterDesc");
			add_location(desc0, file, 2321, 40, 142200);
			...
			add_location(path0, file, 2325, 52, 142587);
			...
			add_location(path1, file, 2326, 52, 142738);
			...
			add_location(path2, file, 2327, 52, 142887);
			...
			add_location(circle3, file, 2335, 40, 143532);
			attr_dev(title2, "id", "compassRadiusTitle");
			add_location(title2, file, 2336, 40, 143829);
			attr_dev(desc1, "id", "compassRadiusDesc");
			add_location(desc1, file, 2337, 40, 143974);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file, 2343, 60, 144479);
			add_location(g7, file, 2342, 56, 144414);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file, 2346, 60, 144717);
			add_location(g8, file, 2345, 56, 144652);
			add_location(g9, file, 2341, 52, 144353);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file, 2351, 60, 145071);
			add_location(g10, file, 2350, 56, 145006);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file, 2354, 60, 145329);
			add_location(g11, file, 2353, 56, 145264);
			add_location(g12, file, 2349, 52, 144945);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file, 2340, 48, 144234);
			attr_dev(pattern1, "id", "previewDrawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file, 2339, 44, 144126);
			add_location(defs1, file, 2338, 40, 144074);
			add_location(g13, file, 2334, 36, 143487);
			...
			add_location(circle4, file, 2362, 40, 145814);
			attr_dev(title3, "id", "compassRotationTitle");
			add_location(title3, file, 2363, 40, 146191);
			attr_dev(desc2, "id", "compassRotationDesc");
			add_location(desc2, file, 2364, 40, 146324);
			...
			add_location(circle5, file, 2374, 40, 147350);
			...
			add_location(circle6, file, 2375, 40, 147506);
			attr_dev(title4, "id", "compassAngleTitle");
			add_location(title4, file, 2376, 40, 147778);
			attr_dev(desc3, "id", "compassAngleDesc");
			add_location(desc3, file, 2377, 40, 147874);
			add_location(g15, file, 2373, 36, 147305);
			...
			add_location(circle7, file, 2380, 40, 148054);
			...
			add_location(path7, file, 2388, 68, 149167);
			...
			add_location(g19, file, 2384, 52, 148562);
			...
			add_location(svg3, file, 2383, 48, 148414);
			attr_dev(pattern3, "id", "previewLastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file, 2382, 44, 148301);
			add_location(defs3, file, 2381, 40, 148249);
			add_location(g20, file, 2379, 36, 148009);
			add_location(g21, file, 2313, 32, 141275);
			add_location(svg4, file, 2312, 28, 141236);
			attr_dev(svg5, "class", "drawingCompassSvg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file, 2311, 24, 141155);
...
//# sourceMappingURL=DrawingPreview-f286e040.js.map
