...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, A as AH, y as language, X as XMLToJSON, a9 as afterUpdate, _ as onUserAnsChange, e as element, c as create_component, f as space, h as text, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as run_all, G as prop_dev } from './main-1c03d8ce.js';
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 522, 24, 26094);
			...
			attr_dev(span1, "data-original-title", span1_data_original_title_value = /*state*/ ctx[4].status == "recording"
			? "Stop Recording"
			: "Start Recording");

			attr_dev(span1, "id", "recordButtonTooltip");
			attr_dev(span1, "name", "recordButtonTooltip");
			add_location(span1, file, 539, 28, 27515);
			...
			add_location(button0, file, 531, 24, 27093);
			...
			add_location(span2, file, 550, 28, 28313);
			...
			add_location(button1, file, 541, 24, 27842);
			...
			add_location(span3, file, 563, 28, 29157);
			...
			add_location(button2, file, 552, 24, 28569);
			...
			add_location(div6, file, 530, 20, 26927);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 519, 16, 25789);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 518, 12, 25730);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 514, 62, 25347);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 514, 25, 25310);
			add_location(div0, file, 514, 20, 25305);
			...
			attr_dev(textarea, "aria-label", textarea_aria_label_value = language.spoken_label + " " + (/*state*/ ctx[4].cdata.trim() != ""
			? /*state*/ ctx[4].cdata.trim()
			: "Nothing"));

			add_location(textarea, file, 515, 20, 25406);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 513, 16, 25258);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 490, 20, 24018);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 489, 16, 23971);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 478, 20, 23465);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 477, 16, 23418);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
...
function create_fragment(ctx) {
	...
	let t5;
	let div3;
	let t6_value = language.modal_data + "";
	let t6;
	let t7;
	let div4;
	let button1;
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 577, 20, 29842);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 575, 16, 29665);
			...
			add_location(div3, file, 579, 16, 30045);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 583, 20, 30312);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-f2c937fc.js.map
