...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(td, file, 449, 12, 15726);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(strong, file, 470, 52, 17192);
			attr_dev(small, "class", "text-danger font13");
			add_location(small, file, 470, 16, 17156);
			attr_dev(span1, "class", "font24 svelte-dt0zmm");
			add_location(span1, file, 479, 26, 17642);
			...
			add_location(button0, file, 473, 24, 17360);
			attr_dev(span2, "class", "font24 svelte-dt0zmm");
			add_location(span2, file, 489, 7, 17947);
...
//# sourceMappingURL=ChoiceMatrix-b466ae07.js.map
