...
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 706, 52, 37050);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 710, 60, 37740);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			div.innerHTML = raw_value;
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 708, 60, 37325);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 694, 28, 35969);
			...
			add_location(div0, file$1, 693, 24, 35755);
...
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 729, 16, 38757);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 732, 16, 38975);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 739, 16, 39277);
			attr_dev(div1, "class", "yourAnswer");
			add_location(div1, file$1, 742, 16, 39504);
			attr_dev(div2, "class", "scoreDiv");
			add_location(div2, file$1, 738, 12, 39237);
			attr_dev(div3, "class", "finalResult");
			add_location(div3, file$1, 737, 8, 39198);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 689, 8, 35488);
			attr_dev(div1, "class", "text-center");
			add_location(div1, file$1, 727, 8, 38661);
			...
			add_location(div2, file$1, 688, 4, 35360);
			add_location(div3, file$1, 680, 0, 35128);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=AlignMatchPreview-4f0d6598.js.map
