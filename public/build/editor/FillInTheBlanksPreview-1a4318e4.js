...
import { I as ItemHelper } from './ItemHelper-22aaa777.js';
import { F as FillInTheBlanksToolbar } from './mathquill-e42dc301.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div4, file, 872, 2, 31217);
			add_location(center1, file, 864, 1, 31017);
			attr_dev(div5, "class", div5_class_value = /*xml*/ ctx[2] ? "mx-4 pl-2 pl-md-0" : "");
			add_location(div5, file, 863, 0, 30971);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 906, 0, 32242);
		},
...
//# sourceMappingURL=FillInTheBlanksPreview-1a4318e4.js.map
