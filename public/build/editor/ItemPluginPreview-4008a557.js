...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1116, 3, 34476);
			...
			add_location(div1, file, 1129, 3, 35357);
			...
			add_location(button, file, 1147, 5, 36457);
			attr_dev(div2, "class", div2_class_value = /*state*/ ctx[5].hideNext ? 'h-imp' : null);
			add_location(div2, file, 1146, 4, 36406);
			add_location(center, file, 1108, 2, 34300);
		},
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1122, 9, 35232);
			...
			add_location(div1, file, 1121, 8, 35014);
			...
			add_location(div2, file, 1120, 7, 34748);
			...
			add_location(div3, file, 1119, 6, 34659);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(div0, "seq", div0_seq_value = "s" + /*index*/ ctx[67]);
			add_location(div0, file, 1135, 9, 36096);
			attr_dev(div1, "id", div1_id_value = 'data-block_' + /*index*/ ctx[67]);
			...
			attr_dev(div1, "key", div1_key_value = /*index*/ ctx[67]);
			add_location(div1, file, 1134, 8, 35878);
			attr_dev(div2, "id", div2_id_value = "s" + /*index*/ ctx[67]);
			...
			add_location(div2, file, 1133, 7, 35612);
			attr_dev(div3, "data-sticky", div3_data_sticky_value = /*isSticky*/ ctx[6](/*index*/ ctx[67]));
			attr_dev(div3, "class", "bt-pd bg-white mt-3");
			attr_dev(div3, "tabindex", div3_tabindex_value = 0);
			add_location(div3, file, 1132, 6, 35526);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div3, anchor);
			append_dev(div3, div2);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			main = element("main");
			if (if_block) if_block.c();
			add_location(main, file, 1105, 0, 34257);
		},
...
//# sourceMappingURL=ItemPluginPreview-4008a557.js.map
