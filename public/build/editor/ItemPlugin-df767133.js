...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, e as element, p as append_dev, R as Checkbox, C as validate_each_argument, Q as Button, L as Dialog, M as binding_callbacks, N as bind, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, I as beforeUpdate, w as writable, y as l, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, q as listen_dev, F as prop_dev, r as group_outros, a as transition_out, u as check_outros, t as transition_in, x as detach_dev, G as run_all, c as create_component, m as mount_component, V as add_flush_callback, b as destroy_component, H as destroy_each, B as noop, a1 as null_to_empty, l as set_style, Z as set_input_value } from './main-0daae4a0.js';
...
function add_css() {
	...
	style.id = "svelte-182g3rw-style";
	style.textContent = ".font18.svelte-182g3rw{font-size:16px}.fwidth.svelte-182g3rw{width:100%}.light-cyan-bg.svelte-182g3rw{background-color:#d4e4ff;color:#333}.top2.svelte-182g3rw{top:2px}.right5.svelte-182g3rw{right:5px}.right35.svelte-182g3rw{right:35px}.step_checkbox.svelte-182g3rw{width:22%;border:1px solid black;margin-left:10px;position:relative;bottom:1px;cursor:pointer;padding:3px 2px 0}.fixed_ans.svelte-182g3rw{top:10px;position:relative;float:right;border:1px solid #e0e0e0;background-color:#f5f5f5;border-radius:4px;padding:5px;font-size:15px;font-weight:700}.check_box.svelte-182g3rw{right:24px;position:relative;width:40px}.inner_inputs.svelte-182g3rw{margin:0 12px!important}.pointer.svelte-182g3rw{cursor:pointer !important}.width100.svelte-182g3rw{width:100px}[id^=\"fillmain\"]{overflow:hidden;text-align:left}[id^=\"fillmain\"] pre{background:none;border:none;font-size:14px!important}[id^=\"fillmain\"] .string{min-height:50px;margin-top:10px;margin-right:10px}[id^=\"fillmain\"] .footerstr{position:relative;margin-top:10px;background-color:#ccc;padding:15px;min-height:60px}[id^=\"fillmain\"] .footerstr .arrow-up{position:absolute;top:-10px;right:50%;width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-bottom:10px solid #ccc}[id^=\"fillmain\"] .fill-row{padding:6px}[id^=\"fillmain\"] .fillelement, [id^=\"fillmain\"] .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}#fillmain .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}#fillmain input[type=\"text\"]{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}#fillmain select{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}[id^=\"fillmain\"] .drag-resize{vertical-align:middle;border:1px solid #31B731;text-align:center;padding:3px;font-size:14px}[id^=\"fillmain\"] .drag-resize.ui-draggable{cursor:move}[id^=\"fillmain\"] .drop-hover{border:1px dashed red!important;box-shadow:0 0 0 2px yellow inset;outline:1px solid blue}[id^=\"fillmain\"] .fillcheck ul{width:220px}[id^=\"fillmain\"] .fillcheck li.selected{background-color:#E5E5E5}.fillcheck .selected .icomoon-checkmark-3:before{float:left;color:blue;padding:3px;position:relative;right:14px}.fillcheck .icomoon-close-2:before{float:left;color:blue;position:relative;right:14px;font-size:20px}.MathJax_Display{display:inline!important}[id^=\"fillmain\"] .select{font-size:15px}[id^=\"fillmain\"] .textarea{vertical-align:middle;border-radius:3px;background:#ffe;border:1px solid #ccc;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075);box-shadow:inset 0 1px 1px rgba(0,0,0,0.075)}.ui-draggable-disabled{cursor:no-drop!important;opacity:0.5!important}.colorStyle{background-color:#dee2e6!important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
// (518:20) <Checkbox                            id="go_next"                           checked = {state.gonext == 1 ? true: false}                           on:click={(e)=>{goNext("go_next",e)}}                       >
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(518:20) <Checkbox                            id=\\\"go_next\\\"                           checked = {state.gonext == 1 ? true: false}                           on:click={(e)=>{goNext(\\\"go_next\\\",e)}}                       >",
		ctx
	});
...
// (525:20) <Checkbox                            id="fixedans_checkbox"                           checked = {state.fixed == 1 ? true: false}                           on:click={(e)=>{fixedAnswer("fixedans_checkbox",e)}}                       >
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(525:20) <Checkbox                            id=\\\"fixedans_checkbox\\\"                           checked = {state.fixed == 1 ? true: false}                           on:click={(e)=>{fixedAnswer(\\\"fixedans_checkbox\\\",e)}}                       >",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 578, 32, 22774);
			...
			add_location(label, file, 585, 32, 23601);
			attr_dev(div, "class", "stick_checkbox d-inline-block");
			add_location(div, file, 577, 28, 22697);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(580:36) {#if item._sticky == \\\"1\\\"}",
		ctx
	});
...
// (534:12) {#each all_steps as item,index}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(legend, file, 535, 20, 19544);
			...
			add_location(span0, file, 551, 24, 20536);
			...
			add_location(fieldset, file, 534, 16, 19422);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(534:12) {#each all_steps as item,index}",
		ctx
	});
...
// (603:12) <Button variant="fab" color="primary" mini aria-label="Add"                  on:click={addEvent.bind(this, 'steps')}                  class="btn btn-outline-primary rounded position-relative bottom0 bg-white shadow-sm height30"                  style={'float:left;width:120px;height:30px;border:1px solid #4285f4;color:#4285f4;text-transform:none;'}>
function create_default_slot_6(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 606, 16, 25064);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(603:12) <Button variant=\\\"fab\\\" color=\\\"primary\\\" mini aria-label=\\\"Add\\\"                  on:click={addEvent.bind(this, 'steps')}                  class=\\\"btn btn-outline-primary rounded position-relative bottom0 bg-white shadow-sm height30\\\"                  style={'float:left;width:120px;height:30px;border:1px solid #4285f4;color:#4285f4;text-transform:none;'}>",
		ctx
	});
...
// (624:16) {#if state.fillInTheBlanksChoice == 1}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 626, 28, 26448);
			attr_dev(input, "type", "text");
			...
			add_location(input, file, 629, 28, 26644);
			attr_dev(div1, "class", "d-flex mr-2");
			add_location(div1, file, 625, 24, 26393);
			attr_dev(div2, "class", "text-danger font-weight-bold ml-2 mt-3");
			add_location(div2, file, 639, 24, 27184);
			attr_dev(div3, "class", "text-danger ml-2");
			attr_dev(div3, "style", div3_style_value = "text-indent:15px");
			add_location(div3, file, 640, 24, 27281);
			attr_dev(div4, "class", "text-danger ml-2");
			attr_dev(div4, "style", div4_style_value = "text-indent:15px");
			add_location(div4, file, 641, 24, 27389);
			add_location(div5, file, 624, 20, 26362);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div5, anchor);
			append_dev(div5, div1);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(624:16) {#if state.fillInTheBlanksChoice == 1}",
		ctx
	});
...
// (655:28) <Button                                   variant = "contained"                                   color = "primary"                                  style = {'border:1px solid #4285f4;color:#4285f4;text-transform:none;'}                                   on:click = {addEditable}                                  class="btn btn-outline-primary height30 bg-white shadow-sm mt-1 top1 ml-1"                              >
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(655:28) <Button                                   variant = \\\"contained\\\"                                   color = \\\"primary\\\"                                  style = {'border:1px solid #4285f4;color:#4285f4;text-transform:none;'}                                   on:click = {addEditable}                                  class=\\\"btn btn-outline-primary height30 bg-white shadow-sm mt-1 top1 ml-1\\\"                              >",
		ctx
	});
...
// (665:32) <Button                                       id = {"latexEdit"}                                      variant = "contained"                                       color = "primary"                                      style = {'margin:5px;display:none;'}                                       on:click = {latexEdit}                                                                     >
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(665:32) <Button                                       id = {\\\"latexEdit\\\"}                                      variant = \\\"contained\\\"                                       color = \\\"primary\\\"                                      style = {'margin:5px;display:none;'}                                       on:click = {latexEdit}                                                                     >",
		ctx
	});
...
// (628:32) <Checkbox  id = "numeric" checked = {state.numeric}>
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(628:32) <Checkbox  id = \\\"numeric\\\" checked = {state.numeric}>",
		ctx
	});
...
// (683:16) <Button variant="contained" on:click={handleClose} class="colorStyle" style={'text-transform:capitalize;'} >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(683:16) <Button variant=\\\"contained\\\" on:click={handleClose} class=\\\"colorStyle\\\" style={'text-transform:capitalize;'} >",
		ctx
	});
...
// (686:16) <Button variant="contained" on:click={storeAns}                      class="bg-primary text-white" style={'text-transform:capitalize;'}>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(686:16) <Button variant=\\\"contained\\\" on:click={storeAns}                      class=\\\"bg-primary text-white\\\" style={'text-transform:capitalize;'}>",
		ctx
	});
...
// (610:8) <Dialog class="remove_right_margin" width="560" overlayClass="materialOverlay"  bind:visible={state.open} on:close={handleClose.bind(this)} disableEnforceFocus={true} style="background-color:#fff; border-radius: 5px;">
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 612, 20, 25502);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 611, 16, 25436);
			attr_dev(button0, "type", "button");
			...
			add_location(button0, file, 616, 24, 25699);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 617, 24, 25900);
			attr_dev(div2, "class", "btn-group mt-2 col-md-12 pl-1");
			add_location(div2, file, 615, 20, 25630);
			attr_dev(div3, "class", "left10 position-relative");
			add_location(div3, file, 614, 16, 25570);
			attr_dev(h4, "class", "mt-0 font21");
			add_location(h4, file, 610, 12, 25394);
			...
			add_location(div4, file, 622, 12, 26200);
			attr_dev(div5, "class", "svelteFooter");
			add_location(div5, file, 681, 12, 29690);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(610:8) <Dialog class=\\\"remove_right_margin\\\" width=\\\"560\\\" overlayClass=\\\"materialOverlay\\\"  bind:visible={state.open} on:close={handleClose.bind(this)} disableEnforceFocus={true} style=\\\"background-color:#fff; border-radius: 5px;\\\">",
		ctx
	});
...
function instance($$self, $$props, $$invalidate) {
	...
	function editTextbox(key) {
		...
		$$invalidate(0, state.math_input_box = "", state);
	}
	...
	function editMathbox(key) {
		...
		$$invalidate(0, state.input_ans = "", state);
	}
...
class StepAlgo extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-182g3rw-style")) add_css();
...
//# sourceMappingURL=ItemPlugin-df767133.js.map
