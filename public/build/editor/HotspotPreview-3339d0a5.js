...
import { L as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, J as append_styles, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, a2 as onUserAnsChange, I as beforeUpdate, w as writable, c as create_component, m as mount_component, t as transition_in, a as transition_out, b as destroy_component, e as element, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, r as group_outros, u as check_outros, F as prop_dev, x as detach_dev, l as set_style, z as empty, h as text, U as src_url_equal, a5 as toggle_class, q as listen_dev, a6 as HtmlTag } from './main-eb00c1bc.js';
...
function add_css(target) {
	append_styles(target, "svelte-11usv4u", "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (579:2) {#if moduleArr[item_type] == "1" || moduleArr[item_type] == "2"}
function create_if_block_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(579:2) {#if moduleArr[item_type] == \\\"1\\\" || moduleArr[item_type] == \\\"2\\\"}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 660, 7, 21909);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 661, 7, 22001);
			...
			add_location(div0, file, 656, 6, 21727);
			...
			add_location(div1, file, 648, 5, 21518);
			...
			add_location(div2, file, 664, 5, 22087);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 647, 4, 21483);
		},
		m: function mount(target, anchor) {
...
// (590:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 608, 10, 20420);
			...
			add_location(div0, file, 617, 10, 20715);
			...
			add_location(span, file, 630, 10, 21079);
			...
			add_location(div1, file, 595, 9, 20037);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 594, 8, 19995);
			attr_dev(td, "class", "border");
			add_location(td, file, 593, 7, 19966);
			add_location(tr, file, 592, 6, 19953);
			add_location(tbody, file, 591, 5, 19938);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 590, 4, 19853);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(590:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 678, 6, 22503);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 587, 2, 19716);
			add_location(center, file, 577, 1, 19431);
			...
			add_location(input, file, 689, 1, 22763);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 576, 0, 19422);
		},
...
//# sourceMappingURL=HotspotPreview-3339d0a5.js.map
