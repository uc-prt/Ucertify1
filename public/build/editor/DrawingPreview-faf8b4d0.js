...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h4, file, 2239, 20, 130850);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "close");
			attr_dev(button0, "data-bs-dismiss", "modal");
			add_location(button0, file, 2240, 20, 130913);
			attr_dev(div0, "class", "modal-header");
			add_location(div0, file, 2238, 16, 130803);
			attr_dev(td0, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td0, file, 2246, 61, 131374);
			attr_dev(span0, "class", "pl-3 font-weight-bold");
			add_location(span0, file, 2246, 155, 131468);
			attr_dev(div1, "class", "d-flex");
			add_location(div1, file, 2246, 135, 131448);
			attr_dev(td1, "class", "py-1");
			add_location(td1, file, 2246, 118, 131431);
			attr_dev(tr0, "tabindex", "0");
			attr_dev(tr0, "role", "shortcut");
			add_location(tr0, file, 2246, 28, 131341);
			attr_dev(td2, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td2, file, 2247, 61, 131600);
			attr_dev(span1, "class", "pl-3");
			add_location(span1, file, 2247, 157, 131696);
			attr_dev(div2, "class", "d-flex");
			add_location(div2, file, 2247, 137, 131676);
			attr_dev(td3, "class", "py-1");
			add_location(td3, file, 2247, 120, 131659);
			attr_dev(tr1, "tabindex", "0");
			attr_dev(tr1, "role", "shortcut");
			add_location(tr1, file, 2247, 28, 131567);
			attr_dev(td4, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td4, file, 2248, 62, 131809);
			attr_dev(span2, "class", "pl-3");
			add_location(span2, file, 2248, 158, 131905);
			attr_dev(div3, "class", "d-flex");
			add_location(div3, file, 2248, 138, 131885);
			attr_dev(td5, "class", "py-1");
			add_location(td5, file, 2248, 121, 131868);
			attr_dev(tr2, "tabindex", "0");
			attr_dev(tr2, "role", "shortcut");
			add_location(tr2, file, 2248, 28, 131775);
			attr_dev(td6, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td6, file, 2249, 62, 132017);
			attr_dev(span3, "class", "pl-3");
			add_location(span3, file, 2249, 158, 132113);
			attr_dev(div4, "class", "d-flex");
			add_location(div4, file, 2249, 138, 132093);
			attr_dev(td7, "class", "py-1");
			add_location(td7, file, 2249, 121, 132076);
			attr_dev(tr3, "tabindex", "0");
			attr_dev(tr3, "role", "shortcut");
			add_location(tr3, file, 2249, 28, 131983);
			attr_dev(td8, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td8, file, 2250, 62, 132226);
			attr_dev(span4, "class", "pl-3");
			add_location(span4, file, 2250, 157, 132321);
			attr_dev(div5, "class", "d-flex");
			add_location(div5, file, 2250, 137, 132301);
			attr_dev(td9, "class", "py-1");
			add_location(td9, file, 2250, 120, 132284);
			attr_dev(tr4, "tabindex", "0");
			attr_dev(tr4, "role", "shortcut");
			add_location(tr4, file, 2250, 28, 132192);
			attr_dev(td10, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td10, file, 2251, 62, 132441);
			attr_dev(span5, "class", "pl-3");
			add_location(span5, file, 2251, 163, 132542);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 2251, 143, 132522);
			attr_dev(td11, "class", "py-1");
			add_location(td11, file, 2251, 126, 132505);
			attr_dev(tr5, "tabindex", "0");
			attr_dev(tr5, "role", "shortcut");
			add_location(tr5, file, 2251, 28, 132407);
			attr_dev(td12, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td12, file, 2252, 62, 132666);
			attr_dev(span6, "class", "pl-3");
			add_location(span6, file, 2252, 163, 132767);
			attr_dev(div7, "class", "d-flex");
			add_location(div7, file, 2252, 143, 132747);
			attr_dev(td13, "class", "py-1");
			add_location(td13, file, 2252, 126, 132730);
			attr_dev(tr6, "tabindex", "0");
			attr_dev(tr6, "role", "shortcut");
			add_location(tr6, file, 2252, 28, 132632);
			attr_dev(td14, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td14, file, 2253, 62, 132889);
			attr_dev(span7, "class", "pl-3");
			add_location(span7, file, 2253, 159, 132986);
			attr_dev(div8, "class", "d-flex");
			add_location(div8, file, 2253, 139, 132966);
			attr_dev(td15, "class", "py-1");
			add_location(td15, file, 2253, 122, 132949);
			attr_dev(tr7, "tabindex", "0");
			attr_dev(tr7, "role", "shortcut");
			add_location(tr7, file, 2253, 28, 132855);
			attr_dev(td16, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td16, file, 2254, 62, 133106);
			attr_dev(span8, "class", "pl-3");
			add_location(span8, file, 2254, 160, 133204);
			attr_dev(div9, "class", "d-flex");
			add_location(div9, file, 2254, 140, 133184);
			attr_dev(td17, "class", "py-1");
			add_location(td17, file, 2254, 123, 133167);
			attr_dev(tr8, "tabindex", "0");
			attr_dev(tr8, "role", "shortcut");
			add_location(tr8, file, 2254, 28, 133072);
			attr_dev(td18, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td18, file, 2255, 62, 133321);
			attr_dev(span9, "class", "pl-3");
			add_location(span9, file, 2255, 155, 133414);
			attr_dev(div10, "class", "d-flex");
			add_location(div10, file, 2255, 135, 133394);
			attr_dev(td19, "class", "py-1");
			add_location(td19, file, 2255, 118, 133377);
			attr_dev(tr9, "tabindex", "0");
			attr_dev(tr9, "role", "shortcut");
			add_location(tr9, file, 2255, 28, 133287);
			attr_dev(td20, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td20, file, 2256, 62, 133533);
			attr_dev(span10, "class", "pl-3");
			add_location(span10, file, 2256, 161, 133632);
			attr_dev(div11, "class", "d-flex");
			add_location(div11, file, 2256, 141, 133612);
			attr_dev(td21, "class", "py-1");
			add_location(td21, file, 2256, 124, 133595);
			attr_dev(tr10, "tabindex", "0");
			attr_dev(tr10, "role", "shortcut");
			add_location(tr10, file, 2256, 28, 133499);
			attr_dev(td22, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td22, file, 2257, 62, 133751);
			attr_dev(span11, "class", "pl-3");
			add_location(span11, file, 2257, 155, 133844);
			attr_dev(div12, "class", "d-flex");
			add_location(div12, file, 2257, 135, 133824);
			attr_dev(td23, "class", "py-1");
			add_location(td23, file, 2257, 118, 133807);
			attr_dev(tr11, "tabindex", "0");
			attr_dev(tr11, "role", "shortcut");
			add_location(tr11, file, 2257, 28, 133717);
			attr_dev(tbody, "tabindex", "0");
			attr_dev(tbody, "role", "shortcut");
			add_location(tbody, file, 2245, 24, 131276);
			...
			add_location(button4, file, 2274, 24, 134727);
			...
			add_location(button5, file, 2275, 24, 135024);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file, 2276, 252, 135500);
			...
			add_location(button6, file, 2276, 24, 135272);
			...
			add_location(div18, file, 2273, 20, 134622);
			attr_dev(i2, "class", "icomoon-delete-sm");
			add_location(i2, file, 2279, 224, 135898);
			...
			add_location(button7, file, 2279, 24, 135698);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file, 2280, 209, 136150);
			...
			add_location(button8, file, 2280, 24, 135965);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file, 2281, 178, 136369);
			...
			add_location(button9, file, 2281, 24, 136215);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file, 2282, 178, 136587);
			...
			add_location(button10, file, 2282, 24, 136433);
			...
			add_location(div19, file, 2278, 20, 135589);
			...
			add_location(button11, file, 2285, 24, 136783);
			...
			add_location(div20, file, 2284, 20, 136674);
			attr_dev(i6, "class", "icomoon-new-24px-reset-1");
			add_location(i6, file, 2288, 182, 137272);
			...
			add_location(button12, file, 2288, 24, 137114);
			...
			add_location(div21, file, 2287, 20, 137015);
			...
			add_location(button13, file, 2291, 24, 137460);
			...
			add_location(div22, file, 2290, 20, 137369);
			...
			add_location(div23, file, 2272, 16, 134508);
			attr_dev(div24, "class", "mt-2 mb-3 previewBtnGrp");
			add_location(div24, file, 2271, 12, 134454);
			...
			add_location(circle0, file, 2311, 36, 138828);
			...
			add_location(line, file, 2313, 40, 139000);
			add_location(g5, file, 2312, 36, 138956);
			...
			add_location(circle1, file, 2316, 40, 139228);
			attr_dev(title1, "id", "compassCenterTitle");
			add_location(title1, file, 2317, 40, 139481);
			attr_dev(desc0, "id", "compassCenterDesc");
			add_location(desc0, file, 2318, 40, 139579);
			...
			add_location(path0, file, 2322, 52, 139951);
			...
			add_location(path1, file, 2323, 52, 140101);
			...
			add_location(path2, file, 2324, 52, 140249);
			...
			add_location(circle3, file, 2332, 40, 140886);
			attr_dev(title2, "id", "compassRadiusTitle");
			add_location(title2, file, 2333, 40, 141165);
			attr_dev(desc1, "id", "compassRadiusDesc");
			add_location(desc1, file, 2334, 40, 141309);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file, 2340, 60, 141808);
			add_location(g7, file, 2339, 56, 141744);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file, 2343, 60, 142043);
			add_location(g8, file, 2342, 56, 141979);
			add_location(g9, file, 2338, 52, 141684);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file, 2348, 60, 142392);
			add_location(g10, file, 2347, 56, 142328);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file, 2351, 60, 142647);
			add_location(g11, file, 2350, 56, 142583);
			add_location(g12, file, 2346, 52, 142268);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file, 2337, 48, 141566);
			attr_dev(pattern1, "id", "previewDrawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file, 2336, 44, 141459);
			add_location(defs1, file, 2335, 40, 141408);
			add_location(g13, file, 2331, 36, 140842);
			...
			add_location(circle4, file, 2359, 40, 143124);
			attr_dev(title3, "id", "compassRotationTitle");
			add_location(title3, file, 2360, 40, 143500);
			attr_dev(desc2, "id", "compassRotationDesc");
			add_location(desc2, file, 2361, 40, 143632);
			...
			add_location(circle5, file, 2371, 40, 144648);
			...
			add_location(circle6, file, 2372, 40, 144803);
			attr_dev(title4, "id", "compassAngleTitle");
			add_location(title4, file, 2373, 40, 145040);
			attr_dev(desc3, "id", "compassAngleDesc");
			add_location(desc3, file, 2374, 40, 145135);
			add_location(g15, file, 2370, 36, 144604);
			...
			add_location(circle7, file, 2377, 40, 145312);
			...
			add_location(path7, file, 2385, 68, 146417);
			...
			add_location(g19, file, 2381, 52, 145816);
			...
			add_location(svg3, file, 2380, 48, 145669);
			attr_dev(pattern3, "id", "previewLastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file, 2379, 44, 145557);
			add_location(defs3, file, 2378, 40, 145506);
			add_location(g20, file, 2376, 36, 145268);
			add_location(g21, file, 2310, 32, 138788);
			add_location(svg4, file, 2309, 28, 138750);
			attr_dev(svg5, "class", "drawingCompassSvg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file, 2308, 24, 138670);
			...
			add_location(svg6, file, 2301, 20, 138136);
			attr_dev(div26, "id", "centerImg");
			attr_dev(div26, "class", "centerImg centerImgPreview my-auto relative ml-0");
			add_location(div26, file, 2296, 16, 137776);
			add_location(div27, file, 2295, 12, 137754);
			attr_dev(center, "class", "preview_drawing_container");
			add_location(center, file, 2270, 8, 134399);
			attr_dev(div28, "class", "drawing_module_container");
			add_location(div28, file, 2267, 4, 134206);
			attr_dev(main, "id", "drawingPreviewMain");
			add_location(main, file, 2234, 0, 130588);
		},
...
//# sourceMappingURL=DrawingPreview-faf8b4d0.js.map
