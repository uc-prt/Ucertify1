...
import { O as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, M as append_styles, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, a5 as onUserAnsChange, L as beforeUpdate, w as writable, e as element, c as create_component, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, m as mount_component, r as group_outros, a as transition_out, u as check_outros, t as transition_in, G as prop_dev, x as detach_dev, b as destroy_component, l as set_style, z as empty, B as noop, h as text, Y as src_url_equal, a8 as toggle_class, q as listen_dev, a9 as HtmlTag } from './main-5c7d1f7a.js';
...
function add_css(target) {
	append_styles(target, "svelte-11usv4u", "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (631:3) {:else}
function create_else_block(ctx) {
	let html_tag;
	let raw_value = /*loadModule*/ ctx[23](/*moduleArr*/ ctx[19][/*item_type*/ ctx[15]]) + "";
	let html_anchor;
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*item_type*/ 32768 && raw_value !== (raw_value = /*loadModule*/ ctx[23](/*moduleArr*/ ctx[19][/*item_type*/ ctx[15]]) + "")) html_tag.p(raw_value);
		},
		i: noop,
		o: noop,
...
function create_if_block_3(ctx) {
	...
	itemhelper = new ItemHelper({
			props: {
				handleReviewClick: /*handleReview*/ ctx[24],
				reviewMode: /*isReview*/ ctx[0]
			},
			$$inline: true
		});

	itemhelper.$on("setReview", /*setReview*/ ctx[21]);
	itemhelper.$on("unsetReview", /*unsetReview*/ ctx[22]);
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if ((!current || dirty[0] & /*item_type*/ 32768) && raw_value !== (raw_value = /*loadModule*/ ctx[23](/*moduleArr*/ ctx[19][/*item_type*/ ctx[15]]) + "")) html_tag.p(raw_value);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 598, 7, 20284);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 599, 7, 20376);
			...
			add_location(div0, file, 594, 6, 20102);
			...
			add_location(div1, file, 586, 5, 19893);
			...
			set_style(div2, "background-image", "url('" + (/*bgImgPath*/ ctx[18] + /*img_url*/ ctx[14]) + "')");
			set_style(div2, "background-repeat", "no-repeat");
			set_style(div2, "position", "relative");
			set_style(div2, "border", "2px solid #d9e7fd");
			add_location(div2, file, 602, 5, 20462);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 585, 4, 19858);
		},
		m: function mount(target, anchor) {
...
// (528:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (!src_url_equal(img.src, img_src_value = /*bgImgPath*/ ctx[18] + /*img_url*/ ctx[14])) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", /*alt*/ ctx[2]);
			add_location(img, file, 546, 10, 18795);
			...
			add_location(div0, file, 555, 10, 19090);
			...
			add_location(span, file, 568, 10, 19454);
			...
			add_location(div1, file, 533, 9, 18412);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 532, 8, 18370);
			attr_dev(td, "class", "border");
			add_location(td, file, 531, 7, 18341);
			add_location(tr, file, 530, 6, 18328);
			add_location(tbody, file, 529, 5, 18313);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 528, 4, 18228);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(img, "click", /*checkAnswer*/ ctx[20], false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*img_url*/ 16384 && !src_url_equal(img.src, img_src_value = /*bgImgPath*/ ctx[18] + /*img_url*/ ctx[14])) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(528:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 616, 6, 20878);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	itemhelper.$on("setReview", /*setReview*/ ctx[21]);
	itemhelper.$on("unsetReview", /*unsetReview*/ ctx[22]);
	const if_block_creators = [create_if_block, create_if_block_1, create_if_block_3, create_else_block];
	const if_blocks = [];

	function select_block_type(ctx, dirty) {
		if (/*moduleArr*/ ctx[19][/*item_type*/ ctx[15]] == "4") return 0;
		if (/*moduleArr*/ ctx[19][/*item_type*/ ctx[15]] == "3") return 1;
		if (/*moduleArr*/ ctx[19][/*item_type*/ ctx[15]] == "1") return 2;
		return 3;
	}
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 525, 2, 18091);
			add_location(center, file, 520, 1, 17991);
			...
			add_location(input, file, 635, 1, 21386);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 519, 0, 17982);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	function checkAnswer(event) {
		...
		if (typeName == 'textclick' || typeName == 'textselect') {
			...
			$$invalidate(25, ansStatus = result.ans);
			$$invalidate(30, answerStatus = ansStatus);
	...
	function imageDraw(hid, review) {
		...
		if (!review) {
			AH.listen('#previewArea', 'click', '#reset', () => {
				...
				$$invalidate(30, answerStatus = false);
			});
		}
	...
	function onReleaseFunc(e, hid, review) {
		...
		if (!review) {
			...
			$$invalidate(30, answerStatus = flag);
	...
	$$self.$$set = $$props => {
		...
		if ('uxml' in $$props) $$invalidate(27, uxml = $$props.uxml);
		if ('ansStatus' in $$props) $$invalidate(25, ansStatus = $$props.ansStatus);
		if ('isReview' in $$props) $$invalidate(0, isReview = $$props.isReview);
		if ('showAns' in $$props) $$invalidate(28, showAns = $$props.showAns);
		if ('editorState' in $$props) $$invalidate(29, editorState = $$props.editorState);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ('answerStatus' in $$props) $$invalidate(30, answerStatus = $$props.answerStatus);
		if ('ansDisable' in $$props) $$invalidate(31, ansDisable = $$props.ansDisable);
		if ('bgImgPath' in $$props) $$invalidate(18, bgImgPath = $$props.bgImgPath);
		if ('alt' in $$props) $$invalidate(2, alt = $$props.alt);
		if ('moduleArr' in $$props) $$invalidate(19, moduleArr = $$props.moduleArr);
		...
		if ('correctans' in $$props) $$invalidate(32, correctans = $$props.correctans);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*isReview, editorState, showAns, answerStatus*/ 1879048193 | $$self.$$.dirty[1] & /*ansDisable*/ 1) {
			 {
				if (isReview) {
					//targetView = "block";
					setReview();
					...
					if (editorState && ansDisable == 0) {
						...
						$$invalidate(31, ansDisable = 1);
					}
				} else {
					//targetView = "none";
					$$invalidate(31, ansDisable = 0);
		...
		if ($$self.$$.dirty[0] & /*xml, totalCorrectAns*/ 67108866 | $$self.$$.dirty[1] & /*correctans*/ 2) {
			 if (xml) {
				...
				if (myXml.match(/<\!\[CDATA\[{|<\!--\[CDATA\[{/gm)) {
					...
					$$invalidate(32, correctans = myXml.toString().match(/{(.*)}/gmi));
					...
					$$invalidate(32, correctans = correctans[0]);
				}
...
class HotspotPreview extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*uxml*/ ctx[27] === undefined && !('uxml' in props)) {
			console_1.warn("<HotspotPreview> was created without expected prop 'uxml'");
		}

		if (/*ansStatus*/ ctx[25] === undefined && !('ansStatus' in props)) {
		...
		if (/*showAns*/ ctx[28] === undefined && !('showAns' in props)) {
			console_1.warn("<HotspotPreview> was created without expected prop 'showAns'");
		}

		if (/*editorState*/ ctx[29] === undefined && !('editorState' in props)) {
...
//# sourceMappingURL=HotspotPreview-9a553f76.js.map
