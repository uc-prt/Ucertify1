...
// (706:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}
function create_if_block_4$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(706:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}",
		ctx
	});
...
// (707:48) {#if state.correct_match['category_'+ dataj.sequence] == false}
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 707, 52, 37083);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(707:48) {#if state.correct_match['category_'+ dataj.sequence] == false}",
		ctx
	});
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 711, 60, 37773);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			div.innerHTML = raw_value;
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 709, 60, 37358);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(709:56) {#if dataj.imageurl != ''}",
		ctx
	});
...
// (705:40) {#each state.xml.item.items as dataj}
function create_each_block_1$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(705:40) {#each state.xml.item.items as dataj}",
		ctx
	});
...
// (693:16) {#each state.xml.category.categories as datai, index}
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 695, 28, 36002);
			...
			add_location(div0, file$1, 694, 24, 35788);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(693:16) {#each state.xml.category.categories as datai, index}",
		ctx
	});
...
// (730:12) {#if AH.get('alignMatchReset') == true}
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 730, 16, 38790);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(730:12) {#if AH.get('alignMatchReset') == true}",
		ctx
	});
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 733, 16, 39008);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 740, 16, 39310);
			attr_dev(div1, "class", "yourAnswer");
			add_location(div1, file$1, 743, 16, 39537);
			attr_dev(div2, "class", "scoreDiv");
			add_location(div2, file$1, 739, 12, 39270);
			attr_dev(div3, "class", "finalResult");
			add_location(div3, file$1, 738, 8, 39231);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(738:4) {#if targetView == 'block'}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 690, 8, 35521);
			attr_dev(div1, "class", "text-center");
			add_location(div1, file$1, 728, 8, 38694);
			...
			add_location(div2, file$1, 689, 4, 35393);
			add_location(div3, file$1, 681, 0, 35161);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=AlignMatchPreview-e98d3143.js.map
