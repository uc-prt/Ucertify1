...
function add_css() {
	...
	style.textContent = ".gridded_tab.svelte-1k7m90a{background-color:#f0f0f0;user-select:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none}.minus_tab.svelte-1k7m90a,.plus_tab.svelte-1k7m90a,.slash_tab.svelte-1k7m90a{text-align:center}.items_element.svelte-1k7m90a:hover{border:1.2px solid #777}.sla_point.svelte-1k7m90a{padding:6px 11px}table.svelte-1k7m90a{border-width:0px!important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(span, "class", span_class_value = "" + (null_to_empty(/*className*/ ctx[1]) + " svelte-1k7m90a"));
			attr_dev(span, "height", "20");
			add_location(span, file, 22, 20, 586);
			attr_dev(td, "width", "50");
			attr_dev(td, "class", "text-center");
			add_location(td, file, 21, 16, 530);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(td, "class", td_class_value = "" + (null_to_empty(/*class1*/ ctx[2]) + " svelte-1k7m90a"));
			attr_dev(td, "width", "50");
			attr_dev(td, "disabled", "true");
			add_location(td, file, 18, 16, 410);
		},
		m: function mount(target, anchor) {
			insert_dev(target, td, anchor);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(tr, file, 15, 4, 320);
			attr_dev(table, "id", /*tableId*/ ctx[3]);
			attr_dev(table, "class", table_class_value = "" + (null_to_empty(/*tableClass*/ ctx[4]) + " svelte-1k7m90a"));
			add_location(table, file, 14, 0, 274);
		},
...
class GriddedHelper extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-1k7m90a-style")) add_css();
...
//# sourceMappingURL=GriddedHelper-db984205.js.map
