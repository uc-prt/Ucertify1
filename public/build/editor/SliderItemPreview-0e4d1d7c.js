...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 255, 8, 10941);
			attr_dev(div, "class", "alert alert-danger font-weight-bold");
			add_location(div, file, 254, 4, 10882);
		},
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 293, 36, 13094);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 292, 32, 12996);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 289, 36, 12797);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 288, 32, 12699);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span1, anchor);
			append_dev(span1, span0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 306, 40, 14093);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 304, 40, 13827);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span, anchor);
			append_dev(span, t0);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 266, 8, 11231);
			attr_dev(div1, "id", "slidermain");
			add_location(div1, file, 265, 4, 11200);
			attr_dev(div2, "class", "text-center");
			add_location(div2, file, 258, 0, 10988);
		},
...
//# sourceMappingURL=SliderItemPreview-0e4d1d7c.js.map
