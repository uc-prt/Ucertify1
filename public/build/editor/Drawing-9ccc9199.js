...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, F as set_data_dev, G as prop_dev, B as noop, x as detach_dev, g as globals, y as l, O as Dialog, P as binding_callbacks, Q as bind, ab as afterUpdate, o as onMount, A as AH, a9 as swal, X as XMLToJSON, M as JSONToXML, w as writable, U as Button, aj as svg_element, c as create_component, m as mount_component, q as listen_dev, Z as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component } from './main-62a2d015.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$1, 1572, 4, 96195);
			attr_dev(div0, "class", "row");
			add_location(div0, file$1, 1571, 3, 96172);
			add_location(div1, file$1, 1570, 2, 96162);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(i0, file$1, 1444, 231, 84705);
			attr_dev(button0, "type", "button");
			...
			add_location(button1, file$1, 1445, 24, 84770);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file$1, 1446, 210, 85176);
			attr_dev(button2, "type", "button");
			...
			add_location(button2, file$1, 1446, 24, 84990);
			...
			add_location(i2, file$1, 1449, 198, 85551);
			attr_dev(button3, "type", "button");
			...
			add_location(button3, file$1, 1449, 24, 85377);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file$1, 1450, 183, 85778);
			...
			add_location(button4, file$1, 1450, 24, 85619);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file$1, 1451, 160, 85980);
			...
			add_location(button5, file$1, 1451, 24, 85844);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file$1, 1452, 160, 86181);
			...
			add_location(button6, file$1, 1452, 24, 86045);
			...
			add_location(div1, file$1, 1448, 20, 85267);
			...
			add_location(button10, file$1, 1469, 24, 87545);
			attr_dev(div8, "class", "btn-group position-absolute setting_btn");
			add_location(div8, file$1, 1468, 20, 87466);
			...
			add_location(img, file$1, 1473, 20, 87816);
			attr_dev(title, "id", "authoringSvgTitle");
			add_location(title, file$1, 1475, 24, 88042);
			attr_dev(g0, "class", "backgroundFocusPath");
			add_location(g0, file$1, 1476, 24, 88117);
			attr_dev(g1, "class", "drawing_paths");
			add_location(g1, file$1, 1477, 24, 88178);
			attr_dev(g2, "class", "backgroundFocusPoint");
			add_location(g2, file$1, 1478, 24, 88233);
			...
			add_location(circle0, file$1, 1482, 36, 88490);
			...
			add_location(line, file$1, 1484, 40, 88666);
			add_location(g3, file$1, 1483, 36, 88621);
			...
			add_location(circle1, file$1, 1487, 40, 88897);
			...
			add_location(path0, file$1, 1491, 52, 89350);
			...
			add_location(path1, file$1, 1492, 52, 89501);
			...
			add_location(path2, file$1, 1493, 52, 89650);
			...
			add_location(circle3, file$1, 1501, 40, 90295);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file$1, 1507, 60, 90898);
			add_location(g5, file$1, 1506, 56, 90833);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file$1, 1510, 60, 91136);
			add_location(g6, file$1, 1509, 56, 91071);
			add_location(g7, file$1, 1505, 52, 90772);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file$1, 1515, 60, 91490);
			add_location(g8, file$1, 1514, 56, 91425);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file$1, 1518, 60, 91748);
			add_location(g9, file$1, 1517, 56, 91683);
			add_location(g10, file$1, 1513, 52, 91364);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file$1, 1504, 48, 90653);
			attr_dev(pattern1, "id", "drawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file$1, 1503, 44, 90552);
			add_location(defs1, file$1, 1502, 40, 90500);
			add_location(g11, file$1, 1500, 36, 90250);
			...
			add_location(circle4, file$1, 1526, 40, 92233);
			...
			add_location(circle5, file$1, 1536, 40, 93363);
			...
			add_location(circle6, file$1, 1537, 40, 93520);
			add_location(g13, file$1, 1535, 36, 93317);
			...
			add_location(circle7, file$1, 1540, 40, 93777);
			...
			add_location(path7, file$1, 1548, 68, 94845);
			...
			add_location(g17, file$1, 1544, 52, 94240);
			...
			add_location(svg3, file$1, 1543, 48, 94092);
			attr_dev(pattern3, "id", "lastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file$1, 1542, 44, 93986);
			add_location(defs3, file$1, 1541, 40, 93934);
			add_location(g18, file$1, 1539, 36, 93732);
			add_location(g19, file$1, 1481, 32, 88449);
			attr_dev(svg4, "class", "drawing-compass-wrapper");
			add_location(svg4, file$1, 1480, 28, 88378);
			attr_dev(svg5, "class", "drawing_compass_svg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file$1, 1479, 24, 88295);
			...
			add_location(svg6, file$1, 1474, 20, 87917);
			attr_dev(div9, "id", "centerImg");
			attr_dev(div9, "class", "centerImg authCenterImg my-auto relative ml-0");
			add_location(div9, file$1, 1467, 16, 87370);
			add_location(div10, file$1, 1466, 12, 87347);
...
//# sourceMappingURL=Drawing-9ccc9199.js.map
