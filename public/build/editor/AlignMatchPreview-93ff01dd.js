...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, C as validate_each_argument, e as element, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, x as detach_dev, K as destroy_each, h as text, F as set_data_dev, z as empty, B as noop, Y as src_url_equal, g as globals, A as AH, ab as add_render_callback, o as onMount, a9 as afterUpdate, X as XMLToJSON, a0 as onUserAnsChange, y as l, q as listen_dev, ai as prevent_default, H as run_all, c as create_component, m as mount_component, t as transition_in, a as transition_out, b as destroy_component, l as set_style, r as group_outros, u as check_outros } from './main-6da9f99a.js';
...
// (687:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}
function create_if_block_4$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(687:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}",
		ctx
	});
...
// (688:48) {#if state.correct_match['category_'+ dataj.sequence] == false}
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 688, 52, 36179);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(688:48) {#if state.correct_match['category_'+ dataj.sequence] == false}",
		ctx
	});
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 692, 60, 36869);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			div.innerHTML = raw_value;
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 690, 60, 36454);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(690:56) {#if dataj.imageurl != ''}",
		ctx
	});
...
// (686:40) {#each state.xml.item.items as dataj}
function create_each_block_1$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(686:40) {#each state.xml.item.items as dataj}",
		ctx
	});
...
// (674:16) {#each state.xml.category.categories as datai, index}
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 676, 28, 35098);
			...
			add_location(div0, file$1, 675, 24, 34884);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(674:16) {#each state.xml.category.categories as datai, index}",
		ctx
	});
...
// (711:12) {#if AH.get('alignMatchReset') == true}
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 711, 16, 37886);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(711:12) {#if AH.get('alignMatchReset') == true}",
		ctx
	});
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 714, 16, 38104);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 721, 16, 38406);
			attr_dev(div1, "class", "yourAnswer");
			add_location(div1, file$1, 724, 16, 38633);
			attr_dev(div2, "class", "scoreDiv");
			add_location(div2, file$1, 720, 12, 38366);
			attr_dev(div3, "class", "finalResult");
			add_location(div3, file$1, 719, 8, 38327);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(719:4) {#if targetView == 'block'}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div3, file$1, 670, 4, 34489);
			add_location(div4, file$1, 661, 0, 34229);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=AlignMatchPreview-93ff01dd.js.map
