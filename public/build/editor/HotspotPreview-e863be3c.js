...
function add_css(target) {
	append_styles(target, "svelte-1m52s8g", "main.svelte-1m52s8g{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-1m52s8g{display:none;position:absolute;z-index:10;width:26px;height:26px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-1m52s8g{display:block}@media(min-width: 640px){main.svelte-1m52s8g{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 571, 7, 19617);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 572, 7, 19709);
			...
			add_location(div0, file, 567, 6, 19435);
			...
			add_location(div1, file, 559, 5, 19226);
			...
			add_location(div2, file, 575, 5, 19795);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 558, 4, 19191);
		},
		m: function mount(target, anchor) {
...
// (501:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 519, 10, 18128);
			...
			add_location(div0, file, 528, 10, 18423);
			...
			add_location(span, file, 541, 10, 18787);
			...
			add_location(div1, file, 506, 9, 17746);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 505, 8, 17704);
			attr_dev(td, "class", "border");
			add_location(td, file, 504, 7, 17675);
			add_location(tr, file, 503, 6, 17662);
			add_location(tbody, file, 502, 5, 17647);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto");
			add_location(table, file, 501, 4, 17571);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(501:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 589, 6, 20211);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 498, 2, 17434);
			add_location(center, file, 493, 1, 17334);
			...
			add_location(input, file, 600, 1, 20472);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 607, 1, 20606);
			attr_dev(main, "class", "svelte-1m52s8g");
			add_location(main, file, 492, 0, 17325);
		},
...
//# sourceMappingURL=HotspotPreview-e863be3c.js.map
