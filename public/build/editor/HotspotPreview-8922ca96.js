...
function add_css() {
	...
	style.textContent = "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 579, 7, 19841);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 580, 7, 19933);
			...
			add_location(div0, file, 575, 6, 19659);
			...
			add_location(div1, file, 567, 5, 19450);
			...
			add_location(div2, file, 583, 5, 20019);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 566, 4, 19415);
		},
		m: function mount(target, anchor) {
...
// (509:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 527, 10, 18352);
			...
			add_location(div0, file, 536, 10, 18647);
			...
			add_location(span, file, 549, 10, 19011);
			...
			add_location(div1, file, 514, 9, 17969);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 513, 8, 17927);
			attr_dev(td, "class", "border");
			add_location(td, file, 512, 7, 17898);
			add_location(tr, file, 511, 6, 17885);
			add_location(tbody, file, 510, 5, 17870);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 509, 4, 17785);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(509:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 597, 6, 20435);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 506, 2, 17648);
			add_location(center, file, 501, 1, 17548);
			...
			add_location(input, file, 608, 1, 20696);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 615, 1, 20830);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 500, 0, 17539);
		},
...
//# sourceMappingURL=HotspotPreview-8922ca96.js.map
