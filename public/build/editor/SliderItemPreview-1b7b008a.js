...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 259, 8, 11057);
			attr_dev(div, "class", "alert alert-danger font-weight-bold");
			add_location(div, file, 258, 4, 10998);
		},
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 298, 36, 13251);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 297, 32, 13153);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 294, 36, 12956);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 293, 32, 12858);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span1, anchor);
			append_dev(span1, span0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 311, 40, 14250);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 309, 40, 13984);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span, anchor);
			append_dev(span, t0);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 271, 8, 11390);
			attr_dev(div1, "id", "slidermain");
			add_location(div1, file, 270, 4, 11359);
			attr_dev(div2, "class", "text-center");
			add_location(div2, file, 262, 0, 11104);
		},
...
//# sourceMappingURL=SliderItemPreview-1b7b008a.js.map
