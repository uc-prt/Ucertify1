...
function add_css() {
	...
	style.textContent = "#resizeX.svelte-dl6gty{position:absolute;right:0;width:3px;opacity:0;height:100%;cursor:w-resize}#resizeY.svelte-dl6gty{position:absolute;bottom:0;width:100%;height:3px;opacity:0;cursor:s-resize}#resizeXY.svelte-dl6gty{position:absolute;bottom:0;right:0;width:3px;height:3px;opacity:0;cursor:se-resize}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
	append_dev(document_1.head, style);
}

// (1087:12) <Button                  on:click={handleClose}                  unelevated={true}                  outlined={true}                  class="text-capitalize"                  color="#ccc"              >
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1087:12) <Button                  on:click={handleClose}                  unelevated={true}                  outlined={true}                  class=\\\"text-capitalize\\\"                  color=\\\"#ccc\\\"              >",
		ctx
	});
...
// (1095:12) <Button                  on:click={handleSubmit.bind(this, 'img')}                  class="bg-primary text-white"                  style="text-transform: none"                  key={l.submit}              >
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1095:12) <Button                  on:click={handleSubmit.bind(this, 'img')}                  class=\\\"bg-primary text-white\\\"                  style=\\\"text-transform: none\\\"                  key={l.submit}              >",
		ctx
	});
...
// (1086:8) <div slot="footer" class="svelteFooter" >
function create_footer_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1085, 8, 49556);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1086:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\" >",
		ctx
	});
...
// (1008:4) <Dialog class="remove_right_margin" width="600" bind:visible={state.openImg} style="background: #fff; border-radius: 5px;">
function create_default_slot_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			t31 = space();
			add_location(div0, file, 1010, 16, 46025);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 1009, 12, 45963);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 1008, 8, 45920);
			...
			add_location(input0, file, 1015, 16, 46190);
			...
			add_location(button, file, 1024, 16, 46534);
			attr_dev(div2, "class", "d-flex");
			add_location(div2, file, 1014, 12, 46152);
			...
			add_location(img, file, 1033, 16, 46901);
			attr_dev(div3, "class", "mx-auto width8 p-2 border mt-2");
			add_location(div3, file, 1032, 12, 46839);
			...
			add_location(label0, file, 1036, 16, 47038);
			add_location(span0, file, 1035, 12, 47014);
			...
			add_location(input1, file, 1038, 12, 47175);
			attr_dev(label1, "for", "hotBorder");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1050, 24, 47719);
			add_location(span1, file, 1049, 20, 47687);
			option0.__value = "0";
			option0.value = option0.__value;
			add_location(option0, file, 1053, 24, 47934);
			option1.__value = "1";
			option1.value = option1.__value;
			add_location(option1, file, 1054, 24, 47991);
			option2.__value = "2";
			option2.value = option2.__value;
			add_location(option2, file, 1055, 24, 48045);
			option3.__value = "3";
			option3.value = option3.__value;
			add_location(option3, file, 1056, 24, 48099);
			option4.__value = "4";
			option4.value = option4.__value;
			add_location(option4, file, 1057, 24, 48153);
			option5.__value = "5";
			option5.value = option5.__value;
			add_location(option5, file, 1058, 24, 48207);
			...
			add_location(select0, file, 1052, 20, 47836);

			attr_dev(div4, "class", div4_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block pr-2 mt-2 w-sm"
			: "hidden");

			add_location(div4, file, 1048, 16, 47580);
			attr_dev(label2, "for", "hotBorderColor");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1063, 24, 48442);
			add_location(span2, file, 1062, 20, 48410);
			option6.__value = "white";
			option6.value = option6.__value;
			add_location(option6, file, 1066, 24, 48672);
			option7.__value = "black";
			option7.value = option7.__value;
			add_location(option7, file, 1067, 24, 48733);
			option8.__value = "grey";
			option8.value = option8.__value;
			add_location(option8, file, 1068, 24, 48795);
			...
			add_location(select1, file, 1065, 20, 48564);

			attr_dev(div5, "class", div5_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block mt-2 w-sm"
			: "hidden");

			add_location(div5, file, 1061, 16, 48308);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 1047, 12, 47542);
			add_location(br, file, 1072, 12, 48918);
			attr_dev(label3, "for", "setLineColor");
			attr_dev(label3, "class", "mt-2 text-dark");
			add_location(label3, file, 1075, 20, 49040);
			add_location(span3, file, 1074, 16, 49012);
			option9.__value = "Please Select";
			option9.value = option9.__value;
			add_location(option9, file, 1078, 20, 49285);
			option10.__value = "red";
			option10.value = option10.__value;
			add_location(option10, file, 1079, 20, 49337);
			option11.__value = "black";
			option11.value = option11.__value;
			add_location(option11, file, 1080, 20, 49391);
			option12.__value = "blue";
			option12.value = option12.__value;
			add_location(option12, file, 1081, 20, 49449);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1008:4) <Dialog class=\\\"remove_right_margin\\\" width=\\\"600\\\" bind:visible={state.openImg} style=\\\"background: #fff; border-radius: 5px;\\\">",
		ctx
	});
...
// (1165:12) <Button                  on:click={handleClose}                  unelevated={true}                  outlined={true}                  class="text-capitalize"                  color="#ccc"              >
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1165:12) <Button                  on:click={handleClose}                  unelevated={true}                  outlined={true}                  class=\\\"text-capitalize\\\"                  color=\\\"#ccc\\\"              >",
		ctx
	});
...
// (1173:12) <Button                  on:click={handleSubmit.bind(this, 'drag')}                  class="bg-primary text-white"                  style="text-transform: none"                  key={l.done}              >
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1173:12) <Button                  on:click={handleSubmit.bind(this, 'drag')}                  class=\\\"bg-primary text-white\\\"                  style=\\\"text-transform: none\\\"                  key={l.done}              >",
		ctx
	});
...
// (1164:8) <div slot="footer" class="svelteFooter">
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 1163, 8, 52509);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(button0, div, null);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1164:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\">",
		ctx
	});
...
// (1104:4) <Dialog class="remove_right_margin" width="600" bind:visible={state.openDrag} style="background: #fff; border-radius: 5px;">
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t13 = space();
			add_location(div0, file, 1106, 16, 50377);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 1105, 12, 50315);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 1104, 8, 50272);
			attr_dev(label0, "for", "dragHeight");
			attr_dev(label0, "class", "my-1 text-dark");
			add_location(label0, file, 1113, 24, 50619);
			add_location(span0, file, 1112, 20, 50587);
			attr_dev(input0, "type", "number");
			attr_dev(input0, "id", "dragHeight");
			attr_dev(input0, "placeholder", "Height");
			attr_dev(input0, "defaultvalue", " ");
			attr_dev(input0, "class", "form-control");
			add_location(input0, file, 1115, 20, 50731);
			attr_dev(div2, "class", "col-6 pr-1");
			add_location(div2, file, 1111, 16, 50541);
			attr_dev(label1, "for", "dragWidth");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1125, 24, 51095);
			add_location(span1, file, 1124, 20, 51063);
			attr_dev(input1, "type", "number");
			attr_dev(input1, "id", "dragWidth");
			attr_dev(input1, "placeholder", "Width");
			attr_dev(input1, "defaultvalue", " ");
			attr_dev(input1, "class", "form-control");
			add_location(input1, file, 1127, 20, 51205);
			attr_dev(div3, "class", "col-6 pl-1");
			add_location(div3, file, 1123, 16, 51017);
			attr_dev(div4, "class", "row");
			add_location(div4, file, 1110, 12, 50506);
			attr_dev(label2, "for", "dragTop");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1139, 24, 51623);
			add_location(span2, file, 1138, 20, 51591);
			attr_dev(input2, "type", "number");
			attr_dev(input2, "id", "dragTop");
			attr_dev(input2, "placeholder", "Top");
			attr_dev(input2, "defaultvalue", " ");
			attr_dev(input2, "class", "form-control");
			add_location(input2, file, 1141, 20, 51729);
			attr_dev(div5, "class", "col-6 pr-1");
			add_location(div5, file, 1137, 16, 51545);
			attr_dev(label3, "for", "dragLeft");
			attr_dev(label3, "class", "my-1 text-dark");
			add_location(label3, file, 1151, 24, 52087);
			add_location(span3, file, 1150, 20, 52055);
			attr_dev(input3, "type", "number");
			attr_dev(input3, "id", "dragLeft");
			attr_dev(input3, "placeholder", "Left");
			attr_dev(input3, "defaultvalue", " ");
			attr_dev(input3, "class", "form-control");
			add_location(input3, file, 1153, 20, 52195);
			attr_dev(div6, "class", "col-6 pl-1");
			add_location(div6, file, 1149, 16, 52009);
			attr_dev(div7, "class", "row mt-2");
			add_location(div7, file, 1136, 12, 51505);
			set_style(div8, "overflow-y", "auto");
			set_style(div8, "padding-right", "20px");
			add_location(div8, file, 1109, 8, 50440);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h4, anchor);
			append_dev(h4, div1);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1104:4) <Dialog class=\\\"remove_right_margin\\\" width=\\\"600\\\" bind:visible={state.openDrag} style=\\\"background: #fff; border-radius: 5px;\\\">",
		ctx
	});
...
// (1186:12) <Button color="#ff0" on:click={() => (state.snackback = false)}>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1186:12) <Button color=\\\"#ff0\\\" on:click={() => (state.snackback = false)}>",
		ctx
	});
...
function create_action_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1184, 8, 53250);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1185:8) <span slot=\\\"action\\\">",
		ctx
	});
...
// (1183:4) <Snackbar bind:visible={state.snackback} bg="#f44336" bottom={true} timeout={10} style="position:fixed; bottom:50px">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1183:4) <Snackbar bind:visible={state.snackback} bg=\\\"#f44336\\\" bottom={true} timeout={10} style=\\\"position:fixed; bottom:50px\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div1, file, 921, 16, 42240);
			...
			add_location(div4, file, 930, 12, 42685);
			attr_dev(div5, "class", "drawImage d-none");
			add_location(div5, file, 912, 8, 41961);
			attr_dev(i1, "class", "icomoon-24px-edit-1");
			add_location(i1, file, 965, 20, 44001);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light px-1 pt-sm1 pb-sm1 mt");
			add_location(button1, file, 960, 16, 43790);
			attr_dev(div6, "class", "btn-group tools");
			add_location(div6, file, 959, 12, 43743);
			attr_dev(img, "id", "im");
			...
			add_location(div11, file, 980, 12, 44531);
			...
			add_location(div12, file, 953, 8, 43565);
			...
			add_location(textarea, file, 1000, 8, 45596);
			attr_dev(center, "class", "mt");
			attr_dev(center, "id", "mainContent");
			add_location(center, file, 893, 4, 41377);
			add_location(div13, file, 892, 0, 41366);
		},
...
//# sourceMappingURL=Hotspot-20429251.js.map
