...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 245, 20, 11858);
		},
		m: function mount(target, anchor) {
...
// (233:4) <Dialog width="400" bind:visible={state.openHelp} style="background: #fff; border-radius: 5px;">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(233:4) <Dialog width=\\\"400\\\" bind:visible={state.openHelp} style=\\\"background: #fff; border-radius: 5px;\\\">",
		ctx
	});
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 249, 8, 11985);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
//# sourceMappingURL=TreeViewAuthoring-734207fa.js.map
