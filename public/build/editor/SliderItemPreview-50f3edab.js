...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			span = element("span");
			span.textContent = `${language.oops_msg}`;
			add_location(span, file, 250, 8, 10539);
			attr_dev(div, "class", "alert alert-danger font-weight-bold");
			add_location(div, file, 249, 4, 10481);
		},
...
// (282:24) {#if (targetView == "block" && user_ans_tab == true)}
function create_if_block_1(ctx) {
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*data*/ ctx[20].anskey == /*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid]) return create_if_block_2;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(282:24) {#if (targetView == \\\"block\\\" && user_ans_tab == true)}",
		ctx
	});
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 288, 36, 12654);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 287, 32, 12557);
		},
		m: function mount(target, anchor) {
...
// (283:28) {#if data.anskey == state.datauserans[data.sliderid]}
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 284, 36, 12361);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 283, 32, 12264);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span1, anchor);
			append_dev(span1, span0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(283:28) {#if data.anskey == state.datauserans[data.sliderid]}",
		ctx
	});
...
function create_else_block(ctx) {
	let span;
	let t0_value = language.correct_val + "";
	let t0;
	let t1;
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 301, 40, 13640);
		},
		m: function mount(target, anchor) {
...
// (299:36) {#if !(targetView == "block" && user_ans_tab == false)}
function create_if_block(ctx) {
	let span;
	let t0_value = language.current_val + "";
	let t0;
	let t1;

	let t2_value = (/*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid] == 0 || /*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid] == undefined
	? /*data*/ ctx[20].defaultans
	: /*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid]) + "";
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 299, 40, 13376);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span, anchor);
			append_dev(span, t0);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*state, localSliderData*/ 10 && t2_value !== (t2_value = (/*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid] == 0 || /*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid] == undefined
			? /*data*/ ctx[20].defaultans
			: /*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid]) + "")) set_data_dev(t2, t2_value);
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(span);
		}
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(299:36) {#if !(targetView == \\\"block\\\" && user_ans_tab == false)}",
		ctx
	});
...
// (263:12) {#each localSliderData as data, i}
function create_each_block(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*targetView*/ ctx[4] == "block" && /*user_ans_tab*/ ctx[2] == true && create_if_block_1(ctx);

	function select_block_type_1(ctx, dirty) {
		if (!(/*targetView*/ ctx[4] == "block" && /*user_ans_tab*/ ctx[2] == false)) return create_if_block;
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*targetView, user_ans_tab, localSliderData, state*/ 30 && input_value_value !== (input_value_value = /*targetView*/ ctx[4] == "block" && /*user_ans_tab*/ ctx[2] == false
			? parseInt(/*data*/ ctx[20].anskey)
			: /*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid] == 0 || /*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid] == undefined
				? parseInt(/*data*/ ctx[20].defaultans)
				: parseInt(/*state*/ ctx[3].datauserans[/*data*/ ctx[20].sliderid]))) {
			...
			if (/*targetView*/ ctx[4] == "block" && /*user_ans_tab*/ ctx[2] == true) {
				if (if_block0) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(263:12) {#each localSliderData as data, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 261, 8, 10818);
			attr_dev(div1, "id", "slidermain");
			add_location(div1, file, 260, 4, 10788);
			attr_dev(div2, "class", "text-center");
			add_location(div2, file, 253, 0, 10583);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	function handleRange() {
		...
		$$invalidate(3, state.datauserans[this.id] = this.value, state);

		// updates the value of state datauserans
		(((($$invalidate(3, state), $$invalidate(0, isReview)), $$invalidate(10, xml)), $$invalidate(11, uxml)), $$invalidate(1, localSliderData));
	...
	function handleReviewMode(mode) {
		if (mode == "c") {
			$$invalidate(2, user_ans_tab = false);
		} else if (mode == "u") {
			$$invalidate(2, user_ans_tab = true);
		}
	}
	...
	$$self.$inject_state = $$props => {
		...
		if ("user_ans_tab" in $$props) $$invalidate(2, user_ans_tab = $$props.user_ans_tab);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*isReview, xml, state, uxml, localSliderData*/ 3083) {
			 {
				if (isReview) {
					$$invalidate(4, targetView = "block");
					...
					oldjson.map(function (data, i) {
						if (newjson[i] != undefined) {
							if (data._defaultans != newjson[i]._defaultans) {
								...
								$$invalidate(3, state.datauserans[data._key] = newjson[i]._defaultans, state);
							}
						}
					});
					...
					if (uxml) {
						...
						if (typeof uaXML.smans.slider != "undefined") {
							...
							localSliderData.map(function (data, i) {
								...
								$$invalidate(3, state.datauserans[data.sliderid] = uaXML.smans.slider[i]._userAns, state);
							});
						}
					}
				}
...
//# sourceMappingURL=SliderItemPreview-50f3edab.js.map
