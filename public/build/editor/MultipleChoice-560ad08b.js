...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 189, 3, 5268);
			...
			add_location(button, file, 181, 2, 5056);
			attr_dev(div0, "class", "mt-lg position-relative col-12 bottom20 pl-0");
			set_style(div0, "padding-top", "8px");
			add_location(div0, file, 180, 1, 4969);
			add_location(div1, file, 168, 0, 4684);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<MultipleChoice> was created with unknown prop '${key}'`);
	});
...
//# sourceMappingURL=MultipleChoice-560ad08b.js.map
