...
import { N as JUI, a7 as Lang, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, e as element, p as append_dev, v as validate_slots, f as space, j as attr_dev, k as add_location, n as insert_dev, B as noop, x as detach_dev, L as beforeUpdate, A as AH, o as onMount, a9 as afterUpdate, X as XMLToJSON, w as writable, c as create_component, l as set_style, m as mount_component, q as listen_dev, G as prop_dev, t as transition_in, a as transition_out, b as destroy_component, H as run_all } from './main-dd9f9f1a.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 221, 32, 10213);
			...
			add_location(button0, file$1, 220, 28, 9969);
			attr_dev(span1, "class", "icomoon-new-24px-delete-1 s2 updateGraph");
			add_location(span1, file$1, 224, 32, 10596);
			...
			add_location(button1, file$1, 223, 28, 10331);
			add_location(span2, file$1, 219, 24, 9933);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$1, 229, 172, 11106);
			...
			add_location(div2, file$1, 234, 16, 11290);
			...
			add_location(div3, file$1, 216, 12, 9685);
			add_location(center, file$1, 215, 8, 9663);
			...
			add_location(textarea, file$1, 237, 8, 11781);
			attr_dev(div4, "id", "authoringDiv");
			add_location(div4, file$1, 213, 4, 9603);
			add_location(main, file$1, 212, 0, 9591);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=ChartAuthoring-35d61310.js.map
