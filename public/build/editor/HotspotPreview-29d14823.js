...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 579, 7, 19832);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 580, 7, 19924);
			...
			add_location(div0, file, 575, 6, 19650);
			...
			add_location(div1, file, 567, 5, 19441);
			...
			add_location(div2, file, 583, 5, 20010);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 566, 4, 19406);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 527, 10, 18343);
			...
			add_location(div0, file, 536, 10, 18638);
			...
			add_location(span, file, 549, 10, 19002);
			...
			add_location(div1, file, 514, 9, 17960);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 513, 8, 17918);
			attr_dev(td, "class", "border");
			add_location(td, file, 512, 7, 17889);
			add_location(tr, file, 511, 6, 17876);
			add_location(tbody, file, 510, 5, 17861);
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 597, 6, 20426);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input, file, 608, 1, 20687);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 615, 1, 20821);
...
//# sourceMappingURL=HotspotPreview-29d14823.js.map
