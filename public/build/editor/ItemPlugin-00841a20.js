...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 635, 32, 25183);
			...
			add_location(label, file, 644, 32, 26083);
			attr_dev(div, "class", "stick_checkbox d-inline-block");
			add_location(div, file, 634, 28, 25106);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label0, file, 612, 32, 23550);
			...
			add_location(span3, file, 619, 28, 23904);
...
function create_default_slot_6(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 666, 16, 27571);
		},
		m: function mount(target, anchor) {
...
function create_title_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div1, file, 676, 24, 28115);
			attr_dev(button0, "type", "button");
			...
			add_location(button0, file, 680, 8, 28365);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 681, 8, 28543);
			attr_dev(div2, "class", "btn-group mt-1 row ml-0");
			add_location(div2, file, 679, 7, 28318);
			attr_dev(div3, "class", "float-right mr-4");
			add_location(div3, file, 678, 24, 28279);
			attr_dev(div0, "slot", "title");
			add_location(div0, file, 675, 20, 28071);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 691, 40, 29120);
			attr_dev(input, "type", "text");
			...
			add_location(input, file, 695, 44, 29402);
			attr_dev(div1, "class", "d-flex mr-2");
			add_location(div1, file, 690, 36, 29053);
			attr_dev(div2, "class", "text-danger font-weight-bold ml-2 mt-3");
			add_location(div2, file, 705, 36, 30089);
			attr_dev(div3, "class", "text-danger ml-2");
			attr_dev(div3, "style", div3_style_value = "text-indent:15px");
			add_location(div3, file, 706, 36, 30192);
			attr_dev(div4, "class", "text-danger ml-2");
			attr_dev(div4, "style", div4_style_value = "text-indent:15px");
			add_location(div4, file, 707, 36, 30312);
			add_location(div5, file, 689, 32, 29010);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div5, anchor);
			append_dev(div5, div1);
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 687, 24, 28883);
			add_location(div1, file, 686, 20, 28852);
			attr_dev(div2, "class", "svelteFooter");
			add_location(div2, file, 750, 20, 33030);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div6, file, 661, 8, 27157);
...
//# sourceMappingURL=ItemPlugin-00841a20.js.map
