...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 220, 192, 10267);
		},
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 252, 20, 12162);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div4, file, 245, 8, 11654);
		},
		m: function mount(target, anchor) {
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 256, 8, 12289);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea0, file, 222, 24, 10361);
			...
			add_location(textarea1, file, 223, 24, 10494);
			add_location(div14, file, 159, 20, 6822);
			attr_dev(div15, "class", "border-0");
			set_style(div15, "width", "95%");
			add_location(div15, file, 158, 16, 6758);
			attr_dev(strong, "class", "ml-lg-3");
			add_location(strong, file, 227, 20, 10811);
			add_location(li0, file, 229, 24, 10909);
			add_location(li1, file, 230, 24, 10959);
			add_location(li2, file, 231, 24, 11010);
			add_location(ol, file, 228, 20, 10879);
			attr_dev(div16, "class", "font13 mx-3 text-left text-danger");
			add_location(div16, file, 226, 16, 10742);
			attr_dev(div17, "id", "main");
			attr_dev(div17, "class", "py-3 min_height_20 width98");
			add_location(div17, file, 157, 12, 6690);
			add_location(center, file, 156, 8, 6668);
			attr_dev(div18, "id", "authoringArea");
			attr_dev(div18, "class", "border");
			add_location(div18, file, 155, 4, 6619);
			add_location(main, file, 154, 0, 6607);
		},
...
//# sourceMappingURL=TreeViewAuthoring-d89d5c7f.js.map
