...
function add_css(target) {
	append_styles(target, "svelte-11usv4u", "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (522:2) {#if moduleArr[item_type] == "1" || moduleArr[item_type] == "2"}
function create_if_block_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(522:2) {#if moduleArr[item_type] == \\\"1\\\" || moduleArr[item_type] == \\\"2\\\"}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 603, 7, 20516);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 604, 7, 20608);
			...
			add_location(div0, file, 599, 6, 20334);
			...
			add_location(div1, file, 591, 5, 20125);
			...
			add_location(div2, file, 607, 5, 20694);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 590, 4, 20090);
		},
		m: function mount(target, anchor) {
...
// (533:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 551, 10, 19027);
			...
			add_location(div0, file, 560, 10, 19322);
			...
			add_location(span, file, 573, 10, 19686);
			...
			add_location(div1, file, 538, 9, 18644);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 537, 8, 18602);
			attr_dev(td, "class", "border");
			add_location(td, file, 536, 7, 18573);
			add_location(tr, file, 535, 6, 18560);
			add_location(tbody, file, 534, 5, 18545);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 533, 4, 18460);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(533:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 621, 6, 21110);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 530, 2, 18323);
			add_location(center, file, 520, 1, 18038);
			...
			add_location(input, file, 632, 1, 21370);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 519, 0, 18029);
		},
...
//# sourceMappingURL=HotspotPreview-8393fcac.js.map
