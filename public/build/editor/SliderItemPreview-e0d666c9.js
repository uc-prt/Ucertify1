...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, C as validate_each_argument, v as validate_slots, o as onMount, X as XMLToJSON, a2 as onUserAnsChange, y as l, A as AH, e as element, k as add_location, j as attr_dev, n as insert_dev, p as append_dev, B as noop, x as detach_dev, h as text, f as space, q as listen_dev, E as set_data_dev, F as prop_dev, c as create_component, m as mount_component, t as transition_in, a as transition_out, b as destroy_component, H as destroy_each, z as empty } from './main-7bd1c528.js';
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 262, 8, 11118);
			attr_dev(div, "class", "alert alert-danger font-weight-bold");
			add_location(div, file, 261, 4, 11059);
		},
...
// (295:24) {#if (targetView == "block" && user_ans_tab == true)}
function create_if_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(295:24) {#if (targetView == \\\"block\\\" && user_ans_tab == true)}",
		ctx
	});
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 301, 36, 13312);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 300, 32, 13214);
		},
		m: function mount(target, anchor) {
...
// (296:28) {#if data.anskey == state.datauserans[data.sliderid]}
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 297, 36, 13017);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 296, 32, 12919);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span1, anchor);
			append_dev(span1, span0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(296:28) {#if data.anskey == state.datauserans[data.sliderid]}",
		ctx
	});
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 314, 40, 14311);
		},
		m: function mount(target, anchor) {
...
// (312:36) {#if !(targetView == "block" && user_ans_tab == false)}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 312, 40, 14045);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span, anchor);
			append_dev(span, t0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(312:36) {#if !(targetView == \\\"block\\\" && user_ans_tab == false)}",
		ctx
	});
...
// (276:12) {#each localSliderData as data, i}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(276:12) {#each localSliderData as data, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 274, 8, 11451);
			attr_dev(div1, "id", "slidermain");
			add_location(div1, file, 273, 4, 11420);
			attr_dev(div2, "class", "text-center");
			add_location(div2, file, 265, 0, 11165);
		},
...
//# sourceMappingURL=SliderItemPreview-e0d666c9.js.map
