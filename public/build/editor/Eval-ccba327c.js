...
// (1353:40) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == "psql")}
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1360, 48, 57440);
			...
			add_location(button, file, 1353, 44, 56930);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1353:40) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == \\\"psql\\\")}",
		ctx
	});
...
// (1381:40) {#if (state.lang_type =='sql' || state.lang_type == 'mssql' || state.lang_type == "psql")}
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file, 1381, 44, 59002);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1381:40) {#if (state.lang_type =='sql' || state.lang_type == 'mssql' || state.lang_type == \\\"psql\\\")}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option0, file, 1481, 44, 66116);
			option1.__value = "raw";
			option1.value = option1.__value;
			add_location(option1, file, 1482, 44, 66216);
			...
			add_location(select, file, 1473, 40, 65562);
		},
		m: function mount(target, anchor) {
...
// (1508:8) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == "psql")}
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1508:8) {#if (state.lang_type=='sql' || state.lang_type=='mssql' || state.lang_type == \\\"psql\\\")}",
		ctx
	});
...
// (1514:20) {#each state.databases as database}
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1514, 24, 68311);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1514:20) {#each state.databases as database}",
		ctx
	});
...
// (1509:12) <Dialog bind:visible={state.database_modal_open} width={225} aria-labelledby="simple-dialog-title" style="background-color:#fff;" class="dialog evalpro_dialog">
function create_default_slot_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1510, 56, 67992);
			attr_dev(div0, "class", "font20");
			add_location(div0, file, 1510, 20, 67956);
			set_style(div1, "text-align", "left");
			set_style(div1, "width", "225px");
			set_style(div1, "margin-left", "17px");
			add_location(div1, file, 1509, 16, 67871);
			set_style(div2, "position", "relative");
			set_style(div2, "top", "14px");
			add_location(div2, file, 1512, 16, 68183);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1509:12) <Dialog bind:visible={state.database_modal_open} width={225} aria-labelledby=\\\"simple-dialog-title\\\" style=\\\"background-color:#fff;\\\" class=\\\"dialog evalpro_dialog\\\">",
		ctx
	});
...
// (1527:16) {#each lang_type as lang}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (img.src !== (img_src_value = window.themeUrl + "/svelte_items/images/" + (/*lang*/ ctx[72] == "c#" ? "csharp" : /*lang*/ ctx[72]) + "_lang.png")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Language");
			add_location(img, file, 1529, 28, 69561);
			...
			add_location(div0, file, 1528, 24, 69419);
			attr_dev(div1, "class", "pl-1 d-inline-block");
			set_style(div1, "padding", "15px");
			add_location(div1, file, 1531, 24, 69777);
			...
			add_location(div2, file, 1527, 20, 69216);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1527:16) {#each lang_type as lang}",
		ctx
	});
...
// (1522:8) <Dialog bind:visible={state.open} width={225} style="background-color:#fff;" class="dialog evalpro_dialog">
function create_default_slot_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(span, "font-size", "20px");
			set_style(span, "cursor", "pointer");
			add_location(span, file, 1523, 52, 68924);
			attr_dev(div0, "class", "font20");
			add_location(div0, file, 1523, 16, 68888);
			set_style(div1, "text-align", "left");
			set_style(div1, "width", "225px");
			set_style(div1, "margin-left", "17px");
			add_location(div1, file, 1522, 12, 68806);
			set_style(div2, "position", "relative");
			set_style(div2, "top", "14px");
			add_location(div2, file, 1525, 12, 69107);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1522:8) <Dialog bind:visible={state.open} width={225} style=\\\"background-color:#fff;\\\" class=\\\"dialog evalpro_dialog\\\">",
		ctx
	});
...
// (1570:28) <Button                                   color="primary"                                   unelevated="true"                                  on:click={addMore}                                   aria-label="Add"                                   style="height: 40px; width: 40px; border-radius: 50%"                              >
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(spna, file, 1576, 32, 73094);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1570:28) <Button                                   color=\\\"primary\\\"                                   unelevated=\\\"true\\\"                                  on:click={addMore}                                   aria-label=\\\"Add\\\"                                   style=\\\"height: 40px; width: 40px; border-radius: 50%\\\"                              >",
		ctx
	});
...
// (1600:8) <Snackbar              bind:visible={state.snackback}               bg="#333"               bottom={true}                timeout={3000}               style="position:fixed; bottom:50px"          >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1600:8) <Snackbar              bind:visible={state.snackback}               bg=\\\"#333\\\"               bottom={true}                timeout={3000}               style=\\\"position:fixed; bottom:50px\\\"          >",
		ctx
	});
...
// (1610:12) <Button                  raised={true}                  on:click = {()=>{ state.remediationToggle = false}}                  class="bg-light"              >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1610:12) <Button                  raised={true}                  on:click = {()=>{ state.remediationToggle = false}}                  class=\\\"bg-light\\\"              >",
		ctx
	});
...
// (1609:8) <div slot="footer" class="svelteFooter">
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1608, 8, 74424);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1609:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\">",
		ctx
	});
...
// (1590:4) <Dialog bind:visible={state.remediationToggle} width={960} class="dialog bg-white">
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			t6 = space();
			attr_dev(div0, "class", "font20");
			add_location(div0, file, 1591, 12, 73872);
			set_style(div1, "text-align", "left");
			add_location(div1, file, 1590, 8, 73827);
			add_location(br, file, 1596, 40, 74100);
			add_location(h4, file, 1596, 16, 74076);
			attr_dev(center, "class", "mt-xl");
			add_location(center, file, 1594, 12, 73980);
			attr_dev(div2, "id", "remediationModel");
			add_location(div2, file, 1593, 8, 73939);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1590:4) <Dialog bind:visible={state.remediationToggle} width={960} class=\\\"dialog bg-white\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	let h5;
	let span8;
	let t44_value = language.select_case_match + "";
	let t44;
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 1350, 44, 56619);
			...
			add_location(button1, file, 1368, 40, 58095);
			attr_dev(i, "class", "fa fa-play");
			add_location(i, file, 1392, 44, 59760);
			...
			add_location(button2, file, 1383, 40, 59189);
			attr_dev(div1, "class", "float-right");
			set_style(div1, "margin", "-9px -14px 0 4px");
			add_location(div1, file, 1367, 36, 57994);
			attr_dev(div2, "class", "card-header editor-heading pt-md");
			set_style(div2, "height", "44px");
			add_location(div2, file, 1341, 32, 55878);
			add_location(span2, file, 1403, 40, 60519);
			...
			add_location(button3, file, 1404, 40, 60577);
			...
			add_location(div3, file, 1402, 36, 60357);
			...
			add_location(textarea0, file, 1416, 40, 61395);
			attr_dev(div4, "class", div4_class_value = "" + ((/*state*/ ctx[2].preBlockShow ? "" : "h-imp") + " pre-div"));
			add_location(div4, file, 1415, 36, 61296);
			attr_dev(span3, "class", "d-inline span4");
			add_location(span3, file, 1419, 40, 61749);
			...
			add_location(label, file, 1421, 44, 61903);
			...
			add_location(input0, file, 1422, 44, 62038);
			attr_dev(div5, "class", "pull-right");
			add_location(div5, file, 1420, 40, 61833);
			...
			add_location(div6, file, 1418, 36, 61571);
			...
			add_location(textarea1, file, 1432, 40, 62683);
			attr_dev(div7, "class", "replEditor");
			add_location(div7, file, 1431, 36, 62617);
			add_location(span4, file, 1435, 40, 63033);
			...
			add_location(button4, file, 1436, 40, 63092);
			...
			add_location(div8, file, 1434, 36, 62871);
			...
			add_location(textarea2, file, 1447, 40, 63851);
			attr_dev(div9, "class", div9_class_value = "post-div " + (/*state*/ ctx[2].postBlockShow ? "" : "h-imp"));
			add_location(div9, file, 1446, 36, 63749);
			...
			add_location(div10, file, 1398, 32, 60059);
			...
			add_location(div21, file, 1499, 32, 67279);
			attr_dev(div22, "class", "card card-default");
			attr_dev(div22, "id", "test_card");
			set_style(div22, "display", "none");
			add_location(div22, file, 1495, 28, 66914);
			add_location(div23, file, 1454, 24, 64271);
			...
			add_location(textarea4, file, 1563, 32, 71946);
 ...
 */
	function addMore(inp = "", oup = "", i) {
		...
		caseStack.innerHTML = `<div class="w-100 p-3 mt-2 mb-2" style="background: #f1f1f1"><div class="w-100"><h5 class="float-left p-1" style="width: 90%"><lable class="bage mr-4 test_case_label">${language.testcase + (index + 1)}</lable><label class="container_eval mr-4">${language.case_insensitive}<input class="case_insensitive" type="checkbox" value="${state.case_insensitive}"><span class="checkmark_eval"></span></label><label class="container_eval mr-4">${language.ignore_special_char}<input class="ignore_special_char" type="checkbox" value="${state.ignore_special_char}"><span class="checkmark_eval"></span></label><label class="container_eval">${language.partial_match}<input class="partial_match" type="checkbox" value="${state.partial_match}" checked="checked"><span class="checkmark_eval"></span></label></h5><span tabIndex="0" class="float-right p-2 icomoon-new-24px-delete-1 s5 pointer caseDelBtn"></span></div><textarea class="form-control d-inline-block mr-md ${isSql}" style="width: 48%;height: 100px;" placeholder="${language.input_seperated_comma}">${inp}</textarea>
...
export default Eval;
//# sourceMappingURL=Eval-ccba327c.js.map
