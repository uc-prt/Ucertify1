...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, A as AH, I as beforeUpdate, w as writable, e as element, f as space, j as attr_dev, l as set_style, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, B as noop, x as detach_dev, G as run_all } from './main-ff508531.js';

/* src\components\VideoPlus.svelte generated by Svelte v3.34.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<VideoPlus> was created with unknown prop '${key}'`);
	});
...
//# sourceMappingURL=VideoPlus-1b05004d.js.map
