...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 588, 7, 20044);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 589, 7, 20136);
			...
			add_location(div0, file, 584, 6, 19862);
			...
			add_location(div1, file, 576, 5, 19653);
			...
			add_location(div2, file, 592, 5, 20222);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 575, 4, 19618);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 536, 10, 18555);
			...
			add_location(div0, file, 545, 10, 18850);
			...
			add_location(span, file, 558, 10, 19214);
			...
			add_location(div1, file, 523, 9, 18172);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 522, 8, 18130);
			attr_dev(td, "class", "border");
			add_location(td, file, 521, 7, 18101);
			add_location(tr, file, 520, 6, 18088);
			add_location(tbody, file, 519, 5, 18073);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 518, 4, 17988);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 606, 6, 20638);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 515, 2, 17851);
			add_location(center, file, 510, 1, 17751);
			...
			add_location(input, file, 617, 1, 20898);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 509, 0, 17742);
		},
...
//# sourceMappingURL=HotspotPreview-7f3c1161.js.map
