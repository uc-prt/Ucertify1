...
import { L as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, J as append_styles, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, a2 as onUserAnsChange, I as beforeUpdate, w as writable, e as element, c as create_component, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, m as mount_component, r as group_outros, a as transition_out, u as check_outros, t as transition_in, F as prop_dev, x as detach_dev, b as destroy_component, l as set_style, z as empty, B as noop, h as text, U as src_url_equal, a5 as toggle_class, q as listen_dev, a6 as HtmlTag } from './main-46dbf898.js';
...
function add_css(target) {
	append_styles(target, "svelte-11usv4u", "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 599, 7, 20353);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 600, 7, 20445);
			...
			add_location(div0, file, 595, 6, 20171);
			...
			add_location(div1, file, 587, 5, 19962);
			...
			add_location(div2, file, 603, 5, 20531);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 586, 4, 19927);
		},
		m: function mount(target, anchor) {
...
// (529:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 547, 10, 18864);
			...
			add_location(div0, file, 556, 10, 19159);
			...
			add_location(span, file, 569, 10, 19523);
			...
			add_location(div1, file, 534, 9, 18481);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 533, 8, 18439);
			attr_dev(td, "class", "border");
			add_location(td, file, 532, 7, 18410);
			add_location(tr, file, 531, 6, 18397);
			add_location(tbody, file, 530, 5, 18382);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 529, 4, 18297);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(529:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 617, 6, 20947);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 526, 2, 18160);
			add_location(center, file, 520, 1, 18022);
			...
			add_location(input, file, 636, 1, 21455);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 519, 0, 18013);
		},
...
//# sourceMappingURL=HotspotPreview-349d8f31.js.map
