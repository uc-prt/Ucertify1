...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(td, file, 392, 36, 14582);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 410, 52, 16116);
			add_location(span1, file, 409, 48, 16056);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (if_block) if_block.c();
			t = space();
			add_location(tr, file, 388, 20, 14353);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t5 = space();
			t6 = text(t6_value);
			add_location(tbody, file, 385, 8, 14208);
...
//# sourceMappingURL=ShadingPreview-c2b0cea0.js.map
