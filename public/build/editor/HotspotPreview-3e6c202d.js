...
import { L as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, J as append_styles, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, a2 as onUserAnsChange, w as writable, c as create_component, m as mount_component, t as transition_in, a as transition_out, b as destroy_component, e as element, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, r as group_outros, u as check_outros, F as prop_dev, x as detach_dev, l as set_style, z as empty, h as text, U as src_url_equal, a5 as toggle_class, q as listen_dev, a6 as HtmlTag } from './main-2240049b.js';
...
function add_css(target) {
	append_styles(target, "svelte-11usv4u", "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (556:2) {#if moduleArr[item_type] == "1" || moduleArr[item_type] == "2"}
function create_if_block_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(556:2) {#if moduleArr[item_type] == \\\"1\\\" || moduleArr[item_type] == \\\"2\\\"}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 637, 7, 21157);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 638, 7, 21249);
			...
			add_location(div0, file, 633, 6, 20975);
			...
			add_location(div1, file, 625, 5, 20766);
			...
			add_location(div2, file, 641, 5, 21335);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 624, 4, 20731);
		},
		m: function mount(target, anchor) {
...
// (567:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (!src_url_equal(img.src, img_src_value = /*bgImgPath*/ ctx[19] + /*img_url*/ ctx[14])) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", /*alt*/ ctx[2]);
			add_location(img, file, 585, 10, 19668);
			...
			add_location(div0, file, 594, 10, 19963);
			...
			add_location(span, file, 607, 10, 20327);
			...
			add_location(div1, file, 572, 9, 19285);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 571, 8, 19243);
			attr_dev(td, "class", "border");
			add_location(td, file, 570, 7, 19214);
			add_location(tr, file, 569, 6, 19201);
			add_location(tbody, file, 568, 5, 19186);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 567, 4, 19101);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*img_url*/ 16384 && !src_url_equal(img.src, img_src_value = /*bgImgPath*/ ctx[19] + /*img_url*/ ctx[14])) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(567:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 655, 6, 21751);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	let input;
	let current;
	let if_block0 = (/*moduleArr*/ ctx[20][/*item_type*/ ctx[15]] == "1" || /*moduleArr*/ ctx[20][/*item_type*/ ctx[15]] == "2") && create_if_block_3(ctx);

	function select_block_type(ctx, dirty) {
		if (/*moduleArr*/ ctx[20][/*item_type*/ ctx[15]] == "4") return create_if_block;
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 564, 2, 18964);
			add_location(center, file, 554, 1, 18679);
			...
			add_location(input, file, 666, 1, 22011);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 553, 0, 18670);
		},
		...
		p: function update(ctx, dirty) {
			if (/*moduleArr*/ ctx[20][/*item_type*/ ctx[15]] == "1" || /*moduleArr*/ ctx[20][/*item_type*/ ctx[15]] == "2") {
				if (if_block0) {
					if_block0.p(ctx, dirty);

					if (dirty[0] & /*item_type*/ 32768) {
...
//# sourceMappingURL=HotspotPreview-3e6c202d.js.map
