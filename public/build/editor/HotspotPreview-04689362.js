...
function add_css(target) {
	append_styles(target, "svelte-11usv4u", "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 588, 7, 20070);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 589, 7, 20162);
			...
			add_location(div0, file, 584, 6, 19888);
			...
			add_location(div1, file, 576, 5, 19679);
			...
			add_location(div2, file, 592, 5, 20248);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 575, 4, 19644);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 536, 10, 18581);
			...
			add_location(div0, file, 545, 10, 18876);
			...
			add_location(span, file, 558, 10, 19240);
			...
			add_location(div1, file, 523, 9, 18198);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 522, 8, 18156);
			attr_dev(td, "class", "border");
			add_location(td, file, 521, 7, 18127);
			add_location(tr, file, 520, 6, 18114);
			add_location(tbody, file, 519, 5, 18099);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 518, 4, 18014);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 606, 6, 20664);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 515, 2, 17877);
			add_location(center, file, 510, 1, 17777);
			...
			add_location(input, file, 617, 1, 20924);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 509, 0, 17768);
		},
...
//# sourceMappingURL=HotspotPreview-04689362.js.map
