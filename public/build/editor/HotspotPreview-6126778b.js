...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 657, 7, 22048);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 658, 7, 22140);
			...
			add_location(div0, file, 653, 6, 21866);
			...
			add_location(div1, file, 645, 5, 21657);
			...
			add_location(div2, file, 661, 5, 22226);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 644, 4, 21622);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 605, 10, 20559);
			...
			add_location(div0, file, 614, 10, 20854);
			...
			add_location(span, file, 627, 10, 21218);
			...
			add_location(div1, file, 592, 9, 20176);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 591, 8, 20134);
			attr_dev(td, "class", "border");
			add_location(td, file, 590, 7, 20105);
			add_location(tr, file, 589, 6, 20092);
			add_location(tbody, file, 588, 5, 20077);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table no_overflow_wrapper");
			add_location(table, file, 587, 4, 19972);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 675, 6, 22663);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 584, 2, 19835);
			add_location(center, file, 569, 1, 19278);
			...
			add_location(input, file, 686, 1, 22923);
			attr_dev(main, "class", "pt-1 svelte-11usv4u");
			add_location(main, file, 568, 0, 19256);
		},
...
//# sourceMappingURL=HotspotPreview-6126778b.js.map
