...
import { O as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, P as Dialog, Q as binding_callbacks, R as bind, T as Snackbar, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, U as Draggable, V as Button, W as Checkbox, N as JSONToXML, y as l, w as writable, g as globals, e as element, f as space, c as create_component, j as attr_dev, l as set_style, k as add_location, Y as src_url_equal, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, Z as stop_propagation, _ as prevent_default, G as prop_dev, $ as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as run_all, a0 as select_value, h as text, a1 as add_render_callback, a2 as set_input_value, a3 as select_option, B as noop } from './main-f7bd88ed.js';
...
function create_default_slot_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1010, 16, 46069);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 1009, 12, 46007);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 1008, 8, 45964);
			...
			add_location(input0, file, 1015, 16, 46234);
			...
			add_location(button, file, 1024, 16, 46578);
			attr_dev(div2, "class", "d-flex");
			add_location(div2, file, 1014, 12, 46196);
			...
			add_location(img, file, 1033, 16, 46945);
			attr_dev(div3, "class", "mx-auto width8 p-2 border mt-2");
			add_location(div3, file, 1032, 12, 46883);
			...
			add_location(label0, file, 1036, 16, 47082);
			add_location(span0, file, 1035, 12, 47058);
			...
			add_location(input1, file, 1038, 12, 47219);
			attr_dev(label1, "for", "hotBorder");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1050, 24, 47763);
			add_location(span1, file, 1049, 20, 47731);
			option0.__value = "0";
			option0.value = option0.__value;
			add_location(option0, file, 1053, 24, 47978);
			option1.__value = "1";
			option1.value = option1.__value;
			add_location(option1, file, 1054, 24, 48035);
			option2.__value = "2";
			option2.value = option2.__value;
			add_location(option2, file, 1055, 24, 48089);
			option3.__value = "3";
			option3.value = option3.__value;
			add_location(option3, file, 1056, 24, 48143);
			option4.__value = "4";
			option4.value = option4.__value;
			add_location(option4, file, 1057, 24, 48197);
			option5.__value = "5";
			option5.value = option5.__value;
			add_location(option5, file, 1058, 24, 48251);
			...
			add_location(select0, file, 1052, 20, 47880);

			attr_dev(div4, "class", div4_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block pr-2 mt-2 w-sm"
			: "hidden");

			add_location(div4, file, 1048, 16, 47624);
			attr_dev(label2, "for", "hotBorderColor");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1063, 24, 48486);
			add_location(span2, file, 1062, 20, 48454);
			option6.__value = "white";
			option6.value = option6.__value;
			add_location(option6, file, 1066, 24, 48716);
			option7.__value = "black";
			option7.value = option7.__value;
			add_location(option7, file, 1067, 24, 48777);
			option8.__value = "grey";
			option8.value = option8.__value;
			add_location(option8, file, 1068, 24, 48839);
			...
			add_location(select1, file, 1065, 20, 48608);

			attr_dev(div5, "class", div5_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block mt-2 w-sm"
			: "hidden");

			add_location(div5, file, 1061, 16, 48352);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 1047, 12, 47586);
			add_location(br, file, 1072, 12, 48962);
			attr_dev(label3, "for", "setLineColor");
			attr_dev(label3, "class", "mt-2 text-dark");
			add_location(label3, file, 1075, 20, 49084);
			add_location(span3, file, 1074, 16, 49056);
			option9.__value = "Please Select";
			option9.value = option9.__value;
			add_location(option9, file, 1078, 20, 49329);
			option10.__value = "red";
			option10.value = option10.__value;
			add_location(option10, file, 1079, 20, 49381);
			option11.__value = "black";
			option11.value = option11.__value;
			add_location(option11, file, 1080, 20, 49435);
			option12.__value = "blue";
			option12.value = option12.__value;
			add_location(option12, file, 1081, 20, 49493);
...
function create_footer_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1085, 8, 49600);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1106, 16, 50421);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 1105, 12, 50359);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 1104, 8, 50316);
			attr_dev(label0, "for", "dragHeight");
			attr_dev(label0, "class", "my-1 text-dark");
			add_location(label0, file, 1113, 24, 50663);
			add_location(span0, file, 1112, 20, 50631);
			attr_dev(input0, "type", "number");
			attr_dev(input0, "id", "dragHeight");
			attr_dev(input0, "placeholder", "Height");
			attr_dev(input0, "defaultvalue", " ");
			attr_dev(input0, "class", "form-control");
			add_location(input0, file, 1115, 20, 50775);
			attr_dev(div2, "class", "col-6 pr-1");
			add_location(div2, file, 1111, 16, 50585);
			attr_dev(label1, "for", "dragWidth");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1125, 24, 51139);
			add_location(span1, file, 1124, 20, 51107);
			attr_dev(input1, "type", "number");
			attr_dev(input1, "id", "dragWidth");
			attr_dev(input1, "placeholder", "Width");
			attr_dev(input1, "defaultvalue", " ");
			attr_dev(input1, "class", "form-control");
			add_location(input1, file, 1127, 20, 51249);
			attr_dev(div3, "class", "col-6 pl-1");
			add_location(div3, file, 1123, 16, 51061);
			attr_dev(div4, "class", "row");
			add_location(div4, file, 1110, 12, 50550);
			attr_dev(label2, "for", "dragTop");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1139, 24, 51667);
			add_location(span2, file, 1138, 20, 51635);
			attr_dev(input2, "type", "number");
			attr_dev(input2, "id", "dragTop");
			attr_dev(input2, "placeholder", "Top");
			attr_dev(input2, "defaultvalue", " ");
			attr_dev(input2, "class", "form-control");
			add_location(input2, file, 1141, 20, 51773);
			attr_dev(div5, "class", "col-6 pr-1");
			add_location(div5, file, 1137, 16, 51589);
			attr_dev(label3, "for", "dragLeft");
			attr_dev(label3, "class", "my-1 text-dark");
			add_location(label3, file, 1151, 24, 52131);
			add_location(span3, file, 1150, 20, 52099);
			attr_dev(input3, "type", "number");
			attr_dev(input3, "id", "dragLeft");
			attr_dev(input3, "placeholder", "Left");
			attr_dev(input3, "defaultvalue", " ");
			attr_dev(input3, "class", "form-control");
			add_location(input3, file, 1153, 20, 52239);
			attr_dev(div6, "class", "col-6 pl-1");
			add_location(div6, file, 1149, 16, 52053);
			attr_dev(div7, "class", "row mt-2");
			add_location(div7, file, 1136, 12, 51549);
			set_style(div8, "overflow-y", "auto");
			set_style(div8, "padding-right", "20px");
			add_location(div8, file, 1109, 8, 50484);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h4, anchor);
			append_dev(h4, div1);
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 1163, 8, 52553);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(button0, div, null);
...
function create_action_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1184, 8, 53294);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div1, file, 921, 16, 42284);
			...
			add_location(div4, file, 930, 12, 42729);
			attr_dev(div5, "class", "drawImage d-none");
			add_location(div5, file, 912, 8, 42005);
			attr_dev(i1, "class", "icomoon-24px-edit-1");
			add_location(i1, file, 965, 20, 44045);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light px-1 pt-sm1 pb-sm1 mt");
			add_location(button1, file, 960, 16, 43834);
			attr_dev(div6, "class", "btn-group tools");
			add_location(div6, file, 959, 12, 43787);
			attr_dev(img, "id", "im");
			...
			add_location(div11, file, 980, 12, 44575);
			...
			add_location(div12, file, 953, 8, 43609);
			...
			add_location(textarea, file, 1000, 8, 45640);
			attr_dev(center, "class", "mt");
			attr_dev(center, "id", "mainContent");
			add_location(center, file, 893, 4, 41421);
			add_location(div13, file, 892, 0, 41410);
		},
...
//# sourceMappingURL=Hotspot-6621dbfb.js.map
