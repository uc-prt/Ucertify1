...
// (353:0) <Snackbar   bind:visible={state.snackback}   timeout={10}  >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(353:0) <Snackbar   bind:visible={state.snackback}   timeout={10}  >",
		ctx
	});
...
// (359:0) <Dialog        bind:visible={state.remediationToggle}   width={450}   style="background: #fff; border-radius: 5px;"   class="remove_right_margin"  >
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t4 = space();
			t5 = text(t5_value);
			add_location(div0, file, 366, 3, 14909);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 365, 2, 14860);
			attr_dev(h40, "class", "mt-1 font21 mb-4");
			add_location(h40, file, 364, 1, 14827);
			add_location(br, file, 372, 27, 15101);
			add_location(h41, file, 372, 3, 15077);
			attr_dev(center, "class", "mt-xl");
			add_location(center, file, 370, 2, 15025);
			attr_dev(div2, "id", "remediationModel");
			set_style(div2, "overflow-y", "auto");
			set_style(div2, "padding-right", "20px");
			add_location(div2, file, 369, 1, 14947);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(359:0) <Dialog        bind:visible={state.remediationToggle}   width={450}   style=\\\"background: #fff; border-radius: 5px;\\\"   class=\\\"remove_right_margin\\\"  >",
		ctx
	});
...
// (377:2) <Button     unelevated={true}              outlined={true}     color="primary"     on:Click={()=>{ state.remediationToggle = false }}    >
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(377:2) <Button     unelevated={true}              outlined={true}     color=\\\"primary\\\"     on:Click={()=>{ state.remediationToggle = false }}    >",
		ctx
	});
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 375, 1, 15152);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=Labsimulation-6497203a.js.map
