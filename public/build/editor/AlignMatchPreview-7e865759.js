...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, C as validate_each_argument, e as element, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, x as detach_dev, K as destroy_each, h as text, F as set_data_dev, z as empty, B as noop, g as globals, A as AH, $ as add_render_callback, o as onMount, ab as afterUpdate, X as XMLToJSON, a3 as onUserAnsChange, y as l, q as listen_dev, Y as prevent_default, H as run_all, c as create_component, m as mount_component, t as transition_in, a as transition_out, b as destroy_component, l as set_style, r as group_outros, u as check_outros } from './main-1f98a0c0.js';
...
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 702, 52, 36888);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 706, 60, 37578);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			div.innerHTML = raw_value;
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 704, 60, 37163);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 690, 28, 35807);
			...
			add_location(div0, file$1, 689, 24, 35593);
...
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 725, 16, 38595);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 728, 16, 38813);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 735, 16, 39115);
			attr_dev(div1, "class", "yourAnswer");
			add_location(div1, file$1, 738, 16, 39342);
			attr_dev(div2, "class", "scoreDiv");
			add_location(div2, file$1, 734, 12, 39075);
			attr_dev(div3, "class", "finalResult");
			add_location(div3, file$1, 733, 8, 39036);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div3, file$1, 684, 4, 35198);
			add_location(div4, file$1, 675, 0, 34938);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=AlignMatchPreview-7e865759.js.map
