...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, W as Checkbox, C as validate_each_argument, V as Button, P as Dialog, Q as binding_callbacks, R as bind, v as validate_slots, o as onMount, X as XMLToJSON, A as AH, L as beforeUpdate, w as writable, y as l, N as JSONToXML, e as element, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, G as prop_dev, r as group_outros, a as transition_out, u as check_outros, t as transition_in, x as detach_dev, H as run_all, c as create_component, m as mount_component, Z as add_flush_callback, b as destroy_component, K as destroy_each, B as noop, a4 as null_to_empty } from './main-854b7bd4.js';

/* clsSMStepAlgo\StepAlgo.svelte generated by Svelte v3.40.2 */
const file = "clsSMStepAlgo\\StepAlgo.svelte";

function add_css(target) {
	append_styles(target, "svelte-122z4mi", ".font18.svelte-122z4mi{font-size:16px}.fwidth.svelte-122z4mi{width:100%}.light-cyan-bg.svelte-122z4mi{background-color:#d4e4ff;color:#333}.top2.svelte-122z4mi{top:2px}.right5.svelte-122z4mi{right:5px}.right35.svelte-122z4mi{right:35px}.step_checkbox.svelte-122z4mi{width:22%;border:1px solid black;margin-left:10px;position:relative;bottom:1px;cursor:pointer;padding:3px 2px 0}.fixed_ans.svelte-122z4mi{top:10px;position:relative;float:right;border:1px solid #e0e0e0;background-color:#f5f5f5;border-radius:4px;padding:5px;font-size:15px;font-weight:700}.check_box.svelte-122z4mi{right:24px;position:relative;width:40px}.inner_inputs.svelte-122z4mi{margin:0 12px!important}.pointer.svelte-122z4mi{cursor:pointer !important}.width100.svelte-122z4mi{width:100px}[id^=\"fillmain\"]{overflow:hidden;text-align:left}[id^=\"fillmain\"] pre{background:none;border:none;font-size:14px!important}[id^=\"fillmain\"] .string{min-height:50px;margin-top:10px;margin-right:10px}[id^=\"fillmain\"] .footerstr{position:relative;margin-top:10px;background-color:#ccc;padding:15px;min-height:60px}[id^=\"fillmain\"] .footerstr .arrow-up{position:absolute;top:-10px;right:50%;width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-bottom:10px solid #ccc}[id^=\"fillmain\"] .fill-row{padding:6px}[id^=\"fillmain\"] .fillelement, [id^=\"fillmain\"] .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}#fillmain .drag-resize{height:30px;display:inline-block;position:relative;min-height:30px;margin:1px}#fillmain input[type=\"text\"]{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}#fillmain select{height:99%!important;resize:none;font-size:12px;color:#000;max-width:800px}[id^=\"fillmain\"] .drag-resize{vertical-align:middle;border:1px solid #31B731;text-align:center;padding:3px;font-size:14px}[id^=\"fillmain\"] .drag-resize.ui-draggable{cursor:move}[id^=\"fillmain\"] .drop-hover{border:1px dashed red!important;box-shadow:0 0 0 2px yellow inset;outline:1px solid blue}[id^=\"fillmain\"] .fillcheck ul{width:220px}[id^=\"fillmain\"] .fillcheck li.selected{background-color:#E5E5E5}.fillcheck .selected .icomoon-checkmark-3:before{float:left;color:blue;padding:3px;position:relative;right:14px}.fillcheck .icomoon-close-2:before{float:left;color:blue;position:relative;right:14px;font-size:20px}.MathJax_Display{display:inline!important}[id^=\"fillmain\"] .select{font-size:15px}[id^=\"fillmain\"] .textarea{vertical-align:middle;border-radius:3px;background:#ffe;border:1px solid #ccc;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,0.075);box-shadow:inset 0 1px 1px rgba(0,0,0,0.075)}.ui-draggable-disabled{cursor:no-drop!important;opacity:0.5!important}.colorStyle{background-color:#dee2e6!important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
// (479:20) <Checkbox                            id="go_next"                           defaultChecked = {state.gonext ? true: false}                           on:click={(e)=>{goNext("go_next",e)}}                       >
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(479:20) <Checkbox                            id=\\\"go_next\\\"                           defaultChecked = {state.gonext ? true: false}                           on:click={(e)=>{goNext(\\\"go_next\\\",e)}}                       >",
		ctx
	});
...
// (486:20) <Checkbox                            id="fixedans_checkbox"                           defaultChecked = {state.variable_button ? true: false}                           on:click={(e)=>{fixedAnswer("fixedans_checkbox",e)}}                       >
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(486:20) <Checkbox                            id=\\\"fixedans_checkbox\\\"                           defaultChecked = {state.variable_button ? true: false}                           on:click={(e)=>{fixedAnswer(\\\"fixedans_checkbox\\\",e)}}                       >",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 539, 32, 21346);
			...
			add_location(label, file, 546, 32, 22173);
			attr_dev(div, "class", "stick_checkbox d-inline-block");
			add_location(div, file, 538, 28, 21269);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(541:36) {#if item._sticky == \\\"1\\\"}",
		ctx
	});
...
// (495:12) {#each all_steps as item,index}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(legend, file, 496, 20, 18116);
			...
			add_location(span0, file, 512, 24, 19108);
			...
			add_location(fieldset, file, 495, 16, 17994);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(495:12) {#each all_steps as item,index}",
		ctx
	});
...
// (564:12) <Button variant="fab" color="primary" mini aria-label="Add"                  on:click={addEvent.bind(this, 'steps')}                  class="btn btn-outline-primary rounded position-relative bottom0 bg-white shadow-sm height30"                  style={'float:left;width:120px;height:30px;border:1px solid #4285f4;color:#4285f4;text-transform:none;'}>
function create_default_slot_6(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 567, 16, 23636);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(564:12) <Button variant=\\\"fab\\\" color=\\\"primary\\\" mini aria-label=\\\"Add\\\"                  on:click={addEvent.bind(this, 'steps')}                  class=\\\"btn btn-outline-primary rounded position-relative bottom0 bg-white shadow-sm height30\\\"                  style={'float:left;width:120px;height:30px;border:1px solid #4285f4;color:#4285f4;text-transform:none;'}>",
		ctx
	});
...
// (584:20) {#if state.fillInTheBlanksChoice == 1}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 586, 32, 24956);
			attr_dev(input, "type", "text");
			...
			add_location(input, file, 589, 32, 25164);
			attr_dev(div1, "class", "d-flex mr-2");
			add_location(div1, file, 585, 28, 24897);
			attr_dev(div2, "class", "text-danger font-weight-bold ml-2 mt-3");
			add_location(div2, file, 599, 28, 25739);
			attr_dev(div3, "class", "text-danger ml-2");
			attr_dev(div3, "style", div3_style_value = 'text-indent:15px');
			add_location(div3, file, 600, 28, 25834);
			attr_dev(div4, "class", "text-danger ml-2");
			attr_dev(div4, "style", div4_style_value = 'text-indent:15px');
			add_location(div4, file, 601, 28, 25946);
			add_location(div5, file, 584, 24, 24862);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div5, anchor);
			append_dev(div5, div1);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(584:20) {#if state.fillInTheBlanksChoice == 1}",
		ctx
	});
...
// (614:32) <Button                                       variant = "contained"                                       color = "primary"                                      style = {'border:1px solid #4285f4;color:#4285f4;text-transform:none;'}                                       on:click = {addEditable}                                      class="btn btn-outline-primary height30 bg-white shadow-sm mt-1 top1 ml-1"                                  >
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(614:32) <Button                                       variant = \\\"contained\\\"                                       color = \\\"primary\\\"                                      style = {'border:1px solid #4285f4;color:#4285f4;text-transform:none;'}                                       on:click = {addEditable}                                      class=\\\"btn btn-outline-primary height30 bg-white shadow-sm mt-1 top1 ml-1\\\"                                  >",
		ctx
	});
...
// (624:36) <Button                                           id = {"latexEdit"}                                          variant = "contained"                                           color = "primary"                                          style = {'margin:5px;display:none;'}                                           on:click = {latexEdit}                                                                         >
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(624:36) <Button                                           id = {\\\"latexEdit\\\"}                                          variant = \\\"contained\\\"                                           color = \\\"primary\\\"                                          style = {'margin:5px;display:none;'}                                           on:click = {latexEdit}                                                                         >",
		ctx
	});
...
// (588:36) <Checkbox  id = "numeric" checked = {state.numeric}>
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(588:36) <Checkbox  id = \\\"numeric\\\" checked = {state.numeric}>",
		ctx
	});
...
// (643:16) <Button variant="contained" on:click={handleClose} class="colorStyle" >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(643:16) <Button variant=\\\"contained\\\" on:click={handleClose} class=\\\"colorStyle\\\" >",
		ctx
	});
...
// (646:16) <Button variant="contained" on:click={storeAns}                      class="bg-primary text-white">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(646:16) <Button variant=\\\"contained\\\" on:click={storeAns}                      class=\\\"bg-primary text-white\\\">",
		ctx
	});
...
// (571:8) <Dialog overlayClass="materialOverlay"  bind:visible={state.open} on:close={handleClose.bind(this)} disableEnforceFocus={true} width="650" class="row" style="background: #fff; border-radius: 5px;">
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 582, 16, 24751);
			add_location(div1, file, 581, 12, 24728);
			attr_dev(div2, "class", "svelteFooter");
			add_location(div2, file, 641, 12, 28338);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(571:8) <Dialog overlayClass=\\\"materialOverlay\\\"  bind:visible={state.open} on:close={handleClose.bind(this)} disableEnforceFocus={true} width=\\\"650\\\" class=\\\"row\\\" style=\\\"background: #fff; border-radius: 5px;\\\">",
		ctx
	});
...
function create_title_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 572, 16, 23981);
			attr_dev(button0, "type", "button");
			...
			add_location(button0, file, 575, 24, 24226);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 576, 24, 24420);
			attr_dev(div1, "class", "btn-group mt-1 row ml-0");
			add_location(div1, file, 574, 20, 24163);
			attr_dev(div2, "class", "float-right mr-4");
			add_location(div2, file, 573, 16, 24111);
			attr_dev(div3, "slot", "title");
			add_location(div3, file, 571, 12, 23945);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=ItemPlugin-466801b9.js.map
