...
import { y as l, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, e as element, p as append_dev, V as Checkbox, C as validate_each_argument, O as Dialog, P as binding_callbacks, Q as bind, v as validate_slots, L as beforeUpdate, X as XMLToJSON, o as onMount, A as AH$1, ab as afterUpdate, w as writable, ac as Loader, M as JSONToXML, U as Button, z as empty, n as insert_dev, x as detach_dev, f as space, c as create_component, h as text, j as attr_dev, k as add_location, m as mount_component, q as listen_dev, G as prop_dev, Z as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component, K as destroy_each, H as run_all, a4 as null_to_empty, l as set_style, B as noop } from './main-1f98a0c0.js';
...
/* clsSMMatchList\MatchList.svelte generated by Svelte v3.34.0 */
...
function add_css() {
	...
	style.id = "svelte-jg5y6h-style";
	style.textContent = ".colorgray.svelte-jg5y6h{width:56px;background-color:#dee2e6}.colorgray1.svelte-jg5y6h{width:74px;background:#E0E0E0}.font24.svelte-jg5y6h{font-size:22px !important;margin-right:5px}.add_button.svelte-jg5y6h{height:31px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
// (722:36) <Checkbox                                          checked={state.drag_mode}                                          on:click = {(e)=>{changeSetting("2",e)}}                                          id="isDragDrop"                                          color="primary"                                         style="position:relative;right:10px;">
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(722:36) <Checkbox                                          checked={state.drag_mode}                                          on:click = {(e)=>{changeSetting(\\\"2\\\",e)}}                                          id=\\\"isDragDrop\\\"                                          color=\\\"primary\\\"                                         style=\\\"position:relative;right:10px;\\\">",
		ctx
	});
...
// (730:36) <Checkbox                                                                                    on:click = {(e)=>{changeSetting("3",e)}}                                          id="isSwap"                                          color="primary"                                      >
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(730:36) <Checkbox                                                                                    on:click = {(e)=>{changeSetting(\\\"3\\\",e)}}                                          id=\\\"isSwap\\\"                                          color=\\\"primary\\\"                                      >",
		ctx
	});
...
// (740:36) <Checkbox                                           defaultChecked = {(state.isalgo == true ? true : false)}                                          on:click = {changeisalgo}                                           name = {"isalgo"}                                           id = {"isalgo"}                                          color="primary"                                      >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(740:36) <Checkbox                                           defaultChecked = {(state.isalgo == true ? true : false)}                                          on:click = {changeisalgo}                                           name = {\\\"isalgo\\\"}                                           id = {\\\"isalgo\\\"}                                          color=\\\"primary\\\"                                      >",
		ctx
	});
...
function create_else_block(ctx) {
	...
	let t0;
	let show_if_3 = /*data*/ ctx[58].value2.charAt(0) == "*";
	let div0_style_value;
	let t1;
	let div1;
	let show_if_2 = /*data*/ ctx[58].value2.charAt(0) == "*";
	let t2;
	let button0;
	let span0;
	let t3;
	...
	let t4;
	let show_if_1 = /*data*/ ctx[58].value1.charAt(0) == "*";
	let div3_style_value;
	let t5;
	let div4;
	let show_if = /*data*/ ctx[58].value1.charAt(0) == "*";
	let t6;
	let button1;
	let span1;
	let t7;
	...
	function change_handler_2(...args) {
		return /*change_handler_2*/ ctx[30](/*data*/ ctx[58], /*i*/ ctx[60], ...args);
	}
	...
	function click_handler_7() {
		return /*click_handler_7*/ ctx[31](/*i*/ ctx[60]);
	}

	function change_handler_3(...args) {
		return /*change_handler_3*/ ctx[32](/*data*/ ctx[58], /*i*/ ctx[60], ...args);
	}
	...
	function click_handler_8() {
		return /*click_handler_8*/ ctx[33](/*i*/ ctx[60]);
	}

	function click_handler_9() {
		return /*click_handler_9*/ ctx[34](/*data*/ ctx[58]);
	}
	...
	const block = {
		c: function create() {
			...
			attr_dev(textarea0, "class", textarea0_class_value = "" + (null_to_empty(/*data*/ ctx[58].value2.charAt(0) == "*"
			? "h form-control textarea_2_" + /*i*/ ctx[60]
			: "form-control textarea_2_" + /*i*/ ctx[60]) + " svelte-jg5y6h"));

			attr_dev(textarea0, "id", "matchList2");
			textarea0.value = textarea0_value_value = /*data*/ ctx[58].value2;
			add_location(textarea0, file, 825, 48, 33183);
			attr_dev(div0, "class", "pull-left word_break width200 p-1 max_width_300");
			attr_dev(div0, "style", div0_style_value = "borderRadius:3px;");
			add_location(div0, file, 824, 44, 33044);
			...
			add_location(span0, file, 836, 52, 34571);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-outline-primary btn-sm edit_btn bg-white");
			add_location(button0, file, 835, 48, 34388);
			attr_dev(div1, "class", "pull-right mt");
			add_location(div1, file, 831, 44, 33993);
			attr_dev(div2, "class", "pull-left d-flex align-items-center");
			add_location(div2, file, 823, 40, 32949);
			attr_dev(textarea1, "rows", "3");
			attr_dev(textarea1, "cols", "20");
			attr_dev(textarea1, "style", textarea1_style_value = "resize:none;");

			attr_dev(textarea1, "class", textarea1_class_value = "" + (null_to_empty(/*data*/ ctx[58].value1.charAt(0) == "*"
			? "h form-control textarea_1_" + /*i*/ ctx[60]
			: "form-control textarea_1_" + /*i*/ ctx[60]) + " svelte-jg5y6h"));

			attr_dev(textarea1, "id", "matchList1");
			textarea1.value = textarea1_value_value = /*data*/ ctx[58].value1;
			add_location(textarea1, file, 843, 48, 35207);
			...
			add_location(div3, file, 842, 44, 35067);
			...
			add_location(span2, file, 861, 44, 37103);
			add_location(a, file, 860, 40, 36992);
			attr_dev(div7, "class", "width1 float-right");
			add_location(div7, file, 859, 36, 36918);
			attr_dev(div8, "key", div8_key_value = /*i*/ ctx[60]);
			attr_dev(div8, "class", "d-flex align-items-center mb-2");
			add_location(div8, file, 821, 32, 32734);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*localCData*/ 1 && textarea0_class_value !== (textarea0_class_value = "" + (null_to_empty(/*data*/ ctx[58].value2.charAt(0) == "*"
			? "h form-control textarea_2_" + /*i*/ ctx[60]
			: "form-control textarea_2_" + /*i*/ ctx[60]) + " svelte-jg5y6h"))) {
				attr_dev(textarea0, "class", textarea0_class_value);
			}

			if (dirty[0] & /*localCData*/ 1 && textarea0_value_value !== (textarea0_value_value = /*data*/ ctx[58].value2)) {
				prop_dev(textarea0, "value", textarea0_value_value);
			}

			if (dirty[0] & /*localCData*/ 1) show_if_3 = /*data*/ ctx[58].value2.charAt(0) == "*";
			...
			if (dirty[0] & /*localCData*/ 1) show_if_2 = /*data*/ ctx[58].value2.charAt(0) == "*";
			...
			if (dirty[0] & /*localCData*/ 1 && textarea1_class_value !== (textarea1_class_value = "" + (null_to_empty(/*data*/ ctx[58].value1.charAt(0) == "*"
			? "h form-control textarea_1_" + /*i*/ ctx[60]
			: "form-control textarea_1_" + /*i*/ ctx[60]) + " svelte-jg5y6h"))) {
				attr_dev(textarea1, "class", textarea1_class_value);
			}

			if (dirty[0] & /*localCData*/ 1 && textarea1_value_value !== (textarea1_value_value = /*data*/ ctx[58].value1)) {
				prop_dev(textarea1, "value", textarea1_value_value);
			}

			if (dirty[0] & /*localCData*/ 1) show_if_1 = /*data*/ ctx[58].value1.charAt(0) == "*";
			...
			if (dirty[0] & /*localCData*/ 1) show_if = /*data*/ ctx[58].value1.charAt(0) == "*";
...
function create_if_block(ctx) {
	...
	let mounted;
	let dispose;
	let each_value_2 = /*data*/ ctx[58].value2.split("%%");
	...
	let each_value_1 = /*data*/ ctx[58].value1.split("%%");
	...
	function click_handler_6() {
		return /*click_handler_6*/ ctx[29](/*data*/ ctx[58]);
	}
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 787, 52, 29008);
			attr_dev(button, "type", "button");
			attr_dev(button, "class", button_class_value = "" + (null_to_empty("add_button px-1 btn btn-outline-primary btn-sm bg-white d-flex align-items-center pr-2 " + "listitem" + /*i*/ ctx[60]) + " svelte-jg5y6h"));
			add_location(button, file, 786, 13, 28785);
			attr_dev(div0, "class", "float-left ms-1");
			add_location(div0, file, 785, 48, 28741);
			attr_dev(div1, "class", "float-left clear-both");
			add_location(div1, file, 762, 44, 25821);
			attr_dev(div2, "class", "pull-right");
			add_location(div2, file, 790, 44, 29212);
			attr_dev(div3, "class", "d-inline-block clear-both pointer light-cyan-bg mx-0 my-1 p-2 width10");
			add_location(div3, file, 761, 40, 25692);
			...
			add_location(span1, file, 815, 48, 32311);
			add_location(a, file, 814, 44, 32196);
			attr_dev(div4, "class", "width1 float-right");
			add_location(div4, file, 813, 40, 32118);
			...
			add_location(div5, file, 760, 36, 25582);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen_dev(button, "click", /*addListItem*/ ctx[15].bind(this, /*i*/ ctx[60]), false, false, false),
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*state, removetextbox, openImageDialogAlgo, localCData, editalgoCData*/ 17475) {
				each_value_2 = /*data*/ ctx[58].value2.split("%%");
				validate_each_argument(each_value_2);
				let i;
			...
			if (dirty[0] & /*state, removetextbox, openImageDialogAlgo, localCData, editalgoCData*/ 17475) {
				each_value_1 = /*data*/ ctx[58].value1.split("%%");
				validate_each_argument(each_value_1);
				let i;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(756:24) {#if state.isalgo === true}",
		ctx
	});
...
function create_if_block_8(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value2.substr(1).split("##")[0].split("%%")[0])) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*data*/ ctx[58].value2.split("##")[1]
			? /*data*/ ctx[58].value2.split("##")[1]
			: null);

			add_location(img, file, 828, 52, 33622);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value2.substr(1).split("##")[0].split("%%")[0])) {
				attr_dev(img, "src", img_src_value);
			}

			if (dirty[0] & /*localCData*/ 1 && img_alt_value !== (img_alt_value = /*data*/ ctx[58].value2.split("##")[1]
			? /*data*/ ctx[58].value2.split("##")[1]
			: null)) {
...
// (833:48) {#if data.value2.charAt(0) == "*"}
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 833, 52, 34159);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(833:48) {#if data.value2.charAt(0) == \\\"*\\\"}",
		ctx
	});
...
function create_if_block_6(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "class", "authoringImage");
			if (img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value1.substr(1).split("##")[0].split("%%")[0])) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*data*/ ctx[58].value1.split("##")[1]
			? /*data*/ ctx[58].value1.split("##")[1]
			: null);

			add_location(img, file, 846, 52, 35598);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*data*/ ctx[58].value1.substr(1).split("##")[0].split("%%")[0])) {
				attr_dev(img, "src", img_src_value);
			}

			if (dirty[0] & /*localCData*/ 1 && img_alt_value !== (img_alt_value = /*data*/ ctx[58].value1.split("##")[1]
			? /*data*/ ctx[58].value1.split("##")[1]
			: null)) {
				attr_dev(img, "alt", img_alt_value);
			}
...
// (851:48) {#if data.value1.charAt(0) == "*"}
function create_if_block_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "data-bs-placement", "right");
			attr_dev(div, "title", "Delete Image");
			add_location(div, file, 851, 52, 36120);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(851:48) {#if data.value1.charAt(0) == \\\"*\\\"}",
		ctx
	});
...
function create_if_block_4(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "class", "authoringImage");
			if (img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp*/ ctx[64].substr(1).split("##")[0])) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*temp*/ ctx[64].split("##")[1]
			? /*temp*/ ctx[64].split("##")[1]
			: null);

			add_location(img, file, 770, 68, 26685);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp*/ ctx[64].substr(1).split("##")[0])) {
				attr_dev(img, "src", img_src_value);
			}

			if (dirty[0] & /*localCData*/ 1 && img_alt_value !== (img_alt_value = /*temp*/ ctx[64].split("##")[1]
			? /*temp*/ ctx[64].split("##")[1]
			: null)) {
				attr_dev(img, "alt", img_alt_value);
			}
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "data-bs-placement", "right");
			attr_dev(div, "title", "Delete Image");
			add_location(div, file, 776, 68, 27321);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(776:64) {#if temp.charAt(0) == \\\"*\\\"}",
		ctx
	});
...
// (765:48) {#each data.value2.split("%%") as temp, j}
function create_each_block_2(ctx) {
	...
	let t0;
	let show_if_1 = /*temp*/ ctx[64].charAt(0) == "*";
	let div0_style_value;
	let t1;
	let div1;
	let show_if = /*temp*/ ctx[64].charAt(0) == "*";
	let t2;
	let button0;
	let span0;
	let t3;
	...
	function change_handler(...args) {
		return /*change_handler*/ ctx[23](/*temp*/ ctx[64], /*i*/ ctx[60], /*j*/ ctx[66], ...args);
	}
	...
	function click_handler_2(...args) {
		return /*click_handler_2*/ ctx[24](/*i*/ ctx[60], /*j*/ ctx[66], ...args);
	}

	function click_handler_3(...args) {
		return /*click_handler_3*/ ctx[25](/*i*/ ctx[60], /*j*/ ctx[66], ...args);
	}
	...
	const block = {
		c: function create() {
			...
			attr_dev(textarea, "class", textarea_class_value = "" + (null_to_empty(/*temp*/ ctx[64].charAt(0) == "*"
			? "h form-control textarea_2_" + /*i*/ ctx[60] + "_" + /*j*/ ctx[66]
			: "form-control textarea_2_" + /*i*/ ctx[60] + "_" + /*j*/ ctx[66]) + " svelte-jg5y6h"));

			attr_dev(textarea, "id", "matchList2");
			textarea.value = textarea_value_value = /*temp*/ ctx[64];
			add_location(textarea, file, 768, 64, 26279);
			attr_dev(div0, "class", "pull-left word_break width200 p-1 max_width_300");
			attr_dev(div0, "style", div0_style_value = "border-radius:3px;");
			add_location(div0, file, 767, 60, 26123);
			attr_dev(span0, "class", "icomoon-images d-flex align-items-center pt-sm1 pb-sm1");
			attr_dev(span0, "data-bs-toggle", "tooltip");
			attr_dev(span0, "data-bs-placement", "right");
			attr_dev(span0, "title", "Add Image");
			add_location(span0, file, 779, 242, 27825);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "d-block btn btn-outline-primary btn-sm edit_btn bg-white mb-1");
			add_location(button0, file, 779, 64, 27647);
			attr_dev(span1, "class", "icomoon-24px-delete-1 d-flex align-items-center pt-sm1 pb-sm1");
			attr_dev(span1, "data-bs-toggle", "tooltip");
			attr_dev(span1, "data-bs-placement", "right");
			attr_dev(span1, "title", "Delete");
			add_location(span1, file, 780, 296, 28290);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 780, 64, 28058);
			attr_dev(div1, "class", "pull-right");
			add_location(div1, file, 774, 60, 27133);
			attr_dev(div2, "class", "d-flex align-items-center");
			add_location(div2, file, 766, 56, 26022);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*localCData*/ 1 && textarea_class_value !== (textarea_class_value = "" + (null_to_empty(/*temp*/ ctx[64].charAt(0) == "*"
			? "h form-control textarea_2_" + /*i*/ ctx[60] + "_" + /*j*/ ctx[66]
			: "form-control textarea_2_" + /*i*/ ctx[60] + "_" + /*j*/ ctx[66]) + " svelte-jg5y6h"))) {
				attr_dev(textarea, "class", textarea_class_value);
			}

			if (dirty[0] & /*localCData*/ 1 && textarea_value_value !== (textarea_value_value = /*temp*/ ctx[64])) {
				prop_dev(textarea, "value", textarea_value_value);
			}

			if (dirty[0] & /*localCData*/ 1) show_if_1 = /*temp*/ ctx[64].charAt(0) == "*";
			...
			if (dirty[0] & /*localCData*/ 1) show_if = /*temp*/ ctx[64].charAt(0) == "*";
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(765:48) {#each data.value2.split(\\\"%%\\\") as temp, j}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "class", "authoringImage");
			if (img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp1*/ ctx[61].substr(1).split("##")[0])) attr_dev(img, "src", img_src_value);

			attr_dev(img, "alt", img_alt_value = /*temp1*/ ctx[61].split("##")[1]
			? /*temp1*/ ctx[61].split("##")[1]
			: null);

			add_location(img, file, 798, 68, 30116);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*localCData*/ 1 && img.src !== (img_src_value = "//s3.amazonaws.com/jigyaasa_content_static/" + /*temp1*/ ctx[61].substr(1).split("##")[0])) {
				attr_dev(img, "src", img_src_value);
			}

			if (dirty[0] & /*localCData*/ 1 && img_alt_value !== (img_alt_value = /*temp1*/ ctx[61].split("##")[1]
			? /*temp1*/ ctx[61].split("##")[1]
			: null)) {
				attr_dev(img, "alt", img_alt_value);
			}
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "data-bs-placement", "right");
			attr_dev(div, "title", "Delete Image");
			add_location(div, file, 804, 68, 30742);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(804:64) {#if temp1.charAt(0) == \\\"*\\\"}",
		ctx
	});
...
// (793:48) {#each data.value1.split("%%") as temp1, k}
function create_each_block_1(ctx) {
	...
	let textarea_value_value;
	let t0;
	let show_if_1 = /*temp1*/ ctx[61].charAt(0) == "*";
	let div0_style_value;
	let t1;
	let div1;
	let show_if = /*temp1*/ ctx[61].charAt(0) == "*";
	let t2;
	let button0;
	let span0;
	let t3;
	...
	function change_handler_1(...args) {
		return /*change_handler_1*/ ctx[26](/*temp1*/ ctx[61], /*i*/ ctx[60], /*k*/ ctx[63], ...args);
	}
	...
	function click_handler_4(...args) {
		return /*click_handler_4*/ ctx[27](/*i*/ ctx[60], /*k*/ ctx[63], ...args);
	}

	function click_handler_5(...args) {
		return /*click_handler_5*/ ctx[28](/*i*/ ctx[60], /*k*/ ctx[63], ...args);
	}
	...
	const block = {
		c: function create() {
			...
			attr_dev(textarea, "class", textarea_class_value = "" + (null_to_empty(/*temp1*/ ctx[61].charAt(0) == "*"
			? "h form-control textarea_1_" + /*i*/ ctx[60] + "_" + /*k*/ ctx[63]
			: "form-control textarea_1_" + /*i*/ ctx[60] + "_" + /*k*/ ctx[63]) + " svelte-jg5y6h"));

			attr_dev(textarea, "id", "matchList1");
			textarea.value = textarea_value_value = /*temp1*/ ctx[61];
			add_location(textarea, file, 796, 64, 29708);
			attr_dev(div0, "class", "pull-left word_break width200 p-1 max_width_300");
			attr_dev(div0, "style", div0_style_value = "border-radius:3px;");
			add_location(div0, file, 795, 60, 29552);
			attr_dev(span0, "class", "icomoon-images d-flex align-items-center pt-sm1 pb-sm1");
			attr_dev(span0, "data-bs-toggle", "tooltip");
			attr_dev(span0, "data-bs-placement", "right");
			attr_dev(span0, "title", "Add Image");
			add_location(span0, file, 806, 242, 31180);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "d-block btn btn-outline-primary btn-sm edit_btn bg-white mb-1");
			add_location(button0, file, 806, 64, 31002);
			attr_dev(span1, "class", "icomoon-24px-delete-1 d-flex align-items-center pt-sm1 pb-sm1");
			attr_dev(span1, "data-bs-toggle", "tooltip");
			attr_dev(span1, "data-bs-placement", "right");
			attr_dev(span1, "title", "Delete");
			add_location(span1, file, 807, 292, 31628);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-outline-primary btn-sm edit_btn textdel bg-white");
			...
			add_location(button1, file, 807, 64, 31400);
			attr_dev(div1, "class", "pull-right");
			add_location(div1, file, 802, 60, 30554);
			attr_dev(div2, "class", "d-flex align-items-center");
			add_location(div2, file, 794, 56, 29451);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*localCData*/ 1 && textarea_class_value !== (textarea_class_value = "" + (null_to_empty(/*temp1*/ ctx[61].charAt(0) == "*"
			? "h form-control textarea_1_" + /*i*/ ctx[60] + "_" + /*k*/ ctx[63]
			: "form-control textarea_1_" + /*i*/ ctx[60] + "_" + /*k*/ ctx[63]) + " svelte-jg5y6h"))) {
				attr_dev(textarea, "class", textarea_class_value);
			}

			if (dirty[0] & /*localCData*/ 1 && textarea_value_value !== (textarea_value_value = /*temp1*/ ctx[61])) {
				prop_dev(textarea, "value", textarea_value_value);
			}

			if (dirty[0] & /*localCData*/ 1) show_if_1 = /*temp1*/ ctx[61].charAt(0) == "*";
			...
			if (dirty[0] & /*localCData*/ 1) show_if = /*temp1*/ ctx[61].charAt(0) == "*";
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(793:48) {#each data.value1.split(\\\"%%\\\") as temp1, k}",
		ctx
	});
...
// (754:16) {#each localCData as data, i}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(754:16) {#each localCData as data, i}",
		ctx
	});
...
// (973:6) <Button variant="contained" on:click={removeRow}         class="bg-primary text-white">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(973:6) <Button variant=\\\"contained\\\" on:click={removeRow}         class=\\\"bg-primary text-white\\\">",
		ctx
	});
...
// (969:5) <div slot="footer" class="svelteFooter">
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			input.value = "No";
			add_location(input, file, 970, 6, 41756);
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 968, 5, 41700);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			...
			if (!mounted) {
				dispose = listen_dev(input, "click", /*click_handler_10*/ ctx[35], false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(969:5) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\">",
		ctx
	});
...
// (957:4) <Dialog       bind:visible={state.openDeleteDialog}       style={'width:500px;'}      >
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 960, 5, 41464);
			attr_dev(span, "class", "col-md-12");
			attr_dev(span, "style", span_style_value = "margin-top:40px;margin-bottom:40px;");
			add_location(span, file, 963, 6, 41561);
			attr_dev(div1, "class", "row");
			add_location(div1, file, 962, 6, 41536);
			add_location(div2, file, 961, 5, 41523);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(957:4) <Dialog       bind:visible={state.openDeleteDialog}       style={'width:500px;'}      >",
		ctx
	});
...
function create_fragment(ctx) {
	...
	checkbox0.$on("click", /*click_handler*/ ctx[21]);
	...
	checkbox1.$on("click", /*click_handler_1*/ ctx[22]);

	checkbox2 = new Checkbox({
			props: {
				defaultChecked: /*state*/ ctx[1].isalgo == true ? true : false,
				name: "isalgo",
				id: "isalgo",
				color: "primary",
	...
	checkbox2.$on("click", /*changeisalgo*/ ctx[13]);
	...
	function dialog_visible_binding(value) {
		/*dialog_visible_binding*/ ctx[36](value);
	}
	...
	const block = {
		c: function create() {
			...
			label3.textContent = "Background Image";
			t21 = space();
			...
			label4.textContent = "Background Alt";
			t24 = space();
			...
			add_location(div6, file, 737, 24, 24663);
			...
			add_location(div10, file, 751, 12, 25309);
			attr_dev(span, "class", "font24 svelte-jg5y6h");
			add_location(span, file, 877, 20, 37890);
			...
			add_location(button0, file, 872, 16, 37627);
			attr_dev(div11, "class", "text-left ml-2 pb-3");
			add_location(div11, file, 871, 12, 37576);
			...
			add_location(input3, file, 930, 12, 40217);
			attr_dev(div14, "class", "form-group");
			add_location(div14, file, 928, 11, 40069);
			attr_dev(div15, "class", "col-md-6 px-1");
			add_location(div15, file, 927, 10, 40029);
			attr_dev(label4, "class", "control-label font-weight-normal mb-0");
			attr_dev(label4, "for", "MatchlistAlt");
			add_location(label4, file, 935, 12, 40444);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*state*/ 2) checkbox0_changes.checked = /*state*/ ctx[1].drag_mode;
			...
			if (dirty[0] & /*state*/ 2) checkbox2_changes.defaultChecked = /*state*/ ctx[1].isalgo == true ? true : false;
			...
			if (dirty[0] & /*state*/ 2 | dirty[2] & /*$$scope*/ 32) {
...
class MatchList extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-jg5y6h-style")) add_css();
...
//# sourceMappingURL=MatchList-73df084c.js.map
