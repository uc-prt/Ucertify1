...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, C as validate_each_argument, e as element, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, x as detach_dev, K as destroy_each, h as text, F as set_data_dev, z as empty, B as noop, Y as src_url_equal, g as globals, A as AH, $ as add_render_callback, o as onMount, aa as afterUpdate, X as XMLToJSON, a3 as onUserAnsChange, y as l, q as listen_dev, ah as prevent_default, H as run_all, c as create_component, m as mount_component, t as transition_in, a as transition_out, b as destroy_component, l as set_style, r as group_outros, u as check_outros } from './main-a3b8c24d.js';
...
// (691:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}
function create_if_block_4$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(691:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}",
		ctx
	});
...
// (692:48) {#if state.correct_match['category_'+ dataj.sequence] == false}
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 692, 52, 36331);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(692:48) {#if state.correct_match['category_'+ dataj.sequence] == false}",
		ctx
	});
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 696, 60, 37021);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			div.innerHTML = raw_value;
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 694, 60, 36606);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(694:56) {#if dataj.imageurl != ''}",
		ctx
	});
...
// (690:40) {#each state.xml.item.items as dataj}
function create_each_block_1$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(690:40) {#each state.xml.item.items as dataj}",
		ctx
	});
...
// (678:16) {#each state.xml.category.categories as datai, index}
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 680, 28, 35250);
			...
			add_location(div0, file$1, 679, 24, 35036);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(678:16) {#each state.xml.category.categories as datai, index}",
		ctx
	});
...
// (715:12) {#if AH.get('alignMatchReset') == true}
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 715, 16, 38038);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(715:12) {#if AH.get('alignMatchReset') == true}",
		ctx
	});
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 718, 16, 38256);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 725, 16, 38558);
			attr_dev(div1, "class", "yourAnswer");
			add_location(div1, file$1, 728, 16, 38785);
			attr_dev(div2, "class", "scoreDiv");
			add_location(div2, file$1, 724, 12, 38518);
			attr_dev(div3, "class", "finalResult");
			add_location(div3, file$1, 723, 8, 38479);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(723:4) {#if targetView == 'block'}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div3, file$1, 674, 4, 34641);
			add_location(div4, file$1, 665, 0, 34381);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=AlignMatchPreview-512924dd.js.map
