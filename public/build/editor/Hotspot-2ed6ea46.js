...
import { N as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, O as Dialog, P as binding_callbacks, Q as bind, R as Snackbar, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, T as Draggable, U as Button, V as Checkbox, M as JSONToXML, y as language, w as writable, e as element, f as space, c as create_component, j as attr_dev, l as set_style, k as add_location, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, G as prop_dev, W as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, H as run_all, h as text, Y as select_option, B as noop } from './main-674e3b87.js';
...
/* clsSMHotspot\Hotspot.svelte generated by Svelte v3.29.0 */

const { Object: Object_1, console: console_1 } = globals;
const file = "clsSMHotspot\\Hotspot.svelte";

// (967:8) <div slot="title" style="text-align: left;">
function create_title_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div1, file, 967, 12, 44136);
			attr_dev(div0, "slot", "title");
			set_style(div0, "text-align", "left");
			add_location(div0, file, 966, 8, 44078);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(967:8) <div slot=\\\"title\\\" style=\\\"text-align: left;\\\">",
		ctx
	});
...
// (1041:12) <Button                  on:click={handleClose}                  style="text-transform: none"                  key={l.cancel}              >
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1041:12) <Button                  on:click={handleClose}                  style=\\\"text-transform: none\\\"                  key={l.cancel}              >",
		ctx
	});
...
// (1048:12) <Button                  on:click={handleSubmit.bind(this, 'img')}                  class="bg-primary text-white"                  style="text-transform: none"                  key={l.submit}              >
function create_default_slot_6(ctx) {
	let t_value = language.submit + "";
	let t;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1048:12) <Button                  on:click={handleSubmit.bind(this, 'img')}                  class=\\\"bg-primary text-white\\\"                  style=\\\"text-transform: none\\\"                  key={l.submit}              >",
		ctx
	});
...
// (1040:8) <div slot="footer" class="svelteFooter" >
function create_footer_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1039, 8, 47402);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1040:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\" >",
		ctx
	});
...
// (966:4) <Dialog width="600" bind:visible={state.openImg}>
function create_default_slot_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file, 971, 16, 44244);
			...
			add_location(button, file, 980, 16, 44588);
			attr_dev(div0, "class", "d-flex");
			add_location(div0, file, 970, 12, 44206);
			...
			add_location(img, file, 989, 16, 44955);
			attr_dev(div1, "class", "mx-auto width8 p-2 border mt-2");
			add_location(div1, file, 988, 12, 44893);
			...
			add_location(label0, file, 992, 16, 45092);
			add_location(span0, file, 991, 12, 45068);
			...
			add_location(input1, file, 994, 12, 45229);
			attr_dev(label1, "for", "hotBorder");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1005, 20, 45729);
			add_location(span1, file, 1004, 16, 45701);
			option0.__value = "0";
			option0.value = option0.__value;
			add_location(option0, file, 1008, 20, 45904);
			option1.__value = "1";
			option1.value = option1.__value;
			add_location(option1, file, 1009, 20, 45957);
			option2.__value = "2";
			option2.value = option2.__value;
			add_location(option2, file, 1010, 20, 46007);
			option3.__value = "3";
			option3.value = option3.__value;
			add_location(option3, file, 1011, 20, 46057);
			option4.__value = "4";
			option4.value = option4.__value;
			add_location(option4, file, 1012, 20, 46107);
			option5.__value = "5";
			option5.value = option5.__value;
			add_location(option5, file, 1013, 20, 46157);
			attr_dev(select0, "id", "hotBorder");
			attr_dev(select0, "class", "form-control");
			add_location(select0, file, 1007, 16, 45838);

			attr_dev(div2, "class", div2_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block pr-2 mt-2 w-sm"
			: "hidden");

			add_location(div2, file, 1003, 12, 45598);
			attr_dev(label2, "for", "hotBorderColor");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1018, 20, 46372);
			add_location(span2, file, 1017, 16, 46344);
			option6.__value = "white";
			option6.value = option6.__value;
			add_location(option6, file, 1021, 20, 46557);
			option7.__value = "black";
			option7.value = option7.__value;
			add_location(option7, file, 1022, 20, 46614);
			option8.__value = "grey";
			option8.value = option8.__value;
			add_location(option8, file, 1023, 20, 46672);
			attr_dev(select1, "id", "hotBorderColor");
			attr_dev(select1, "class", "form-control");
			add_location(select1, file, 1020, 16, 46486);

			attr_dev(div3, "class", div3_class_value = /*state*/ ctx[7].valueMultiple == 4
			? "d-inline-block mt-2 w-sm"
			: "hidden");

			add_location(div3, file, 1016, 12, 46246);
			add_location(br, file, 1026, 12, 46767);
			attr_dev(label3, "for", "setLineColor");
			attr_dev(label3, "class", "mt-2 text-dark");
			add_location(label3, file, 1029, 20, 46890);
			add_location(span3, file, 1028, 16, 46862);
			option9.__value = "Please Select";
			option9.value = option9.__value;
			add_location(option9, file, 1032, 20, 47131);
			option10.__value = "red";
			option10.value = option10.__value;
			add_location(option10, file, 1033, 20, 47183);
			option11.__value = "black";
			option11.value = option11.__value;
			add_location(option11, file, 1034, 20, 47237);
			option12.__value = "blue";
			option12.value = option12.__value;
			add_location(option12, file, 1035, 20, 47295);
			attr_dev(select2, "id", "setLineColor");
			attr_dev(select2, "class", "form-control");
			add_location(select2, file, 1031, 16, 47005);
			attr_dev(div4, "class", div4_class_value = /*state*/ ctx[7].valueMultiple == 3 ? " " : "hidden");
			add_location(div4, file, 1027, 12, 46787);
			add_location(div5, file, 969, 8, 44187);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(966:4) <Dialog width=\\\"600\\\" bind:visible={state.openImg}>",
		ctx
	});
...
// (1059:8) <div slot="title" style="text-align: left;">
function create_title_slot(ctx) {
	...
	const block = {
		c: function create() {
			div0 = element("div");
			div1 = element("div");
			div1.textContent = "Hotspot";
			add_location(div1, file, 1059, 12, 48074);
			attr_dev(div0, "slot", "title");
			set_style(div0, "text-align", "left");
			add_location(div0, file, 1058, 8, 48016);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div0, anchor);
			append_dev(div0, div1);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1059:8) <div slot=\\\"title\\\" style=\\\"text-align: left;\\\">",
		ctx
	});
...
// (1117:12) <Button                  on:click={handleClose}                  style="text-transform: none"                  key={l.cancel + "1"}              >
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1117:12) <Button                  on:click={handleClose}                  style=\\\"text-transform: none\\\"                  key={l.cancel + \\\"1\\\"}              >",
		ctx
	});
...
// (1124:12) <Button                  on:click={handleSubmit.bind(this, 'drag')}                  class="bg-primary text-white"                  style="text-transform: none"                  key={l.done}              >
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1124:12) <Button                  on:click={handleSubmit.bind(this, 'drag')}                  class=\\\"bg-primary text-white\\\"                  style=\\\"text-transform: none\\\"                  key={l.done}              >",
		ctx
	});
...
// (1116:8) <div slot="footer" class="svelteFooter">
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 1115, 8, 50149);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(button0, div, null);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1116:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\">",
		ctx
	});
...
// (1058:4) <Dialog width="600" bind:visible={state.openDrag}>
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label0, file, 1065, 24, 48259);
			add_location(span0, file, 1064, 20, 48227);
			attr_dev(input0, "type", "number");
			attr_dev(input0, "id", "dragHeight");
			attr_dev(input0, "placeholder", "Height");
			attr_dev(input0, "defaultvalue", " ");
			attr_dev(input0, "class", "form-control");
			add_location(input0, file, 1067, 20, 48371);
			attr_dev(div0, "class", "col-6 pr-1");
			add_location(div0, file, 1063, 16, 48181);
			attr_dev(label1, "for", "dragWidth");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1077, 24, 48735);
			add_location(span1, file, 1076, 20, 48703);
			attr_dev(input1, "type", "number");
			attr_dev(input1, "id", "dragWidth");
			attr_dev(input1, "placeholder", "Width");
			attr_dev(input1, "defaultvalue", " ");
			attr_dev(input1, "class", "form-control");
			add_location(input1, file, 1079, 20, 48845);
			attr_dev(div1, "class", "col-6 pl-1");
			add_location(div1, file, 1075, 16, 48657);
			attr_dev(div2, "class", "row");
			add_location(div2, file, 1062, 12, 48146);
			attr_dev(label2, "for", "dragTop");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1091, 24, 49263);
			add_location(span2, file, 1090, 20, 49231);
			attr_dev(input2, "type", "number");
			attr_dev(input2, "id", "dragTop");
			attr_dev(input2, "placeholder", "Top");
			attr_dev(input2, "defaultvalue", " ");
			attr_dev(input2, "class", "form-control");
			add_location(input2, file, 1093, 20, 49369);
			attr_dev(div3, "class", "col-6 pr-1");
			add_location(div3, file, 1089, 16, 49185);
			attr_dev(label3, "for", "dragLeft");
			attr_dev(label3, "class", "my-1 text-dark");
			add_location(label3, file, 1103, 24, 49727);
			add_location(span3, file, 1102, 20, 49695);
			attr_dev(input3, "type", "number");
			attr_dev(input3, "id", "dragLeft");
			attr_dev(input3, "placeholder", "Left");
			attr_dev(input3, "defaultvalue", " ");
			attr_dev(input3, "class", "form-control");
			add_location(input3, file, 1105, 20, 49835);
			attr_dev(div4, "class", "col-6 pl-1");
			add_location(div4, file, 1101, 16, 49649);
			attr_dev(div5, "class", "row mt-2");
			add_location(div5, file, 1088, 12, 49145);
			add_location(div6, file, 1061, 8, 48127);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1058:4) <Dialog width=\\\"600\\\" bind:visible={state.openDrag}>",
		ctx
	});
...
// (1137:12) <Button color="#ff0" on:click={() => (state.snackback = false)}>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1137:12) <Button color=\\\"#ff0\\\" on:click={() => (state.snackback = false)}>",
		ctx
	});
...
function create_action_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1135, 8, 50851);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1136:8) <span slot=\\\"action\\\">",
		ctx
	});
...
// (1134:4) <Snackbar bind:visible={state.snackback} bg="#f44336" bottom={true} timeout={10} style="position:fixed; bottom:50px">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1134:4) <Snackbar bind:visible={state.snackback} bg=\\\"#f44336\\\" bottom={true} timeout={10} style=\\\"position:fixed; bottom:50px\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	function dialog0_visible_binding(value) {
		/*dialog0_visible_binding*/ ctx[19].call(null, value);
	}
	...
	function dialog1_visible_binding(value) {
		/*dialog1_visible_binding*/ ctx[20].call(null, value);
	}
	...
	function snackbar_visible_binding(value) {
		/*snackbar_visible_binding*/ ctx[22].call(null, value);
	}
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			span1 = element("span");
			span1.textContent = `${language.reset}`;
			t3 = space();
			div4 = element("div");
			div3 = element("div");
			...
			add_location(div1, file, 883, 16, 40895);
			...
			add_location(div2, file, 875, 12, 40660);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file, 909, 24, 42039);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light px-1 pt-sm1 pb-sm1 mt");
			add_location(button0, file, 904, 20, 41808);
			attr_dev(div3, "class", "btn-group tools");
			add_location(div3, file, 903, 16, 41757);
			...
			add_location(div4, file, 892, 12, 41340);
			attr_dev(div5, "class", "drawImage d-none");
			add_location(div5, file, 874, 8, 40616);
			attr_dev(i1, "class", "icomoon-24px-edit-1");
			add_location(i1, file, 926, 20, 42611);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light px-1 pt-sm1 pb-sm1 mt");
			add_location(button1, file, 921, 16, 42400);
			attr_dev(div6, "class", "btn-group tools");
			add_location(div6, file, 920, 12, 42353);
			attr_dev(img, "id", "im");
			attr_dev(img, "class", "hotSpotImg border");
			if (img.src !== (img_src_value = /*bgImgPath*/ ctx[8] + /*state*/ ctx[7].bgImg)) attr_dev(img, "src", img_src_value);
			...
			add_location(img, file, 929, 12, 42707);
			attr_dev(i2, "class", "icomoon-24px-edit-1");
			add_location(i2, file, 953, 24, 43692);
			attr_dev(button2, "type", "button");
			attr_dev(button2, "class", "btn btn-light px-1 pt-sm1 pb-sm1");
			add_location(button2, file, 948, 20, 43462);
			attr_dev(div7, "class", "btn-group tools h");
			add_location(div7, file, 947, 16, 43409);
			...
			add_location(div8, file, 941, 12, 43141);
			...
			add_location(div9, file, 914, 8, 42175);
			...
			add_location(textarea, file, 958, 8, 43828);
			attr_dev(center, "class", "mt");
			attr_dev(center, "id", "mainContent");
			add_location(center, file, 855, 4, 40032);
			add_location(div10, file, 854, 0, 40021);
		},
		...
		p: function update(ctx, dirty) {
			...
			if (!current || dirty[0] & /*state*/ 128 && img.src !== (img_src_value = /*bgImgPath*/ ctx[8] + /*state*/ ctx[7].bgImg)) {
				attr_dev(img, "src", img_src_value);
			}
			...
			if (dirty[0] & /*state*/ 128 | dirty[1] & /*$$scope*/ 131072) {
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(() => {
		...
		AH.createLink(editor.itemUrl + "clsSMHotspot/css/hotspot.min.css", { preload: true });
			...
			image.onload = function () {
				...
				if (this.width >= 100 && this.width <= 1000) {
					...
					if (this.height >= 80 && this.height <= 550) {
						...
						AH.alert(language.height_warning);
						isHeightValid = false;
					}
				} else {
					AH.alert(language.width_warning);
					isWidthValid = false;
				}
...
*/
	...
	$$self.$$set = $$props => {
		...
		if ("getChildXml" in $$props) $$invalidate(18, getChildXml = $$props.getChildXml);
	};
...
class Hotspot extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*editorState*/ ctx[17] === undefined && !("editorState" in props)) {
			console_1.warn("<Hotspot> was created without expected prop 'editorState'");
		}

		if (/*getChildXml*/ ctx[18] === undefined && !("getChildXml" in props)) {
...
//# sourceMappingURL=Hotspot-2ed6ea46.js.map
