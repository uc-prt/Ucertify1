...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(td, file, 399, 36, 14901);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 417, 52, 16435);
			add_location(span1, file, 416, 48, 16375);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (if_block) if_block.c();
			t = space();
			add_location(tr, file, 395, 20, 14672);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t5 = space();
			t6 = text(t6_value);
			add_location(tbody, file, 392, 8, 14527);
...
//# sourceMappingURL=ShadingPreview-b49fc09c.js.map
