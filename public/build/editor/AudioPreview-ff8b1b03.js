...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, A as AH, y as l, X as XMLToJSON, a2 as onUserAnsChange, aa as afterUpdate, e as element, c as create_component, f as space, h as text, j as attr_dev, k as add_location, n as insert_dev, m as mount_component, p as append_dev, q as listen_dev, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, G as run_all, F as prop_dev, U as src_url_equal } from './main-0f2a09b1.js';
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 559, 24, 27382);
			...
			add_location(span1, file, 576, 28, 28803);
			...
			add_location(button0, file, 568, 24, 28381);
			...
			add_location(span2, file, 587, 28, 29590);
			...
			add_location(button1, file, 578, 24, 29119);
			...
			add_location(span3, file, 602, 28, 30538);
			...
			add_location(button2, file, 589, 24, 29835);
			...
			add_location(div6, file, 567, 20, 28215);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 556, 16, 27077);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 555, 12, 27018);
		},
...
// (550:12) {#if state.showTranscript == true}
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 551, 62, 26635);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 551, 25, 26598);
			add_location(div0, file, 551, 20, 26593);
			...
			add_location(textarea, file, 552, 20, 26694);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 550, 16, 26546);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(550:12) {#if state.showTranscript == true}",
		ctx
	});
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 527, 20, 25306);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 526, 16, 25259);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 515, 20, 24753);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 514, 16, 24706);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(514:12) {#if answer_status != true}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 616, 20, 31223);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 614, 16, 31046);
			...
			add_location(div3, file, 618, 16, 31447);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 622, 20, 31714);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-ff8b1b03.js.map
