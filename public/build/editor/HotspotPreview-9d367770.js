...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 491, 7, 16107);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 492, 7, 16198);
			...
			add_location(div0, file, 487, 6, 15956);
			...
			add_location(div1, file, 479, 5, 15755);
			...
			add_location(div2, file, 495, 5, 16281);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 478, 4, 15721);
		},
		m: function mount(target, anchor) {
...
// (421:3) {#if moduleArr[item_type] == "4"}
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 439, 10, 14697);
			...
			add_location(div0, file, 448, 10, 14983);
			...
			add_location(span, file, 461, 10, 15334);
			...
			add_location(div1, file, 426, 9, 14328);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 425, 8, 14287);
			attr_dev(td, "class", "border");
			add_location(td, file, 424, 7, 14259);
			add_location(tr, file, 423, 6, 14247);
			add_location(tbody, file, 422, 5, 14233);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto");
			add_location(table, file, 421, 4, 14158);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(421:3) {#if moduleArr[item_type] == \\\"4\\\"}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 509, 6, 16683);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 418, 2, 14024);
			add_location(center, file, 413, 1, 13929);
			...
			add_location(input, file, 520, 1, 16933);
			attr_dev(main, "class", "svelte-1x7u5s5");
			add_location(main, file, 412, 0, 13921);
		},
...
//# sourceMappingURL=HotspotPreview-9d367770.js.map
