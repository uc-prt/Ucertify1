...
import { K as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, e as element, p as append_dev, L as Dialog, M as binding_callbacks, N as bind, O as Snackbar, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, P as Draggable, Q as Button, R as Checkbox, J as JSONToXML, y as l, w as writable, f as space, c as create_component, j as attr_dev, l as set_style, k as add_location, n as insert_dev, m as mount_component, q as listen_dev, T as stop_propagation, U as prevent_default, F as prop_dev, V as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, G as run_all, W as select_value, h as text, Y as add_render_callback, Z as set_input_value, _ as select_option, B as noop } from './main-ff508531.js';
...
// (1088:8) <div slot="footer" class="svelteFooter" >
function create_footer_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 1087, 8, 49574);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1088:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\" >",
		ctx
	});
...
function create_default_slot_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label1, file, 1052, 24, 47779);
			add_location(span1, file, 1051, 20, 47747);
			option0.__value = "0";
			option0.value = option0.__value;
			add_location(option0, file, 1055, 24, 47994);
			option1.__value = "1";
			option1.value = option1.__value;
			add_location(option1, file, 1056, 24, 48051);
			option2.__value = "2";
			option2.value = option2.__value;
			add_location(option2, file, 1057, 24, 48105);
			option3.__value = "3";
			option3.value = option3.__value;
			add_location(option3, file, 1058, 24, 48159);
			option4.__value = "4";
			option4.value = option4.__value;
			add_location(option4, file, 1059, 24, 48213);
			option5.__value = "5";
			option5.value = option5.__value;
			add_location(option5, file, 1060, 24, 48267);
			...
			add_location(select0, file, 1054, 20, 47896);
			attr_dev(div4, "class", "d-inline-block pr-2 mt-2 w-sm");
			add_location(div4, file, 1050, 16, 47682);
			attr_dev(label2, "for", "hotBorderColor");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1065, 24, 48460);
			add_location(span2, file, 1064, 20, 48428);
			option6.__value = "white";
			option6.value = option6.__value;
			add_location(option6, file, 1068, 24, 48690);
			option7.__value = "black";
			option7.value = option7.__value;
			add_location(option7, file, 1069, 24, 48751);
			option8.__value = "grey";
			option8.value = option8.__value;
			add_location(option8, file, 1070, 24, 48813);
			...
			add_location(select1, file, 1067, 20, 48582);
			attr_dev(div5, "class", "d-inline-block mt-2 w-sm");
			add_location(div5, file, 1063, 16, 48368);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 1049, 12, 47644);
			add_location(br, file, 1074, 12, 48936);
			attr_dev(label3, "for", "setLineColor");
			attr_dev(label3, "class", "mt-2 text-dark");
			add_location(label3, file, 1077, 20, 49058);
			add_location(span3, file, 1076, 16, 49030);
			option9.__value = "Please Select";
			option9.value = option9.__value;
			add_location(option9, file, 1080, 20, 49303);
			option10.__value = "red";
			option10.value = option10.__value;
			add_location(option10, file, 1081, 20, 49355);
			option11.__value = "black";
			option11.value = option11.__value;
			add_location(option11, file, 1082, 20, 49409);
			option12.__value = "blue";
			option12.value = option12.__value;
			add_location(option12, file, 1083, 20, 49467);
			...
			add_location(select2, file, 1079, 16, 49173);
			attr_dev(div7, "class", div7_class_value = /*state*/ ctx[7].valueMultiple == 3 ? "" : "hidden");
			add_location(div7, file, 1075, 12, 48956);
...
// (1166:8) <div slot="footer" class="svelteFooter">
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 1165, 8, 52527);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(button0, div, null);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1166:8) <div slot=\\\"footer\\\" class=\\\"svelteFooter\\\">",
		ctx
	});
...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t13 = space();
			add_location(div0, file, 1108, 16, 50395);
			attr_dev(div1, "class", "d-flex justify-content-between");
			add_location(div1, file, 1107, 12, 50333);
			attr_dev(h4, "class", "mt-1 font21 mb-4");
			add_location(h4, file, 1106, 8, 50290);
			attr_dev(label0, "for", "dragHeight");
			attr_dev(label0, "class", "my-1 text-dark");
			add_location(label0, file, 1115, 24, 50637);
			add_location(span0, file, 1114, 20, 50605);
			attr_dev(input0, "type", "number");
			attr_dev(input0, "id", "dragHeight");
			attr_dev(input0, "placeholder", "Height");
			attr_dev(input0, "defaultvalue", " ");
			attr_dev(input0, "class", "form-control");
			add_location(input0, file, 1117, 20, 50749);
			attr_dev(div2, "class", "col-6 pr-1");
			add_location(div2, file, 1113, 16, 50559);
			attr_dev(label1, "for", "dragWidth");
			attr_dev(label1, "class", "my-1 text-dark");
			add_location(label1, file, 1127, 24, 51113);
			add_location(span1, file, 1126, 20, 51081);
			attr_dev(input1, "type", "number");
			attr_dev(input1, "id", "dragWidth");
			attr_dev(input1, "placeholder", "Width");
			attr_dev(input1, "defaultvalue", " ");
			attr_dev(input1, "class", "form-control");
			add_location(input1, file, 1129, 20, 51223);
			attr_dev(div3, "class", "col-6 pl-1");
			add_location(div3, file, 1125, 16, 51035);
			attr_dev(div4, "class", "row");
			add_location(div4, file, 1112, 12, 50524);
			attr_dev(label2, "for", "dragTop");
			attr_dev(label2, "class", "my-1 text-dark");
			add_location(label2, file, 1141, 24, 51641);
			add_location(span2, file, 1140, 20, 51609);
			attr_dev(input2, "type", "number");
			attr_dev(input2, "id", "dragTop");
			attr_dev(input2, "placeholder", "Top");
			attr_dev(input2, "defaultvalue", " ");
			attr_dev(input2, "class", "form-control");
			add_location(input2, file, 1143, 20, 51747);
			attr_dev(div5, "class", "col-6 pr-1");
			add_location(div5, file, 1139, 16, 51563);
			attr_dev(label3, "for", "dragLeft");
			attr_dev(label3, "class", "my-1 text-dark");
			add_location(label3, file, 1153, 24, 52105);
			add_location(span3, file, 1152, 20, 52073);
			attr_dev(input3, "type", "number");
			attr_dev(input3, "id", "dragLeft");
			attr_dev(input3, "placeholder", "Left");
			attr_dev(input3, "defaultvalue", " ");
			attr_dev(input3, "class", "form-control");
			add_location(input3, file, 1155, 20, 52213);
			attr_dev(div6, "class", "col-6 pl-1");
			add_location(div6, file, 1151, 16, 52027);
			attr_dev(div7, "class", "row mt-2");
			add_location(div7, file, 1138, 12, 51523);
			set_style(div8, "overflow-y", "auto");
			set_style(div8, "padding-right", "20px");
			add_location(div8, file, 1111, 8, 50458);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h4, anchor);
			append_dev(h4, div1);
...
function create_action_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 1186, 8, 53268);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(1187:8) <span slot=\\\"action\\\">",
		ctx
	});
...
//# sourceMappingURL=Hotspot-20727ae9.js.map
