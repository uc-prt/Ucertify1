...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$1, 570, 48, 25551);
			attr_dev(button, "type", "button");
			attr_dev(button, "class", "btn_category btn mx-auto");
			add_location(button, file$1, 566, 44, 25259);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file$1, 559, 10, 24482);
			attr_dev(div0, "class", "d-flex flex-column-reverse width180");
			add_location(div0, file$1, 558, 9, 24422);
			...
			add_location(div1, file$1, 557, 8, 24352);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(span, "data-bs-toggle", "tooltip");
			add_location(span, file$1, 584, 36, 26625);
			attr_dev(button, "type", "button");
			...
			add_location(button, file$1, 583, 32, 26481);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, span);
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 555, 6, 24241);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=AlignMatch-666da0e4.js.map
