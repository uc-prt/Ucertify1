...
function add_css$1() {
	...
	style.textContent = "#resizeX.svelte-dt0ps7{position:absolute;top:0;right:0;width:3px;opacity:1;height:100%;cursor:w-resize}#resizeY.svelte-dt0ps7{position:absolute;bottom:0;width:100%;height:3px;opacity:1;cursor:s-resize}#resizeXY.svelte-dt0ps7{position:absolute;bottom:0;right:0;opacity:1;cursor:se-resize}#resizeXY.svelte-dt0ps7::before{content:'\\e354'\r\n    }\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_if_block_2$2(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*step, state, DND_AUTH, changeStep*/ 32964) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(792:2) {#if step && step.length}",
		ctx
	});
...
// (794:16) {#if (data._display == "1" || data._ddisplay == '1') && state.store.updated == false}
function create_if_block_3(ctx) {
	let t_value = /*changeStep*/ ctx[15](/*data*/ ctx[56]._id) + "";
	let t;
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*step*/ 64 && t_value !== (t_value = /*changeStep*/ ctx[15](/*data*/ ctx[56]._id) + "")) set_data_dev(t, t_value);
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(t);
		}
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(794:16) {#if (data._display == \\\"1\\\" || data._ddisplay == '1') && state.store.updated == false}",
		ctx
	});
...
function create_each_block$g(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = (/*data*/ ctx[56]._display == "1" || /*data*/ ctx[56]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false && create_if_block_3(ctx);

	function click_handler_1() {
		return /*click_handler_1*/ ctx[26](/*data*/ ctx[56]);
	}
	...
	const block = {
		c: function create() {
			...
			t2 = text(t2_value);
			t3 = space();
			attr_dev(input, "id", input_id_value = "step_" + /*data*/ ctx[56]._id);
			attr_dev(input, "type", "radio");
			attr_dev(input, "defaultvalue", "1");
			attr_dev(input, "name", "rbsAuth");
			attr_dev(input, "class", "baseradio dndradio svelte-dt0ps7");

			attr_dev(input, "defaultchecked", input_defaultchecked_value = (/*data*/ ctx[56]._display == "1" || /*data*/ ctx[56]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false
			? true
			: false);

			add_location(input, file$i, 797, 5, 33165);
			attr_dev(span, "for", span_for_value = /*data*/ ctx[56]._id);
			attr_dev(span, "key", span_key_value = /*data*/ ctx[56]._id);
			add_location(span, file$i, 796, 4, 33122);
		},
		m: function mount(target, anchor) {
			if (if_block) if_block.m(target, anchor);
		...
		p: function update(new_ctx, dirty) {
			...
			if ((/*data*/ ctx[56]._display == "1" || /*data*/ ctx[56]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false) {
				if (if_block) {
					if_block.p(ctx, dirty);
				} else {
			...
			if (dirty[0] & /*step*/ 64 && input_id_value !== (input_id_value = "step_" + /*data*/ ctx[56]._id)) {
				attr_dev(input, "id", input_id_value);
			}

			if (dirty[0] & /*step, state*/ 192 && input_defaultchecked_value !== (input_defaultchecked_value = (/*data*/ ctx[56]._display == "1" || /*data*/ ctx[56]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false
			? true
			: false)) {
				attr_dev(input, "defaultchecked", input_defaultchecked_value);
			}

			if (dirty[0] & /*step*/ 64 && t2_value !== (t2_value = /*data*/ ctx[56]._id + "")) set_data_dev(t2, t2_value);

			if (dirty[0] & /*step*/ 64 && span_for_value !== (span_for_value = /*data*/ ctx[56]._id)) {
				attr_dev(span, "for", span_for_value);
			}

			if (dirty[0] & /*step*/ 64 && span_key_value !== (span_key_value = /*data*/ ctx[56]._id)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(793:3) {#each step as data}",
		ctx
	});
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 826, 16, 34554);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);

			if (!mounted) {
				dispose = listen_dev(img, "load", /*changeLoadState*/ ctx[17], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 824, 16, 34251);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
			...
			if (!mounted) {
				dispose = [
					listen_dev(img, "error", /*checkError*/ ctx[14], false, false, false),
					listen_dev(img, "load", /*load_handler*/ ctx[28], false, false, false)
				];
...
// (829:12) {#if state.data && image_loaded}
function create_if_block$h(ctx) {
	...
	step_1 = new Step({
			props: {
				...
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem,
				checkImageStatus: /*checkImageStatus*/ ctx[13]
			},
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 829, 16, 34778);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(829:12) {#if state.data && image_loaded}",
		ctx
	});
...
function create_fragment$i(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 789, 2, 32713);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 788, 4, 32682);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 821, 232, 34144);
			...
			add_render_callback(() => /*div5_elementresize_handler*/ ctx[32].call(div5));
			add_location(div5, file$i, 813, 8, 33602);
			add_location(center0, file$i, 812, 4, 33584);
			attr_dev(input1, "type", "hidden");
			attr_dev(input1, "id", "special_module_xml");
			attr_dev(input1, "name", "special_module_xml");
			add_location(input1, file$i, 855, 4, 37594);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "h");
			attr_dev(button1, "id", "update_xml");
			attr_dev(button1, "name", "update_xml");
			add_location(button1, file$i, 856, 4, 37673);
			attr_dev(div6, "class", "smnotes");
			add_location(div6, file$i, 858, 8, 37772);
			add_location(center1, file$i, 857, 4, 37754);
			attr_dev(div7, "class", "parent h");
			attr_dev(div7, "data-parent", "dndmain");
			add_location(div7, file$i, 860, 4, 37820);
			attr_dev(div8, "class", "input_border dragable-container overflow-auto p");
			add_location(div8, file$i, 787, 0, 32615);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			div5_resize_listener = add_resize_listener(div5, /*div5_elementresize_handler*/ ctx[32].bind(div5));
			append_dev(div8, t9);
			...
			if (!mounted) {
				dispose = [
					listen_dev(window, "keydown", /*handleKeyDown*/ ctx[16], false, false, false),
					listen_dev(input0, "click", /*click_handler*/ ctx[25], false, false, false),
					listen_dev(button0, "click", /*click_handler_2*/ ctx[27], false, false, false),
					listen_dev(div2, "mousedown", stop_propagation(prevent_default(/*resizeHandleW*/ ctx[18])), false, true, true),
					listen_dev(div3, "mousedown", stop_propagation(prevent_default(/*resizeHandleH*/ ctx[19])), false, true, true),
					listen_dev(div4, "mousedown", stop_propagation(prevent_default(/*resizeHandleWH*/ ctx[20])), false, true, true)
				];
...
function instance$i($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ("m_posX" in $$props) $$invalidate(23, m_posX = $$props.m_posX);
		if ("m_posY" in $$props) $$invalidate(24, m_posY = $$props.m_posY);
		if ("resize_elW" in $$props) $$invalidate(10, resize_elW = $$props.resize_elW);
		if ("resize_elH" in $$props) $$invalidate(11, resize_elH = $$props.resize_elH);
		if ("resize_elWH" in $$props) $$invalidate(12, resize_elWH = $$props.resize_elWH);
	};
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*m_posX*/ 8388608) ;

		if ($$self.$$.dirty[0] & /*m_posY*/ 16777216) ;
	};
...
class DragNDrop extends SvelteComponentDev {
	constructor(options) {
		...
		init(this, options, instance$i, create_fragment$i, safe_not_equal, { xml: 21, getChildXml: 22 }, [-1, -1]);
		...
		if (/*getChildXml*/ ctx[22] === undefined && !("getChildXml" in props)) {
...
//# sourceMappingURL=DragNDrop-d1b52773.js.map
