...
import { N as JUI, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, C as validate_each_argument, v as validate_slots, o as onMount, A as AH$1, a7 as afterUpdate, w as writable, X as XMLToJSON, e as element, j as attr_dev, k as add_location, n as insert_dev, x as detach_dev, f as space, c as create_component, h as text, p as append_dev, m as mount_component, q as listen_dev, F as set_data_dev, t as transition_in, a as transition_out, b as destroy_component, K as destroy_each, H as run_all } from './main-0211720b.js';
...
// (440:20) {#each localCData as data,i}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(li, file, 441, 28, 11841);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(440:20) {#each localCData as data,i}",
		ctx
	});
...
// (459:5) {#if state.allowSort == 1 || state.isSentence == 1 || state.isParagraph == 1}
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(459:5) {#if state.allowSort == 1 || state.isSentence == 1 || state.isParagraph == 1}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 427, 16, 11168);
			...
			add_location(ul, file, 428, 16, 11252);
			attr_dev(div1, "class", "choose_bottom pl-4");
			attr_dev(div1, "id", "instruction");
			add_location(div1, file, 457, 16, 12635);
			...
			add_location(div2, file, 426, 12, 11022);
			add_location(center1, file, 425, 8, 11001);
			add_location(div3, file, 413, 4, 10790);
			add_location(main, file, 412, 0, 10779);
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if ((!current || dirty & /*state*/ 8) && t2_value !== (t2_value = /*state*/ ctx[3].headingCorrect + "")) set_data_dev(t2, t2_value);
...
class ChooseNReorderPreview extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*uaXML*/ ctx[16] === undefined && !("uaXML" in props)) {
			console_1.warn("<ChooseNReorderPreview> was created without expected prop 'uaXML'");
		}
	}
...
//# sourceMappingURL=ChooseNReorderPreview-0623bae4.js.map
