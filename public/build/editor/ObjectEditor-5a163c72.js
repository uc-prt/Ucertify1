...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label, file, 61, 16, 1737);
			attr_dev(div0, "class", "col-sm-2");
			add_location(div0, file, 60, 12, 1698);
			...
			add_location(input, file, 64, 16, 1843);
			attr_dev(div1, "class", "col-sm-10");
			add_location(div1, file, 63, 12, 1803);
			attr_dev(div2, "class", "row form-group");
			add_location(div2, file, 59, 9, 1657);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file, 57, 4, 1576);
			attr_dev(div, "key", "3d_object");
			set_style(div, "width", "98%");
			add_location(div, file, 56, 0, 1505);
		},
...
//# sourceMappingURL=ObjectEditor-5a163c72.js.map
