...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 81, 4, 2081);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div2, file, 83, 12, 2183);
		},
		m: function mount(target, anchor) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 66, 4, 1694);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			div1 = element("div");
			t4 = space();
			add_location(p, file$1, 84, 16, 2378);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$1, 90, 24, 2705);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$1, 89, 20, 2562);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$1, 93, 24, 2925);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "id", "editButton");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$1, 92, 20, 2791);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "drop");
			add_location(div0, file$1, 85, 16, 2436);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$1, 96, 16, 3036);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			attr_dev(div2, "data-title", div2_data_title_value = /*data*/ ctx[8].title);
			attr_dev(div2, "tabindex", "0");
			...
			add_location(div2, file$1, 68, 12, 1794);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, p);
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			input.value = "0";
			add_location(input, file$2, 57, 16, 1623);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$2, 71, 24, 2206);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$2, 70, 20, 2062);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$2, 74, 24, 2411);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$2, 73, 20, 2292);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "radio");
			add_location(div0, file$2, 66, 16, 1936);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$2, 77, 16, 2522);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			...
			set_style(div2, "height", /*data*/ ctx[8].height);
			set_style(div2, "width", /*data*/ ctx[8].width);
			add_location(div2, file$2, 45, 12, 1200);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
function create_if_block$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$3, 73, 4, 2259);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option, file$3, 100, 24, 3623);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.value = option.__value;
			add_location(option, file$3, 96, 32, 3346);
		},
		m: function mount(target, anchor) {
			insert_dev(target, option, anchor);
			append_dev(option, t);
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.__value = option_value_value = /*option*/ ctx[10].key + 1;
			option.value = option.__value;
			add_location(option, file$3, 94, 32, 3099);
		},
		m: function mount(target, anchor) {
			insert_dev(target, option, anchor);
			append_dev(option, t);
...
function create_each_block$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(select_1, file$3, 87, 16, 2774);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$3, 108, 24, 3998);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$3, 107, 20, 3851);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$3, 111, 24, 4206);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$3, 110, 20, 4084);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "dropdown");
			add_location(div0, file$3, 103, 16, 3722);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$3, 114, 16, 4317);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			...
			set_style(div2, "height", /*data*/ ctx[8].height);
			set_style(div2, "width", /*data*/ ctx[8].width);
			add_location(div2, file$3, 75, 12, 2365);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
function create_if_block$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$4, 36, 4, 824);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input, file$4, 50, 16, 1357);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$4, 63, 24, 2012);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$4, 62, 20, 1867);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$4, 66, 24, 2218);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$4, 65, 20, 2098);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "input");
			add_location(div0, file$4, 58, 16, 1741);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$4, 69, 16, 2329);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			...
			add_location(div2, file$4, 38, 12, 933);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, input);
...
function create_if_block$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$5, 40, 1, 1158);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file$5, 54, 16, 1706);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$5, 63, 24, 2165);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$5, 62, 20, 2017);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$5, 66, 24, 2374);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$5, 65, 20, 2251);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "multiline");
			add_location(div0, file$5, 58, 16, 1887);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$5, 69, 16, 2485);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			attr_dev(div2, "class", "drag-resize cursor_move ui-draggable ui-resizable");
			set_style(div2, "position", "absolute");
			...
			set_style(div2, "height", /*data*/ ctx[8].height);
			set_style(div2, "width", /*data*/ ctx[8].width);
			add_location(div2, file$5, 42, 12, 1282);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
function create_if_block$6(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$6, 42, 4, 1090);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$6(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(input, "data-title", input_data_title_value = /*data*/ ctx[8].id);
			add_location(input, file$6, 56, 16, 1610);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$6, 66, 24, 2065);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$6, 65, 20, 1918);
			attr_dev(i1, "class", "icomoon-24px-delete-1");
			add_location(i1, file$6, 69, 24, 2273);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$6, 68, 20, 2151);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "checkbox");
			add_location(div0, file$6, 61, 16, 1789);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$6, 72, 16, 2380);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			attr_dev(div2, "class", "drag-resize cursor_move ui-draggable ui-resizable");
			set_style(div2, "position", "absolute");
			...
			set_style(div2, "height", /*data*/ ctx[8].height);
			set_style(div2, "width", /*data*/ ctx[8].width);
			add_location(div2, file$6, 44, 12, 1202);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, input);
...
function create_if_block$7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 45, 4, 1220);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file$7, 59, 16, 1750);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$7, 71, 24, 2275);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$7, 70, 20, 2130);
			attr_dev(i1, "class", "icomoon-24px-delete-1");
			add_location(i1, file$7, 74, 24, 2481);
			attr_dev(button2, "type", "button");
			attr_dev(button2, "class", "btn btn-light p-sm");
			add_location(button2, file$7, 73, 20, 2361);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "button");
			add_location(div0, file$7, 66, 16, 2003);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$7, 77, 16, 2588);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			attr_dev(div2, "class", "drag-resize cursor_move ui-draggable ui-resizable");
			set_style(div2, "position", "absolute");
			...
			set_style(div2, "height", /*data*/ ctx[8].height);
			set_style(div2, "width", /*data*/ ctx[8].width);
			add_location(div2, file$7, 47, 12, 1342);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
function create_if_block$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$8, 44, 4, 1181);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$8, 65, 20, 1972);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$8, 64, 16, 1830);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$8, 68, 20, 2167);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$8, 67, 16, 2050);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "tabhead");
			add_location(div0, file$8, 60, 12, 1718);
			...
			add_location(div1, file$8, 46, 12, 1290);
		},
		m: function mount(target, anchor) {
...
function create_if_block$9(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$9, 43, 4, 1069);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$9(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(img_1, "alt", "");
			add_location(img_1, file$9, 57, 16, 1563);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$9, 69, 24, 2074);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$9, 68, 20, 1932);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$9, 72, 24, 2277);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$9, 71, 20, 2160);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "img");
			add_location(div0, file$9, 64, 16, 1808);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$9, 75, 16, 2388);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			attr_dev(div2, "class", "drag-resize cursor_move ui-draggable ui-resizable");
			set_style(div2, "position", "absolute");
			...
			set_style(div2, "height", /*data*/ ctx[8].height);
			set_style(div2, "width", /*data*/ ctx[8].width);
			add_location(div2, file$9, 45, 12, 1166);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
function create_if_block$a(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$a, 66, 4, 2117);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$a(ctx) {
	...
	const block = {
		c: function create() {
			...
			div1 = element("div");
			t4 = space();
			add_location(p, file$a, 77, 16, 2489);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$a, 83, 24, 2819);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$a, 82, 20, 2675);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$a, 86, 24, 3024);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$a, 85, 20, 2905);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "label");
			add_location(div0, file$a, 78, 16, 2549);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$a, 89, 16, 3135);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			...
			add_location(div2, file$a, 70, 12, 2296);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, p);
...
function create_if_block$b(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$b, 64, 4, 1910);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$b, 81, 20, 2582);
		},
		m: function mount(target, anchor) {
...
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$b, 103, 36, 3894);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$b, 102, 32, 3704);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$b, 106, 36, 4169);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$b, 105, 32, 4004);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "hotspot_click");
			add_location(div0, file$b, 98, 28, 3522);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$b, 109, 28, 4316);
			...
			add_location(div2, file$b, 85, 24, 2856);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
...
function create_each_block$b(ctx) {
	...
	const block = {
		c: function create() {
			...
			t5 = space();
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$b, 119, 24, 4731);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$b, 118, 20, 4585);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$b, 122, 24, 4938);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$b, 121, 20, 4817);
			attr_dev(i2, "class", "icomoon-plus");
			add_location(i2, file$b, 125, 24, 5171);
			attr_dev(button2, "type", "button");
			attr_dev(button2, "class", "btn btn-light p-sm");
			add_location(button2, file$b, 124, 20, 5030);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "hotspot");
			add_location(div0, file$b, 114, 16, 4457);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$b, 128, 16, 5269);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			...
			add_location(div2, file$b, 66, 12, 2019);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
function create_if_block$c(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$c, 43, 4, 1132);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block$c(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$c, 63, 24, 1969);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$c, 62, 20, 1822);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$c, 66, 24, 2177);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$c, 65, 20, 2055);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "menulist");
			add_location(div0, file$c, 58, 16, 1693);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$c, 69, 16, 2288);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			...
			set_style(div2, "height", /*data*/ ctx[8].height);
			set_style(div2, "width", /*data*/ ctx[8].width);
			add_location(div2, file$c, 45, 12, 1244);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
...
function create_if_block$d(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file$d, 42, 8, 1299);
			attr_dev(div, "class", "tab-content");
			attr_dev(div, "type", "tab");
			set_style(div, "position", "relative");
			add_location(div, file$d, 49, 8, 1743);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$d, 58, 24, 2167);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_each_block$d(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$d, 51, 16, 1875);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$d(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			if (if_block) if_block.c();
			add_location(div, file$d, 40, 0, 1225);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_each_block_1$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file$e, 48, 20, 1602);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$e, 54, 28, 2076);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$e, 53, 24, 1929);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$e, 57, 28, 2292);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$e, 56, 24, 2170);
			attr_dev(div, "class", "btn-group tools tabTools h");
			attr_dev(div, "data-t", "label");
			add_location(div, file$e, 49, 20, 1778);
			...
			add_location(li, file$e, 47, 16, 1512);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_if_block_1$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$e, 71, 24, 2818);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_each_block$e(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "role", "tabpanel");
			add_location(div, file$e, 65, 16, 2585);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			if (if_block) if_block.m(div, null);
...
function create_if_block$f(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$f, 45, 4, 1262);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$f, 57, 5, 1832);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_each_block$f(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(i, file$f, 54, 196, 1725);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$f, 54, 76, 1605);
			attr_dev(div0, "class", "btn-group tools");
			attr_dev(div0, "data-type", "step");
			attr_dev(div0, "data-t", "step");
			add_location(div0, file$f, 54, 16, 1545);
			...
			add_location(div1, file$f, 47, 12, 1352);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_fragment$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$g, 34, 8, 2031);
			...
			add_location(input1, file$g, 35, 8, 2191);
			...
			add_location(input2, file$g, 36, 8, 2358);
			...
			add_location(input3, file$g, 37, 8, 2529);
			...
			add_location(input4, file$g, 38, 8, 2699);
			...
			add_location(input5, file$g, 39, 8, 2853);
			...
			add_location(input6, file$g, 40, 8, 3017);
			...
			add_location(input7, file$g, 41, 8, 3171);
			...
			add_location(input8, file$g, 42, 8, 3341);
			...
			add_location(input9, file$g, 43, 8, 3505);
			...
			add_location(input10, file$g, 44, 8, 3675);
			...
			add_location(input11, file$g, 45, 8, 3835);
			...
			add_location(input12, file$g, 46, 8, 3992);
			...
			add_location(input13, file$g, 47, 8, 4146);
			...
			add_location(input14, file$g, 48, 8, 4304);
			...
			add_location(input15, file$g, 49, 8, 4471);
			attr_dev(div3, "class", "row-fluid margin-top1 event-input");
			add_location(div3, file$g, 33, 4, 1975);
			add_location(div4, file$g, 11, 0, 301);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function add_css() {
	...
	style.textContent = ".modal_height.svelte-rrvcgd{max-height:350px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_if_block$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label, file$h, 728, 36, 55129);
			...
			add_location(textarea, file$h, 729, 36, 55256);
			attr_dev(div0, "class", "form-group");
			add_location(div0, file$h, 727, 32, 55068);
			attr_dev(div1, "class", "ev");
			attr_dev(div1, "type", "tbd");
			add_location(div1, file$h, 731, 32, 55463);
			attr_dev(div2, "class", "col-sm-6 pr-1 pl-2");
			add_location(div2, file$h, 726, 28, 55003);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
...
function create_fragment$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input1, file$h, 34, 40, 1855);
			attr_dev(div3, "class", "form-group");
			add_location(div3, file$h, 32, 36, 1637);
			attr_dev(div4, "class", "col-sm-3 px-1");
			add_location(div4, file$h, 31, 32, 1573);
			attr_dev(label2, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label2, "for", "drag-top");
			add_location(label2, file$h, 39, 40, 2267);
			attr_dev(input2, "type", "text");
			...
			add_location(input2, file$h, 40, 40, 2407);
			attr_dev(div5, "class", "form-group");
			add_location(div5, file$h, 38, 36, 2202);
			attr_dev(div6, "class", "col-sm-6 px-1");
			add_location(div6, file$h, 37, 32, 2138);
			attr_dev(label3, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label3, "for", "drag-left");
			add_location(label3, file$h, 45, 40, 2793);
			attr_dev(input3, "type", "text");
			...
			add_location(input4, file$h, 52, 40, 3451);
			attr_dev(div9, "class", "form-group");
			add_location(div9, file$h, 50, 36, 3258);
			attr_dev(div10, "class", "col-sm-6 px-1");
			add_location(div10, file$h, 49, 32, 3194);
			attr_dev(label5, "class", "control-label font-weight-normal mb-0");
			attr_dev(label5, "for", "drag-border_color");
			add_location(label5, file$h, 57, 40, 3819);
			option0.__value = "";
			option0.value = option0.__value;
			add_location(option0, file$h, 59, 44, 4094);
			option1.__value = "black";
			option1.value = option1.__value;
			add_location(option1, file$h, 60, 44, 4173);
			option2.__value = "gray";
			option2.value = option2.__value;
			add_location(option2, file$h, 61, 44, 4258);
			...
			add_location(input14, file$h, 138, 40, 10287);
			attr_dev(div38, "class", "form-group");
			add_location(div38, file$h, 136, 36, 10080);
			attr_dev(div39, "class", "col-sm-6 px-1");
			add_location(div39, file$h, 135, 32, 10016);
			attr_dev(div40, "class", "row");
			add_location(div40, file$h, 128, 28, 9447);
			attr_dev(label16, "class", "control-label font-weight-normal mb-0");
			attr_dev(label16, "for", "drop-value");
			add_location(label16, file$h, 145, 40, 10750);
			attr_dev(input15, "type", "text");
			...
			add_location(input18, file$h, 176, 40, 13221);
			attr_dev(div50, "class", "form-group");
			add_location(div50, file$h, 174, 36, 13014);
			attr_dev(div51, "class", "col-sm-12 px-1 d-none");
			add_location(div51, file$h, 173, 32, 12942);
			...
			add_location(input19, file$h, 181, 40, 13602);
			...
			add_location(input22, file$h, 212, 40, 15808);
			attr_dev(div63, "class", "form-group");
			add_location(div63, file$h, 210, 36, 15591);
			attr_dev(div64, "class", "col-sm-6 px-1");
			add_location(div64, file$h, 209, 32, 15527);
			attr_dev(div65, "class", "row");
			add_location(div65, file$h, 202, 28, 14921);
			attr_dev(label25, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label25, "for", "int-top");
			add_location(label25, file$h, 219, 40, 16297);
			...
			add_location(input32, file$h, 310, 40, 23517);
			attr_dev(div95, "class", "form-group");
			add_location(div95, file$h, 308, 36, 23300);
			attr_dev(div96, "class", "col-sm-6 px-1");
			add_location(div96, file$h, 307, 32, 23236);
			attr_dev(div97, "class", "row");
			add_location(div97, file$h, 300, 28, 22626);
			attr_dev(label38, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label38, "for", "mlt-top");
			add_location(label38, file$h, 317, 40, 24010);
			...
			add_location(input39, file$h, 393, 40, 30008);
			attr_dev(div123, "class", "form-group");
			add_location(div123, file$h, 391, 36, 29791);
			attr_dev(div124, "class", "col-sm-6 px-1");
			add_location(div124, file$h, 390, 32, 29727);
			attr_dev(div125, "class", "row");
			add_location(div125, file$h, 383, 28, 29123);
			attr_dev(label49, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label49, "for", "chk-top");
			add_location(label49, file$h, 400, 40, 30500);
			...
			add_location(input46, file$h, 451, 40, 34353);
			attr_dev(div144, "class", "form-group");
			add_location(div144, file$h, 449, 36, 34137);
			attr_dev(div145, "class", "col-sm-6 px-1");
			add_location(div145, file$h, 448, 32, 34073);
			attr_dev(div146, "class", "row");
			add_location(div146, file$h, 441, 28, 33470);
			attr_dev(label56, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label56, "for", "rd-top");
			add_location(label56, file$h, 458, 40, 34841);
			...
			add_location(input48, file$h, 465, 40, 35499);
			attr_dev(div149, "class", "form-group");
			add_location(div149, file$h, 463, 36, 35294);
			attr_dev(div150, "class", "col-sm-6 px-1");
			add_location(div150, file$h, 462, 32, 35230);
			attr_dev(div151, "class", "row");
			add_location(div151, file$h, 455, 28, 34662);
			attr_dev(label58, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label58, "for", "rd-name");
			add_location(label58, file$h, 472, 40, 35964);
			...
			add_location(input55, file$h, 521, 40, 39708);
			attr_dev(div169, "class", "form-group");
			add_location(div169, file$h, 519, 36, 39491);
			attr_dev(div170, "class", "col-sm-6 px-1");
			add_location(div170, file$h, 518, 32, 39427);
			attr_dev(div171, "class", "row");
			add_location(div171, file$h, 511, 28, 38820);
			attr_dev(label65, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label65, "for", "btn-top");
			add_location(label65, file$h, 528, 40, 40198);
			...
			add_location(input57, file$h, 535, 40, 40860);
			attr_dev(div174, "class", "form-group");
			add_location(div174, file$h, 533, 36, 40654);
			attr_dev(div175, "class", "col-sm-6 px-1");
			add_location(div175, file$h, 532, 32, 40590);
			attr_dev(div176, "class", "row");
			add_location(div176, file$h, 525, 28, 40019);
			attr_dev(label67, "class", "control-label font-weight-normal mb-0");
			attr_dev(label67, "for", "btn-value");
			add_location(label67, file$h, 542, 40, 41327);
			...
			add_location(input58, file$h, 543, 40, 41450);
			attr_dev(div177, "class", "form-group");
			add_location(div177, file$h, 541, 36, 41262);
			attr_dev(div178, "class", "col-sm-12 px-1");
			add_location(div178, file$h, 540, 32, 41197);
			attr_dev(label68, "class", "control-label font-weight-normal mb-0");
			attr_dev(label68, "for", "btn-class");
			add_location(label68, file$h, 548, 40, 41815);
			...
			add_location(input62, file$h, 579, 40, 43997);
			attr_dev(div190, "class", "form-group");
			add_location(div190, file$h, 577, 36, 43780);
			attr_dev(div191, "class", "col-sm-6 px-1");
			add_location(div191, file$h, 576, 32, 43716);
			attr_dev(div192, "class", "row");
			add_location(div192, file$h, 569, 28, 43107);
			attr_dev(label72, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label72, "for", "ddn-top");
			add_location(label72, file$h, 586, 40, 44489);
			...
			add_location(input64, file$h, 593, 40, 45153);
			attr_dev(div195, "class", "form-group");
			add_location(div195, file$h, 591, 36, 44947);
			attr_dev(div196, "class", "col-sm-6 px-1");
			add_location(div196, file$h, 590, 32, 44883);
			attr_dev(div197, "class", "row");
			add_location(div197, file$h, 583, 28, 44310);
			attr_dev(label74, "class", "control-label font-weight-normal mb-0");
			attr_dev(label74, "for", "ddn-value");
			add_location(label74, file$h, 600, 40, 45622);
			...
			add_location(input67, file$h, 631, 40, 47812);
			attr_dev(div209, "class", "form-group");
			add_location(div209, file$h, 629, 36, 47595);
			attr_dev(div210, "class", "col-sm-6 px-1");
			add_location(div210, file$h, 628, 32, 47531);
			attr_dev(div211, "class", "row");
			add_location(div211, file$h, 621, 28, 46923);
			attr_dev(label78, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label78, "for", "lst-top");
			add_location(label78, file$h, 638, 40, 48303);
			...
			add_location(input69, file$h, 645, 40, 48966);
			attr_dev(div214, "class", "form-group");
			add_location(div214, file$h, 643, 36, 48760);
			attr_dev(div215, "class", "col-sm-6 px-1");
			add_location(div215, file$h, 642, 32, 48696);
			attr_dev(div216, "class", "row");
			add_location(div216, file$h, 635, 28, 48124);
			attr_dev(label80, "class", "control-label font-weight-normal mb-0");
			attr_dev(label80, "for", "lst-value");
			add_location(label80, file$h, 652, 40, 49434);
			...
			add_location(textarea11, file$h, 653, 40, 49563);
			attr_dev(div217, "class", "form-group");
			add_location(div217, file$h, 651, 36, 49369);
			attr_dev(div218, "class", "col-sm-12 px-1");
			add_location(div218, file$h, 650, 32, 49304);
			...
			add_location(input74, file$h, 691, 40, 52332);
			attr_dev(div230, "class", "form-group");
			add_location(div230, file$h, 689, 36, 52115);
			attr_dev(div231, "class", "col-sm-6 px-1");
			add_location(div231, file$h, 688, 32, 52051);
			attr_dev(div232, "class", "row");
			add_location(div232, file$h, 681, 28, 51443);
			attr_dev(label85, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label85, "for", "tbd-top");
			add_location(label85, file$h, 698, 40, 52823);
			...
			add_location(input76, file$h, 705, 40, 53486);
			attr_dev(div235, "class", "form-group");
			add_location(div235, file$h, 703, 36, 53280);
			attr_dev(div236, "class", "col-sm-6 px-1");
			add_location(div236, file$h, 702, 32, 53216);
			attr_dev(div237, "class", "row");
			add_location(div237, file$h, 695, 28, 52644);
			attr_dev(label87, "class", "control-label font-weight-normal mb-0");
			attr_dev(label87, "for", "tbd-title");
			add_location(label87, file$h, 712, 40, 53954);
			...
			add_location(input77, file$h, 713, 40, 54081);
			attr_dev(div238, "class", "form-group");
			add_location(div238, file$h, 711, 36, 53889);
			attr_dev(div239, "class", "col-sm-12 px-1");
			add_location(div239, file$h, 710, 32, 53824);
			attr_dev(label88, "class", "control-label font-weight-normal mb-0");
			attr_dev(label88, "for", "tbd-class");
			add_location(label88, file$h, 718, 40, 54447);
			...
			add_location(input81, file$h, 751, 40, 56736);
			attr_dev(div248, "class", "form-group");
			add_location(div248, file$h, 749, 36, 56519);
			attr_dev(div249, "class", "col-sm-6 px-1");
			add_location(div249, file$h, 748, 32, 56455);
			attr_dev(div250, "class", "row");
			add_location(div250, file$h, 741, 28, 55849);
			attr_dev(label91, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label91, "for", "img-top");
			add_location(label91, file$h, 758, 40, 57225);
			...
			add_location(input83, file$h, 765, 40, 57886);
			attr_dev(div253, "class", "form-group");
			add_location(div253, file$h, 763, 36, 57680);
			attr_dev(div254, "class", "col-sm-6 px-1");
			add_location(div254, file$h, 762, 32, 57616);
			attr_dev(div255, "class", "row");
			add_location(div255, file$h, 755, 28, 57046);
			attr_dev(label93, "class", "control-label font-weight-normal mb-0");
			attr_dev(label93, "for", "img-title");
			add_location(label93, file$h, 772, 40, 58352);
			...
			add_location(input84, file$h, 773, 40, 58479);
			attr_dev(div256, "class", "form-group");
			add_location(div256, file$h, 771, 36, 58287);
			attr_dev(div257, "class", "col-sm-12 px-1");
			add_location(div257, file$h, 770, 32, 58222);
			attr_dev(label94, "class", "control-label font-weight-normal mb-0");
			attr_dev(label94, "for", "img-bgimg");
			add_location(label94, file$h, 778, 40, 58843);
			...
			add_location(input90, file$h, 821, 40, 62095);
			attr_dev(div273, "class", "form-group");
			add_location(div273, file$h, 819, 36, 61889);
			attr_dev(div274, "class", "col-sm-6 px-1");
			add_location(div274, file$h, 818, 32, 61825);
			attr_dev(label100, "class", "control-label font-weight-normal mb-0");
			attr_dev(label100, "for", "lbl-title");
			add_location(label100, file$h, 826, 40, 62480);
			...
			add_location(input91, file$h, 827, 40, 62607);
			attr_dev(div275, "class", "form-group");
			add_location(div275, file$h, 825, 36, 62415);
			attr_dev(div276, "class", "col-sm-12 px-1");
			add_location(div276, file$h, 824, 32, 62350);
			attr_dev(label101, "class", "control-label font-weight-normal mb-0");
			attr_dev(label101, "for", "lbl_border_size");
			add_location(label101, file$h, 832, 40, 62970);
			option12.__value = "0";
			option12.value = option12.__value;
			add_location(option12, file$h, 834, 44, 63249);
			option13.__value = "1";
			option13.value = option13.__value;
			add_location(option13, file$h, 835, 44, 63329);
			option14.__value = "2";
			option14.value = option14.__value;
			add_location(option14, file$h, 836, 44, 63402);
			option15.__value = "3";
			option15.value = option15.__value;
			add_location(option15, file$h, 837, 44, 63475);
			option16.__value = "4";
			option16.value = option16.__value;
			add_location(option16, file$h, 838, 44, 63548);
			option17.__value = "5";
			option17.value = option17.__value;
			add_location(option17, file$h, 839, 44, 63621);
			...
			add_location(select7, file$h, 833, 40, 63109);
			attr_dev(div277, "class", "form-group");
			add_location(div277, file$h, 831, 36, 62905);
			attr_dev(div278, "class", "col-sm-4 px-1");
			add_location(div278, file$h, 830, 32, 62841);
			attr_dev(label102, "class", "control-label font-weight-normal mb-0");
			attr_dev(label102, "for", "lbl_border_color");
			add_location(label102, file$h, 845, 40, 63943);
			option18.__value = "white";
			option18.value = option18.__value;
			add_location(option18, file$h, 847, 44, 64222);
			option19.__value = "black";
			option19.value = option19.__value;
			add_location(option19, file$h, 848, 44, 64306);
			option20.__value = "blue";
			option20.value = option20.__value;
			add_location(option20, file$h, 849, 44, 64391);
			option21.__value = "green";
			option21.value = option21.__value;
			add_location(option21, file$h, 850, 44, 64474);
			option22.__value = "red";
			option22.value = option22.__value;
			add_location(option22, file$h, 851, 44, 64559);
			...
			add_location(input97, file$h, 918, 40, 69376);
			attr_dev(div301, "class", "form-group");
			add_location(div301, file$h, 916, 36, 69169);
			attr_dev(div302, "class", "col-sm-3 px-1");
			add_location(div302, file$h, 915, 32, 69105);
			attr_dev(div303, "class", "row");
			add_location(div303, file$h, 896, 28, 67416);
			attr_dev(label110, "class", "control-label font-weight-normal mb-0");
			attr_dev(label110, "for", "area-matrix");
			add_location(label110, file$h, 925, 40, 69841);
			...
			add_location(input99, file$h, 932, 40, 70479);
			attr_dev(div306, "class", "form-group");
			add_location(div306, file$h, 930, 36, 70272);
			attr_dev(div307, "class", "col-sm-6 px-1");
			add_location(div307, file$h, 929, 32, 70208);
			attr_dev(div308, "class", "row");
			add_location(div308, file$h, 922, 28, 69662);
			attr_dev(label112, "class", "control-label font-weight-normal mb-0");
			attr_dev(label112, "for", "area-defaultans");
			add_location(label112, file$h, 939, 40, 70931);
			...
			add_location(input105, file$h, 975, 40, 73677);
			attr_dev(div322, "class", "form-group");
			add_location(div322, file$h, 973, 36, 73471);
			attr_dev(div323, "class", "col-sm-3 px-1");
			add_location(div323, file$h, 972, 32, 73407);
			attr_dev(div324, "class", "row");
			add_location(div324, file$h, 953, 28, 71712);
			attr_dev(label117, "class", "control-label font-weight-normal mb-0");
			attr_dev(label117, "for", "mnl-matrix");
			add_location(label117, file$h, 982, 40, 74145);
			...
			add_location(input107, file$h, 989, 40, 74784);
			attr_dev(div327, "class", "form-group");
			add_location(div327, file$h, 987, 36, 74578);
			attr_dev(div328, "class", "col-sm-6 px-1");
			add_location(div328, file$h, 986, 32, 74514);
			attr_dev(div329, "class", "row");
			add_location(div329, file$h, 979, 28, 73966);
			attr_dev(label119, "class", "control-label font-weight-normal mb-0");
			attr_dev(label119, "for", "mnl-value");
			add_location(label119, file$h, 996, 40, 75239);
			...
			add_location(input113, file$h, 1032, 40, 77968);
			attr_dev(div343, "class", "form-group");
			add_location(div343, file$h, 1030, 36, 77762);
			attr_dev(div344, "class", "col-sm-3 px-1");
			add_location(div344, file$h, 1029, 32, 77698);
			attr_dev(div345, "class", "row");
			add_location(div345, file$h, 1010, 28, 76005);
			attr_dev(label124, "class", "control-label font-weight-normal mb-0");
			attr_dev(label124, "for", "hpt-title");
			add_location(label124, file$h, 1039, 40, 78435);
			...
			add_location(input114, file$h, 1040, 40, 78562);
			attr_dev(div346, "class", "form-group");
			add_location(div346, file$h, 1038, 36, 78370);
			attr_dev(div347, "class", "col-sm-6 px-1");
			add_location(div347, file$h, 1037, 32, 78306);
			attr_dev(label125, "class", "control-label font-weight-normal mb-0");
			attr_dev(label125, "for", "hpt-name");
			add_location(label125, file$h, 1045, 40, 78927);
			...
			add_location(input115, file$h, 1046, 40, 79057);
			attr_dev(div348, "class", "form-group");
			add_location(div348, file$h, 1044, 36, 78862);
			attr_dev(div349, "class", "col-sm-6 px-1");
			add_location(div349, file$h, 1043, 32, 78798);
			attr_dev(div350, "class", "row");
			add_location(div350, file$h, 1036, 28, 78256);
			attr_dev(label126, "class", "control-label font-weight-normal mb-0");
			attr_dev(label126, "for", "hpt-targetimg");
			add_location(label126, file$h, 1053, 40, 79502);
			...
			add_location(input116, file$h, 1054, 40, 79638);
			attr_dev(div351, "class", "form-group");
			add_location(div351, file$h, 1052, 36, 79437);
			attr_dev(div352, "class", "col-sm-6 px-1");
			add_location(div352, file$h, 1051, 32, 79373);
			...
			add_location(input124, file$h, 1108, 40, 83641);
			attr_dev(div371, "class", "form-group");
			add_location(div371, file$h, 1106, 36, 83449);
			attr_dev(div372, "class", "col-sm-6 px-1");
			add_location(div372, file$h, 1105, 32, 83385);
			attr_dev(label133, "class", "control-label font-weight-normal mb-0");
			attr_dev(label133, "for", "tab-alt");
			add_location(label133, file$h, 1113, 40, 84020);
			...
			add_location(input125, file$h, 1114, 40, 84148);
			attr_dev(div373, "class", "form-group");
			add_location(div373, file$h, 1112, 36, 83955);
			attr_dev(div374, "class", "col-sm-6 px-1");
			add_location(div374, file$h, 1111, 32, 83891);
			attr_dev(div375, "class", "row");
			add_location(div375, file$h, 1104, 28, 83335);
			attr_dev(label134, "class", "control-label font-weight-normal mb-0");
			attr_dev(label134, "for", "tab-bgimg");
			add_location(label134, file$h, 1121, 40, 84586);
			...
			add_location(input126, file$h, 1122, 40, 84724);
			attr_dev(div376, "class", "form-group");
			add_location(div376, file$h, 1120, 36, 84521);
			attr_dev(button2, "type", "button");
			...
			add_location(button2, file$h, 1124, 36, 84918);
			attr_dev(div377, "class", "col-sm-6 px-1");
			add_location(div377, file$h, 1119, 32, 84457);
			...
			add_location(input129, file$h, 1144, 40, 86329);
			attr_dev(div384, "class", "form-group");
			add_location(div384, file$h, 1142, 36, 86125);
			...
			add_location(input130, file$h, 1151, 40, 86993);
			attr_dev(div386, "class", "form-group");
			add_location(div386, file$h, 1149, 36, 86800);
			attr_dev(div387, "class", "col-sm-6 px-1");
			add_location(div387, file$h, 1148, 32, 86736);
			attr_dev(div388, "class", "row");
			add_location(div388, file$h, 1140, 28, 86011);
			...
			add_location(input134, file$h, 1180, 40, 89009);
			attr_dev(div397, "class", "form-group");
			add_location(div397, file$h, 1178, 36, 88791);
			attr_dev(div398, "class", "col-sm-4 px-1");
			add_location(div398, file$h, 1177, 32, 88727);
			attr_dev(label141, "class", "control-label font-weight-normal mb-0");
			attr_dev(label141, "for", "base-bgimg-alt");
			add_location(label141, file$h, 1185, 40, 89399);
			...
			add_location(input135, file$h, 1186, 40, 89537);
			attr_dev(div399, "class", "form-group");
			add_location(div399, file$h, 1184, 36, 89334);
			attr_dev(div400, "class", "col-sm-4 px-1");
			add_location(div400, file$h, 1183, 32, 89270);
			attr_dev(div401, "class", "row");
			add_location(div401, file$h, 1170, 28, 88139);
			attr_dev(label142, "class", "control-label font-weight-normal mb-0");
			attr_dev(label142, "for", "base-bgimg");
			add_location(label142, file$h, 1193, 40, 89983);
			...
			add_location(input136, file$h, 1194, 40, 90122);
			attr_dev(div402, "class", "form-group");
			add_location(div402, file$h, 1192, 36, 89918);
			attr_dev(div403, "class", "col-sm-6 px-1");
			add_location(div403, file$h, 1191, 32, 89854);
			attr_dev(button4, "type", "button");
			attr_dev(button4, "id", "upload_media");
			attr_dev(button4, "class", "btn btn-outline-primary float-start");
			add_location(button4, file$h, 1198, 36, 90447);
			...
			add_location(input137, file$h, 1200, 40, 90680);
			...
			add_location(label143, file$h, 1201, 40, 90883);
			attr_dev(div404, "class", "form-group float-start mt-2");
			add_location(div404, file$h, 1199, 36, 90598);
			attr_dev(div405, "class", "col-sm-6 mt-3 pt-1 px-1");
			add_location(div405, file$h, 1197, 32, 90373);
			attr_dev(div406, "class", "row");
			add_location(div406, file$h, 1190, 28, 89804);
			attr_dev(div407, "class", "col-sm-12");
			add_location(div407, file$h, 1169, 24, 88087);
			attr_dev(div408, "class", "row mx-0");
			add_location(div408, file$h, 1168, 20, 88040);
			attr_dev(div409, "class", "base h");
			add_location(div409, file$h, 1167, 16, 87999);
			...
			add_location(input141, file$h, 1238, 40, 93636);
			attr_dev(div418, "class", "form-group");
			add_location(div418, file$h, 1236, 36, 93421);
			attr_dev(div419, "class", "col-sm-6 px-1");
			add_location(div419, file$h, 1235, 32, 93357);
			attr_dev(div420, "class", "row");
			add_location(div420, file$h, 1228, 28, 92772);
			attr_dev(label148, "class", "control-label font-weight-normal mb-0");
			attr_dev(label148, "for", "choicematrix-name");
			add_location(label148, file$h, 1245, 40, 94108);
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 762, 16, 31482);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 760, 16, 31181);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 765, 16, 31703);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$i(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 726, 2, 29729);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 725, 4, 29699);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 757, 232, 31077);
			...
			add_location(button0, file$i, 757, 16, 30861);
			attr_dev(div1, "class", "btn-group tools mr-1");
			attr_dev(div1, "data-t", "base");
			add_location(div1, file$i, 756, 12, 30796);
...
//# sourceMappingURL=DragNDrop-8146f9eb.js.map
