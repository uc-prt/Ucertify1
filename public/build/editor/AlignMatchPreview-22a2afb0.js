...
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 700, 52, 36809);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 704, 60, 37499);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			div.innerHTML = raw_value;
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 702, 60, 37084);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 688, 28, 35728);
			...
			add_location(div0, file$1, 687, 24, 35514);
...
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 723, 16, 38516);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 726, 16, 38734);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 733, 16, 39036);
			attr_dev(div1, "class", "yourAnswer");
			add_location(div1, file$1, 736, 16, 39263);
			attr_dev(div2, "class", "scoreDiv");
			add_location(div2, file$1, 732, 12, 38996);
			attr_dev(div3, "class", "finalResult");
			add_location(div3, file$1, 731, 8, 38957);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div3, file$1, 682, 4, 35119);
			add_location(div4, file$1, 673, 0, 34859);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=AlignMatchPreview-22a2afb0.js.map
