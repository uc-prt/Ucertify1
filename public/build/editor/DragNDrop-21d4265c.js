...
function add_css$1() {
	var style = element("style");
	style.id = "svelte-9kkd1n-style";
	style.textContent = "#resizeX.svelte-9kkd1n{position:absolute;top:0;right:0;width:3px;opacity:1;height:100%;cursor:w-resize}#resizeY.svelte-9kkd1n{position:absolute;bottom:0;width:100%;height:3px;opacity:1;cursor:s-resize}#resizeXY.svelte-9kkd1n{position:absolute;bottom:0;right:0;width:3px;height:3px;opacity:1;cursor:se-resize}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_each_block$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(input, "class", "baseradio dndradio svelte-9kkd1n");
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 826, 16, 34586);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 824, 16, 34283);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 829, 16, 34810);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$i(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 789, 2, 32745);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 788, 4, 32714);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 821, 232, 34176);
			...
			add_location(button0, file$i, 821, 16, 33960);
			attr_dev(div1, "class", "btn-group tools mr-1");
			attr_dev(div1, "data-t", "base");
			add_location(div1, file$i, 820, 12, 33894);
			attr_dev(div2, "id", "resizeX");
			attr_dev(div2, "class", "svelte-9kkd1n");
			add_location(div2, file$i, 850, 12, 37214);
			attr_dev(div3, "id", "resizeY");
			attr_dev(div3, "class", "svelte-9kkd1n");
			add_location(div3, file$i, 851, 12, 37335);
			attr_dev(div4, "id", "resizeXY");
			attr_dev(div4, "class", "svelte-9kkd1n");
			add_location(div4, file$i, 852, 12, 37456);
...
class DragNDrop extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-9kkd1n-style")) add_css$1();
...
//# sourceMappingURL=DragNDrop-21d4265c.js.map
