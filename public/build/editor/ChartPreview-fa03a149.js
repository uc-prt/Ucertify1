...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 547, 32, 23630);
			...
			add_location(span1, file, 546, 28, 23344);
			attr_dev(span2, "class", "icomoon-new-24px-delete-1 s2");
			add_location(span2, file, 550, 32, 24035);
			...
			add_location(span3, file, 549, 28, 23734);
			attr_dev(span4, "class", "icomoon-keyboard-2 s2");
			add_location(span4, file, 553, 32, 24404);
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file, 582, 36, 26443);
			attr_dev(label0, "class", "col-6 text-body");
			add_location(label0, file, 580, 32, 26316);
...
//# sourceMappingURL=ChartPreview-fa03a149.js.map
