...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 569, 7, 19535);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 570, 7, 19627);
			...
			add_location(div2, file, 573, 5, 19713);
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 587, 6, 20129);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input, file, 598, 1, 20390);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 605, 1, 20524);
...
//# sourceMappingURL=HotspotPreview-51ce1808.js.map
