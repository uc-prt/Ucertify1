...
import { y as l, a7 as swal, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, C as validate_each_argument, e as element, j as attr_dev, k as add_location, n as insert_dev, x as detach_dev, H as destroy_each, h as text, f as space, l as set_style, p as append_dev, q as listen_dev, E as set_data_dev, G as run_all, z as empty, B as noop, F as prop_dev, t as transition_in, r as group_outros, a as transition_out, u as check_outros, c as create_component, m as mount_component, b as destroy_component, o as onMount, g as globals, I as beforeUpdate, A as AH, X as XMLToJSON, w as writable, Y as add_render_callback, a8 as add_resize_listener, T as stop_propagation, U as prevent_default, M as binding_callbacks } from './main-ff508531.js';
...
/* clsSMDragNDrop\libs\authoring\Drag.svelte generated by Svelte v3.34.0 */
...
/* clsSMDragNDrop\libs\authoring\Drop.svelte generated by Svelte v3.34.0 */
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			div1 = element("div");
			t4 = space();
			add_location(p, file$1, 85, 16, 2493);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$1, 91, 24, 2826);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$1, 90, 20, 2682);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$1, 94, 24, 3049);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "id", "editButton");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$1, 93, 20, 2914);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "drop");
			add_location(div0, file$1, 86, 16, 2552);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$1, 97, 16, 3163);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			attr_dev(div2, "data-title", div2_data_title_value = /*data*/ ctx[8].title);
			attr_dev(div2, "tabindex", "0");
...
/* clsSMDragNDrop\libs\authoring\Radio.svelte generated by Svelte v3.34.0 */
...
function create_each_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			input.value = "0";
			add_location(input, file$2, 58, 16, 1713);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$2, 72, 24, 2310);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$2, 71, 20, 2165);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$2, 75, 24, 2518);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$2, 74, 20, 2398);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "radio");
			add_location(div0, file$2, 67, 16, 2035);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$2, 78, 16, 2632);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
...
/* clsSMDragNDrop\libs\authoring\Select.svelte generated by Svelte v3.34.0 */
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option, file$3, 101, 24, 3754);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(93:20) {#if data.select.length}",
		ctx
	});
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.value = option.__value;
			add_location(option, file$3, 97, 32, 3473);
		},
		m: function mount(target, anchor) {
			insert_dev(target, option, anchor);
			append_dev(option, t);
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.__value = option_value_value = /*option*/ ctx[10].key + 1;
			option.value = option.__value;
			add_location(option, file$3, 95, 32, 3224);
		},
		m: function mount(target, anchor) {
			insert_dev(target, option, anchor);
			append_dev(option, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(95:28) {#if option.selected == 1}",
		ctx
	});
...
// (94:24) {#each data.select as option}
function create_each_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(94:24) {#each data.select as option}",
		ctx
	});
...
function create_each_block$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(select_1, file$3, 88, 16, 2892);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$3, 109, 24, 4137);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$3, 108, 20, 3989);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$3, 112, 24, 4348);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$3, 111, 20, 4225);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "dropdown");
			add_location(div0, file$3, 104, 16, 3856);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$3, 115, 16, 4462);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
...
/* clsSMDragNDrop\libs\authoring\Textbox.svelte generated by Svelte v3.34.0 */
...
function create_each_block$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input, file$4, 51, 16, 1440);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$4, 64, 24, 2108);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$4, 63, 20, 1962);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$4, 67, 24, 2317);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$4, 66, 20, 2196);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "input");
			add_location(div0, file$4, 59, 16, 1832);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$4, 70, 16, 2431);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
...
/* clsSMDragNDrop\libs\authoring\Multilinebox.svelte generated by Svelte v3.34.0 */
...
function create_each_block$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file$5, 55, 16, 1793);
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$5, 64, 24, 2261);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$5, 63, 20, 2112);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$5, 67, 24, 2473);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$5, 66, 20, 2349);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "multiline");
			add_location(div0, file$5, 59, 16, 1978);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$5, 70, 16, 2587);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
			attr_dev(div2, "class", "drag-resize cursor_move ui-draggable ui-resizable");
			set_style(div2, "position", "absolute");
...
/* clsSMDragNDrop\libs\authoring\Checkbox.svelte generated by Svelte v3.34.0 */
...
/* clsSMDragNDrop\libs\authoring\Button.svelte generated by Svelte v3.34.0 */
...
/* clsSMDragNDrop\libs\authoring\Tabhead.svelte generated by Svelte v3.34.0 */
...
/* clsSMDragNDrop\libs\authoring\Img.svelte generated by Svelte v3.34.0 */
...
/* clsSMDragNDrop\libs\authoring\Label.svelte generated by Svelte v3.34.0 */
...
function create_each_block$a(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$a, 83, 24, 2915);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$a, 82, 20, 2770);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$a, 86, 24, 3123);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$a, 85, 20, 3003);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "label");
			add_location(div0, file$a, 78, 16, 2640);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$a, 89, 16, 3237);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
...
/* clsSMDragNDrop\libs\authoring\Hotspot.svelte generated by Svelte v3.34.0 */
...
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$b, 82, 20, 2695);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(85:16) {#if data.child.length > 0}",
		ctx
	});
...
// (86:20) {#each data.child as child_data, child_index}
function create_each_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$b, 104, 36, 4029);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$b, 103, 32, 3838);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$b, 107, 36, 4307);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$b, 106, 32, 4141);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "hotspot_click");
			add_location(div0, file$b, 99, 28, 3652);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$b, 110, 28, 4457);
			...
			add_location(div2, file$b, 86, 24, 2973);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(86:20) {#each data.child as child_data, child_index}",
		ctx
	});
...
function create_each_block$b(ctx) {
	...
	const block = {
		c: function create() {
			...
			t5 = space();
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$b, 120, 24, 4882);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$b, 119, 20, 4735);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$b, 123, 24, 5092);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$b, 122, 20, 4970);
			attr_dev(i2, "class", "icomoon-plus");
			add_location(i2, file$b, 126, 24, 5328);
			attr_dev(button2, "type", "button");
			attr_dev(button2, "class", "btn btn-light p-sm");
			add_location(button2, file$b, 125, 20, 5186);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "hotspot");
			add_location(div0, file$b, 115, 16, 4603);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$b, 129, 16, 5429);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
...
/* clsSMDragNDrop\libs\authoring\Menulist.svelte generated by Svelte v3.34.0 */
...
function create_each_block$c(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			attr_dev(i0, "class", "icomoon-24px-edit-1");
			add_location(i0, file$c, 64, 24, 2065);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "btn btn-light p-sm");
			add_location(button0, file$c, 63, 20, 1917);
			attr_dev(i1, "class", "icomoon-new-24px-delete-1");
			add_location(i1, file$c, 67, 24, 2276);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-light p-sm");
			add_location(button1, file$c, 66, 20, 2153);
			attr_dev(div0, "class", "btn-group tools h");
			attr_dev(div0, "data-t", "menulist");
			add_location(div0, file$c, 59, 16, 1784);
			attr_dev(div1, "class", "resizer icomoon-resize");
			add_location(div1, file$c, 70, 16, 2390);
			attr_dev(div2, "key", div2_key_value = /*index*/ ctx[2]);
			attr_dev(div2, "id", div2_id_value = /*data*/ ctx[8].id);
...
/* clsSMDragNDrop\libs\authoring\Tabpills.svelte generated by Svelte v3.34.0 */
...
function create_if_block$d(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$d, 49, 8, 1838);
		},
		m: function mount(target, anchor) {
...
function create_each_block_1$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a, "data-target", a_data_target_value = "#" + /*data*/ ctx[6]._id);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*tab_pills_preview*/ 8 && a_data_target_value !== (a_data_target_value = "#" + /*data*/ ctx[6]._id)) {
...
function create_if_block_1$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$d, 58, 24, 2271);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_each_block$d(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$d, 51, 16, 1972);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
/* clsSMDragNDrop\libs\authoring\Tab.svelte generated by Svelte v3.34.0 */
...
/* clsSMDragNDrop\libs\authoring\Step.svelte generated by Svelte v3.34.0 */
...
/* clsSMDragNDrop\libs\authoring\ModalEvent.svelte generated by Svelte v3.34.0 */
const file$g = "clsSMDragNDrop\\libs\\authoring\\ModalEvent.svelte";

function add_css() {
	var style = element("style");
	style.id = "svelte-1lz0pf1-style";
	style.textContent = "a.svelte-1lz0pf1{text-decoration:none}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiTW9kYWxFdmVudC5zdmVsdGUiLCJtYXBwaW5ncyI6IkFBc0RJLGdCQUFDLENBQUMsQUFDRSxlQUFlLENBQUUsSUFBSSxBQUN6QixDQUFDIiwibmFtZXMiOltdLCJzb3VyY2VzIjpbIk1vZGFsRXZlbnQuc3ZlbHRlIl19 */";
...
function create_fragment$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a0, "class", "list-group-item active svelte-1lz0pf1");
			attr_dev(a0, "href", a0_href_value = "javascript:;");
			add_location(a0, file$g, 14, 12, 441);
			attr_dev(a1, "for", "ondblclick");
			attr_dev(a1, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a1, "href", a1_href_value = "javascript:;");
			add_location(a1, file$g, 15, 12, 541);
			attr_dev(a2, "for", "oncontextmenu");
			attr_dev(a2, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a2, "href", a2_href_value = "javascript:;");
			add_location(a2, file$g, 16, 12, 641);
			attr_dev(a3, "for", "ondragstart");
			attr_dev(a3, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a3, "href", a3_href_value = "javascript:;");
			add_location(a3, file$g, 17, 12, 742);
			attr_dev(a4, "for", "ondrag");
			attr_dev(a4, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a4, "href", a4_href_value = "javascript:;");
			add_location(a4, file$g, 18, 12, 844);
			attr_dev(a5, "for", "ondragend");
			attr_dev(a5, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a5, "href", a5_href_value = "javascript:;");
			add_location(a5, file$g, 19, 12, 935);
			attr_dev(a6, "for", "ondrop");
			attr_dev(a6, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a6, "href", a6_href_value = "javascript:;");
			add_location(a6, file$g, 20, 12, 1033);
			attr_dev(a7, "for", "onmouseover");
			attr_dev(a7, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a7, "href", a7_href_value = "javascript:;");
			add_location(a7, file$g, 21, 12, 1124);
			attr_dev(a8, "for", "onmouseup");
			attr_dev(a8, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a8, "href", a8_href_value = "javascript:;");
			add_location(a8, file$g, 22, 12, 1226);
			attr_dev(a9, "for", "onmousedown");
			attr_dev(a9, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a9, "href", a9_href_value = "javascript:;");
			add_location(a9, file$g, 23, 12, 1324);
			attr_dev(a10, "for", "onchange");
			attr_dev(a10, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a10, "href", a10_href_value = "javascript:;");
			add_location(a10, file$g, 24, 12, 1426);
			attr_dev(a11, "for", "onfocus");
			attr_dev(a11, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a11, "href", a11_href_value = "javascript:;");
			add_location(a11, file$g, 25, 12, 1521);
			attr_dev(a12, "for", "onblur");
			attr_dev(a12, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a12, "href", a12_href_value = "javascript:;");
			add_location(a12, file$g, 26, 12, 1614);
			attr_dev(a13, "for", "onkeyup");
			attr_dev(a13, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a13, "href", a13_href_value = "javascript:;");
			add_location(a13, file$g, 27, 12, 1705);
			attr_dev(a14, "for", "onkeypress");
			attr_dev(a14, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a14, "href", a14_href_value = "javascript:;");
			add_location(a14, file$g, 28, 12, 1799);
			attr_dev(a15, "for", "onkeydown");
			attr_dev(a15, "class", "list-group-item svelte-1lz0pf1");
			attr_dev(a15, "href", a15_href_value = "javascript:;");
			add_location(a15, file$g, 29, 12, 1899);
			attr_dev(div0, "class", "list-group");
			add_location(div0, file$g, 13, 8, 403);
			attr_dev(div1, "class", "row-fluid events");
			set_style(div1, "height", "221px");
			add_location(div1, file$g, 12, 4, 340);
			attr_dev(div2, "class", "clearboth mb-3");
			add_location(div2, file$g, 32, 4, 2017);
			...
			add_location(input0, file$g, 34, 8, 2114);
			...
			add_location(input1, file$g, 35, 8, 2275);
			...
			add_location(input2, file$g, 36, 8, 2443);
			...
			add_location(input3, file$g, 37, 8, 2615);
			...
			add_location(input4, file$g, 38, 8, 2786);
			...
			add_location(input5, file$g, 39, 8, 2941);
			...
			add_location(input6, file$g, 40, 8, 3106);
			...
			add_location(input7, file$g, 41, 8, 3261);
			...
			add_location(input8, file$g, 42, 8, 3432);
			...
			add_location(input9, file$g, 43, 8, 3597);
			...
			add_location(input10, file$g, 44, 8, 3768);
			...
			add_location(input11, file$g, 45, 8, 3929);
			...
			add_location(input12, file$g, 46, 8, 4087);
			...
			add_location(input13, file$g, 47, 8, 4242);
			...
			add_location(input14, file$g, 48, 8, 4401);
			...
			add_location(input15, file$g, 49, 8, 4569);
			attr_dev(div3, "class", "row-fluid margin-top1 event-input");
			add_location(div3, file$g, 33, 4, 2057);
			add_location(div4, file$g, 11, 0, 329);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
class ModalEvent extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-1lz0pf1-style")) add_css();
...
function create_if_block$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label, file$h, 729, 36, 55876);
			...
			add_location(textarea, file$h, 730, 36, 56004);
			attr_dev(div0, "class", "form-group");
			add_location(div0, file$h, 728, 32, 55814);
			attr_dev(div1, "class", "ev");
			attr_dev(div1, "type", "tbd");
			add_location(div1, file$h, 732, 32, 56213);
			attr_dev(div2, "class", "col-sm-6 pr-1 pl-2");
			add_location(div2, file$h, 727, 28, 55748);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
...
function create_fragment$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input1, file$h, 35, 40, 1922);
			attr_dev(div3, "class", "form-group");
			add_location(div3, file$h, 33, 36, 1702);
			attr_dev(div4, "class", "col-sm-3 px-1");
			add_location(div4, file$h, 32, 32, 1637);
			attr_dev(label2, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label2, "for", "drag-top");
			add_location(label2, file$h, 40, 40, 2339);
			attr_dev(input2, "type", "text");
			...
			add_location(input2, file$h, 41, 40, 2480);
			attr_dev(div5, "class", "form-group");
			add_location(div5, file$h, 39, 36, 2273);
			attr_dev(div6, "class", "col-sm-6 px-1");
			add_location(div6, file$h, 38, 32, 2208);
			attr_dev(label3, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label3, "for", "drag-left");
			add_location(label3, file$h, 46, 40, 2871);
			attr_dev(input3, "type", "text");
			...
			add_location(input4, file$h, 53, 40, 3536);
			attr_dev(div9, "class", "form-group");
			add_location(div9, file$h, 51, 36, 3341);
			attr_dev(div10, "class", "col-sm-6 px-1");
			add_location(div10, file$h, 50, 32, 3276);
			attr_dev(label5, "class", "control-label font-weight-normal mb-0");
			attr_dev(label5, "for", "drag-border_color");
			add_location(label5, file$h, 58, 40, 3909);
			option0.__value = "";
			option0.value = option0.__value;
			add_location(option0, file$h, 60, 44, 4184);
			option1.__value = "black";
			option1.value = option1.__value;
			add_location(option1, file$h, 61, 44, 4264);
			option2.__value = "gray";
			option2.value = option2.__value;
			add_location(option2, file$h, 62, 44, 4350);
			attr_dev(select0, "class", "form-select form-select-md");
			attr_dev(select0, "id", "drag-border_color");
			attr_dev(select0, "name", "border_color");
			add_location(select0, file$h, 59, 40, 4052);
			attr_dev(div11, "class", "form-group");
			add_location(div11, file$h, 57, 36, 3843);
			attr_dev(div12, "class", "col-sm-6 px-1");
			add_location(div12, file$h, 56, 32, 3778);
			attr_dev(label6, "class", "control-label font-weight-normal mb-0");
			attr_dev(label6, "for", "drag-name");
			add_location(label6, file$h, 68, 40, 4688);
			attr_dev(input5, "type", "text");
			...
			add_location(input14, file$h, 139, 40, 10456);
			attr_dev(div38, "class", "form-group");
			add_location(div38, file$h, 137, 36, 10247);
			attr_dev(div39, "class", "col-sm-6 px-1");
			add_location(div39, file$h, 136, 32, 10182);
			attr_dev(div40, "class", "row");
			add_location(div40, file$h, 129, 28, 9606);
			attr_dev(label16, "class", "control-label font-weight-normal mb-0");
			attr_dev(label16, "for", "drop-value");
			add_location(label16, file$h, 146, 40, 10926);
			attr_dev(input15, "type", "text");
			...
			add_location(input15, file$h, 147, 40, 11055);
			attr_dev(div41, "class", "form-group");
			add_location(div41, file$h, 145, 36, 10860);
			attr_dev(div42, "class", "col-sm-6 px-1");
			add_location(div42, file$h, 144, 32, 10795);
			attr_dev(label17, "class", "control-label font-weight-normal mb-0");
			attr_dev(label17, "for", "drop-border");
			add_location(label17, file$h, 152, 40, 11421);
			option3.__value = "";
			option3.value = option3.__value;
			add_location(option3, file$h, 154, 44, 11678);
			option4.__value = "black";
			option4.value = option4.__value;
			add_location(option4, file$h, 155, 44, 11758);
			option5.__value = "gray";
			option5.value = option5.__value;
			add_location(option5, file$h, 156, 44, 11844);
			attr_dev(select1, "class", "form-select form-select-md");
			attr_dev(select1, "id", "drop-border");
			attr_dev(select1, "name", "border");
			add_location(select1, file$h, 153, 40, 11558);
			attr_dev(div43, "class", "form-group");
			add_location(div43, file$h, 151, 36, 11355);
			attr_dev(div44, "class", "col-sm-6 px-1");
			add_location(div44, file$h, 150, 32, 11290);
			attr_dev(div45, "class", "row");
			add_location(div45, file$h, 143, 28, 10744);
			attr_dev(label18, "class", "control-label font-weight-normal mb-0");
			attr_dev(label18, "for", "drop-name");
			add_location(label18, file$h, 164, 40, 12265);
			...
			add_location(input18, file$h, 177, 40, 13426);
			attr_dev(div50, "class", "form-group");
			add_location(div50, file$h, 175, 36, 13217);
			attr_dev(div51, "class", "col-sm-12 px-1 d-none");
			add_location(div51, file$h, 174, 32, 13144);
			...
			add_location(input19, file$h, 182, 40, 13812);
			...
			add_location(input22, file$h, 213, 40, 16049);
			attr_dev(div63, "class", "form-group");
			add_location(div63, file$h, 211, 36, 15830);
			attr_dev(div64, "class", "col-sm-6 px-1");
			add_location(div64, file$h, 210, 32, 15765);
			attr_dev(div65, "class", "row");
			add_location(div65, file$h, 203, 28, 15152);
			attr_dev(label25, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label25, "for", "int-top");
			add_location(label25, file$h, 220, 40, 16545);
			...
			add_location(input27, file$h, 247, 40, 18915);
			attr_dev(div75, "class", "form-group");
			add_location(div75, file$h, 245, 36, 18709);
			attr_dev(div76, "class", "col-sm-12 px-1");
			add_location(div76, file$h, 244, 32, 18643);
			attr_dev(label30, "class", "control-label font-weight-normal mb-0");
			attr_dev(label30, "for", "int-type");
			add_location(label30, file$h, 252, 40, 19298);
			option6.__value = "text";
			option6.value = option6.__value;
			option6.selected = "selected";
			add_location(option6, file$h, 254, 44, 19539);
			option7.__value = "password";
			option7.value = option7.__value;
			add_location(option7, file$h, 255, 44, 19647);
			attr_dev(select2, "class", "form-select form-select-md");
			attr_dev(select2, "id", "int-type");
			attr_dev(select2, "name", "type");
			add_location(select2, file$h, 253, 40, 19424);
			attr_dev(div77, "class", "form-group");
			add_location(div77, file$h, 251, 36, 19232);
			attr_dev(div78, "class", "col-sm-6 px-1");
			add_location(div78, file$h, 250, 32, 19167);
			attr_dev(label31, "class", "control-label font-weight-normal mb-0");
			attr_dev(label31, "for", "int-parser");
			add_location(label31, file$h, 261, 40, 19993);
			option8.__value = "";
			option8.value = option8.__value;
			add_location(option8, file$h, 263, 44, 20242);
			option9.__value = "sql";
			option9.value = option9.__value;
			add_location(option9, file$h, 264, 44, 20331);
			attr_dev(select3, "class", "form-select form-select-md");
			attr_dev(select3, "id", "int-parser");
			attr_dev(select3, "name", "parser");
			add_location(select3, file$h, 262, 40, 20123);
			attr_dev(div79, "class", "form-group");
			add_location(div79, file$h, 260, 36, 19927);
			attr_dev(div80, "class", "col-sm-6 px-1");
			add_location(div80, file$h, 259, 32, 19862);
			...
			add_location(input32, file$h, 311, 40, 23850);
			attr_dev(div95, "class", "form-group");
			add_location(div95, file$h, 309, 36, 23631);
			attr_dev(div96, "class", "col-sm-6 px-1");
			add_location(div96, file$h, 308, 32, 23566);
			attr_dev(div97, "class", "row");
			add_location(div97, file$h, 301, 28, 22949);
			attr_dev(label38, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label38, "for", "mlt-top");
			add_location(label38, file$h, 318, 40, 24350);
			...
			add_location(input35, file$h, 345, 40, 26744);
			attr_dev(div107, "class", "form-group");
			add_location(div107, file$h, 343, 36, 26538);
			attr_dev(div108, "class", "col-sm-12 px-1");
			add_location(div108, file$h, 342, 32, 26472);
			attr_dev(label43, "class", "control-label font-weight-normal mb-0");
			attr_dev(label43, "for", "mlt-parser");
			add_location(label43, file$h, 350, 40, 27132);
			option10.__value = "";
			option10.value = option10.__value;
			add_location(option10, file$h, 352, 44, 27381);
			option11.__value = "sql";
			option11.value = option11.__value;
			add_location(option11, file$h, 353, 44, 27476);
			attr_dev(select5, "class", "form-select form-select-md");
			attr_dev(select5, "id", "mlt-parser");
			attr_dev(select5, "name", "parser");
			add_location(select5, file$h, 351, 40, 27262);
			attr_dev(div109, "class", "form-group");
			add_location(div109, file$h, 349, 36, 27066);
			attr_dev(div110, "class", "col-sm-12 px-1");
			add_location(div110, file$h, 348, 32, 27000);
			...
			add_location(input39, file$h, 394, 40, 30420);
			attr_dev(div123, "class", "form-group");
			add_location(div123, file$h, 392, 36, 30201);
			attr_dev(div124, "class", "col-sm-6 px-1");
			add_location(div124, file$h, 391, 32, 30136);
			attr_dev(div125, "class", "row");
			add_location(div125, file$h, 384, 28, 29525);
			attr_dev(label49, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label49, "for", "chk-top");
			add_location(label49, file$h, 401, 40, 30919);
			...
			add_location(input46, file$h, 452, 40, 34823);
			attr_dev(div144, "class", "form-group");
			add_location(div144, file$h, 450, 36, 34605);
			attr_dev(div145, "class", "col-sm-6 px-1");
			add_location(div145, file$h, 449, 32, 34540);
			attr_dev(div146, "class", "row");
			add_location(div146, file$h, 442, 28, 33930);
			attr_dev(label56, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label56, "for", "rd-top");
			add_location(label56, file$h, 459, 40, 35318);
			...
			add_location(input48, file$h, 466, 40, 35983);
			attr_dev(div149, "class", "form-group");
			add_location(div149, file$h, 464, 36, 35776);
			attr_dev(div150, "class", "col-sm-6 px-1");
			add_location(div150, file$h, 463, 32, 35711);
			attr_dev(div151, "class", "row");
			add_location(div151, file$h, 456, 28, 35136);
			attr_dev(label58, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label58, "for", "rd-name");
			add_location(label58, file$h, 473, 40, 36455);
			...
			add_location(input55, file$h, 522, 40, 40248);
			attr_dev(div169, "class", "form-group");
			add_location(div169, file$h, 520, 36, 40029);
			attr_dev(div170, "class", "col-sm-6 px-1");
			add_location(div170, file$h, 519, 32, 39964);
			attr_dev(div171, "class", "row");
			add_location(div171, file$h, 512, 28, 39350);
			attr_dev(label65, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label65, "for", "btn-top");
			add_location(label65, file$h, 529, 40, 40745);
			...
			add_location(input57, file$h, 536, 40, 41414);
			attr_dev(div174, "class", "form-group");
			add_location(div174, file$h, 534, 36, 41206);
			attr_dev(div175, "class", "col-sm-6 px-1");
			add_location(div175, file$h, 533, 32, 41141);
			attr_dev(div176, "class", "row");
			add_location(div176, file$h, 526, 28, 40563);
			attr_dev(label67, "class", "control-label font-weight-normal mb-0");
			attr_dev(label67, "for", "btn-value");
			add_location(label67, file$h, 543, 40, 41888);
			...
			add_location(input58, file$h, 544, 40, 42012);
			attr_dev(div177, "class", "form-group");
			add_location(div177, file$h, 542, 36, 41822);
			attr_dev(div178, "class", "col-sm-12 px-1");
			add_location(div178, file$h, 541, 32, 41756);
			attr_dev(label68, "class", "control-label font-weight-normal mb-0");
			attr_dev(label68, "for", "btn-class");
			add_location(label68, file$h, 549, 40, 42382);
			...
			add_location(input62, file$h, 580, 40, 44595);
			attr_dev(div190, "class", "form-group");
			add_location(div190, file$h, 578, 36, 44376);
			attr_dev(div191, "class", "col-sm-6 px-1");
			add_location(div191, file$h, 577, 32, 44311);
			attr_dev(div192, "class", "row");
			add_location(div192, file$h, 570, 28, 43695);
			attr_dev(label72, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label72, "for", "ddn-top");
			add_location(label72, file$h, 587, 40, 45094);
			...
			add_location(input64, file$h, 594, 40, 45765);
			attr_dev(div195, "class", "form-group");
			add_location(div195, file$h, 592, 36, 45557);
			attr_dev(div196, "class", "col-sm-6 px-1");
			add_location(div196, file$h, 591, 32, 45492);
			attr_dev(div197, "class", "row");
			add_location(div197, file$h, 584, 28, 44912);
			attr_dev(label74, "class", "control-label font-weight-normal mb-0");
			attr_dev(label74, "for", "ddn-value");
			add_location(label74, file$h, 601, 40, 46241);
			...
			add_location(input67, file$h, 632, 40, 48462);
			attr_dev(div209, "class", "form-group");
			add_location(div209, file$h, 630, 36, 48243);
			attr_dev(div210, "class", "col-sm-6 px-1");
			add_location(div210, file$h, 629, 32, 48178);
			attr_dev(div211, "class", "row");
			add_location(div211, file$h, 622, 28, 47563);
			attr_dev(label78, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label78, "for", "lst-top");
			add_location(label78, file$h, 639, 40, 48960);
			...
			add_location(input69, file$h, 646, 40, 49630);
			attr_dev(div214, "class", "form-group");
			add_location(div214, file$h, 644, 36, 49422);
			attr_dev(div215, "class", "col-sm-6 px-1");
			add_location(div215, file$h, 643, 32, 49357);
			attr_dev(div216, "class", "row");
			add_location(div216, file$h, 636, 28, 48778);
			attr_dev(label80, "class", "control-label font-weight-normal mb-0");
			attr_dev(label80, "for", "lst-value");
			add_location(label80, file$h, 653, 40, 50105);
			...
			add_location(textarea11, file$h, 654, 40, 50235);
			attr_dev(div217, "class", "form-group");
			add_location(div217, file$h, 652, 36, 50039);
			attr_dev(div218, "class", "col-sm-12 px-1");
			add_location(div218, file$h, 651, 32, 49973);
			...
			add_location(input74, file$h, 692, 40, 53042);
			attr_dev(div230, "class", "form-group");
			add_location(div230, file$h, 690, 36, 52823);
			attr_dev(div231, "class", "col-sm-6 px-1");
			add_location(div231, file$h, 689, 32, 52758);
			attr_dev(div232, "class", "row");
			add_location(div232, file$h, 682, 28, 52143);
			attr_dev(label85, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label85, "for", "tbd-top");
			add_location(label85, file$h, 699, 40, 53540);
			...
			add_location(input76, file$h, 706, 40, 54210);
			attr_dev(div235, "class", "form-group");
			add_location(div235, file$h, 704, 36, 54002);
			attr_dev(div236, "class", "col-sm-6 px-1");
			add_location(div236, file$h, 703, 32, 53937);
			attr_dev(div237, "class", "row");
			add_location(div237, file$h, 696, 28, 53358);
			attr_dev(label87, "class", "control-label font-weight-normal mb-0");
			attr_dev(label87, "for", "tbd-title");
			add_location(label87, file$h, 713, 40, 54685);
			...
			add_location(input77, file$h, 714, 40, 54813);
			attr_dev(div238, "class", "form-group");
			add_location(div238, file$h, 712, 36, 54619);
			attr_dev(div239, "class", "col-sm-12 px-1");
			add_location(div239, file$h, 711, 32, 54553);
			attr_dev(label88, "class", "control-label font-weight-normal mb-0");
			attr_dev(label88, "for", "tbd-class");
			add_location(label88, file$h, 719, 40, 55184);
			...
			add_location(input81, file$h, 752, 40, 57506);
			attr_dev(div248, "class", "form-group");
			add_location(div248, file$h, 750, 36, 57287);
			attr_dev(div249, "class", "col-sm-6 px-1");
			add_location(div249, file$h, 749, 32, 57222);
			attr_dev(div250, "class", "row");
			add_location(div250, file$h, 742, 28, 56609);
			attr_dev(label91, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label91, "for", "img-top");
			add_location(label91, file$h, 759, 40, 58002);
			...
			add_location(input83, file$h, 766, 40, 58670);
			attr_dev(div253, "class", "form-group");
			add_location(div253, file$h, 764, 36, 58462);
			attr_dev(div254, "class", "col-sm-6 px-1");
			add_location(div254, file$h, 763, 32, 58397);
			attr_dev(div255, "class", "row");
			add_location(div255, file$h, 756, 28, 57820);
			attr_dev(label93, "class", "control-label font-weight-normal mb-0");
			attr_dev(label93, "for", "img-title");
			add_location(label93, file$h, 773, 40, 59143);
			...
			add_location(input84, file$h, 774, 40, 59271);
			attr_dev(div256, "class", "form-group");
			add_location(div256, file$h, 772, 36, 59077);
			attr_dev(div257, "class", "col-sm-12 px-1");
			add_location(div257, file$h, 771, 32, 59011);
			attr_dev(label94, "class", "control-label font-weight-normal mb-0");
			attr_dev(label94, "for", "img-bgimg");
			add_location(label94, file$h, 779, 40, 59640);
			...
			add_location(input90, file$h, 822, 40, 62935);
			attr_dev(div273, "class", "form-group");
			add_location(div273, file$h, 820, 36, 62727);
			attr_dev(div274, "class", "col-sm-6 px-1");
			add_location(div274, file$h, 819, 32, 62662);
			attr_dev(label100, "class", "control-label font-weight-normal mb-0");
			attr_dev(label100, "for", "lbl-title");
			add_location(label100, file$h, 827, 40, 63325);
			...
			add_location(input91, file$h, 828, 40, 63453);
			attr_dev(div275, "class", "form-group");
			add_location(div275, file$h, 826, 36, 63259);
			attr_dev(div276, "class", "col-sm-12 px-1");
			add_location(div276, file$h, 825, 32, 63193);
			attr_dev(label101, "class", "control-label font-weight-normal mb-0");
			attr_dev(label101, "for", "lbl_border_size");
			add_location(label101, file$h, 833, 40, 63821);
			option12.__value = "0";
			option12.value = option12.__value;
			add_location(option12, file$h, 835, 44, 64100);
			option13.__value = "1";
			option13.value = option13.__value;
			add_location(option13, file$h, 836, 44, 64181);
			option14.__value = "2";
			option14.value = option14.__value;
			add_location(option14, file$h, 837, 44, 64255);
			option15.__value = "3";
			option15.value = option15.__value;
			add_location(option15, file$h, 838, 44, 64329);
			option16.__value = "4";
			option16.value = option16.__value;
			add_location(option16, file$h, 839, 44, 64403);
			option17.__value = "5";
			option17.value = option17.__value;
			add_location(option17, file$h, 840, 44, 64477);
			attr_dev(select7, "id", "lbl_border_size");
			attr_dev(select7, "class", "form-select form-select-md height_34");
			attr_dev(select7, "name", "border_size");
			add_location(select7, file$h, 834, 40, 63961);
			attr_dev(div277, "class", "form-group");
			add_location(div277, file$h, 832, 36, 63755);
			attr_dev(div278, "class", "col-sm-4 px-1");
			add_location(div278, file$h, 831, 32, 63690);
			attr_dev(label102, "class", "control-label font-weight-normal mb-0");
			attr_dev(label102, "for", "lbl_border_color");
			add_location(label102, file$h, 846, 40, 64805);
			option18.__value = "white";
			option18.value = option18.__value;
			add_location(option18, file$h, 848, 44, 65084);
			option19.__value = "black";
			option19.value = option19.__value;
			add_location(option19, file$h, 849, 44, 65169);
			option20.__value = "blue";
			option20.value = option20.__value;
			add_location(option20, file$h, 850, 44, 65255);
			option21.__value = "green";
			option21.value = option21.__value;
			add_location(option21, file$h, 851, 44, 65339);
			option22.__value = "red";
			option22.value = option22.__value;
			add_location(option22, file$h, 852, 44, 65425);
			attr_dev(select8, "id", "lbl_border_color");
			attr_dev(select8, "class", "form-select form-select-md height_34");
			attr_dev(select8, "name", "border_color");
			add_location(select8, file$h, 847, 40, 64943);
			attr_dev(div279, "class", "form-group");
			add_location(div279, file$h, 845, 36, 64739);
			attr_dev(div280, "class", "col-sm-4 px-1");
			add_location(div280, file$h, 844, 32, 64674);
			attr_dev(label103, "class", "control-label font-weight-normal mb-0");
			attr_dev(label103, "for", "lbl_background_color");
			add_location(label103, file$h, 858, 40, 65761);
			option23.__value = "";
			option23.value = option23.__value;
			add_location(option23, file$h, 860, 44, 66052);
			option24.__value = "#c5d0fa";
			option24.value = option24.__value;
			add_location(option24, file$h, 861, 44, 66132);
			option25.__value = "#ffa354";
			option25.value = option25.__value;
			add_location(option25, file$h, 862, 44, 66228);
			option26.__value = "#f5785d";
			option26.value = option26.__value;
			add_location(option26, file$h, 863, 44, 66324);
			attr_dev(select9, "id", "lbl_background_color");
			attr_dev(select9, "class", "form-select form-select-md height_34");
			attr_dev(select9, "name", "background_color");
			add_location(select9, file$h, 859, 40, 65903);
			attr_dev(input92, "type", "hidden");
			attr_dev(input92, "id", "lbl-id");
			attr_dev(input92, "name", "id");
			add_location(input92, file$h, 865, 40, 66466);
			attr_dev(div281, "class", "form-group");
			add_location(div281, file$h, 857, 36, 65695);
			attr_dev(div282, "class", "col-sm-4 px-1");
			add_location(div282, file$h, 856, 32, 65630);
			attr_dev(label104, "class", "font-weight-normal mb-0");
			attr_dev(label104, "for", "label_class");
			add_location(label104, file$h, 870, 40, 66761);
			attr_dev(select10, "class", "form-select form-select-md");
			attr_dev(select10, "id", "label_class");
			attr_dev(select10, "name", "label_class");
			add_location(select10, file$h, 871, 40, 66882);
			attr_dev(div283, "class", "form-group");
			add_location(div283, file$h, 869, 36, 66695);
			attr_dev(div284, "class", "col-sm-12 px-1");
			add_location(div284, file$h, 868, 32, 66629);
			...
			add_location(input97, file$h, 919, 40, 70305);
			attr_dev(div301, "class", "form-group");
			add_location(div301, file$h, 917, 36, 70096);
			attr_dev(div302, "class", "col-sm-3 px-1");
			add_location(div302, file$h, 916, 32, 70031);
			attr_dev(div303, "class", "row");
			add_location(div303, file$h, 897, 28, 68323);
			attr_dev(label110, "class", "control-label font-weight-normal mb-0");
			attr_dev(label110, "for", "area-matrix");
			add_location(label110, file$h, 926, 40, 70777);
			...
			add_location(input99, file$h, 933, 40, 71422);
			attr_dev(div306, "class", "form-group");
			add_location(div306, file$h, 931, 36, 71213);
			attr_dev(div307, "class", "col-sm-6 px-1");
			add_location(div307, file$h, 930, 32, 71148);
			attr_dev(div308, "class", "row");
			add_location(div308, file$h, 923, 28, 70595);
			attr_dev(label112, "class", "control-label font-weight-normal mb-0");
			attr_dev(label112, "for", "area-defaultans");
			add_location(label112, file$h, 940, 40, 71881);
			...
			add_location(input105, file$h, 976, 40, 74663);
			attr_dev(div322, "class", "form-group");
			add_location(div322, file$h, 974, 36, 74455);
			attr_dev(div323, "class", "col-sm-3 px-1");
			add_location(div323, file$h, 973, 32, 74390);
			attr_dev(div324, "class", "row");
			add_location(div324, file$h, 954, 28, 72676);
			attr_dev(label117, "class", "control-label font-weight-normal mb-0");
			attr_dev(label117, "for", "mnl-matrix");
			add_location(label117, file$h, 983, 40, 75138);
			...
			add_location(input107, file$h, 990, 40, 75784);
			attr_dev(div327, "class", "form-group");
			add_location(div327, file$h, 988, 36, 75576);
			attr_dev(div328, "class", "col-sm-6 px-1");
			add_location(div328, file$h, 987, 32, 75511);
			attr_dev(div329, "class", "row");
			add_location(div329, file$h, 980, 28, 74956);
			attr_dev(label119, "class", "control-label font-weight-normal mb-0");
			attr_dev(label119, "for", "mnl-value");
			add_location(label119, file$h, 997, 40, 76246);
			...
			add_location(input113, file$h, 1033, 40, 79011);
			attr_dev(div343, "class", "form-group");
			add_location(div343, file$h, 1031, 36, 78803);
			attr_dev(div344, "class", "col-sm-3 px-1");
			add_location(div344, file$h, 1030, 32, 78738);
			attr_dev(div345, "class", "row");
			add_location(div345, file$h, 1011, 28, 77026);
			attr_dev(label124, "class", "control-label font-weight-normal mb-0");
			attr_dev(label124, "for", "hpt-title");
			add_location(label124, file$h, 1040, 40, 79485);
			...
			add_location(input114, file$h, 1041, 40, 79613);
			attr_dev(div346, "class", "form-group");
			add_location(div346, file$h, 1039, 36, 79419);
			attr_dev(div347, "class", "col-sm-6 px-1");
			add_location(div347, file$h, 1038, 32, 79354);
			attr_dev(label125, "class", "control-label font-weight-normal mb-0");
			attr_dev(label125, "for", "hpt-name");
			add_location(label125, file$h, 1046, 40, 79983);
			...
			add_location(input115, file$h, 1047, 40, 80114);
			attr_dev(div348, "class", "form-group");
			add_location(div348, file$h, 1045, 36, 79917);
			attr_dev(div349, "class", "col-sm-6 px-1");
			add_location(div349, file$h, 1044, 32, 79852);
			attr_dev(div350, "class", "row");
			add_location(div350, file$h, 1037, 28, 79303);
			attr_dev(label126, "class", "control-label font-weight-normal mb-0");
			attr_dev(label126, "for", "hpt-targetimg");
			add_location(label126, file$h, 1054, 40, 80564);
			...
			add_location(input116, file$h, 1055, 40, 80701);
			attr_dev(div351, "class", "form-group");
			add_location(div351, file$h, 1053, 36, 80498);
			attr_dev(div352, "class", "col-sm-6 px-1");
			add_location(div352, file$h, 1052, 32, 80433);
			...
			add_location(input124, file$h, 1109, 40, 84758);
			attr_dev(div371, "class", "form-group");
			add_location(div371, file$h, 1107, 36, 84564);
			attr_dev(div372, "class", "col-sm-6 px-1");
			add_location(div372, file$h, 1106, 32, 84499);
			attr_dev(label133, "class", "control-label font-weight-normal mb-0");
			attr_dev(label133, "for", "tab-alt");
			add_location(label133, file$h, 1114, 40, 85142);
			...
			add_location(input125, file$h, 1115, 40, 85271);
			attr_dev(div373, "class", "form-group");
			add_location(div373, file$h, 1113, 36, 85076);
			attr_dev(div374, "class", "col-sm-6 px-1");
			add_location(div374, file$h, 1112, 32, 85011);
			attr_dev(div375, "class", "row");
			add_location(div375, file$h, 1105, 28, 84448);
			attr_dev(label134, "class", "control-label font-weight-normal mb-0");
			attr_dev(label134, "for", "tab-bgimg");
			add_location(label134, file$h, 1122, 40, 85716);
			...
			add_location(input126, file$h, 1123, 40, 85855);
			attr_dev(div376, "class", "form-group");
			add_location(div376, file$h, 1121, 36, 85650);
			attr_dev(button2, "type", "button");
			...
			add_location(button2, file$h, 1125, 36, 86051);
			attr_dev(div377, "class", "col-sm-6 px-1");
			add_location(div377, file$h, 1120, 32, 85585);
			...
			add_location(input129, file$h, 1145, 40, 87482);
			attr_dev(div384, "class", "form-group");
			add_location(div384, file$h, 1143, 36, 87276);
			...
			add_location(input130, file$h, 1152, 40, 88153);
			attr_dev(div386, "class", "form-group");
			add_location(div386, file$h, 1150, 36, 87958);
			attr_dev(div387, "class", "col-sm-6 px-1");
			add_location(div387, file$h, 1149, 32, 87893);
			attr_dev(div388, "class", "row");
			add_location(div388, file$h, 1141, 28, 87160);
			...
			add_location(input134, file$h, 1181, 40, 90198);
			attr_dev(div397, "class", "form-group");
			add_location(div397, file$h, 1179, 36, 89978);
			attr_dev(div398, "class", "col-sm-4 px-1");
			add_location(div398, file$h, 1178, 32, 89913);
			attr_dev(label141, "class", "control-label font-weight-normal mb-0");
			attr_dev(label141, "for", "base-bgimg-alt");
			add_location(label141, file$h, 1186, 40, 90593);
			...
			add_location(input135, file$h, 1187, 40, 90732);
			attr_dev(div399, "class", "form-group");
			add_location(div399, file$h, 1185, 36, 90527);
			attr_dev(div400, "class", "col-sm-4 px-1");
			add_location(div400, file$h, 1184, 32, 90462);
			attr_dev(div401, "class", "row");
			add_location(div401, file$h, 1171, 28, 89318);
			attr_dev(label142, "class", "control-label font-weight-normal mb-0");
			attr_dev(label142, "for", "base-bgimg");
			add_location(label142, file$h, 1194, 40, 91185);
			...
			add_location(input136, file$h, 1195, 40, 91325);
			attr_dev(div402, "class", "form-group");
			add_location(div402, file$h, 1193, 36, 91119);
			attr_dev(div403, "class", "col-sm-6 px-1");
			add_location(div403, file$h, 1192, 32, 91054);
			attr_dev(button4, "type", "button");
			attr_dev(button4, "id", "upload_media");
			attr_dev(button4, "class", "btn btn-outline-primary float-start");
			add_location(button4, file$h, 1199, 36, 91654);
			...
			add_location(input137, file$h, 1201, 40, 91889);
			...
			add_location(label143, file$h, 1202, 40, 92127);
			attr_dev(div404, "class", "form-group float-start mt-2");
			add_location(div404, file$h, 1200, 36, 91806);
			attr_dev(div405, "class", "col-sm-6 mt-3 pt-1 px-1");
			add_location(div405, file$h, 1198, 32, 91579);
			attr_dev(div406, "class", "row");
			add_location(div406, file$h, 1191, 28, 91003);
			attr_dev(div407, "class", "col-sm-12");
			add_location(div407, file$h, 1170, 24, 89265);
			attr_dev(div408, "class", "row mx-0");
			add_location(div408, file$h, 1169, 20, 89217);
			attr_dev(div409, "class", "base h");
			add_location(div409, file$h, 1168, 16, 89175);
			...
			add_location(input141, file$h, 1239, 40, 94917);
			attr_dev(div418, "class", "form-group");
			add_location(div418, file$h, 1237, 36, 94700);
			attr_dev(div419, "class", "col-sm-6 px-1");
			add_location(div419, file$h, 1236, 32, 94635);
			attr_dev(div420, "class", "row");
			add_location(div420, file$h, 1229, 28, 94043);
			attr_dev(label148, "class", "control-label font-weight-normal mb-0");
			attr_dev(label148, "for", "choicematrix-name");
			add_location(label148, file$h, 1246, 40, 95396);
...
class DndModalBox extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-16t69t-style")) add_css$1();
		init(this, options, instance$h, create_fragment$h, safe_not_equal, { isDNDExtended: 0, imgBorder: 1 });
...
/* clsSMDragNDrop\DragNDrop.svelte generated by Svelte v3.34.0 */
...
function add_css$2() {
	var style = element("style");
	style.id = "svelte-dt0ps7-style";
	style.textContent = "#resizeX.svelte-dt0ps7{position:absolute;top:0;right:0;width:3px;opacity:1;height:100%;cursor:w-resize}#resizeY.svelte-dt0ps7{position:absolute;bottom:0;width:100%;height:3px;opacity:1;cursor:s-resize}#resizeXY.svelte-dt0ps7{position:absolute;bottom:0;right:0;opacity:1;cursor:se-resize}#resizeXY.svelte-dt0ps7::before{content:'\\e354'\r\n    }\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
// (808:2) {#if step && step.length}
function create_if_block_2$2(ctx) {
	let each_1_anchor;
	let each_value = /*step*/ ctx[6];
	validate_each_argument(each_value);
	let each_blocks = [];
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*step, state, DND_AUTH, changeStep*/ 8388) {
				each_value = /*step*/ ctx[6];
				validate_each_argument(each_value);
				let i;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(808:2) {#if step && step.length}",
		ctx
	});
...
// (810:16) {#if (data._display == "1" || data._ddisplay == '1') && state.store.updated == false}
function create_if_block_3(ctx) {
	let t_value = /*changeStep*/ ctx[13](/*data*/ ctx[54]._id) + "";
	let t;
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*step*/ 64 && t_value !== (t_value = /*changeStep*/ ctx[13](/*data*/ ctx[54]._id) + "")) set_data_dev(t, t_value);
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(t);
		}
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(810:16) {#if (data._display == \\\"1\\\" || data._ddisplay == '1') && state.store.updated == false}",
		ctx
	});
...
function create_each_block$g(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = (/*data*/ ctx[54]._display == "1" || /*data*/ ctx[54]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false && create_if_block_3(ctx);

	function click_handler_1() {
		return /*click_handler_1*/ ctx[24](/*data*/ ctx[54]);
	}
	...
	const block = {
		c: function create() {
			...
			t2 = text(t2_value);
			t3 = space();
			attr_dev(input, "id", input_id_value = "step_" + /*data*/ ctx[54]._id);
			attr_dev(input, "type", "radio");
			attr_dev(input, "defaultvalue", "1");
			attr_dev(input, "name", "rbsAuth");
			attr_dev(input, "class", "baseradio dndradio svelte-dt0ps7");

			attr_dev(input, "defaultchecked", input_defaultchecked_value = (/*data*/ ctx[54]._display == "1" || /*data*/ ctx[54]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false
			? true
			: false);

			add_location(input, file$i, 813, 5, 33770);
			attr_dev(span, "for", span_for_value = /*data*/ ctx[54]._id);
			attr_dev(span, "key", span_key_value = /*data*/ ctx[54]._id);
			add_location(span, file$i, 812, 4, 33727);
		},
		m: function mount(target, anchor) {
			if (if_block) if_block.m(target, anchor);
		...
		p: function update(new_ctx, dirty) {
			...
			if ((/*data*/ ctx[54]._display == "1" || /*data*/ ctx[54]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false) {
				if (if_block) {
					if_block.p(ctx, dirty);
				} else {
			...
			if (dirty[0] & /*step*/ 64 && input_id_value !== (input_id_value = "step_" + /*data*/ ctx[54]._id)) {
				attr_dev(input, "id", input_id_value);
			}

			if (dirty[0] & /*step, state*/ 192 && input_defaultchecked_value !== (input_defaultchecked_value = (/*data*/ ctx[54]._display == "1" || /*data*/ ctx[54]._ddisplay == "1") && /*state*/ ctx[7].store.updated == false
			? true
			: false)) {
				attr_dev(input, "defaultchecked", input_defaultchecked_value);
			}

			if (dirty[0] & /*step*/ 64 && t2_value !== (t2_value = /*data*/ ctx[54]._id + "")) set_data_dev(t2, t2_value);

			if (dirty[0] & /*step*/ 64 && span_for_value !== (span_for_value = /*data*/ ctx[54]._id)) {
				attr_dev(span, "for", span_for_value);
			}

			if (dirty[0] & /*step*/ 64 && span_key_value !== (span_key_value = /*data*/ ctx[54]._id)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(809:3) {#each step as data}",
		ctx
	});
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 844, 16, 35260);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			img = element("img");
			attr_dev(img, "height", img_height_value = /*imgHeight*/ ctx[4] + "px");
			attr_dev(img, "width", img_width_value = /*imgWidth*/ ctx[5] + "px");
			if (img.src !== (img_src_value = "https://s3.amazonaws.com/jigyaasa_content_static/" + /*bgImg*/ ctx[3])) attr_dev(img, "src", img_src_value);
			attr_dev(img, "class", img_class_value = /*state*/ ctx[7].store.borderclass);

			attr_dev(img, "alt", img_alt_value = /*state*/ ctx[7].store.alt
			? /*state*/ ctx[7].store.alt
			: l.sample_img);

			add_location(img, file$i, 842, 16, 34957);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
			...
			if (!mounted) {
				dispose = [
					listen_dev(img, "error", /*checkError*/ ctx[12], false, false, false),
					listen_dev(img, "load", /*load_handler*/ ctx[26], false, false, false)
				];
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*imgHeight*/ 16 && img_height_value !== (img_height_value = /*imgHeight*/ ctx[4] + "px")) {
				attr_dev(img, "height", img_height_value);
			}

			if (dirty[0] & /*imgWidth*/ 32 && img_width_value !== (img_width_value = /*imgWidth*/ ctx[5] + "px")) {
				attr_dev(img, "width", img_width_value);
			}

			if (dirty[0] & /*bgImg*/ 8 && img.src !== (img_src_value = "https://s3.amazonaws.com/jigyaasa_content_static/" + /*bgImg*/ ctx[3])) {
				attr_dev(img, "src", img_src_value);
			}

			if (dirty[0] & /*state*/ 128 && img_class_value !== (img_class_value = /*state*/ ctx[7].store.borderclass)) {
				attr_dev(img, "class", img_class_value);
			}

			if (dirty[0] & /*state*/ 128 && img_alt_value !== (img_alt_value = /*state*/ ctx[7].store.alt
			? /*state*/ ctx[7].store.alt
			: l.sample_img)) {
				attr_dev(img, "alt", img_alt_value);
			}
...
// (847:12) {#if state.data && image_loaded}
function create_if_block$h(ctx) {
	...
	drag0 = new Drag({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].drag,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
		});
	...
	drop0 = new Drop({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].drop,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	radio = new Radio({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].radio,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	select = new Select({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].select,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	textbox = new Textbox({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].textbox,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	multilinebox = new Multilinebox({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].multilinebox,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	checkbox = new Checkbox({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].checkbox,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	button = new Button({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].button,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	tabhead = new Tabhead({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].tabhead,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	img = new Img({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].img,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	label = new Label({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].label,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	hotspot = new Hotspot({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].hotspot,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	menulist = new Menulist({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].menulist,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem
			},
			$$inline: true
	...
	step_1 = new Step({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].step,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem,
				checkImageStatus: /*checkImageStatus*/ ctx[11]
			},
			$$inline: true
		});
	...
	tab = new Tab({
			props: {
				index: 0,
				modules: /*state*/ ctx[7].data[0].tab,
				elemModal: /*DND_AUTH*/ ctx[2].elemModal,
				deleteElem: /*DND_AUTH*/ ctx[2].deleteElem,
				checkImageStatus: /*checkImageStatus*/ ctx[11]
			},
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 847, 16, 35484);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		...
		p: function update(ctx, dirty) {
			const drag0_changes = {};
			if (dirty[0] & /*state*/ 128) drag0_changes.modules = /*state*/ ctx[7].data[0].drag;
			if (dirty[0] & /*DND_AUTH*/ 4) drag0_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) drag0_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			drag0.$set(drag0_changes);
			const drag1_changes = {};
			if (dirty[0] & /*state*/ 128) drag1_changes.modules = /*state*/ ctx[7].data[1];
			if (dirty[0] & /*DND_AUTH*/ 4) drag1_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) drag1_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			drag1.$set(drag1_changes);
			const drop0_changes = {};
			if (dirty[0] & /*state*/ 128) drop0_changes.modules = /*state*/ ctx[7].data[0].drop;
			if (dirty[0] & /*DND_AUTH*/ 4) drop0_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) drop0_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			drop0.$set(drop0_changes);
			const drop1_changes = {};
			if (dirty[0] & /*state*/ 128) drop1_changes.modules = /*state*/ ctx[7].data[2];
			if (dirty[0] & /*DND_AUTH*/ 4) drop1_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) drop1_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			drop1.$set(drop1_changes);
			const radio_changes = {};
			if (dirty[0] & /*state*/ 128) radio_changes.modules = /*state*/ ctx[7].data[0].radio;
			if (dirty[0] & /*DND_AUTH*/ 4) radio_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) radio_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			radio.$set(radio_changes);
			const select_changes = {};
			if (dirty[0] & /*state*/ 128) select_changes.modules = /*state*/ ctx[7].data[0].select;
			if (dirty[0] & /*DND_AUTH*/ 4) select_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) select_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			select.$set(select_changes);
			const textbox_changes = {};
			if (dirty[0] & /*state*/ 128) textbox_changes.modules = /*state*/ ctx[7].data[0].textbox;
			if (dirty[0] & /*DND_AUTH*/ 4) textbox_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) textbox_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			textbox.$set(textbox_changes);
			const multilinebox_changes = {};
			if (dirty[0] & /*state*/ 128) multilinebox_changes.modules = /*state*/ ctx[7].data[0].multilinebox;
			if (dirty[0] & /*DND_AUTH*/ 4) multilinebox_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) multilinebox_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			multilinebox.$set(multilinebox_changes);
			const checkbox_changes = {};
			if (dirty[0] & /*state*/ 128) checkbox_changes.modules = /*state*/ ctx[7].data[0].checkbox;
			if (dirty[0] & /*DND_AUTH*/ 4) checkbox_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) checkbox_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			checkbox.$set(checkbox_changes);
			const button_changes = {};
			if (dirty[0] & /*state*/ 128) button_changes.modules = /*state*/ ctx[7].data[0].button;
			if (dirty[0] & /*DND_AUTH*/ 4) button_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) button_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			button.$set(button_changes);
			const tabhead_changes = {};
			if (dirty[0] & /*state*/ 128) tabhead_changes.modules = /*state*/ ctx[7].data[0].tabhead;
			if (dirty[0] & /*DND_AUTH*/ 4) tabhead_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) tabhead_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			tabhead.$set(tabhead_changes);
			const img_changes = {};
			if (dirty[0] & /*state*/ 128) img_changes.modules = /*state*/ ctx[7].data[0].img;
			if (dirty[0] & /*DND_AUTH*/ 4) img_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) img_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			img.$set(img_changes);
			const label_changes = {};
			if (dirty[0] & /*state*/ 128) label_changes.modules = /*state*/ ctx[7].data[0].label;
			if (dirty[0] & /*DND_AUTH*/ 4) label_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) label_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			label.$set(label_changes);
			const hotspot_changes = {};
			if (dirty[0] & /*state*/ 128) hotspot_changes.modules = /*state*/ ctx[7].data[0].hotspot;
			if (dirty[0] & /*DND_AUTH*/ 4) hotspot_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) hotspot_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			hotspot.$set(hotspot_changes);
			const menulist_changes = {};
			if (dirty[0] & /*state*/ 128) menulist_changes.modules = /*state*/ ctx[7].data[0].menulist;
			if (dirty[0] & /*DND_AUTH*/ 4) menulist_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) menulist_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			menulist.$set(menulist_changes);
			const step_1_changes = {};
			if (dirty[0] & /*state*/ 128) step_1_changes.modules = /*state*/ ctx[7].data[0].step;
			if (dirty[0] & /*DND_AUTH*/ 4) step_1_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) step_1_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			step_1.$set(step_1_changes);
			const tab_changes = {};
			if (dirty[0] & /*state*/ 128) tab_changes.modules = /*state*/ ctx[7].data[0].tab;
			if (dirty[0] & /*DND_AUTH*/ 4) tab_changes.elemModal = /*DND_AUTH*/ ctx[2].elemModal;
			if (dirty[0] & /*DND_AUTH*/ 4) tab_changes.deleteElem = /*DND_AUTH*/ ctx[2].deleteElem;
			tab.$set(tab_changes);
		},
		i: function intro(local) {
			if (current) return;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(847:12) {#if state.data && image_loaded}",
		ctx
	});
...
function create_fragment$i(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*step*/ ctx[6] && /*step*/ ctx[6].length && create_if_block_2$2(ctx);

	function select_block_type(ctx, dirty) {
		if (/*bgImg*/ ctx[3]) return create_if_block_1$5;
		return create_else_block$1;
	}

	let current_block_type = select_block_type(ctx);
	let if_block1 = current_block_type(ctx);
	let if_block2 = /*state*/ ctx[7].data && /*image_loaded*/ ctx[8] && create_if_block$h(ctx);

	dndmodalbox = new DndModalBox({
			props: {
				isDNDExtended: /*DND_AUTH*/ ctx[2].isDNDExtended,
				imgBorder: /*imgBorder*/ ctx[9]
			},
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 805, 2, 33318);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 804, 4, 33287);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 839, 232, 34850);
			...
			add_location(button0, file$i, 839, 16, 34634);
			attr_dev(div1, "class", "btn-group tools mr-1");
			attr_dev(div1, "data-t", "base");
			add_location(div1, file$i, 838, 12, 34568);
			attr_dev(div2, "id", "resizeX");
			attr_dev(div2, "class", "svelte-dt0ps7");
			add_location(div2, file$i, 868, 12, 37888);
			attr_dev(div3, "id", "resizeY");
			attr_dev(div3, "class", "svelte-dt0ps7");
			add_location(div3, file$i, 870, 12, 38004);
			attr_dev(div4, "id", "resizeXY");
			attr_dev(div4, "class", "icomoon-resize svelte-dt0ps7");
			add_location(div4, file$i, 872, 12, 38120);
			attr_dev(div5, "id", "dndmain");
			attr_dev(div5, "path", "https://s3.amazonaws.com/jigyaasa_content_static/");
			set_style(div5, "height", "400px");
			set_style(div5, "width", "100%");
			add_render_callback(() => /*div5_elementresize_handler*/ ctx[28].call(div5));
			add_location(div5, file$i, 830, 8, 34275);
			add_location(center0, file$i, 828, 4, 34189);
			attr_dev(input1, "type", "hidden");
			attr_dev(input1, "id", "special_module_xml");
			attr_dev(input1, "name", "special_module_xml");
			add_location(input1, file$i, 877, 4, 38302);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "h");
			attr_dev(button1, "id", "update_xml");
			attr_dev(button1, "name", "update_xml");
			add_location(button1, file$i, 878, 4, 38381);
			attr_dev(div6, "class", "smnotes");
			add_location(div6, file$i, 880, 8, 38480);
			add_location(center1, file$i, 879, 4, 38462);
			attr_dev(div7, "class", "parent h");
			attr_dev(div7, "data-parent", "dndmain");
			add_location(div7, file$i, 882, 4, 38528);
			attr_dev(div8, "class", "input_border dragable-container overflow-auto p");
			add_location(div8, file$i, 803, 0, 33220);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			append_dev(div8, t3);
			append_dev(div8, center0);
			append_dev(center0, div5);
			...
			div5_resize_listener = add_resize_listener(div5, /*div5_elementresize_handler*/ ctx[28].bind(div5));
			append_dev(div8, t9);
			append_dev(div8, input1);
			append_dev(div8, t10);
			append_dev(div8, button1);
			append_dev(div8, t11);
			append_dev(div8, center1);
			append_dev(center1, div6);
			append_dev(div8, t12);
			append_dev(div8, div7);
			append_dev(div8, t13);
			mount_component(dndmodalbox, div8, null);
			current = true;

			if (!mounted) {
				dispose = [
					listen_dev(window, "keydown", /*handleKeyDown*/ ctx[14], false, false, false),
					listen_dev(input0, "click", /*click_handler*/ ctx[23], false, false, false),
					listen_dev(button0, "click", /*click_handler_2*/ ctx[25], false, false, false),
					listen_dev(div2, "mousedown", stop_propagation(prevent_default(/*resizeHandleW*/ ctx[16])), false, true, true),
					listen_dev(div3, "mousedown", stop_propagation(prevent_default(/*resizeHandleH*/ ctx[17])), false, true, true),
					listen_dev(div4, "mousedown", stop_propagation(prevent_default(/*resizeHandleWH*/ ctx[18])), false, true, true)
				];
		...
		p: function update(ctx, dirty) {
			if (/*step*/ ctx[6] && /*step*/ ctx[6].length) {
				if (if_block0) {
					if_block0.p(ctx, dirty);
				} else {
			...
			if (/*state*/ ctx[7].data && /*image_loaded*/ ctx[8]) {
				if (if_block2) {
					if_block2.p(ctx, dirty);

					if (dirty[0] & /*state, image_loaded*/ 384) {
			...
			if (dirty[0] & /*DND_AUTH*/ 4) dndmodalbox_changes.isDNDExtended = /*DND_AUTH*/ ctx[2].isDNDExtended;
			if (dirty[0] & /*imgBorder*/ 512) dndmodalbox_changes.imgBorder = /*imgBorder*/ ctx[9];
...
function instance$i($$self, $$props, $$invalidate) {
	...
	const unsubscribe = auth_store.subscribe(value => {
		$$invalidate(7, state.store = value, state);
	});
	...
	function bindEvents() {
		...
		AH.listen("body", "hidden.bs.modal", "#authoring-modal", function () {
			$$invalidate(2, DND_AUTH.visible_class = "", DND_AUTH);
			$$invalidate(2, DND_AUTH.error_message = "", DND_AUTH);
		});
	...
	function toggleBtn(current) {
		if (current.value.trim() != "") {
			...
			$$invalidate(2, DND_AUTH.error_message = l.required_field, DND_AUTH);
			AH.select("#authoring-modal .errorBtn", "removeClass", "h");
			AH.select("#authoring-modal .addElement", "addClass", "h");
		}
	}
	...
	function loadModule(loadXml) {
		...
		$$invalidate(7, state.data = loadNestedModule(QXML.smxml), state);
	...
	function initialize() {
		...
		if (dndmain.nodeName && IS_EVENT_CALLED) {
			...
			$$invalidate(2, DND_AUTH.isDNDExtended = checkDndExtended(), DND_AUTH);
	...
	function parseXMLAuthoring(MYXML) {
		...
		$$invalidate(3, bgImg = MYXML.smxml._bgimg);

		module_type = MYXML.smxml._type || 1;
		$$invalidate(4, imgHeight = MYXML.smxml._height);
		$$invalidate(5, imgWidth = MYXML.smxml._width);
		$$invalidate(9, imgBorder = MYXML.smxml._borderrequired == undefined ? 0 : 1);
		...
		$$invalidate(6, step = MYXML.smxml.step);

		if (Array.isArray(step) == false && step) {
			$$invalidate(6, step = []);
			$$invalidate(6, step[0] = MYXML.smxml.step, step);
		}
	}
	...
	function resizeX(e) {
		let dx = m_posX - e.x;
		$$invalidate(21, m_posX = e.x);
		const width = parseInt(getComputedStyle(dndMain, "").width) - dx;
		$$invalidate(10, dndMain.style.width = width + "px", dndMain);
		$$invalidate(5, imgWidth = width);
	}

	function resizeY(e) {
		let dy = m_posY - e.y;
		$$invalidate(22, m_posY = e.y);
		const height = parseInt(getComputedStyle(dndMain, "").height) - dy;
		$$invalidate(10, dndMain.style.height = height + "px", dndMain);
		$$invalidate(4, imgHeight = height);
	}
	...
	function div5_elementresize_handler() {
		...
		$$invalidate(0, baseWidth);
		$$invalidate(1, baseHeight);
	}

	$$self.$$set = $$props => {
		if ("xml" in $$props) $$invalidate(19, xml = $$props.xml);
		if ("getChildXml" in $$props) $$invalidate(20, getChildXml = $$props.getChildXml);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ("imgHeight" in $$props) $$invalidate(4, imgHeight = $$props.imgHeight);
		if ("imgWidth" in $$props) $$invalidate(5, imgWidth = $$props.imgWidth);
		...
		if ("image_loaded" in $$props) $$invalidate(8, image_loaded = $$props.image_loaded);
		if ("imgBorder" in $$props) $$invalidate(9, imgBorder = $$props.imgBorder);
		if ("auth_store" in $$props) auth_store = $$props.auth_store;
		if ("baseWidth" in $$props) $$invalidate(0, baseWidth = $$props.baseWidth);
		if ("isresizerClicked" in $$props) isresizerClicked = $$props.isresizerClicked;
		if ("baseHeight" in $$props) $$invalidate(1, baseHeight = $$props.baseHeight);
		if ("m_posX" in $$props) $$invalidate(21, m_posX = $$props.m_posX);
		if ("m_posY" in $$props) $$invalidate(22, m_posY = $$props.m_posY);
		if ("dndMain" in $$props) $$invalidate(10, dndMain = $$props.dndMain);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*baseWidth*/ 1) ;

		if ($$self.$$.dirty[0] & /*baseHeight*/ 2) ;

		if ($$self.$$.dirty[0] & /*baseHeight*/ 2) {
			 $$invalidate(7, state.store.imgHeight = baseHeight, state);
		}

		if ($$self.$$.dirty[0] & /*baseWidth*/ 1) {
			 $$invalidate(7, state.store.imgWidth = baseWidth, state);
		}

		if ($$self.$$.dirty[0] & /*m_posX*/ 2097152) ;

		if ($$self.$$.dirty[0] & /*m_posY*/ 4194304) ;
	};
...
class DragNDrop extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-dt0ps7-style")) add_css$2();
		init(this, options, instance$i, create_fragment$i, safe_not_equal, { xml: 19, getChildXml: 20 }, [-1, -1]);
		...
		if (/*xml*/ ctx[19] === undefined && !("xml" in props)) {
			console_1.warn("<DragNDrop> was created without expected prop 'xml'");
		}

		if (/*getChildXml*/ ctx[20] === undefined && !("getChildXml" in props)) {
...
//# sourceMappingURL=DragNDrop-ee84d63b.js.map
