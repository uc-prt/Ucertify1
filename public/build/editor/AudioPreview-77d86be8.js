...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 525, 24, 26218);
			...
			add_location(span1, file, 542, 28, 27639);
			...
			add_location(button0, file, 534, 24, 27217);
			...
			add_location(span2, file, 553, 28, 28426);
			...
			add_location(button1, file, 544, 24, 27955);
			...
			add_location(span3, file, 568, 28, 29374);
			...
			add_location(button2, file, 555, 24, 28671);
			...
			add_location(div6, file, 533, 20, 27051);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 522, 16, 25913);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 521, 12, 25854);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 517, 62, 25471);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 517, 25, 25434);
			add_location(div0, file, 517, 20, 25429);
			...
			add_location(textarea, file, 518, 20, 25530);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 516, 16, 25382);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 493, 20, 24142);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 492, 16, 24095);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 481, 20, 23589);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 480, 16, 23542);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 582, 20, 30059);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 580, 16, 29882);
			...
			add_location(div3, file, 584, 16, 30283);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 588, 20, 30550);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-77d86be8.js.map
