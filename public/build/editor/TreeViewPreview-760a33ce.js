...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div2, file, 670, 28, 32709);
			attr_dev(div3, "class", "row-fluid tree");
			add_location(div3, file, 631, 24, 29912);
			...
			add_location(div4, file, 620, 20, 29272);
			add_location(center1, file, 619, 16, 29242);
			add_location(div5, file, 608, 12, 28684);
		},
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*ucTree*/ 2) itemhelper_changes.handleReviewClick = /*func*/ ctx[14];
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			add_location(div, file, 606, 12, 28642);
		},
		m: function mount(target, anchor) {
...
function create_if_block_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 624, 36, 29546);
			attr_dev(div1, "class", "span6");
			add_location(div1, file, 623, 32, 29489);
			attr_dev(div2, "class", "heading");
			add_location(div2, file, 627, 36, 29730);
			attr_dev(div3, "class", "span6");
			add_location(div3, file, 626, 32, 29673);
			attr_dev(div4, "class", "row-fluid");
			add_location(div4, file, 622, 28, 29432);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(622:24) {#if !window.inNative}",
		ctx
	});
...
// (633:28) {#if (window.inNative && window.inNative != undefined)}
function create_if_block_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 633, 32, 30059);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(633:28) {#if (window.inNative && window.inNative != undefined)}",
		ctx
	});
...
// (639:40) {#if _listItemCorrect.item.length > 0}
function create_if_block_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(639:40) {#if _listItemCorrect.item.length > 0}",
		ctx
	});
...
function create_else_block_1(ctx) {
	let li;
	let t0_value = /*_listItemCorrect*/ ctx[39].item + "";
	let t0;
	let t1;
	let li_key_value;
	let li_tid_value;
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			attr_dev(li, "key", li_key_value = "treeC_" + /*isRerender*/ ctx[2] + "_" + /*_listItemCorrect*/ ctx[39].ID);
			attr_dev(li, "class", "liItemIndex");
			attr_dev(li, "tid", li_tid_value = /*_listItemCorrect*/ ctx[39].ID);
			attr_dev(li, "correctans", li_correctans_value = /*_listItemCorrect*/ ctx[39].correctAns);
			attr_dev(li, "userans", li_userans_value = /*_listItemCorrect*/ ctx[39].userAns);

			attr_dev(li, "data-jstree", li_data_jstree_value = JSON.stringify({
				opened: true,
				selected: /*_listItemCorrect*/ ctx[39].isParant ? true : false,
				icon: /*getIcon*/ ctx[9](/*_listItemCorrect*/ ctx[39]['level'])
			}));

			add_location(li, file, 650, 48, 31386);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*listItemCorrect*/ 8 && t0_value !== (t0_value = /*_listItemCorrect*/ ctx[39].item + "")) set_data_dev(t0, t0_value);

			if (dirty[0] & /*isRerender, listItemCorrect*/ 12 && li_key_value !== (li_key_value = "treeC_" + /*isRerender*/ ctx[2] + "_" + /*_listItemCorrect*/ ctx[39].ID)) {
				attr_dev(li, "key", li_key_value);
			}

			if (dirty[0] & /*listItemCorrect*/ 8 && li_tid_value !== (li_tid_value = /*_listItemCorrect*/ ctx[39].ID)) {
				attr_dev(li, "tid", li_tid_value);
			}

			if (dirty[0] & /*listItemCorrect*/ 8 && li_correctans_value !== (li_correctans_value = /*_listItemCorrect*/ ctx[39].correctAns)) {
				attr_dev(li, "correctans", li_correctans_value);
			}

			if (dirty[0] & /*listItemCorrect*/ 8 && li_userans_value !== (li_userans_value = /*_listItemCorrect*/ ctx[39].userAns)) {
...
// (640:44) {#if (window.inNative && window.inNative != undefined)}
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(li, file, 640, 48, 30606);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, t0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(640:44) {#if (window.inNative && window.inNative != undefined)}",
		ctx
	});
...
// (638:36) {#each listItemCorrect as _listItemCorrect}
function create_each_block_1(ctx) {
	let if_block_anchor;
	let if_block = /*_listItemCorrect*/ ctx[39].item.length > 0 && create_if_block_2(ctx);
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (/*_listItemCorrect*/ ctx[39].item.length > 0) {
				if (if_block) {
					if_block.p(ctx, dirty);
				} else {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(638:36) {#each listItemCorrect as _listItemCorrect}",
		ctx
	});
...
// (668:28) {#if (AH.isValid(window.inNative))}
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 668, 32, 32579);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(668:28) {#if (AH.isValid(window.inNative))}",
		ctx
	});
...
// (674:40) {#each state.listItemAll as data, i}
function create_each_block(ctx) {
	let li;
	let span0;
	let t0_value = /*data*/ ctx[36].item + "";
	let t0;
	let t1;
	let span1;
	let t2;
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 682, 48, 33644);
			attr_dev(span1, "class", "delete_button");
			add_location(span1, file, 683, 48, 33737);
			attr_dev(li, "key", li_key_value = "trreAll_" + /*isRerender*/ ctx[2] + "_" + /*i*/ ctx[38]);
			attr_dev(li, "class", "liItemIndex");
			attr_dev(li, "tid", li_tid_value = /*data*/ ctx[36].ID);
			attr_dev(li, "seq", li_seq_value = /*data*/ ctx[36].isParant.toString().replace(/,\s|{|}/gmi, ''));
			attr_dev(li, "multi", li_multi_value = /*data*/ ctx[36].multi);

			attr_dev(li, "data-jstree", li_data_jstree_value = JSON.stringify({
				icon: /*getIcon*/ ctx[9](/*data*/ ctx[36].level)
			}));

			add_location(li, file, 674, 44, 33044);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, span0);
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*state*/ 16 && t0_value !== (t0_value = /*data*/ ctx[36].item + "")) set_data_dev(t0, t0_value);

			if (dirty[0] & /*isRerender*/ 4 && li_key_value !== (li_key_value = "trreAll_" + /*isRerender*/ ctx[2] + "_" + /*i*/ ctx[38])) {
				attr_dev(li, "key", li_key_value);
			}

			if (dirty[0] & /*state*/ 16 && li_tid_value !== (li_tid_value = /*data*/ ctx[36].ID)) {
				attr_dev(li, "tid", li_tid_value);
			}

			if (dirty[0] & /*state*/ 16 && li_seq_value !== (li_seq_value = /*data*/ ctx[36].isParant.toString().replace(/,\s|{|}/gmi, ''))) {
				attr_dev(li, "seq", li_seq_value);
			}

			if (dirty[0] & /*state*/ 16 && li_multi_value !== (li_multi_value = /*data*/ ctx[36].multi)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(674:40) {#each state.listItemAll as data, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			main = element("main");
			if_block.c();
			add_location(main, file, 604, 4, 28595);
		},
...
//# sourceMappingURL=TreeViewPreview-760a33ce.js.map
