...
function create_fragment$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div2, file$g, 32, 4, 2000);
			...
			add_location(input0, file$g, 34, 8, 2097);
			...
			add_location(input1, file$g, 35, 8, 2258);
			...
			add_location(input2, file$g, 36, 8, 2426);
			...
			add_location(input3, file$g, 37, 8, 2598);
			...
			add_location(input4, file$g, 38, 8, 2769);
			...
			add_location(input5, file$g, 39, 8, 2924);
			...
			add_location(input6, file$g, 40, 8, 3089);
			...
			add_location(input7, file$g, 41, 8, 3244);
			...
			add_location(input8, file$g, 42, 8, 3415);
			...
			add_location(input9, file$g, 43, 8, 3580);
			...
			add_location(input10, file$g, 44, 8, 3751);
			...
			add_location(input11, file$g, 45, 8, 3912);
			...
			add_location(input12, file$g, 46, 8, 4070);
			...
			add_location(input13, file$g, 47, 8, 4225);
			...
			add_location(input14, file$g, 48, 8, 4384);
			...
			add_location(input15, file$g, 49, 8, 4552);
			attr_dev(div3, "class", "row-fluid margin-top1 event-input");
			add_location(div3, file$g, 33, 4, 2040);
...
function create_if_block$g(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label, file$h, 729, 36, 55859);
			...
			add_location(textarea, file$h, 730, 36, 55987);
			attr_dev(div0, "class", "form-group");
			add_location(div0, file$h, 728, 32, 55797);
			attr_dev(div1, "class", "ev");
			attr_dev(div1, "type", "tbd");
			add_location(div1, file$h, 732, 32, 56196);
			attr_dev(div2, "class", "col-sm-6 pr-1 pl-2");
			add_location(div2, file$h, 727, 28, 55731);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
...
function create_fragment$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option0, file$h, 60, 44, 4167);
			option1.__value = "black";
			option1.value = option1.__value;
			add_location(option1, file$h, 61, 44, 4247);
			option2.__value = "gray";
			option2.value = option2.__value;
			add_location(option2, file$h, 62, 44, 4333);
			...
			add_location(label6, file$h, 68, 40, 4671);
			attr_dev(input5, "type", "text");
			...
			add_location(label10, file$h, 97, 40, 7150);
			...
			add_location(input9, file$h, 104, 40, 7803);
			attr_dev(div25, "class", "form-group");
			add_location(div25, file$h, 102, 36, 7606);
			attr_dev(div26, "class", "col-sm-6 px-1");
			add_location(div26, file$h, 101, 32, 7541);
			attr_dev(div27, "class", "row");
			add_location(div27, file$h, 94, 28, 6968);
			attr_dev(div28, "class", "col-sm-12 d-none");
			add_location(div28, file$h, 93, 24, 6908);
			...
			add_location(input10, file$h, 110, 20, 8127);
			...
			add_location(label12, file$h, 118, 40, 8544);
			attr_dev(input11, "type", "text");
			...
			add_location(input14, file$h, 139, 40, 10439);
			attr_dev(div38, "class", "form-group");
			add_location(div38, file$h, 137, 36, 10230);
			attr_dev(div39, "class", "col-sm-6 px-1");
			add_location(div39, file$h, 136, 32, 10165);
			attr_dev(div40, "class", "row");
			add_location(div40, file$h, 129, 28, 9589);
			attr_dev(label16, "class", "control-label font-weight-normal mb-0");
			attr_dev(label16, "for", "drop-value");
			add_location(label16, file$h, 146, 40, 10909);
			attr_dev(input15, "type", "text");
			...
			add_location(input18, file$h, 177, 40, 13409);
			attr_dev(div50, "class", "form-group");
			add_location(div50, file$h, 175, 36, 13200);
			attr_dev(div51, "class", "col-sm-12 px-1 d-none");
			add_location(div51, file$h, 174, 32, 13127);
			...
			add_location(input19, file$h, 182, 40, 13795);
			...
			add_location(input22, file$h, 213, 40, 16032);
			attr_dev(div63, "class", "form-group");
			add_location(div63, file$h, 211, 36, 15813);
			attr_dev(div64, "class", "col-sm-6 px-1");
			add_location(div64, file$h, 210, 32, 15748);
			attr_dev(div65, "class", "row");
			add_location(div65, file$h, 203, 28, 15135);
			attr_dev(label25, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label25, "for", "int-top");
			add_location(label25, file$h, 220, 40, 16528);
			...
			add_location(input32, file$h, 311, 40, 23833);
			attr_dev(div95, "class", "form-group");
			add_location(div95, file$h, 309, 36, 23614);
			attr_dev(div96, "class", "col-sm-6 px-1");
			add_location(div96, file$h, 308, 32, 23549);
			attr_dev(div97, "class", "row");
			add_location(div97, file$h, 301, 28, 22932);
			attr_dev(label38, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label38, "for", "mlt-top");
			add_location(label38, file$h, 318, 40, 24333);
			...
			add_location(input39, file$h, 394, 40, 30403);
			attr_dev(div123, "class", "form-group");
			add_location(div123, file$h, 392, 36, 30184);
			attr_dev(div124, "class", "col-sm-6 px-1");
			add_location(div124, file$h, 391, 32, 30119);
			attr_dev(div125, "class", "row");
			add_location(div125, file$h, 384, 28, 29508);
			attr_dev(label49, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label49, "for", "chk-top");
			add_location(label49, file$h, 401, 40, 30902);
			...
			add_location(input46, file$h, 452, 40, 34806);
			attr_dev(div144, "class", "form-group");
			add_location(div144, file$h, 450, 36, 34588);
			attr_dev(div145, "class", "col-sm-6 px-1");
			add_location(div145, file$h, 449, 32, 34523);
			attr_dev(div146, "class", "row");
			add_location(div146, file$h, 442, 28, 33913);
			attr_dev(label56, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label56, "for", "rd-top");
			add_location(label56, file$h, 459, 40, 35301);
			...
			add_location(input48, file$h, 466, 40, 35966);
			attr_dev(div149, "class", "form-group");
			add_location(div149, file$h, 464, 36, 35759);
			attr_dev(div150, "class", "col-sm-6 px-1");
			add_location(div150, file$h, 463, 32, 35694);
			attr_dev(div151, "class", "row");
			add_location(div151, file$h, 456, 28, 35119);
			attr_dev(label58, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label58, "for", "rd-name");
			add_location(label58, file$h, 473, 40, 36438);
			...
			add_location(input55, file$h, 522, 40, 40231);
			attr_dev(div169, "class", "form-group");
			add_location(div169, file$h, 520, 36, 40012);
			attr_dev(div170, "class", "col-sm-6 px-1");
			add_location(div170, file$h, 519, 32, 39947);
			attr_dev(div171, "class", "row");
			add_location(div171, file$h, 512, 28, 39333);
			attr_dev(label65, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label65, "for", "btn-top");
			add_location(label65, file$h, 529, 40, 40728);
			...
			add_location(input57, file$h, 536, 40, 41397);
			attr_dev(div174, "class", "form-group");
			add_location(div174, file$h, 534, 36, 41189);
			attr_dev(div175, "class", "col-sm-6 px-1");
			add_location(div175, file$h, 533, 32, 41124);
			attr_dev(div176, "class", "row");
			add_location(div176, file$h, 526, 28, 40546);
			attr_dev(label67, "class", "control-label font-weight-normal mb-0");
			attr_dev(label67, "for", "btn-value");
			add_location(label67, file$h, 543, 40, 41871);
			...
			add_location(input58, file$h, 544, 40, 41995);
			attr_dev(div177, "class", "form-group");
			add_location(div177, file$h, 542, 36, 41805);
			attr_dev(div178, "class", "col-sm-12 px-1");
			add_location(div178, file$h, 541, 32, 41739);
			attr_dev(label68, "class", "control-label font-weight-normal mb-0");
			attr_dev(label68, "for", "btn-class");
			add_location(label68, file$h, 549, 40, 42365);
			...
			add_location(input62, file$h, 580, 40, 44578);
			attr_dev(div190, "class", "form-group");
			add_location(div190, file$h, 578, 36, 44359);
			attr_dev(div191, "class", "col-sm-6 px-1");
			add_location(div191, file$h, 577, 32, 44294);
			attr_dev(div192, "class", "row");
			add_location(div192, file$h, 570, 28, 43678);
			attr_dev(label72, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label72, "for", "ddn-top");
			add_location(label72, file$h, 587, 40, 45077);
			...
			add_location(input64, file$h, 594, 40, 45748);
			attr_dev(div195, "class", "form-group");
			add_location(div195, file$h, 592, 36, 45540);
			attr_dev(div196, "class", "col-sm-6 px-1");
			add_location(div196, file$h, 591, 32, 45475);
			attr_dev(div197, "class", "row");
			add_location(div197, file$h, 584, 28, 44895);
			attr_dev(label74, "class", "control-label font-weight-normal mb-0");
			attr_dev(label74, "for", "ddn-value");
			add_location(label74, file$h, 601, 40, 46224);
			...
			add_location(input67, file$h, 632, 40, 48445);
			attr_dev(div209, "class", "form-group");
			add_location(div209, file$h, 630, 36, 48226);
			attr_dev(div210, "class", "col-sm-6 px-1");
			add_location(div210, file$h, 629, 32, 48161);
			attr_dev(div211, "class", "row");
			add_location(div211, file$h, 622, 28, 47546);
			attr_dev(label78, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label78, "for", "lst-top");
			add_location(label78, file$h, 639, 40, 48943);
			...
			add_location(input69, file$h, 646, 40, 49613);
			attr_dev(div214, "class", "form-group");
			add_location(div214, file$h, 644, 36, 49405);
			attr_dev(div215, "class", "col-sm-6 px-1");
			add_location(div215, file$h, 643, 32, 49340);
			attr_dev(div216, "class", "row");
			add_location(div216, file$h, 636, 28, 48761);
			attr_dev(label80, "class", "control-label font-weight-normal mb-0");
			attr_dev(label80, "for", "lst-value");
			add_location(label80, file$h, 653, 40, 50088);
			...
			add_location(textarea11, file$h, 654, 40, 50218);
			attr_dev(div217, "class", "form-group");
			add_location(div217, file$h, 652, 36, 50022);
			attr_dev(div218, "class", "col-sm-12 px-1");
			add_location(div218, file$h, 651, 32, 49956);
			...
			add_location(input74, file$h, 692, 40, 53025);
			attr_dev(div230, "class", "form-group");
			add_location(div230, file$h, 690, 36, 52806);
			attr_dev(div231, "class", "col-sm-6 px-1");
			add_location(div231, file$h, 689, 32, 52741);
			attr_dev(div232, "class", "row");
			add_location(div232, file$h, 682, 28, 52126);
			attr_dev(label85, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label85, "for", "tbd-top");
			add_location(label85, file$h, 699, 40, 53523);
			...
			add_location(input76, file$h, 706, 40, 54193);
			attr_dev(div235, "class", "form-group");
			add_location(div235, file$h, 704, 36, 53985);
			attr_dev(div236, "class", "col-sm-6 px-1");
			add_location(div236, file$h, 703, 32, 53920);
			attr_dev(div237, "class", "row");
			add_location(div237, file$h, 696, 28, 53341);
			attr_dev(label87, "class", "control-label font-weight-normal mb-0");
			attr_dev(label87, "for", "tbd-title");
			add_location(label87, file$h, 713, 40, 54668);
			...
			add_location(input77, file$h, 714, 40, 54796);
			attr_dev(div238, "class", "form-group");
			add_location(div238, file$h, 712, 36, 54602);
			attr_dev(div239, "class", "col-sm-12 px-1");
			add_location(div239, file$h, 711, 32, 54536);
			attr_dev(label88, "class", "control-label font-weight-normal mb-0");
			attr_dev(label88, "for", "tbd-class");
			add_location(label88, file$h, 719, 40, 55167);
			...
			add_location(input81, file$h, 752, 40, 57489);
			attr_dev(div248, "class", "form-group");
			add_location(div248, file$h, 750, 36, 57270);
			attr_dev(div249, "class", "col-sm-6 px-1");
			add_location(div249, file$h, 749, 32, 57205);
			attr_dev(div250, "class", "row");
			add_location(div250, file$h, 742, 28, 56592);
			attr_dev(label91, "class", "control-label font-weight-normal mb-0 mendatory_label");
			attr_dev(label91, "for", "img-top");
			add_location(label91, file$h, 759, 40, 57985);
			...
			add_location(input83, file$h, 766, 40, 58653);
			attr_dev(div253, "class", "form-group");
			add_location(div253, file$h, 764, 36, 58445);
			attr_dev(div254, "class", "col-sm-6 px-1");
			add_location(div254, file$h, 763, 32, 58380);
			attr_dev(div255, "class", "row");
			add_location(div255, file$h, 756, 28, 57803);
			attr_dev(label93, "class", "control-label font-weight-normal mb-0");
			attr_dev(label93, "for", "img-title");
			add_location(label93, file$h, 773, 40, 59126);
			...
			add_location(input84, file$h, 774, 40, 59254);
			attr_dev(div256, "class", "form-group");
			add_location(div256, file$h, 772, 36, 59060);
			attr_dev(div257, "class", "col-sm-12 px-1");
			add_location(div257, file$h, 771, 32, 58994);
			attr_dev(label94, "class", "control-label font-weight-normal mb-0");
			attr_dev(label94, "for", "img-bgimg");
			add_location(label94, file$h, 779, 40, 59623);
			...
			add_location(input90, file$h, 822, 40, 62918);
			attr_dev(div273, "class", "form-group");
			add_location(div273, file$h, 820, 36, 62710);
			attr_dev(div274, "class", "col-sm-6 px-1");
			add_location(div274, file$h, 819, 32, 62645);
			attr_dev(label100, "class", "control-label font-weight-normal mb-0");
			attr_dev(label100, "for", "lbl-title");
			add_location(label100, file$h, 827, 40, 63308);
			...
			add_location(input91, file$h, 828, 40, 63436);
			attr_dev(div275, "class", "form-group");
			add_location(div275, file$h, 826, 36, 63242);
			attr_dev(div276, "class", "col-sm-12 px-1");
			add_location(div276, file$h, 825, 32, 63176);
			attr_dev(label101, "class", "control-label font-weight-normal mb-0");
			attr_dev(label101, "for", "lbl_border_size");
			add_location(label101, file$h, 833, 40, 63804);
			option12.__value = "0";
			option12.value = option12.__value;
			add_location(option12, file$h, 835, 44, 64083);
			option13.__value = "1";
			option13.value = option13.__value;
			add_location(option13, file$h, 836, 44, 64164);
			option14.__value = "2";
			option14.value = option14.__value;
			add_location(option14, file$h, 837, 44, 64238);
			option15.__value = "3";
			option15.value = option15.__value;
			add_location(option15, file$h, 838, 44, 64312);
			option16.__value = "4";
			option16.value = option16.__value;
			add_location(option16, file$h, 839, 44, 64386);
			option17.__value = "5";
			option17.value = option17.__value;
			add_location(option17, file$h, 840, 44, 64460);
			...
			add_location(select7, file$h, 834, 40, 63944);
			attr_dev(div277, "class", "form-group");
			add_location(div277, file$h, 832, 36, 63738);
			attr_dev(div278, "class", "col-sm-4 px-1");
			add_location(div278, file$h, 831, 32, 63673);
			attr_dev(label102, "class", "control-label font-weight-normal mb-0");
			attr_dev(label102, "for", "lbl_border_color");
			add_location(label102, file$h, 846, 40, 64788);
			option18.__value = "white";
			option18.value = option18.__value;
			add_location(option18, file$h, 848, 44, 65067);
			option19.__value = "black";
			option19.value = option19.__value;
			add_location(option19, file$h, 849, 44, 65152);
			option20.__value = "blue";
			option20.value = option20.__value;
			add_location(option20, file$h, 850, 44, 65238);
			option21.__value = "green";
			option21.value = option21.__value;
			add_location(option21, file$h, 851, 44, 65322);
			option22.__value = "red";
			option22.value = option22.__value;
			add_location(option22, file$h, 852, 44, 65408);
			...
			add_location(input97, file$h, 919, 40, 70288);
			attr_dev(div301, "class", "form-group");
			add_location(div301, file$h, 917, 36, 70079);
			attr_dev(div302, "class", "col-sm-3 px-1");
			add_location(div302, file$h, 916, 32, 70014);
			attr_dev(div303, "class", "row");
			add_location(div303, file$h, 897, 28, 68306);
			attr_dev(label110, "class", "control-label font-weight-normal mb-0");
			attr_dev(label110, "for", "area-matrix");
			add_location(label110, file$h, 926, 40, 70760);
			...
			add_location(input99, file$h, 933, 40, 71405);
			attr_dev(div306, "class", "form-group");
			add_location(div306, file$h, 931, 36, 71196);
			attr_dev(div307, "class", "col-sm-6 px-1");
			add_location(div307, file$h, 930, 32, 71131);
			attr_dev(div308, "class", "row");
			add_location(div308, file$h, 923, 28, 70578);
			attr_dev(label112, "class", "control-label font-weight-normal mb-0");
			attr_dev(label112, "for", "area-defaultans");
			add_location(label112, file$h, 940, 40, 71864);
			...
			add_location(input105, file$h, 976, 40, 74646);
			attr_dev(div322, "class", "form-group");
			add_location(div322, file$h, 974, 36, 74438);
			attr_dev(div323, "class", "col-sm-3 px-1");
			add_location(div323, file$h, 973, 32, 74373);
			attr_dev(div324, "class", "row");
			add_location(div324, file$h, 954, 28, 72659);
			attr_dev(label117, "class", "control-label font-weight-normal mb-0");
			attr_dev(label117, "for", "mnl-matrix");
			add_location(label117, file$h, 983, 40, 75121);
			...
			add_location(input107, file$h, 990, 40, 75767);
			attr_dev(div327, "class", "form-group");
			add_location(div327, file$h, 988, 36, 75559);
			attr_dev(div328, "class", "col-sm-6 px-1");
			add_location(div328, file$h, 987, 32, 75494);
			attr_dev(div329, "class", "row");
			add_location(div329, file$h, 980, 28, 74939);
			attr_dev(label119, "class", "control-label font-weight-normal mb-0");
			attr_dev(label119, "for", "mnl-value");
			add_location(label119, file$h, 997, 40, 76229);
			...
			add_location(input113, file$h, 1033, 40, 78994);
			attr_dev(div343, "class", "form-group");
			add_location(div343, file$h, 1031, 36, 78786);
			attr_dev(div344, "class", "col-sm-3 px-1");
			add_location(div344, file$h, 1030, 32, 78721);
			attr_dev(div345, "class", "row");
			add_location(div345, file$h, 1011, 28, 77009);
			attr_dev(label124, "class", "control-label font-weight-normal mb-0");
			attr_dev(label124, "for", "hpt-title");
			add_location(label124, file$h, 1040, 40, 79468);
			...
			add_location(input114, file$h, 1041, 40, 79596);
			attr_dev(div346, "class", "form-group");
			add_location(div346, file$h, 1039, 36, 79402);
			attr_dev(div347, "class", "col-sm-6 px-1");
			add_location(div347, file$h, 1038, 32, 79337);
			attr_dev(label125, "class", "control-label font-weight-normal mb-0");
			attr_dev(label125, "for", "hpt-name");
			add_location(label125, file$h, 1046, 40, 79966);
			...
			add_location(input115, file$h, 1047, 40, 80097);
			attr_dev(div348, "class", "form-group");
			add_location(div348, file$h, 1045, 36, 79900);
			attr_dev(div349, "class", "col-sm-6 px-1");
			add_location(div349, file$h, 1044, 32, 79835);
			attr_dev(div350, "class", "row");
			add_location(div350, file$h, 1037, 28, 79286);
			attr_dev(label126, "class", "control-label font-weight-normal mb-0");
			attr_dev(label126, "for", "hpt-targetimg");
			add_location(label126, file$h, 1054, 40, 80549);
			...
			add_location(input116, file$h, 1055, 40, 80686);
			attr_dev(div351, "class", "form-group");
			add_location(div351, file$h, 1053, 36, 80483);
			attr_dev(div352, "class", "col-sm-6 px-1");
			add_location(div352, file$h, 1052, 32, 80418);
			...
			add_location(input124, file$h, 1109, 40, 84743);
			attr_dev(div371, "class", "form-group");
			add_location(div371, file$h, 1107, 36, 84549);
			attr_dev(div372, "class", "col-sm-6 px-1");
			add_location(div372, file$h, 1106, 32, 84484);
			attr_dev(label133, "class", "control-label font-weight-normal mb-0");
			attr_dev(label133, "for", "tab-alt");
			add_location(label133, file$h, 1114, 40, 85127);
			...
			add_location(input125, file$h, 1115, 40, 85256);
			attr_dev(div373, "class", "form-group");
			add_location(div373, file$h, 1113, 36, 85061);
			attr_dev(div374, "class", "col-sm-6 px-1");
			add_location(div374, file$h, 1112, 32, 84996);
			attr_dev(div375, "class", "row");
			add_location(div375, file$h, 1105, 28, 84433);
			attr_dev(label134, "class", "control-label font-weight-normal mb-0");
			attr_dev(label134, "for", "tab-bgimg");
			add_location(label134, file$h, 1122, 40, 85701);
			...
			add_location(input126, file$h, 1123, 40, 85840);
			attr_dev(div376, "class", "form-group");
			add_location(div376, file$h, 1121, 36, 85635);
			attr_dev(button2, "type", "button");
			...
			add_location(button2, file$h, 1125, 36, 86036);
			attr_dev(div377, "class", "col-sm-6 px-1");
			add_location(div377, file$h, 1120, 32, 85570);
			...
			add_location(input129, file$h, 1145, 40, 87467);
			attr_dev(div384, "class", "form-group");
			add_location(div384, file$h, 1143, 36, 87261);
			...
			add_location(input130, file$h, 1152, 40, 88138);
			attr_dev(div386, "class", "form-group");
			add_location(div386, file$h, 1150, 36, 87943);
			attr_dev(div387, "class", "col-sm-6 px-1");
			add_location(div387, file$h, 1149, 32, 87878);
			attr_dev(div388, "class", "row");
			add_location(div388, file$h, 1141, 28, 87145);
			...
			add_location(input134, file$h, 1181, 40, 90183);
			attr_dev(div397, "class", "form-group");
			add_location(div397, file$h, 1179, 36, 89963);
			attr_dev(div398, "class", "col-sm-4 px-1");
			add_location(div398, file$h, 1178, 32, 89898);
			attr_dev(label141, "class", "control-label font-weight-normal mb-0");
			attr_dev(label141, "for", "base-bgimg-alt");
			add_location(label141, file$h, 1186, 40, 90578);
			...
			add_location(input135, file$h, 1187, 40, 90717);
			attr_dev(div399, "class", "form-group");
			add_location(div399, file$h, 1185, 36, 90512);
			attr_dev(div400, "class", "col-sm-4 px-1");
			add_location(div400, file$h, 1184, 32, 90447);
			attr_dev(div401, "class", "row");
			add_location(div401, file$h, 1171, 28, 89303);
			attr_dev(label142, "class", "control-label font-weight-normal mb-0");
			attr_dev(label142, "for", "base-bgimg");
			add_location(label142, file$h, 1194, 40, 91170);
			...
			add_location(input136, file$h, 1195, 40, 91310);
			attr_dev(div402, "class", "form-group");
			add_location(div402, file$h, 1193, 36, 91104);
			attr_dev(div403, "class", "col-sm-6 px-1");
			add_location(div403, file$h, 1192, 32, 91039);
			attr_dev(button4, "type", "button");
			attr_dev(button4, "id", "upload_media");
			attr_dev(button4, "class", "btn btn-outline-primary float-start");
			add_location(button4, file$h, 1199, 36, 91639);
			...
			add_location(input137, file$h, 1201, 40, 91874);
			...
			add_location(label143, file$h, 1202, 40, 92112);
			attr_dev(div404, "class", "form-group float-start mt-2");
			add_location(div404, file$h, 1200, 36, 91791);
			attr_dev(div405, "class", "col-sm-6 mt-3 pt-1 px-1");
			add_location(div405, file$h, 1198, 32, 91564);
			attr_dev(div406, "class", "row");
			add_location(div406, file$h, 1191, 28, 90988);
			attr_dev(div407, "class", "col-sm-12");
			add_location(div407, file$h, 1170, 24, 89250);
			attr_dev(div408, "class", "row mx-0");
			add_location(div408, file$h, 1169, 20, 89202);
			attr_dev(div409, "class", "base h");
			add_location(div409, file$h, 1168, 16, 89160);
			...
			add_location(input141, file$h, 1239, 40, 94902);
			attr_dev(div418, "class", "form-group");
			add_location(div418, file$h, 1237, 36, 94685);
			attr_dev(div419, "class", "col-sm-6 px-1");
			add_location(div419, file$h, 1236, 32, 94620);
			attr_dev(div420, "class", "row");
			add_location(div420, file$h, 1229, 28, 94028);
			attr_dev(label148, "class", "control-label font-weight-normal mb-0");
			attr_dev(label148, "for", "choicematrix-name");
			add_location(label148, file$h, 1246, 40, 95381);
			...
			add_location(textarea15, file$h, 1268, 32, 97230);
			attr_dev(div429, "class", "form-group");
			add_location(div429, file$h, 1266, 28, 97039);
			attr_dev(div430, "class", "ev");
			attr_dev(div430, "type", "rd");
			add_location(div430, file$h, 1270, 28, 97429);
			attr_dev(div431, "class", "col-sm-6 pl-2 pr-1");
			add_location(div431, file$h, 1265, 24, 96977);
			attr_dev(div432, "class", "row mx-0");
			add_location(div432, file$h, 1213, 20, 92688);
			attr_dev(div433, "class", "choicematrix h");
			add_location(div433, file$h, 1212, 16, 92638);
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 765, 16, 32364);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block_1$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$i, 763, 16, 32061);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
...
function create_if_block$h(ctx) {
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			create_component(tab.$$.fragment);
			add_location(div, file$i, 768, 16, 32588);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$i(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$i, 729, 2, 30575);
			attr_dev(div0, "id", "steps");
			attr_dev(div0, "class", "h");
			add_location(div0, file$i, 728, 4, 30544);
			attr_dev(i, "class", "icomoon-24px-edit-1");
			add_location(i, file$i, 760, 232, 31954);
			...
			add_location(button0, file$i, 760, 16, 31738);
			attr_dev(div1, "class", "btn-group tools mr-1");
			attr_dev(div1, "data-t", "base");
			add_location(div1, file$i, 759, 12, 31672);
...
//# sourceMappingURL=DragNDrop-faad6d2e.js.map
