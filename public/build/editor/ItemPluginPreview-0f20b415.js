...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1131, 3, 35164);
			...
			add_location(div1, file, 1144, 3, 36045);
			...
			add_location(button, file, 1162, 5, 37145);
			attr_dev(div2, "class", div2_class_value = /*state*/ ctx[5].hideNext ? 'h-imp' : null);
			add_location(div2, file, 1161, 4, 37094);
			add_location(center, file, 1123, 2, 34988);
		},
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1137, 9, 35920);
			...
			add_location(div1, file, 1136, 8, 35702);
			...
			add_location(div2, file, 1135, 7, 35436);
			...
			add_location(div3, file, 1134, 6, 35347);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(div0, "seq", div0_seq_value = "s" + /*index*/ ctx[69]);
			add_location(div0, file, 1150, 9, 36784);
			attr_dev(div1, "id", div1_id_value = 'data-block_' + /*index*/ ctx[69]);
			...
			attr_dev(div1, "key", div1_key_value = /*index*/ ctx[69]);
			add_location(div1, file, 1149, 8, 36566);
			attr_dev(div2, "id", div2_id_value = "s" + /*index*/ ctx[69]);
			...
			add_location(div2, file, 1148, 7, 36300);
			attr_dev(div3, "data-sticky", div3_data_sticky_value = /*isSticky*/ ctx[6](/*index*/ ctx[69]));
			attr_dev(div3, "class", "bt-pd bg-white mt-3");
			attr_dev(div3, "tabindex", div3_tabindex_value = 0);
			add_location(div3, file, 1147, 6, 36214);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div3, anchor);
			append_dev(div3, div2);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			main = element("main");
			if (if_block) if_block.c();
			add_location(main, file, 1120, 0, 34945);
		},
...
//# sourceMappingURL=ItemPluginPreview-0f20b415.js.map
