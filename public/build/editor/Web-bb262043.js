...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, e as element, p as append_dev, O as Dialog, P as binding_callbacks, Q as bind, v as validate_slots, L as beforeUpdate, o as onMount, A as AH, _ as onUserAnsChange, a9 as afterUpdate, U as Button, aa as Loader, w as writable, y as language, j as attr_dev, k as add_location, n as insert_dev, x as detach_dev, f as space, c as create_component, m as mount_component, q as listen_dev, W as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component, H as run_all, l as set_style, B as noop, h as text, G as prop_dev, F as set_data_dev, V as Checkbox, Z as tick, r as group_outros, u as check_outros } from './main-674e3b87.js';
...
// (779:28) <Checkbox                                    checked={state.goDark}                                   on:click={changeTheme}                                   id="goDark"                              >
function create_default_slot$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(779:28) <Checkbox                                    checked={state.goDark}                                   on:click={changeTheme}                                   id=\\\"goDark\\\"                              >",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file$1, 752, 24, 33619);
			attr_dev(div0, "class", "inline-block pull-left");
			add_location(div0, file$1, 751, 20, 33557);
			attr_dev(button1, "type", "button");
			...
			add_location(button3, file$1, 868, 20, 39586);
			attr_dev(div25, "class", "modal-header");
			add_location(div25, file$1, 857, 16, 39015);
			...
			add_location(a0, file$1, 882, 36, 40309);
			...
			add_location(textarea3, file$1, 900, 36, 41376);
			attr_dev(div27, "class", "card-body p-md");
			add_location(div27, file$1, 899, 32, 41310);
			attr_dev(div28, "id", "test_case_collapse");
			attr_dev(div28, "class", "collapse in");
			add_location(div28, file$1, 898, 28, 41227);
			attr_dev(div29, "class", "card mb-2");
			add_location(div29, file$1, 879, 24, 40072);
			...
			add_location(a1, file$1, 914, 36, 42253);
			...
			add_location(span6, file$1, 922, 40, 42717);
			attr_dev(h42, "class", "panel-title");
			add_location(h42, file$1, 913, 32, 42191);
			...
			add_location(div30, file$1, 912, 28, 42063);
			...
			add_location(textarea4, file$1, 932, 36, 43403);
			attr_dev(div31, "class", "card-body p-md");
			add_location(div31, file$1, 931, 32, 43337);
			attr_dev(div32, "id", "internal_script_collapse");
			attr_dev(div32, "class", "panel-collapse collapse");
			add_location(div32, file$1, 930, 28, 43236);
			attr_dev(div33, "class", "card mb-2");
			add_location(div33, file$1, 911, 24, 42010);
			...
			add_location(a2, file$1, 946, 36, 44290);
			...
			add_location(span7, file$1, 954, 36, 44750);
			attr_dev(h43, "class", "panel-title");
			add_location(h43, file$1, 945, 32, 44228);
			...
			add_location(div34, file$1, 944, 28, 44100);
			...
			add_location(button4, file$1, 979, 20, 46094);
			attr_dev(div40, "class", "modal-footer");
			add_location(div40, file$1, 978, 16, 46046);
			attr_dev(div41, "class", "modal-content");
			add_location(div41, file$1, 856, 12, 38970);
			attr_dev(div42, "class", "modal-dialog modal-lg modal-dialog-centered");
			add_location(div42, file$1, 855, 8, 38899);
			attr_dev(div43, "id", "autograde_modal");
			attr_dev(div43, "class", "modal fade");
			attr_dev(div43, "role", "dialog");
			add_location(div43, file$1, 854, 4, 38830);
			attr_dev(h44, "class", "modal-title");
			add_location(h44, file$1, 996, 20, 46732);
			attr_dev(button5, "type", "button");
			attr_dev(button5, "class", "close");
			attr_dev(button5, "data-bs-dismiss", "modal");
			attr_dev(button5, "aria-hidden", "true");
			add_location(button5, file$1, 997, 20, 46794);
			attr_dev(div44, "class", "modal-header");
			add_location(div44, file$1, 995, 16, 46684);
			attr_dev(label1, "for", "html_disable");
			add_location(label1, file$1, 1001, 24, 47021);
			option0.__value = "";
			option0.value = option0.__value;
			add_location(option0, file$1, 1003, 28, 47212);
			option1.__value = "0";
			option1.value = option1.__value;
			add_location(option1, file$1, 1004, 28, 47280);
			option2.__value = "1";
			option2.value = option2.__value;
			add_location(option2, file$1, 1005, 28, 47347);
			attr_dev(select0, "class", "form-control");
			attr_dev(select0, "id", "html_disable");
			attr_dev(select0, "auto:focus", "autofocus");
			add_location(select0, file$1, 1002, 24, 47090);
			attr_dev(div45, "class", "form-group");
			add_location(div45, file$1, 1000, 20, 46971);
			attr_dev(label2, "for", "css_disable");
			add_location(label2, file$1, 1009, 24, 47521);
			option3.__value = "";
			option3.value = option3.__value;
			add_location(option3, file$1, 1011, 28, 47686);
			option4.__value = "0";
			option4.value = option4.__value;
			add_location(option4, file$1, 1012, 28, 47754);
			option5.__value = "1";
			option5.value = option5.__value;
			add_location(option5, file$1, 1013, 28, 47821);
			attr_dev(select1, "class", "form-control");
			attr_dev(select1, "id", "css_disable");
			add_location(select1, file$1, 1010, 24, 47588);
			attr_dev(div46, "class", "form-group");
			add_location(div46, file$1, 1008, 20, 47471);
			attr_dev(label3, "for", "js_disable");
			add_location(label3, file$1, 1017, 24, 47995);
			option6.__value = "";
			option6.value = option6.__value;
			add_location(option6, file$1, 1019, 28, 48157);
			option7.__value = "0";
			option7.value = option7.__value;
			add_location(option7, file$1, 1020, 28, 48225);
			option8.__value = "1";
			option8.value = option8.__value;
			add_location(option8, file$1, 1021, 28, 48292);
			attr_dev(select2, "class", "form-control");
			attr_dev(select2, "id", "js_disable");
			add_location(select2, file$1, 1018, 24, 48060);
			attr_dev(div47, "class", "form-group");
			add_location(div47, file$1, 1016, 20, 47945);
			attr_dev(button6, "type", "button");
			attr_dev(button6, "class", "btn btn-primary");
			attr_dev(button6, "data-bs-dismiss", "modal");
			add_location(button6, file$1, 1025, 24, 48467);
			attr_dev(div48, "class", "float-right");
			add_location(div48, file$1, 1024, 20, 48416);
			attr_dev(div49, "class", "modal-body");
			add_location(div49, file$1, 999, 16, 46925);
			attr_dev(div50, "class", "modal-content");
			add_location(div50, file$1, 994, 12, 46639);
			attr_dev(div51, "class", "modal-dialog modal-sm modal-dialog-centered");
			add_location(div51, file$1, 993, 8, 46568);
			attr_dev(div52, "id", "disable_modal");
			attr_dev(div52, "class", "modal fade");
			attr_dev(div52, "role", "dialog");
			add_location(div52, file$1, 992, 4, 46501);
			attr_dev(input2, "type", "hidden");
			attr_dev(input2, "id", "ansModeAnswer");
			input2.value = "";
			add_location(input2, file$1, 1031, 4, 48660);
			attr_dev(div53, "id", "authoringArea");
			set_style(div53, "line-height", "20px");
			set_style(div53, "font-size", "14px");
			add_location(div53, file$1, 746, 0, 33300);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
export default Web;
//# sourceMappingURL=Web-bb262043.js.map
