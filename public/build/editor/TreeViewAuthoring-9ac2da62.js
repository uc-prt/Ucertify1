...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as append_styles, W as Checkbox, Q as binding_callbacks, R as bind, P as Dialog, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, a9 as l, V as Button, w as writable, e as element, f as space, c as create_component, j as attr_dev, k as add_location, l as set_style, n as insert_dev, p as append_dev, m as mount_component, q as listen_dev, Z as add_flush_callback, t as transition_in, a as transition_out, x as detach_dev, b as destroy_component, h as text, B as noop, z as empty, a7 as HtmlTag } from './main-87423616.js';
...
function add_css(target) {
	append_styles(target, "svelte-1j37dlv", ".btnColor{background-color:#dee2e6!important;box-shadow:2px 2px 5px #000}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 213, 130, 10027);
		},
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 245, 20, 11922);
		},
		m: function mount(target, anchor) {
...
// (233:4) <Dialog class="remove_right_margin" width="400" bind:visible={state.openHelp} style="background: #fff; border-radius: 5px;">
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div4, file, 238, 8, 11414);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(233:4) <Dialog class=\\\"remove_right_margin\\\" width=\\\"400\\\" bind:visible={state.openHelp} style=\\\"background: #fff; border-radius: 5px;\\\">",
		ctx
	});
...
// (251:12) <Button      on:click={handleClose}      class="btnColor"     >
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(251:12) <Button      on:click={handleClose}      class=\\\"btnColor\\\"     >",
		ctx
	});
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 249, 8, 12049);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea0, file, 215, 24, 10121);
			...
			add_location(textarea1, file, 216, 24, 10254);
			add_location(div14, file, 152, 20, 6644);
			attr_dev(div15, "class", "border-0");
			set_style(div15, "width", "95%");
			add_location(div15, file, 151, 16, 6580);
			attr_dev(strong, "class", "ml-lg-3");
			add_location(strong, file, 220, 20, 10571);
			add_location(li0, file, 222, 24, 10669);
			add_location(li1, file, 223, 24, 10719);
			add_location(li2, file, 224, 24, 10770);
			add_location(ol, file, 221, 20, 10639);
			attr_dev(div16, "class", "font13 mx-3 text-left text-danger");
			add_location(div16, file, 219, 16, 10502);
			attr_dev(div17, "id", "main");
			attr_dev(div17, "class", "py-3 min_height_20 width98");
			add_location(div17, file, 150, 12, 6512);
			add_location(center, file, 149, 8, 6490);
			attr_dev(div18, "id", "authoringArea");
			attr_dev(div18, "class", "border");
			add_location(div18, file, 148, 4, 6441);
			add_location(main, file, 147, 0, 6429);
		},
...
class TreeViewAuthoring extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { xml: 6, getChildXml: 7, visible: 5 }, add_css);
...
//# sourceMappingURL=TreeViewAuthoring-9ac2da62.js.map
