...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 256, 8, 10977);
			attr_dev(div, "class", "alert alert-danger font-weight-bold");
			add_location(div, file, 255, 4, 10918);
		},
...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 295, 36, 13173);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 294, 32, 13075);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 291, 36, 12876);
			attr_dev(span1, "class", "correct_incorrect_icon_fill position-absolute");
			add_location(span1, file, 290, 32, 12778);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span1, anchor);
			append_dev(span1, span0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 308, 40, 14172);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = text(": ");
			t2 = text(t2_value);
			add_location(span, file, 306, 40, 13906);
		},
		m: function mount(target, anchor) {
			insert_dev(target, span, anchor);
			append_dev(span, t0);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 268, 8, 11310);
			attr_dev(div1, "id", "slidermain");
			add_location(div1, file, 267, 4, 11279);
			attr_dev(div2, "class", "text-center");
			add_location(div2, file, 259, 0, 11024);
		},
...
//# sourceMappingURL=SliderItemPreview-c287a4d3.js.map
