...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 38, 131, 1659);
			...
			add_location(button0, file, 38, 8, 1536);
			add_location(span1, file, 39, 135, 1832);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button1, file, 35, 0, 1261);
...
//# sourceMappingURL=ItemHelper-e96e3b69.js.map
