...
/* clsSMMatchList\MatchListHelper.svelte generated by Svelte v3.29.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<MatchListHelper> was created with unknown prop '${key}'`);
	});
...
export { itemHelper };
//# sourceMappingURL=MatchListHelper-d3b6f5b3.js.map
