...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(td, file, 392, 36, 14206);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 410, 52, 15722);
			add_location(span1, file, 409, 48, 15663);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (if_block) if_block.c();
			t = space();
			add_location(tr, file, 388, 20, 13981);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if ((!current || dirty[0] & /*state*/ 32) && t5_value !== (t5_value = /*state*/ ctx[5].correctCount + "")) set_data_dev(t5, t5_value);
...
//# sourceMappingURL=ShadingPreview-3c920312.js.map
