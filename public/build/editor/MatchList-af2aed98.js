...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea1, file, 837, 48, 34173);
			...
			add_location(div3, file, 836, 44, 34034);
			...
			add_location(span2, file, 855, 44, 36051);
			add_location(a, file, 854, 40, 35941);
			attr_dev(div7, "class", "width1 float-right");
			add_location(div7, file, 853, 36, 35868);
			attr_dev(div8, "key", div8_key_value = /*i*/ ctx[62]);
			attr_dev(div8, "class", "d-flex align-items-center mb-2");
			add_location(div8, file, 815, 32, 31722);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 748, 7, 24463);
			attr_dev(span0, "class", "font24 svelte-1kpz00h");
			add_location(span0, file, 781, 52, 28044);
			...
			add_location(span1, file, 809, 48, 31305);
			add_location(a, file, 808, 44, 31191);
			attr_dev(div5, "class", "width1 float-right");
			add_location(div5, file, 807, 40, 31114);
			...
			add_location(div6, file, 754, 36, 24659);
		},
		m: function mount(target, anchor) {
...
function create_if_block_8(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 822, 52, 32603);
		},
		m: function mount(target, anchor) {
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 827, 52, 33135);
		},
		m: function mount(target, anchor) {
...
function create_if_block_6(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 840, 52, 34561);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
...
function create_if_block_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "data-bs-placement", "right");
			attr_dev(div, "title", "Delete Image");
			add_location(div, file, 845, 52, 35078);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
...
function create_if_block_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 764, 68, 25738);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "data-bs-placement", "right");
			attr_dev(div, "title", "Delete Image");
			add_location(div, file, 770, 68, 26368);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button1, file, 774, 64, 27101);
			attr_dev(div1, "class", "pull-right");
			add_location(div1, file, 768, 60, 26182);
			attr_dev(div2, "class", "d-flex align-items-center");
			add_location(div2, file, 760, 56, 25079);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 792, 68, 29127);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "data-bs-placement", "right");
			attr_dev(div, "title", "Delete Image");
			add_location(div, file, 798, 68, 29747);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 790, 64, 28721);
			attr_dev(div0, "class", "pull-left word_break width200 p-1 max_width_300");
			attr_dev(div0, "style", div0_style_value = "border-radius:3px;");
			add_location(div0, file, 789, 60, 28566);
			attr_dev(span0, "class", "icomoon-images d-flex align-items-center pt-sm1 pb-sm1");
			attr_dev(span0, "data-bs-toggle", "tooltip");
			attr_dev(span0, "data-bs-placement", "right");
			attr_dev(span0, "title", "Add Image");
			add_location(span0, file, 800, 242, 30183);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "d-block btn btn-outline-primary btn-sm edit_btn bg-white mb-1");
			add_location(button0, file, 800, 64, 30005);
			attr_dev(span1, "class", "icomoon-24px-delete-1 d-flex align-items-center pt-sm1 pb-sm1");
			attr_dev(span1, "data-bs-toggle", "tooltip");
			attr_dev(span1, "data-bs-placement", "right");
			attr_dev(span1, "title", "Delete");
			add_location(span1, file, 801, 292, 30630);
			attr_dev(button1, "type", "button");
			attr_dev(button1, "class", "btn btn-outline-primary btn-sm edit_btn textdel bg-white");
			...
			add_location(button1, file, 801, 64, 30402);
			attr_dev(div1, "class", "pull-right");
			add_location(div1, file, 796, 60, 29561);
			attr_dev(div2, "class", "d-flex align-items-center");
			add_location(div2, file, 788, 56, 28466);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
...
function create_footer_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input, file, 902, 7, 38165);
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 901, 6, 38117);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file, 886, 10, 37419);
			attr_dev(div2, "class", "form-group");
			add_location(div2, file, 884, 9, 37277);
			attr_dev(div3, "class", "col-md-6 px-1");
			add_location(div3, file, 883, 14, 37240);
			attr_dev(label1, "class", "control-label font-weight-normal mb-0");
			attr_dev(label1, "for", "MatchlistAlt");
			add_location(label1, file, 891, 10, 37643);
			...
			add_location(input1, file, 892, 10, 37748);
			attr_dev(div4, "class", "form-group");
			add_location(div4, file, 890, 9, 37608);
			attr_dev(div5, "class", "col-md-6 px-1");
			add_location(div5, file, 889, 14, 37571);
			attr_dev(button, "class", "btn btn-outline-primary");
			add_location(button, file, 896, 12, 37950);
			attr_dev(div6, "class", "col-md-6 px-1");
			add_location(div6, file, 895, 14, 37910);
			attr_dev(div7, "class", "row mx-0");
			add_location(div7, file, 882, 13, 37203);
			attr_dev(div8, "class", "imageDialog");
			add_location(div8, file, 881, 12, 37164);
			add_location(div9, file, 880, 11, 37146);
		},
		m: function mount(target, anchor) {
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			input.value = "No";
			add_location(input, file, 924, 6, 38940);
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 921, 5, 38786);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(button, div, null);
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 913, 5, 38558);
			attr_dev(span, "class", "col-md-12");
			attr_dev(span, "style", span_style_value = "margin-top:40px;margin-bottom:40px;");
			add_location(span, file, 916, 6, 38652);
			attr_dev(div1, "class", "row");
			add_location(div1, file, 915, 6, 38628);
			add_location(div2, file, 914, 5, 38616);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div0, anchor);
			insert_dev(target, t1, anchor);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file, 866, 16, 36564);
			attr_dev(div11, "class", "text-left ml-2 pb-3");
			add_location(div11, file, 865, 12, 36514);
			attr_dev(div12, "id", "fixedMatchList");
			attr_dev(div12, "class", "border h-auto fwidth");
			add_location(div12, file, 690, 8, 21311);
			add_location(center, file, 689, 4, 21294);
			add_location(main, file, 688, 0, 21283);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	function loadLibs() {
		...
		AH$1.createLink(baseUrlTheme + "clsSMMatchList/css/matchlistAuth.css", config);
	}
...
//# sourceMappingURL=MatchList-af2aed98.js.map
