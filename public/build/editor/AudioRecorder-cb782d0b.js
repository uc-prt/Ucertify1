...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, o as onMount, A as AH, aa as afterUpdate, X as XMLToJSON, L as beforeUpdate, y as l, e as element, f as space, h as text, j as attr_dev, k as add_location, Y as src_url_equal, n as insert_dev, p as append_dev, _ as select_option, q as listen_dev, G as prop_dev, B as noop, x as detach_dev, H as run_all } from './main-74719bf5.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			option8.textContent = `${l.english_in}`;
			t18 = space();
			div5 = element("div");
			...
			add_location(span0, file, 461, 20, 23311);
			...
			add_location(img0, file, 463, 24, 23611);
			...
			add_location(div8, file, 462, 20, 23489);
			...
			add_location(img1, file, 466, 24, 23934);
			...
			add_location(span1, file, 478, 24, 24587);
			...
			add_location(button0, file, 470, 20, 24217);
			...
			add_location(span2, file, 489, 24, 25258);
			...
			add_location(button1, file, 480, 20, 24843);
			...
			add_location(span3, file, 502, 24, 25993);
			...
			add_location(h4, file, 514, 20, 26525);
			...
			add_location(button3, file, 515, 20, 26654);
			attr_dev(div16, "class", "modal-header");
			add_location(div16, file, 513, 16, 26477);
			...
			add_location(div17, file, 517, 16, 26857);
			...
			add_location(button4, file, 521, 20, 27103);
...
//# sourceMappingURL=AudioRecorder-cb782d0b.js.map
