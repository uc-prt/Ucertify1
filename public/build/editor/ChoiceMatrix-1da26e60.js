...
function add_css(target) {
	append_styles(target, "svelte-12kbld3", ".fa-check.svelte-12kbld3{color:#46A546}.fa-close.svelte-12kbld3{color:#A80000}.fa-close.svelte-12kbld3,.fa-check.svelte-12kbld3{margin-left:9px;font-size:18px}.fa-close.svelte-12kbld3,.fa-check.svelte-12kbld3,.middle_align.svelte-12kbld3{vertical-align:middle!important}.middle_align.svelte-12kbld3{width:164px;min-width:164px}.topic_input.svelte-12kbld3{min-width:257px}.preview_header.svelte-12kbld3{font-size:16pt;font-weight:bold;vertical-align:middle}.adjust_width.svelte-12kbld3{width:12%;text-align:center}.width180.svelte-12kbld3{width:180px}.width150.svelte-12kbld3{width:150px}.full_day.svelte-12kbld3{background-color:#eee !important;color:#000 !important}.width90.svelte-12kbld3{width:90px}.width20.svelte-12kbld3{width:20px}.relative.svelte-12kbld3{position:relative}.min_height_38.svelte-12kbld3{min-height:38px}.min_width_200.svelte-12kbld3{min-width:200px !important}.min_width_125.svelte-12kbld3{min-width:125px}.max_width_150.svelte-12kbld3{max-width:150px !important}.height34.svelte-12kbld3{height:34px !important}.width_90.svelte-12kbld3{width:90%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option, file, 363, 8, 10661);
		},
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 407, 48, 12935);
			attr_dev(div0, "class", "float-left");
			add_location(div0, file, 406, 44, 12859);
			attr_dev(span, "class", span_class_value = "" + (null_to_empty(/*icon_class*/ ctx[4]) + " svelte-12kbld3"));
			add_location(span, file, 421, 48, 13929);
			attr_dev(div1, "class", "float-left pointer pt-1 ml-2 delete_column height35 top1 position-relative");
			attr_dev(div1, "tab-index", "0");
			add_location(div1, file, 416, 44, 13570);
			attr_dev(th, "key", th_key_value = /*i*/ ctx[27]);
			attr_dev(th, "class", th_class_value = "" + (null_to_empty("middle_align text-center " + /*data*/ ctx[25].id) + " svelte-12kbld3"));
			set_style(th, "background-color", /*theme_color*/ ctx[1][/*state*/ ctx[0].theme], 1);
			add_location(th, file, 401, 40, 12541);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*state*/ 1 && th_class_value !== (th_class_value = "" + (null_to_empty("middle_align text-center " + /*data*/ ctx[25].id) + " svelte-12kbld3"))) {
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(td, file, 449, 12, 15771);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 433, 44, 14648);
			attr_dev(span, "class", span_class_value = "" + (null_to_empty(/*icon_class*/ ctx[4]) + " svelte-12kbld3"));
			add_location(span, file, 445, 48, 15545);
			attr_dev(div, "class", "pointer pt-1 mt-sm2 ml-2 delete_row height34 svelte-12kbld3");
			attr_dev(div, "tab-index", "0");
			add_location(div, file, 440, 44, 15181);
			attr_dev(td, "class", td_class_value = "" + (null_to_empty("min_width_200 h-auto " + /*data*/ ctx[25].id) + " svelte-12kbld3"));
			...
			add_location(td, file, 432, 40, 14455);
			attr_dev(tr, "key", tr_key_value = /*i*/ ctx[27]);
			add_location(tr, file, 431, 36, 14401);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*state*/ 1 && td_class_value !== (td_class_value = "" + (null_to_empty("min_width_200 h-auto " + /*data*/ ctx[25].id) + " svelte-12kbld3"))) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			button0.textContent = `${l.add_row}`;
			t17 = space();
			button1 = element("button");
			button1.textContent = `${l.add_column}`;
			attr_dev(label0, "for", "select_themes");
			attr_dev(label0, "class", "mb-0 pl-1 mt-2 mr-2 float-left");
			add_location(label0, file, 350, 6, 10151);
			...
			attr_dev(textarea, "rows", "1");
			add_location(textarea, file, 390, 36, 11879);
			attr_dev(th, "class", "topic_input text-center svelte-12kbld3");
			attr_dev(th, "id", "hello");
			set_style(th, "background-color", /*theme_color*/ ctx[1][/*state*/ ctx[0].theme], 1);
			add_location(th, file, 385, 32, 11681);
			attr_dev(tr, "class", "table-head");
			add_location(tr, file, 384, 28, 11622);
			add_location(thead, file, 383, 24, 11585);
			add_location(tbody, file, 428, 24, 14241);
			attr_dev(table, "class", "table table-bordered relative w-100 ml-0 mt-0 svelte-12kbld3");
			attr_dev(table, "id", "my_table");
			add_location(table, file, 382, 20, 11480);
			attr_dev(div2, "class", "table-responsive mt-4 d-flex align-items-center");
			add_location(div2, file, 381, 16, 11395);
			add_location(strong, file, 470, 52, 17237);
			attr_dev(small, "class", "text-danger font13");
			add_location(small, file, 470, 16, 17201);
			...
			add_location(button0, file, 472, 24, 17398);
			...
			add_location(button1, file, 482, 6, 17747);
			attr_dev(div3, "class", "text-center");
			attr_dev(div3, "style", div3_style_value = 'width:100%;');
			add_location(div3, file, 471, 16, 17321);
			attr_dev(div4, "class", "col-12 col-lg-12 p-0");
			add_location(div4, file, 346, 12, 9878);
			attr_dev(div5, "id", "authoring");
			attr_dev(div5, "class", "p-2 border");
			add_location(div5, file, 345, 8, 9821);
			add_location(div6, file, 344, 4, 9806);
			add_location(main, file, 343, 0, 9794);
		},
...
//# sourceMappingURL=ChoiceMatrix-1da26e60.js.map
