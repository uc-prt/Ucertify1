...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, F as set_data_dev, G as prop_dev, B as noop, x as detach_dev, g as globals, y as l, P as Dialog, Q as binding_callbacks, R as bind, aa as afterUpdate, o as onMount, A as AH, a9 as swal, X as XMLToJSON, N as JSONToXML, w as writable, V as Button, aj as svg_element, c as create_component, Y as src_url_equal, m as mount_component, q as listen_dev, Z as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component } from './main-a3b8c24d.js';
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$1, 1572, 4, 96175);
			attr_dev(div0, "class", "row");
			add_location(div0, file$1, 1571, 3, 96152);
			add_location(div1, file$1, 1570, 2, 96142);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(i2, file$1, 1449, 178, 85531);
			attr_dev(button3, "type", "button");
			...
			add_location(i3, file$1, 1450, 183, 85758);
			...
			add_location(button4, file$1, 1450, 24, 85599);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file$1, 1451, 160, 85960);
			...
			add_location(button5, file$1, 1451, 24, 85824);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file$1, 1452, 160, 86161);
			...
			add_location(button6, file$1, 1452, 24, 86025);
			...
			add_location(button10, file$1, 1469, 24, 87525);
			attr_dev(div8, "class", "btn-group position-absolute setting_btn");
			add_location(div8, file$1, 1468, 20, 87446);
			...
			add_location(img, file$1, 1473, 20, 87796);
			attr_dev(title, "id", "authoringSvgTitle");
			add_location(title, file$1, 1475, 24, 88022);
			attr_dev(g0, "class", "backgroundFocusPath");
			add_location(g0, file$1, 1476, 24, 88097);
			attr_dev(g1, "class", "drawing_paths");
			add_location(g1, file$1, 1477, 24, 88158);
			attr_dev(g2, "class", "backgroundFocusPoint");
			add_location(g2, file$1, 1478, 24, 88213);
			...
			add_location(circle0, file$1, 1482, 36, 88470);
			...
			add_location(line, file$1, 1484, 40, 88646);
			add_location(g3, file$1, 1483, 36, 88601);
			...
			add_location(circle1, file$1, 1487, 40, 88877);
			...
			add_location(path0, file$1, 1491, 52, 89330);
			...
			add_location(path1, file$1, 1492, 52, 89481);
			...
			add_location(path2, file$1, 1493, 52, 89630);
			...
			add_location(circle3, file$1, 1501, 40, 90275);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file$1, 1507, 60, 90878);
			add_location(g5, file$1, 1506, 56, 90813);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file$1, 1510, 60, 91116);
			add_location(g6, file$1, 1509, 56, 91051);
			add_location(g7, file$1, 1505, 52, 90752);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file$1, 1515, 60, 91470);
			add_location(g8, file$1, 1514, 56, 91405);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file$1, 1518, 60, 91728);
			add_location(g9, file$1, 1517, 56, 91663);
			add_location(g10, file$1, 1513, 52, 91344);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file$1, 1504, 48, 90633);
			attr_dev(pattern1, "id", "drawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file$1, 1503, 44, 90532);
			add_location(defs1, file$1, 1502, 40, 90480);
			add_location(g11, file$1, 1500, 36, 90230);
			...
			add_location(circle4, file$1, 1526, 40, 92213);
			...
			add_location(circle5, file$1, 1536, 40, 93343);
			...
			add_location(circle6, file$1, 1537, 40, 93500);
			add_location(g13, file$1, 1535, 36, 93297);
			...
			add_location(circle7, file$1, 1540, 40, 93757);
			...
			add_location(path7, file$1, 1548, 68, 94825);
			...
			add_location(g17, file$1, 1544, 52, 94220);
			...
			add_location(svg3, file$1, 1543, 48, 94072);
			attr_dev(pattern3, "id", "lastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file$1, 1542, 44, 93966);
			add_location(defs3, file$1, 1541, 40, 93914);
			add_location(g18, file$1, 1539, 36, 93712);
			add_location(g19, file$1, 1481, 32, 88429);
			attr_dev(svg4, "class", "drawing-compass-wrapper");
			add_location(svg4, file$1, 1480, 28, 88358);
			attr_dev(svg5, "class", "drawing_compass_svg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file$1, 1479, 24, 88275);
			...
			add_location(svg6, file$1, 1474, 20, 87897);
			attr_dev(div9, "id", "centerImg");
			attr_dev(div9, "class", "centerImg authCenterImg my-auto relative ml-0");
			add_location(div9, file$1, 1467, 16, 87350);
			add_location(div10, file$1, 1466, 12, 87327);
...
//# sourceMappingURL=Drawing-5d76121a.js.map
