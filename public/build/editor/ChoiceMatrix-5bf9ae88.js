...
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option, file, 364, 8, 10923);
		},
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(th, file, 402, 40, 12940);
		},
		m: function mount(target, anchor) {
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(td, file, 450, 12, 16459);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 434, 44, 15336);
			attr_dev(span, "class", span_class_value = "" + (null_to_empty(/*icon_class*/ ctx[2]) + " svelte-12kbld3"));
			add_location(span, file, 446, 48, 16233);
			attr_dev(div, "class", "pointer pt-1 mt-sm2 ml-2 delete_row height34 svelte-12kbld3");
			attr_dev(div, "tab-index", "0");
			add_location(div, file, 441, 44, 15869);
			...
			add_location(td, file, 433, 40, 14994);
			attr_dev(tr, "key", tr_key_value = /*i*/ ctx[25]);
			add_location(tr, file, 432, 36, 14940);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(textarea, "rows", "1");
			add_location(textarea, file, 391, 36, 12278);
			...
			add_location(th, file, 386, 32, 11943);
			attr_dev(tr, "class", "table-head");
			add_location(tr, file, 385, 28, 11884);
			add_location(thead, file, 384, 24, 11847);
			add_location(tbody, file, 429, 24, 14780);
			attr_dev(table, "class", "table table-bordered relative w-100 ml-0 mt-0 svelte-12kbld3");
			attr_dev(table, "id", "my_table");
			add_location(table, file, 383, 20, 11742);
			attr_dev(div2, "class", "table-responsive mt-4 d-flex align-items-center");
			add_location(div2, file, 382, 16, 11657);
			add_location(strong, file, 472, 52, 18069);
			attr_dev(small, "class", "text-danger font13");
			add_location(small, file, 472, 16, 18033);
			...
			add_location(button0, file, 474, 24, 18230);
			...
			add_location(button1, file, 484, 6, 18579);
			attr_dev(div3, "class", "text-center");
			attr_dev(div3, "style", div3_style_value = "width:100%;");
			add_location(div3, file, 473, 16, 18153);
			attr_dev(div4, "class", "col-12 col-lg-12 p-0");
			add_location(div4, file, 347, 12, 10140);
			attr_dev(div5, "id", "authoring");
			attr_dev(div5, "class", "p-2 border");
			add_location(div5, file, 346, 8, 10083);
			add_location(div6, file, 345, 4, 10068);
			add_location(main, file, 344, 0, 10056);
		},
...
//# sourceMappingURL=ChoiceMatrix-5bf9ae88.js.map
