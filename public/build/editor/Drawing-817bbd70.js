...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, F as set_data_dev, G as prop_dev, B as noop, x as detach_dev, g as globals, a7 as Lang, a9 as afterUpdate, o as onMount, A as AH, a8 as swal, X as XMLToJSON, M as JSONToXML, w as writable, ai as svg_element, c as create_component, m as mount_component, q as listen_dev, t as transition_in, a as transition_out, b as destroy_component } from './main-674e3b87.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(i0, file$1, 1441, 231, 84453);
			attr_dev(button0, "type", "button");
			...
			add_location(button0, file$1, 1441, 24, 84246);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file$1, 1442, 24, 84518);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file$1, 1443, 210, 84924);
			attr_dev(button2, "type", "button");
			...
			add_location(button2, file$1, 1443, 24, 84738);
			...
			add_location(div0, file$1, 1440, 20, 84140);
			attr_dev(i2, "class", "icomoon-delete-sm");
			add_location(i2, file$1, 1446, 198, 85299);
			attr_dev(button3, "type", "button");
			...
			add_location(button3, file$1, 1446, 24, 85125);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file$1, 1447, 183, 85526);
			...
			add_location(button4, file$1, 1447, 24, 85367);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file$1, 1448, 160, 85728);
			...
			add_location(button5, file$1, 1448, 24, 85592);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file$1, 1449, 160, 85929);
			...
			add_location(button6, file$1, 1449, 24, 85793);
			...
			add_location(div1, file$1, 1445, 20, 85015);
			...
			add_location(button7, file$1, 1452, 24, 86113);
			...
			add_location(div2, file$1, 1451, 20, 86018);
			...
			add_location(button8, file$1, 1455, 24, 86446);
			...
			add_location(div3, file$1, 1454, 20, 86352);
			attr_dev(i6, "class", "icomoon-new-24px-reset-1");
			add_location(i6, file$1, 1458, 146, 86867);
			...
			add_location(div5, file$1, 1439, 16, 84028);
			attr_dev(div6, "id", "add_point_msg");
			attr_dev(div6, "class", "text-danger my-1");
			add_location(div6, file$1, 1461, 16, 86986);
			attr_dev(div7, "class", "mt-2 mb-2");
			add_location(div7, file$1, 1438, 12, 83987);
			attr_dev(i7, "class", "icomoon-24px-settings-1");
			add_location(i7, file$1, 1467, 28, 87440);
			...
			add_location(button10, file$1, 1466, 24, 87293);
			attr_dev(div8, "class", "btn-group position-absolute setting_btn");
			add_location(div8, file$1, 1465, 20, 87214);
			...
			add_location(img, file$1, 1470, 20, 87564);
			attr_dev(title, "id", "authoringSvgTitle");
			add_location(title, file$1, 1472, 24, 87790);
			attr_dev(g0, "class", "backgroundFocusPath");
			add_location(g0, file$1, 1473, 24, 87865);
			attr_dev(g1, "class", "drawing_paths");
			add_location(g1, file$1, 1474, 24, 87926);
			attr_dev(g2, "class", "backgroundFocusPoint");
			add_location(g2, file$1, 1475, 24, 87981);
			...
			add_location(circle0, file$1, 1479, 36, 88238);
			...
			add_location(line, file$1, 1481, 40, 88414);
			add_location(g3, file$1, 1480, 36, 88369);
			...
			add_location(circle1, file$1, 1484, 40, 88645);
			...
			add_location(path0, file$1, 1488, 52, 89098);
			...
			add_location(path1, file$1, 1489, 52, 89249);
			...
			add_location(path2, file$1, 1490, 52, 89398);
			...
			add_location(circle3, file$1, 1498, 40, 90043);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file$1, 1504, 60, 90646);
			add_location(g5, file$1, 1503, 56, 90581);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file$1, 1507, 60, 90884);
			add_location(g6, file$1, 1506, 56, 90819);
			add_location(g7, file$1, 1502, 52, 90520);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file$1, 1512, 60, 91238);
			add_location(g8, file$1, 1511, 56, 91173);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file$1, 1515, 60, 91496);
			add_location(g9, file$1, 1514, 56, 91431);
			add_location(g10, file$1, 1510, 52, 91112);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file$1, 1501, 48, 90401);
			attr_dev(pattern1, "id", "drawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file$1, 1500, 44, 90300);
			add_location(defs1, file$1, 1499, 40, 90248);
			add_location(g11, file$1, 1497, 36, 89998);
			...
			add_location(circle4, file$1, 1523, 40, 91981);
			...
			add_location(circle5, file$1, 1533, 40, 93111);
			...
			add_location(circle6, file$1, 1534, 40, 93268);
			add_location(g13, file$1, 1532, 36, 93065);
			...
			add_location(circle7, file$1, 1537, 40, 93525);
			...
			add_location(path7, file$1, 1545, 68, 94593);
			...
			add_location(g17, file$1, 1541, 52, 93988);
			...
			add_location(svg3, file$1, 1540, 48, 93840);
			attr_dev(pattern3, "id", "lastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file$1, 1539, 44, 93734);
			add_location(defs3, file$1, 1538, 40, 93682);
			add_location(g18, file$1, 1536, 36, 93480);
			add_location(g19, file$1, 1478, 32, 88197);
			attr_dev(svg4, "class", "drawing-compass-wrapper");
			add_location(svg4, file$1, 1477, 28, 88126);
			attr_dev(svg5, "class", "drawing_compass_svg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file$1, 1476, 24, 88043);
			...
			add_location(svg6, file$1, 1471, 20, 87665);
			attr_dev(div9, "id", "centerImg");
			attr_dev(div9, "class", "centerImg authCenterImg my-auto relative ml-0");
			add_location(div9, file$1, 1464, 16, 87118);
			add_location(div10, file$1, 1463, 12, 87095);
			add_location(center, file$1, 1437, 8, 83965);
			attr_dev(div11, "class", "drawing_module_container");
			add_location(div11, file$1, 1436, 4, 83917);
			add_location(main, file$1, 1435, 0, 83905);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=Drawing-817bbd70.js.map
