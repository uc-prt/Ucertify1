...
function add_css(target) {
	append_styles(target, "svelte-11usv4u", "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (576:2) {#if moduleArr[item_type] == "1" || moduleArr[item_type] == "2"}
function create_if_block_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(576:2) {#if moduleArr[item_type] == \\\"1\\\" || moduleArr[item_type] == \\\"2\\\"}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 657, 7, 21950);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 658, 7, 22042);
			...
			add_location(div0, file, 653, 6, 21768);
			...
			add_location(div1, file, 645, 5, 21559);
			...
			add_location(div2, file, 661, 5, 22128);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 644, 4, 21524);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 605, 10, 20461);
			...
			add_location(div0, file, 614, 10, 20756);
			...
			add_location(span, file, 627, 10, 21120);
			...
			add_location(div1, file, 592, 9, 20078);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 591, 8, 20036);
			attr_dev(td, "class", "border");
			add_location(td, file, 590, 7, 20007);
			add_location(tr, file, 589, 6, 19994);
			add_location(tbody, file, 588, 5, 19979);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 587, 4, 19894);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 675, 6, 22544);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 584, 2, 19757);
			add_location(center, file, 574, 1, 19472);
			...
			add_location(input, file, 686, 1, 22804);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 573, 0, 19463);
		},
...
//# sourceMappingURL=HotspotPreview-b854ff53.js.map
