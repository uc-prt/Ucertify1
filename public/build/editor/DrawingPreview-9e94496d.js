...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, a7 as Lang, v as validate_slots, o as onMount, A as AH, a8 as swal, a9 as afterUpdate, X as XMLToJSON, _ as onUserAnsChange, w as writable, e as element, f as space, h as text, ai as svg_element, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, F as set_data_dev, B as noop, x as detach_dev } from './main-4ecd610a.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h4, file, 2234, 20, 132997);
			attr_dev(button0, "type", "button");
			attr_dev(button0, "class", "close");
			attr_dev(button0, "data-bs-dismiss", "modal");
			add_location(button0, file, 2235, 20, 133061);
			attr_dev(div0, "class", "modal-header");
			add_location(div0, file, 2233, 16, 132949);
			attr_dev(td0, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td0, file, 2242, 61, 133530);
			attr_dev(span0, "class", "pl-3 font-weight-bold");
			add_location(span0, file, 2242, 155, 133624);
			attr_dev(div1, "class", "d-flex");
			add_location(div1, file, 2242, 135, 133604);
			attr_dev(td1, "class", "py-1");
			add_location(td1, file, 2242, 118, 133587);
			attr_dev(tr0, "tabindex", "0");
			attr_dev(tr0, "role", "shortcut");
			add_location(tr0, file, 2242, 28, 133497);
			attr_dev(td2, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td2, file, 2243, 61, 133757);
			attr_dev(span1, "class", "pl-3");
			add_location(span1, file, 2243, 157, 133853);
			attr_dev(div2, "class", "d-flex");
			add_location(div2, file, 2243, 137, 133833);
			attr_dev(td3, "class", "py-1");
			add_location(td3, file, 2243, 120, 133816);
			attr_dev(tr1, "tabindex", "0");
			attr_dev(tr1, "role", "shortcut");
			add_location(tr1, file, 2243, 28, 133724);
			attr_dev(td4, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td4, file, 2244, 62, 133967);
			attr_dev(span2, "class", "pl-3");
			add_location(span2, file, 2244, 158, 134063);
			attr_dev(div3, "class", "d-flex");
			add_location(div3, file, 2244, 138, 134043);
			attr_dev(td5, "class", "py-1");
			add_location(td5, file, 2244, 121, 134026);
			attr_dev(tr2, "tabindex", "0");
			attr_dev(tr2, "role", "shortcut");
			add_location(tr2, file, 2244, 28, 133933);
			attr_dev(td6, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td6, file, 2245, 62, 134176);
			attr_dev(span3, "class", "pl-3");
			add_location(span3, file, 2245, 158, 134272);
			attr_dev(div4, "class", "d-flex");
			add_location(div4, file, 2245, 138, 134252);
			attr_dev(td7, "class", "py-1");
			add_location(td7, file, 2245, 121, 134235);
			attr_dev(tr3, "tabindex", "0");
			attr_dev(tr3, "role", "shortcut");
			add_location(tr3, file, 2245, 28, 134142);
			attr_dev(td8, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td8, file, 2246, 62, 134386);
			attr_dev(span4, "class", "pl-3");
			add_location(span4, file, 2246, 157, 134481);
			attr_dev(div5, "class", "d-flex");
			add_location(div5, file, 2246, 137, 134461);
			attr_dev(td9, "class", "py-1");
			add_location(td9, file, 2246, 120, 134444);
			attr_dev(tr4, "tabindex", "0");
			attr_dev(tr4, "role", "shortcut");
			add_location(tr4, file, 2246, 28, 134352);
			attr_dev(td10, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td10, file, 2247, 62, 134602);
			attr_dev(span5, "class", "pl-3");
			add_location(span5, file, 2247, 163, 134703);
			attr_dev(div6, "class", "d-flex");
			add_location(div6, file, 2247, 143, 134683);
			attr_dev(td11, "class", "py-1");
			add_location(td11, file, 2247, 126, 134666);
			attr_dev(tr5, "tabindex", "0");
			attr_dev(tr5, "role", "shortcut");
			add_location(tr5, file, 2247, 28, 134568);
			attr_dev(td12, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td12, file, 2248, 62, 134828);
			attr_dev(span6, "class", "pl-3");
			add_location(span6, file, 2248, 163, 134929);
			attr_dev(div7, "class", "d-flex");
			add_location(div7, file, 2248, 143, 134909);
			attr_dev(td13, "class", "py-1");
			add_location(td13, file, 2248, 126, 134892);
			attr_dev(tr6, "tabindex", "0");
			attr_dev(tr6, "role", "shortcut");
			add_location(tr6, file, 2248, 28, 134794);
			attr_dev(td14, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td14, file, 2249, 62, 135052);
			attr_dev(span7, "class", "pl-3");
			add_location(span7, file, 2249, 159, 135149);
			attr_dev(div8, "class", "d-flex");
			add_location(div8, file, 2249, 139, 135129);
			attr_dev(td15, "class", "py-1");
			add_location(td15, file, 2249, 122, 135112);
			attr_dev(tr7, "tabindex", "0");
			attr_dev(tr7, "role", "shortcut");
			add_location(tr7, file, 2249, 28, 135018);
			attr_dev(td16, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td16, file, 2250, 62, 135270);
			attr_dev(span8, "class", "pl-3");
			add_location(span8, file, 2250, 160, 135368);
			attr_dev(div9, "class", "d-flex");
			add_location(div9, file, 2250, 140, 135348);
			attr_dev(td17, "class", "py-1");
			add_location(td17, file, 2250, 123, 135331);
			attr_dev(tr8, "tabindex", "0");
			attr_dev(tr8, "role", "shortcut");
			add_location(tr8, file, 2250, 28, 135236);
			attr_dev(td18, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td18, file, 2251, 62, 135486);
			attr_dev(span9, "class", "pl-3");
			add_location(span9, file, 2251, 155, 135579);
			attr_dev(div10, "class", "d-flex");
			add_location(div10, file, 2251, 135, 135559);
			attr_dev(td19, "class", "py-1");
			add_location(td19, file, 2251, 118, 135542);
			attr_dev(tr9, "tabindex", "0");
			attr_dev(tr9, "role", "shortcut");
			add_location(tr9, file, 2251, 28, 135452);
			attr_dev(td20, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td20, file, 2252, 62, 135699);
			attr_dev(span10, "class", "pl-3");
			add_location(span10, file, 2252, 161, 135798);
			attr_dev(div11, "class", "d-flex");
			add_location(div11, file, 2252, 141, 135778);
			attr_dev(td21, "class", "py-1");
			add_location(td21, file, 2252, 124, 135761);
			attr_dev(tr10, "tabindex", "0");
			attr_dev(tr10, "role", "shortcut");
			add_location(tr10, file, 2252, 28, 135665);
			attr_dev(td22, "class", "py-1 font-weight-bold w-50 pr-0");
			add_location(td22, file, 2253, 62, 135918);
			attr_dev(span11, "class", "pl-3");
			add_location(span11, file, 2253, 155, 136011);
			attr_dev(div12, "class", "d-flex");
			add_location(div12, file, 2253, 135, 135991);
			attr_dev(td23, "class", "py-1");
			add_location(td23, file, 2253, 118, 135974);
			attr_dev(tr11, "tabindex", "0");
			attr_dev(tr11, "role", "shortcut");
			add_location(tr11, file, 2253, 28, 135884);
			attr_dev(tbody, "tabindex", "0");
			attr_dev(tbody, "role", "shortcut");
			add_location(tbody, file, 2241, 24, 133431);
			...
			add_location(button4, file, 2270, 24, 136911);
			...
			add_location(button5, file, 2271, 24, 137209);
			attr_dev(i1, "class", "icomoon-compass1");
			add_location(i1, file, 2272, 252, 137686);
			...
			add_location(button6, file, 2272, 24, 137458);
			...
			add_location(div18, file, 2269, 20, 136805);
			attr_dev(i2, "class", "icomoon-delete-sm");
			add_location(i2, file, 2275, 224, 138087);
			...
			add_location(button7, file, 2275, 24, 137887);
			attr_dev(i3, "class", "icomoon-close-2");
			add_location(i3, file, 2276, 209, 138340);
			...
			add_location(button8, file, 2276, 24, 138155);
			attr_dev(i4, "class", "icomoon-redo-2");
			add_location(i4, file, 2277, 178, 138560);
			...
			add_location(button9, file, 2277, 24, 138406);
			attr_dev(i5, "class", "icomoon-undo-2");
			add_location(i5, file, 2278, 178, 138779);
			...
			add_location(button10, file, 2278, 24, 138625);
			...
			add_location(div19, file, 2274, 20, 137777);
			...
			add_location(button11, file, 2281, 24, 138978);
			...
			add_location(div20, file, 2280, 20, 138868);
			attr_dev(i6, "class", "icomoon-new-24px-reset-1");
			add_location(i6, file, 2284, 182, 139470);
			...
			add_location(button12, file, 2284, 24, 139312);
			...
			add_location(div21, file, 2283, 20, 139212);
			...
			add_location(button13, file, 2287, 24, 139661);
			...
			add_location(div22, file, 2286, 20, 139569);
			...
			add_location(div23, file, 2268, 16, 136690);
			attr_dev(div24, "class", "mt-2 mb-3 previewBtnGrp");
			add_location(div24, file, 2267, 12, 136635);
			...
			add_location(circle0, file, 2307, 36, 141049);
			...
			add_location(line, file, 2309, 40, 141298);
			add_location(g5, file, 2308, 36, 141253);
			...
			add_location(circle1, file, 2312, 40, 141563);
			attr_dev(title1, "id", "compassCenterTitle");
			add_location(title1, file, 2313, 40, 141834);
			attr_dev(desc0, "id", "compassCenterDesc");
			add_location(desc0, file, 2314, 40, 141933);
			...
			add_location(path0, file, 2318, 52, 142320);
			...
			add_location(path1, file, 2319, 52, 142471);
			...
			add_location(path2, file, 2320, 52, 142620);
			...
			add_location(circle3, file, 2328, 40, 143265);
			attr_dev(title2, "id", "compassRadiusTitle");
			add_location(title2, file, 2329, 40, 143562);
			attr_dev(desc1, "id", "compassRadiusDesc");
			add_location(desc1, file, 2330, 40, 143707);
			attr_dev(rect0, "x", "8.53");
			attr_dev(rect0, "y", "1.11");
			attr_dev(rect0, "width", "1.5");
			attr_dev(rect0, "height", "21.79");
			add_location(rect0, file, 2336, 60, 144212);
			add_location(g7, file, 2335, 56, 144147);
			attr_dev(rect1, "x", "13.97");
			attr_dev(rect1, "y", "1.11");
			attr_dev(rect1, "width", "1.5");
			attr_dev(rect1, "height", "21.79");
			add_location(rect1, file, 2339, 60, 144450);
			add_location(g8, file, 2338, 56, 144385);
			add_location(g9, file, 2334, 52, 144086);
			attr_dev(path4, "d", "M5.87,16.87L1,12l4.87-4.87C5.87,10.38,5.87,13.62,5.87,16.87z");
			add_location(path4, file, 2344, 60, 144804);
			add_location(g10, file, 2343, 56, 144739);
			attr_dev(path5, "d", "M18.13,16.87L23,12l-4.87-4.87C18.13,10.38,18.13,13.62,18.13,16.87z");
			add_location(path5, file, 2347, 60, 145062);
			add_location(g11, file, 2346, 56, 144997);
			add_location(g12, file, 2342, 52, 144678);
			attr_dev(svg1, "x", "0px");
			attr_dev(svg1, "y", "0px");
			attr_dev(svg1, "viewBox", "1 -5 21 34");
			attr_dev(svg1, "width", "33");
			attr_dev(svg1, "height", "33");
			add_location(svg1, file, 2333, 48, 143967);
			attr_dev(pattern1, "id", "previewDrawingRadius");
			attr_dev(pattern1, "width", "20");
			attr_dev(pattern1, "height", "20");
			add_location(pattern1, file, 2332, 44, 143859);
			add_location(defs1, file, 2331, 40, 143807);
			add_location(g13, file, 2327, 36, 143220);
			...
			add_location(circle4, file, 2355, 40, 145547);
			attr_dev(title3, "id", "compassRotationTitle");
			add_location(title3, file, 2356, 40, 145924);
			attr_dev(desc2, "id", "compassRotationDesc");
			add_location(desc2, file, 2357, 40, 146057);
			...
			add_location(circle5, file, 2367, 40, 147083);
			...
			add_location(circle6, file, 2368, 40, 147239);
			attr_dev(title4, "id", "compassAngleTitle");
			add_location(title4, file, 2369, 40, 147511);
			attr_dev(desc3, "id", "compassAngleDesc");
			add_location(desc3, file, 2370, 40, 147607);
			add_location(g15, file, 2366, 36, 147038);
			...
			add_location(circle7, file, 2373, 40, 147787);
			...
			add_location(path7, file, 2381, 68, 148900);
			...
			add_location(g19, file, 2377, 52, 148295);
			...
			add_location(svg3, file, 2376, 48, 148147);
			attr_dev(pattern3, "id", "previewLastCircleMid_icon");
			attr_dev(pattern3, "width", "20");
			attr_dev(pattern3, "height", "20");
			add_location(pattern3, file, 2375, 44, 148034);
			add_location(defs3, file, 2374, 40, 147982);
			add_location(g20, file, 2372, 36, 147742);
			add_location(g21, file, 2306, 32, 141008);
			add_location(svg4, file, 2305, 28, 140969);
			attr_dev(svg5, "class", "drawingCompassSvg h");
			attr_dev(svg5, "focusable", "false");
			add_location(svg5, file, 2304, 24, 140888);
			...
			add_location(svg6, file, 2297, 20, 140347);
			attr_dev(div26, "id", "centerImg");
			attr_dev(div26, "class", "centerImg centerImgPreview my-auto relative ml-0");
			add_location(div26, file, 2292, 16, 139982);
			add_location(div27, file, 2291, 12, 139959);
			attr_dev(center, "class", "preview_drawing_container");
			add_location(center, file, 2266, 8, 136579);
			attr_dev(div28, "class", "drawing_module_container");
			add_location(div28, file, 2263, 4, 136383);
			attr_dev(main, "id", "drawingPreviewMain");
			add_location(main, file, 2229, 0, 132730);
		},
...
//# sourceMappingURL=DrawingPreview-9e94496d.js.map
