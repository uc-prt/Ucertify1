...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1121, 3, 34989);
			...
			add_location(div1, file, 1134, 3, 35870);
			...
			add_location(button, file, 1152, 5, 36956);
			attr_dev(div2, "class", div2_class_value = /*state*/ ctx[5].hideNext ? "h-imp" : null);
			add_location(div2, file, 1151, 4, 36905);
			add_location(center, file, 1109, 2, 34341);
		},
...
// (1124:4) {#each state.itemArray as item, index}
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 1127, 9, 35745);
			...
			add_location(div1, file, 1126, 8, 35527);
			...
			add_location(div2, file, 1125, 7, 35261);
			...
			add_location(div3, file, 1124, 6, 35172);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1124:4) {#each state.itemArray as item, index}",
		ctx
	});
...
// (1136:4) {#each answer_array as item,index}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(div0, "seq", div0_seq_value = "s" + /*index*/ ctx[69]);
			add_location(div0, file, 1140, 9, 36595);
			attr_dev(div1, "id", div1_id_value = "data-block_" + /*index*/ ctx[69]);
			...
			attr_dev(div1, "key", div1_key_value = /*index*/ ctx[69]);
			add_location(div1, file, 1139, 8, 36377);
			attr_dev(div2, "id", div2_id_value = "s" + /*index*/ ctx[69]);
			...
			add_location(div2, file, 1138, 7, 36111);
			attr_dev(div3, "data-sticky", div3_data_sticky_value = /*isSticky*/ ctx[6](/*index*/ ctx[69]));
			attr_dev(div3, "class", "bt-pd bg-white mt-3");
			add_location(div3, file, 1137, 6, 36039);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div3, anchor);
			append_dev(div3, div2);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1136:4) {#each answer_array as item,index}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1148:3) {#if state.showToolbar}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			main = element("main");
			if (if_block) if_block.c();
			add_location(main, file, 1106, 0, 34298);
		},
...
//# sourceMappingURL=ItemPluginPreview-e80f55e6.js.map
