...
function add_css() {
	...
	style.textContent = "main.svelte-11usv4u{text-align:center !important;padding:1em;max-width:240px;margin:0 auto;font-size:26px}.targetImg.svelte-11usv4u{display:none;position:absolute;z-index:10;width:17px;height:15px;border-radius:50%;background:#fff;color:#1c3ad4}.showBlock.svelte-11usv4u{display:block}@media(min-width: 640px){main.svelte-11usv4u{max-width:none}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 587, 7, 19978);
			attr_dev(span1, "class", "position-relative bottom1");
			add_location(span1, file, 588, 7, 20070);
			...
			add_location(div0, file, 583, 6, 19796);
			...
			add_location(div1, file, 575, 5, 19587);
			...
			add_location(div2, file, 591, 5, 20156);
			attr_dev(center, "key", "imageHeight_3");
			add_location(center, file, 574, 4, 19552);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 535, 10, 18489);
			...
			add_location(div0, file, 544, 10, 18784);
			...
			add_location(span, file, 557, 10, 19148);
			...
			add_location(div1, file, 522, 9, 18106);
			attr_dev(div2, "id", "SM0");
			attr_dev(div2, "class", "relative");
			add_location(div2, file, 521, 8, 18064);
			attr_dev(td, "class", "border");
			add_location(td, file, 520, 7, 18035);
			add_location(tr, file, 519, 6, 18022);
			add_location(tbody, file, 518, 5, 18007);
			attr_dev(table, "id", "hptmain0");
			attr_dev(table, "class", "smbase smhotspot border-0 h-auto w-auto uc-table");
			add_location(table, file, 517, 4, 17922);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 605, 6, 20572);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 514, 2, 17785);
			add_location(center, file, 509, 1, 17685);
			...
			add_location(input, file, 616, 1, 20833);
			attr_dev(textarea, "class", "h");
			attr_dev(textarea, "id", "special_module_user_xml");
			add_location(textarea, file, 623, 1, 20967);
			attr_dev(main, "class", "svelte-11usv4u");
			add_location(main, file, 508, 0, 17676);
		},
...
//# sourceMappingURL=HotspotPreview-253f0f6b.js.map
