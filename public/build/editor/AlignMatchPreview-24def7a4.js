...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, C as validate_each_argument, e as element, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, x as detach_dev, K as destroy_each, h as text, F as set_data_dev, z as empty, B as noop, g as globals, A as AH, a9 as add_render_callback, o as onMount, a7 as afterUpdate, X as XMLToJSON, _ as onUserAnsChange, y as language, q as listen_dev, ah as prevent_default, H as run_all, c as create_component, m as mount_component, t as transition_in, a as transition_out, b as destroy_component, l as set_style, r as group_outros, u as check_outros } from './main-ad414885.js';
...
function create_if_block_4$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(682:44) {#if datai.id == dataj.category && (ignoreItemIds.indexOf(dataj.id) == -1)}",
		ctx
	});
...
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 683, 52, 35356);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(683:48) {#if state.correct_match['category_'+ dataj.sequence] == false}",
		ctx
	});
...
function create_if_block_7(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 687, 60, 36042);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			div.innerHTML = raw_value;
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$1, 685, 60, 35629);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(685:56) {#if dataj.imageurl != ''}",
		ctx
	});
...
function create_each_block_1$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(681:40) {#each state.xml.item.items as dataj}",
		ctx
	});
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file$1, 671, 28, 34287);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(669:16) {#each state.xml.category.categories as datai, index}",
		ctx
	});
...
function create_if_block_2$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 706, 16, 37040);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(706:12) {#if AH.get('alignMatchReset') == true}",
		ctx
	});
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 709, 16, 37255);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t);
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 716, 16, 37550);
			attr_dev(div1, "class", "yourAnswer");
			add_location(div1, file$1, 719, 16, 37774);
			attr_dev(div2, "class", "scoreDiv");
			add_location(div2, file$1, 715, 12, 37511);
			attr_dev(div3, "class", "finalResult");
			add_location(div3, file$1, 714, 8, 37473);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(714:4) {#if targetView == 'block'}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 656, 4, 33288);
			...
			add_location(div2, file$1, 704, 8, 36946);
			...
			add_location(div3, file$1, 665, 4, 33684);
			add_location(div4, file$1, 655, 0, 33278);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=AlignMatchPreview-24def7a4.js.map
