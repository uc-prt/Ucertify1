...
import { F as FillInTheBlanksToolbar } from './mathquill-42af0184.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div4, file, 917, 2, 32178);
			add_location(center1, file, 906, 1, 31932);
			attr_dev(div5, "class", div5_class_value = /*xml*/ ctx[2] ? "mx-4 pl-2 pl-md-0" : "");
			add_location(div5, file, 905, 0, 31886);
		},
...
class FillInTheBlanksPreview extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document_1.getElementById("svelte-1n3vsyo-style")) add_css();
...
//# sourceMappingURL=FillInTheBlanksPreview-ff5b753f.js.map
