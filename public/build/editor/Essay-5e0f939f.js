...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, M as append_styles, W as Checkbox, Q as binding_callbacks, R as bind, v as validate_slots, o as onMount, A as AH, X as XMLToJSON, L as beforeUpdate, e as element, h as text, f as space, j as attr_dev, k as add_location, n as insert_dev, p as append_dev, q as listen_dev, F as set_data_dev, G as prop_dev, x as detach_dev, H as run_all, c as create_component, m as mount_component, $ as add_flush_callback, t as transition_in, a as transition_out, b as destroy_component } from './main-3d161efa.js';
...
function add_css(target) {
	append_styles(target, "svelte-j2f4ig", "a:hover{text-decoration:none}.hero-unit.svelte-j2f4ig.svelte-j2f4ig{border:1px solid #ccc;width:84%;padding:18px!important;font-size:15px!important;margin-bottom:30px;font-weight:200;line-height:30px;color:inherit;background-color:#eeeeee;-webkit-border-radius:6px;-moz-border-radius:6px;border-radius:6px}#essay_editorAuth.svelte-j2f4ig.svelte-j2f4ig{max-height:250px;height:250px;background-color:white;border-collapse:separate;border:1px solid rgb(204, 204, 204);padding:4px;box-sizing:content-box;-webkit-box-shadow:rgba(0, 0, 0, 0.0745098) 0px 1px 1px 0px inset;box-shadow:rgba(0, 0, 0, 0.0745098) 0px 1px 1px 0px inset;border-top-right-radius:3px;border-bottom-right-radius:3px;border-bottom-left-radius:3px;border-top-left-radius:3px;overflow:scroll;outline:none}.essay-container .upload-area.svelte-j2f4ig #files_number.svelte-j2f4ig{width:115px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (156:8) <Checkbox                bind:checked={isUpload}              on:click={updateXML}              id="uploadChk"              name="uploadChk"              color="primary"          >
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file, 162, 12, 6398);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(156:8) <Checkbox                bind:checked={isUpload}              on:click={updateXML}              id=\\\"uploadChk\\\"              name=\\\"uploadChk\\\"              color=\\\"primary\\\"          >",
		ctx
	});
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label0, file, 168, 24, 6621);
			attr_dev(div0, "class", "col-sm-3");
			add_location(div0, file, 167, 20, 6573);
			option0.__value = "*.txt,*.doc,*.docx,*.pdf,*.jpg,*.png,*.gif,*.bmp,*.jpeg";
			option0.value = option0.__value;
			option0.selected = "selected";
			add_location(option0, file, 172, 28, 6943);
			option1.__value = "*.txt";
			option1.value = option1.__value;
			add_location(option1, file, 173, 28, 7082);
			option2.__value = "*.pdf";
			option2.value = option2.__value;
			add_location(option2, file, 174, 28, 7148);
			option3.__value = "*.doc,*.docx";
			option3.value = option3.__value;
			add_location(option3, file, 175, 28, 7214);
			option4.__value = "*.doc,*.docx,*.pdf";
			option4.value = option4.__value;
			add_location(option4, file, 176, 28, 7294);
			option5.__value = "*.jpg,*.png,*.gif,*.bmp,*.jpeg";
			option5.value = option5.__value;
			add_location(option5, file, 177, 28, 7386);
			attr_dev(select, "name", "choose_ext");
			attr_dev(select, "id", "choose_ext");
			attr_dev(select, "class", "form-control form-control-md");
			add_location(select, file, 171, 24, 6802);
			attr_dev(div1, "class", "col-sm-8");
			add_location(div1, file, 170, 20, 6754);
			attr_dev(div2, "class", "row");
			add_location(div2, file, 166, 16, 6534);
			attr_dev(label1, "for", "files_number");
			attr_dev(label1, "class", "mb-0 font14 pt-1");
			add_location(label1, file, 183, 24, 7669);
			attr_dev(div3, "class", "col-sm-3");
			add_location(div3, file, 182, 20, 7621);
			...
			add_location(input, file, 186, 24, 7846);
			attr_dev(small, "class", "font11");
			add_location(small, file, 198, 24, 8417);
			attr_dev(div4, "class", "col-sm-8");
			add_location(div4, file, 185, 20, 7798);
			attr_dev(div5, "class", "row mt-2");
			add_location(div5, file, 181, 16, 7577);
			attr_dev(div6, "class", "upload-area mt-3 text-left svelte-j2f4ig");
			add_location(div6, file, 165, 12, 6476);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=Essay-5e0f939f.js.map
