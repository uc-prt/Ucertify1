...
function create_else_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span0, file, 522, 24, 26066);
			...
			add_location(span1, file, 539, 28, 27487);
			...
			add_location(button0, file, 531, 24, 27065);
			...
			add_location(span2, file, 550, 28, 28274);
			...
			add_location(button1, file, 541, 24, 27803);
			...
			add_location(span3, file, 563, 28, 29107);
			...
			add_location(button2, file, 552, 24, 28519);
			...
			add_location(div6, file, 530, 20, 26899);
			attr_dev(div7, "class", "border rounded shadow-sm");
			add_location(div7, file, 519, 16, 25761);
			attr_dev(div8, "class", "col-12 col-md-8 offset-md-2");
			add_location(div8, file, 518, 12, 25702);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(b, file, 514, 62, 25319);
			attr_dev(label, "for", "preview_show_transcript");
			add_location(label, file, 514, 25, 25282);
			add_location(div0, file, 514, 20, 25277);
			...
			add_location(textarea, file, 515, 20, 25378);
			attr_dev(div1, "class", "col-12 pb-3");
			add_location(div1, file, 513, 16, 25230);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 490, 20, 23990);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 489, 16, 23943);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(textarea, file, 478, 20, 23437);
			attr_dev(div, "class", "col-12 py-3");
			add_location(div, file, 477, 16, 23390);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, textarea);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button0, file, 577, 20, 29792);
			attr_dev(div2, "class", "modal-header");
			add_location(div2, file, 575, 16, 29615);
			...
			add_location(div3, file, 579, 16, 29995);
			attr_dev(button1, "type", "button");
			...
			add_location(button1, file, 583, 20, 30262);
			attr_dev(button2, "type", "button");
...
//# sourceMappingURL=AudioPreview-88667b24.js.map
