...
// (465:28) <Checkbox on:click={updateSetting} id="allowSort" color="" checked = {((state.allowSort == 1)? true : false)}>
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(465:28) <Checkbox on:click={updateSetting} id=\\\"allowSort\\\" color=\\\"\\\" checked = {((state.allowSort == 1)? true : false)}>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input, file, 480, 36, 19234);
			attr_dev(div0, "class", "col-1");
			add_location(div0, file, 479, 36, 19177);
			...
			add_location(textarea, file, 482, 40, 19583);
			attr_dev(div1, "class", "col");
			add_location(div1, file, 481, 36, 19524);
			...
			add_location(span, file, 488, 40, 20026);
			add_location(div2, file, 487, 36, 19979);
			attr_dev(div3, "class", "form-row mt-head");
			add_location(div3, file, 478, 32, 19109);
			attr_dev(div4, "class", "clearfix mt choose_options");
			attr_dev(div4, "key", div4_key_value = /*i*/ ctx[27]);
			add_location(div4, file, 477, 28, 19027);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h4, file, 520, 8, 21713);
			attr_dev(span, "class", "col-md-12 mt-4");
			add_location(span, file, 522, 12, 21775);
			attr_dev(div, "class", "row");
			add_location(div, file, 521, 8, 21744);
		},
		m: function mount(target, anchor) {
...
function create_footer_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			input.value = "No";
			add_location(input, file, 526, 12, 21922);
			attr_dev(div, "slot", "footer");
			attr_dev(div, "class", "svelteFooter");
			add_location(div, file, 525, 8, 21868);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div2, file, 466, 24, 18283);
			attr_dev(div3, "class", "col-md-3 pd-0 float-left");
			add_location(div3, file, 469, 24, 18559);
			...
			add_location(b, file, 501, 59, 20814);
			attr_dev(p, "class", "mb-md");
			add_location(p, file, 500, 24, 20736);
			attr_dev(div6, "class", "alert alert-info message_content");
			add_location(div6, file, 499, 20, 20664);
			attr_dev(span, "class", "addbuttonplus svelte-1afsy3o");
			add_location(span, file, 510, 44, 21270);
			...
			add_location(button, file, 504, 20, 20943);
			attr_dev(div7, "class", "choose_item_container mb ps-4");
			add_location(div7, file, 474, 16, 18881);
			attr_dev(input1, "id", "check");
			attr_dev(input1, "type", "hidden");
			attr_dev(input1, "class", "");
			input1.value = "";
			add_location(input1, file, 513, 16, 21401);
			...
			add_location(input2, file, 514, 16, 21472);
...
//# sourceMappingURL=ChooseNReorder-64f66d7a.js.map
