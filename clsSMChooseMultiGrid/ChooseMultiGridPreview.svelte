...
<script>
    ...
    $: {
        if (xml != state.xml) {	
            ...
            loadModule(xml);
            box_width = ((638 - preview_data.countcol * 2) / preview_data.countcol).toFixed(2) + 'px';
		}
    }
...
<link
	...
	rel="preload"
	as="style"
	href={editor.baseUrlTheme + "pe-items/svelte/clsSMChooseMultiGrid/css/ChooseMultiGrid.min.css"}
/>
<div id="chid">
	<ItemHelper
