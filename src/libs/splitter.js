(function($, undefined) {
    ...
    $.fn.split = function(options, p1 = '', p2 = '') {
        ...
        if(p1 != '' || p2 != '') { 
        	if (settings.orientation == 'vertical') {
            	panel_1 = panel_1.addClass('left_panel');
            	panel_2 = panel_2.addClass('right_panel');
            	cls = 'vsplitter';
        	} else if (settings.orientation == 'horizontal') {
            	panel_1 = panel_1.addClass('top_panel');
            	panel_2 = panel_2.addClass('bottom_panel');
            	cls = 'hsplitter';
        	}
        } else {
        	if (settings.orientation == 'vertical') {
