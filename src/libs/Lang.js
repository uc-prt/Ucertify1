...
module.exports = {
    ...
    descp_welcome : "This is the welcome page that contains home page link, you can navigate to my library and go to previous link. It will also provide the link for updating your profile",
    descp_cover : "This is the Dashboard that contains the course components. You can also go to the studyplanner, certification of completion, and test history from here. The shortcut for the course navigation is Alt+G.", 
    descp_start_test_4 : "This is the Pre Assessment Dashboard. The shortcut keys available are. Alt+G for course navgation. Alt+S to start the assessment. Alt+K for going back.",
    descp_start_test_2 : "This is the Pre Assessment Dashboard which contains questions to assess your knowledge of the course topics before you begin the course. The shortcut keys available are. Alt+G for course navgation. Alt+L for learn with immediate feedback. Alt+T to start the test. Alt+R for the review. Alt+K for going back",
    descp_analytics : "This page contains Test History and Progress Report, Study Planner, and Performance on Practice Test. The shortcut key used for course navgation is Alt+G.",
    descp_report_test_performance : "This is the Performance on Practice Tests page which contains the graphical description of the practice test. You can select the required option from the See reports of dropdown list. The shortcut key used for course navgation is Alt+G.",
    search_toc : "This is the Search field from where you can search the content in the TOC.",
}