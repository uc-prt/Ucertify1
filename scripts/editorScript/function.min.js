...
const ucFeature_image_annotation = {
    ...
    function wguVideoPlayer(t,e){var i="",a="";if(t.getAttribute("security")&&""!=t.getAttribute("security"))for(var r in i=JSON.parse(t.getAttribute("security")))a+=""!=a?"&"+r+"="+i[r]:r+"="+i[r];var o="https://fod.infobase.com/OnDemandEmbed.aspx?"+a+"&amp;plt=FOD",l='<iframe tabindex-1" title="'+e+'" allowfullscreen="" frameborder="0" height="410" src="https://wgu.idm.oclc.org/login?url='+o+'&amp;w=640&amp;h=360&amp;fWidth=660&amp;fHeight=410&#10;ref=http://wgu.libguides.com.wgu.idm.oclc.org/c.php?g=57662&amp;p=1384747" style="border:1px solid #ddd;" width="660">&amp;amp;nbsp;</iframe>',p='<div class="alert alert-info clearfix"><b>Error in displaying video?</b> Please click on SHOW VIDEO button to open the video in new tab.';p+='<a class="btn btn-primary float-right" href="'+("https://wgu.idm.oclc.org/login?&url="+o+"&amp;w=640&amp;h=360&amp;fWidth=660&amp;fHeight=410")+'" target="_blank">Show Video</a></div>',t.insertAdjacentHTML("beforeend",p+l)}