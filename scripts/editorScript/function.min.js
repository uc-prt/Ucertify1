...
e+'" ><label class="border exam_obj_label d-flex p rounded"><input type="checkbox" class="exam_obj_radio h" name="exam_obj[]" id="radio_'+e+'" value="'+e+'" /><div class="mt-sm"></div><span>'+c[d].c[e].n+"</span></label></li>","beforeend")}checkedExamObjective(a);AI.activate(0)})):checkedExamObjective(a)}
