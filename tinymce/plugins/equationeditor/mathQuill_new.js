...
(function() {
    ...
    var manageTextarea = (function() {
        ...
        return function manageTextarea(el, opts) {
            ...
            var textarea = typeof el == "function" ? el : document.querySelector(el);
    ...
    LatexCmds.overarc = LatexCmds.bar = bind(Style, '\\overset{\\frown}', 'span', 'class="non-leaf overarc"');
    ...
    LatexCmds.openquotes = P(BinaryOperator, function(_, _super) {
        _.init = function(latex) {
            _super.init.call(this, '``', '&#8220;');
        };
    });

    LatexCmds.closequotes = P(BinaryOperator, function(_, _super) {
        _.init = function(latex) {
            _super.init.call(this, '"', '&#8221;');
        };
    });
