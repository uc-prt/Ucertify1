...
tinymce.PluginManager.add('lists', function(editor) {
	...
	editor.on('init', function() {
		...
		function indent(li) {
			var sibling, newList, listStyle, parentClass,nested;
			...
			if($(sibling.parentNode).attr("nested")) {
				parentClass = $(sibling.parentNode).attr("nested").split(",")[0];
				var remainingClass = $(sibling.parentNode).attr("nested").split(",");
