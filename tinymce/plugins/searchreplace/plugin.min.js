...
(function() {
    ...
    function Plugin(editor) {
        ...
        function showDialog() {
            ...
            //@pradeep : tinymce does not accept blank selection in this version
            if(!selectedText){
               swal("Please select text first to find !");
                return false;
            }
            ...
            function endOfDocument() {
                editor.windowManager.alert('You reached end of the document', function() {
                    win.find('#find')[0].focus();
                });
            }
            ...
            function replaced() {
                ...
                editor.windowManager.alert(findCount+' '+item+' replaced.', function() {
                    win.find('#find')[0].focus();
                });
            }
            ...
            function found_items() {
                ...
                editor.windowManager.alert(findCount+' '+item+' found.', function() {
                    win.find('#find')[0].focus();
                });
            }
            ...
            setTimeout(function(){
                $(document).find('label').each(function(){
                    if($(this).html() == "Find") {
                        var local_html = $(this).parent().clone();
                        var __this = $(this).parent();
                        local_html = JSON.stringify(local_html.html());
                        local_html = local_html.replace("\\u0001|\\b","\n").replace(/\\/g,"");
                        // @pradeep: This is causing problem
                        //$(this).parent().html('');
                        $(local_html).each(function(){
                            if($(this)[0].nodeName == "INPUT") {
                                $(this).val(selectedText);
                            }
                            if($(this)[0].nodeName != "#text") {
                                __this.parent().append($(this));
                            }
                        });
                    } 
                });
